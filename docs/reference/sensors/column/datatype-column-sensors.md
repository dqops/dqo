...
All [data quality sensors](../../../dqo-concepts/sensors/sensors.md) in the **datatype** category supported by DQOps are listed below. Those sensors are measured on a column level.
