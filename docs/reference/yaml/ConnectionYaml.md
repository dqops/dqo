...
|[mysql](../ConnectionYaml/#MysqlParametersSpec)|MySQL connection parameters. Specify parameters in the sqlserver section or set the url (which is the MySQL JDBC url).|[MysqlParametersSpec](../ConnectionYaml/#MysqlParametersSpec)| | | |
|[oracle](../ConnectionYaml/#OracleParametersSpec)|Oracle connection parameters. Specify parameters in the postgresql section or set the url (which is the Oracle JDBC url).|[OracleParametersSpec](../ConnectionYaml/#OracleParametersSpec)| | | |
