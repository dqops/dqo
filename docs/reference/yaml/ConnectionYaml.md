...
|properties||Dict[string, string]| | | |
|athena_authentication_mode|The authentication mode for AWS Athena. Supports also a ${ATHENA_AUTHENTICATION_MODE} configuration with a custom environment variable.|enum|default_credentials<br/>iam<br/>| | |
