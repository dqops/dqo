...
|[sslmode](#postgresqlsslmode)|Sslmode PostgreSQL connection parameter. The default value is disabled.|[PostgresqlSslMode](#postgresqlsslmode)|allow<br/>prefer<br/>disable<br/>verify-ca<br/>require<br/>verify-full<br/>| | |
|properties||Dict[string, string]| | | |
