...
|[monthly_partition_median_in_range](../../../../checks/column/numeric/median-in-range/)|Verifies that the median of all values in a column is not outside the set range. Creates a separate data quality check (and an alert) for each monthly partition.|[ColumnMedianInRangeCheckSpec](../../../../checks/column/numeric/median-in-range/)| | | |
|[monthly_partition_percentile_10_in_range](../../../../checks/column/numeric/percentile-10-in-range/)|Verifies that the percentile 10 of all values in a column is not outside the set range. Creates a separate data quality check (and an alert) for each monthly partition.|[ColumnPercentile10InRangeCheckSpec](../../../../checks/column/numeric/percentile-10-in-range/)| | | |
|[monthly_partition_percentile_25_in_range](../../../../checks/column/numeric/percentile-25-in-range/)|Verifies that the percentile 25 of all values in a column is not outside the set range. Creates a separate data quality check (and an alert) for each monthly partition.|[ColumnPercentile25InRangeCheckSpec](../../../../checks/column/numeric/percentile-25-in-range/)| | | |
|[monthly_partition_percentile_75_in_range](../../../../checks/column/numeric/percentile-75-in-range/)|Verifies that the percentile 75 of all values in a column is not outside the set range. Creates a separate data quality check (and an alert) for each monthly partition.|[ColumnPercentile75InRangeCheckSpec](../../../../checks/column/numeric/percentile-75-in-range/)| | | |
|[monthly_partition_percentile_90_in_range](../../../../checks/column/numeric/percentile-90-in-range/)|Verifies that the percentile 90 of all values in a column is not outside the set range. Creates a separate data quality check (and an alert) for each monthly partition.|[ColumnPercentile90InRangeCheckSpec](../../../../checks/column/numeric/percentile-90-in-range/)| | | |
...
|[monthly_partition_anomaly_stationary_distinct_count_30_days](../../../../checks/column/uniqueness/anomaly-stationary-distinct-count-30-days/)|Verifies that the distinct count in a monitored column is within a two-tailed percentile from measurements made during the last 30 days.|[ColumnAnomalyStationaryPartitionDistinctCount30DaysCheckSpec](../../../../checks/column/uniqueness/anomaly-stationary-distinct-count-30-days/)| | | |
|[monthly_partition_anomaly_stationary_distinct_count](../../../../checks/column/uniqueness/anomaly-stationary-distinct-count/)|Verifies that the distinct count in a monitored column is within a two-tailed percentile from measurements made during the last 90 days.|[ColumnAnomalyStationaryPartitionDistinctCountCheckSpec](../../../../checks/column/uniqueness/anomaly-stationary-distinct-count/)| | | |
...
|&nbsp;Property&nbsp;name&nbsp;|&nbsp;Description&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;Data&nbsp;type&nbsp;|&nbsp;Enum&nbsp;values&nbsp;|&nbsp;Default&nbsp;value&nbsp;|&nbsp;Sample&nbsp;values&nbsp;|
|---------------|---------------------------------|-----------|-------------|---------------|---------------|
|[monthly_partition_nulls_count](../../../../checks/column/nulls/nulls-count/)|Detects columns with any null values when the max_count&#x3D;0. Verifies that the number of null values in a column does not exceed the set count. Creates a separate data quality check (and an alert) for each monthly partition.|[ColumnNullsCountCheckSpec](../../../../checks/column/nulls/nulls-count/)| | | |
...
|[monthly_partition_not_nulls_count](../../../../checks/column/nulls/not-nulls-count/)|Detects empty columns with the min_count&#x3D;0 rule. Verifies that the number of not null values in a column does not exceed the set count. Creates a separate data quality check (and an alert) for each monthly partition.|[ColumnNotNullsCountCheckSpec](../../../../checks/column/nulls/not-nulls-count/)| | | |
