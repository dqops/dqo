...
|<span class="no-wrap-code ">`default_severity`</span>|The severity level (warning, error, fatal) for the default rule that is activated in the data quality check editor when the check is enabled.|*enum*|*warning*<br/>*error*<br/>*fatal*<br/>| | |
