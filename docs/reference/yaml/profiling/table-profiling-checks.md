...
|[parameters](\docs\reference\yaml\profiling\table-profiling-checks\#customsensorparametersspec)|Custom sensor parameters|[CustomSensorParametersSpec](\docs\reference\yaml\profiling\table-profiling-checks\#customsensorparametersspec)| | | |
|[warning](\docs\reference\yaml\profiling\table-profiling-checks\#customruleparametersspec)|Alerting threshold that raises a data quality warning that is considered as a passed data quality check|[CustomRuleParametersSpec](\docs\reference\yaml\profiling\table-profiling-checks\#customruleparametersspec)| | | |
|[error](\docs\reference\yaml\profiling\table-profiling-checks\#customruleparametersspec)|Default alerting threshold for a row count that raises a data quality error (alert)|[CustomRuleParametersSpec](\docs\reference\yaml\profiling\table-profiling-checks\#customruleparametersspec)| | | |
|[fatal](\docs\reference\yaml\profiling\table-profiling-checks\#customruleparametersspec)|Alerting threshold that raises a fatal data quality issue which indicates a serious data quality problem|[CustomRuleParametersSpec](\docs\reference\yaml\profiling\table-profiling-checks\#customruleparametersspec)| | | |
