...
|------------------|-------------|--------------------------|
 | id | Column for a statistics result id (primary key), it is a uuid of the statistics collector hash, executed at and the data stream id. This value identifies a single row. | STRING |
 ...
 | scope | String column that says if the result is for a whole table (&quot;table&quot;) or for each data stream separately (&quot;data_stream&quot;) | STRING |
