...
|[type](\docs\client\models\#rulerunnertype)|Rule runner type|[RuleRunnerType](\docs\client\models\#rulerunnertype)|
|java_class_name|Java class name for a rule runner that will execute the sensor. The &quot;type&quot; must be &quot;java_class&quot;.|string|
|[mode](\docs\client\models\#ruletimewindowmode)|Rule historic (past) values mode. A rule may require just the current sensor readout or use sensor readouts from past periods to perform prediction. The number of time windows is configured in the time_window setting.|[RuleTimeWindowMode](\docs\client\models\#ruletimewindowmode)|
