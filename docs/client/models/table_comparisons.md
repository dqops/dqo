...
|<span class="no-wrap-code">[`check_type`](./table_comparisons.md#checktype)</span>|The type of checks (profiling, monitoring, partitioned) that this check comparison configuration is applicable. The default value is 'profiling'.|*[CheckType](./table_comparisons.md#checktype)*|
