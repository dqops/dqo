...
|<span class="no-wrap-code">[`blanks`](\docs\reference\yaml\monitoring\column-daily-monitoring-checks\#columnblanksdailymonitoringchecksspec)</span>|Configuration of column level checks that detect blank and whitespace values|*[ColumnBlanksDailyMonitoringChecksSpec](\docs\reference\yaml\monitoring\column-daily-monitoring-checks\#columnblanksdailymonitoringchecksspec)*|
...
|<span class="no-wrap-code">[`blanks`](\docs\reference\yaml\partitioned\column-daily-partitioned-checks\#columnblanksdailypartitionedchecksspec)</span>|Configuration of column level checks that detect blank and whitespace values|*[ColumnBlanksDailyPartitionedChecksSpec](\docs\reference\yaml\partitioned\column-daily-partitioned-checks\#columnblanksdailypartitionedchecksspec)*|
...
|<span class="no-wrap-code">[`blanks`](\docs\reference\yaml\monitoring\column-monthly-monitoring-checks\#columnblanksmonthlymonitoringchecksspec)</span>|Configuration of column level checks that detect blank and whitespace values|*[ColumnBlanksMonthlyMonitoringChecksSpec](\docs\reference\yaml\monitoring\column-monthly-monitoring-checks\#columnblanksmonthlymonitoringchecksspec)*|
...
|<span class="no-wrap-code">[`anomaly`](\docs\reference\yaml\monitoring\column-monthly-monitoring-checks\#columnanomalymonthlymonitoringchecksspec)</span>|Monthly monitoring checks of anomalies in numeric columns|*[ColumnAnomalyMonthlyMonitoringChecksSpec](\docs\reference\yaml\monitoring\column-monthly-monitoring-checks\#columnanomalymonthlymonitoringchecksspec)*|
...
|<span class="no-wrap-code">[`blanks`](\docs\reference\yaml\partitioned\column-monthly-partitioned-checks\#columnblanksmonthlypartitionedchecksspec)</span>|Configuration of column level checks that detect blank and whitespace values|*[ColumnBlanksMonthlyPartitionedChecksSpec](\docs\reference\yaml\partitioned\column-monthly-partitioned-checks\#columnblanksmonthlypartitionedchecksspec)*|
...
|<span class="no-wrap-code">[`anomaly`](\docs\reference\yaml\partitioned\column-monthly-partitioned-checks\#columnanomalymonthlypartitionedchecksspec)</span>|Monthly partitioned checks for anomalies in numeric columns|*[ColumnAnomalyMonthlyPartitionedChecksSpec](\docs\reference\yaml\partitioned\column-monthly-partitioned-checks\#columnanomalymonthlypartitionedchecksspec)*|
...
|<span class="no-wrap-code">[`blanks`](\docs\reference\yaml\profiling\column-profiling-checks\#columnblanksprofilingchecksspec)</span>|Configuration of column level checks that detect blank and whitespace values.|*[ColumnBlanksProfilingChecksSpec](\docs\reference\yaml\profiling\column-profiling-checks\#columnblanksprofilingchecksspec)*|
