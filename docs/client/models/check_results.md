...
|[check_type](../table_comparisons/#CheckType)|The check type: profiling, monitoring, partitioned.|[CheckType](../table_comparisons/#CheckType)|
|[time_scale](../Common/#checktimescale)|The check time scale for *monitoring* and *partitioned* check types. The time scales are *daily* and *monthly*. The profiling checks do not have a time scale.|[CheckTimeScale](../Common/#checktimescale)|
