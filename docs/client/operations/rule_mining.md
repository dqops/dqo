...
=== "curl"
    **Execution**
    ...
    curl -X POST http://localhost:8888/api/connections/sample_connection/schemas/sample_schema/tables/sample_table/monitoring/daily/propose^
		...
		-H "Content-Type: application/json"^
		-d^
		"{\"severity_level\":\"error\",\"copy_failed_profiling_checks\":false,\"copy_disabled_profiling_checks\":false,\"propose_minimum_row_count\":true,\"propose_column_count_check\":true,\"propose_timeliness_checks\":true,\"propose_null_checks\":true,\"propose_uniqueness_checks\":true,\"propose_numeric_ranges\":true,\"propose_text_length_ranges\":true,\"propose_accepted_values_checks\":true}"
