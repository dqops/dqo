...
2. Select Redshift database type.
    ...
    ![Selecting Redshift database type](https://dqops.com/docs/images/working-with-dqo/adding-connection-redshift.jpg)

3. Add connection settings.

    ![Adding connection settings](https://dqops.com/docs/images/working-with-dqo/connection-settings-redshift.jpg)
