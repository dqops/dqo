...
|<p id="column add-t">`-t`</p><br/><p id="column add--table">`--table`</p><br/>|Table name| ||
...
| Command&nbsp;argument&nbsp;&nbsp;&nbsp;&nbsp; | Description | Required | Accepted values |
|-----------------------------------------------|-------------|:-----------------:|-----------------|
|<p id="column remove-C">`-C`</p><br/><p id="column remove--column">`--column`</p><br/>|Column name| ||
...
|<p id="column remove-t">`-t`</p><br/><p id="column remove--table">`--table`</p><br/>|Table name| ||
...
|<p id="column update-t">`-t`</p><br/><p id="column update--table">`--table`</p><br/>|Table name| ||
...
|<p id="column list-t">`-t`</p><br/><p id="column list--table">`--table`</p><br/>|Table name filter| ||
...
|<p id="column enable-t">`-t`</p><br/><p id="column enable--table">`--table`</p><br/>|Table name| ||
...
|<p id="column disable-t">`-t`</p><br/><p id="column disable--table">`--table`</p><br/>|Table name| ||
...
|<p id="column rename-t">`-t`</p><br/><p id="column rename--table">`--table`</p><br/>|Table name| ||
