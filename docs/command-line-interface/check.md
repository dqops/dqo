...
|<p id="check run-tag">`-tag`</p><br/><p id="check run--data-stream-level-tag">`--data-stream-level-tag`</p><br/>|Data stream hierarchy level filter (tag)| ||
...
|<p id="check run-t">`-t`</p><br/><p id="check run--table">`--table`</p><br/>|Full table name (schema.table), supports wildcard patterns &#x27;sch*.tab*&#x27;| ||
...
|<p id="check enable-t">`-t`</p><br/><p id="check enable--table">`--table`</p><br/>|Full table name (schema.table), supports patterns like &#x27;sch*.tab*&#x27;| ||
...
|<p id="check disable-t">`-t`</p><br/><p id="check disable--table">`--table`</p><br/>|Full table name (schema.table), supports patterns like &#x27;sch*.tab*&#x27;| ||
