...
| [Percent of valid UUID](data-completeness/percent-of-valid-uuid.md)                                                         | This example shows how to detect that the percentage of valid UUID values in a column does not fall below the minimum accepted percentage using [string_valid_uuid_percent](../checks/column/strings/string-valid-uuid-percent.md) check.                                                                             | DQOps dataset                                                                                                    |
| [Percent of string in set](data-completeness/percent-of-string-in-set.md)                                                   | This example shows hot to detect that the percentage of strings from a set in a column does not fall below the minimum accepted percentage using [string_in_set_percent](../../checks/column/strings/string-in-set-percent.md) check.                                                                                 | Dream Housing Finance company dataset                                                                            |
| **Data uniqueness**                                                                                                         |                                                                                                                                                                                                                                                                                                                       |                                                                                                                  |
