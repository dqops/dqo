...
| [Percentage of passed SQL condition](data-validity/percentage-of-passed-sql-condition.md)                                   | This example shows how to detect that the percentage of passed sql condition in a column does not fall below a set threshold using [sql_condition_passed_percent](../checks/table/sql/sql-condition-passed-percent-on-table.md)  check.                                                                                                                                                                            | [Link](https://www.americashealthrankings.org/about/methodology/our-reports)                                     |
| **Data reasonability**                                                                                                      |                                                                                                                                                                                                                                                                                                                                                                                                                    |                                                                                                                  |
