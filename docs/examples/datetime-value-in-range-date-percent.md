...
The objective is to assess the validity for the `close_date` column. This is to determine the percentage of data that falls within the user-specified range of `2018-01-01` to `2018-12-30`
