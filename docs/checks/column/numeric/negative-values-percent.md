...
??? example "Managing profile negative values percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_negative_values_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_negative_values_percent
        ```
...
??? example "Managing daily negative values percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_negative_values_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_negative_values_percent
        ```
...
??? example "Managing monthly negative values percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_negative_values_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_negative_values_percent
        ```
...
Please expand the section below to see the DQOps command-line examples to run or activate the daily partition negative values percent data quality check.
...
??? example "Managing daily partition negative values percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_negative_values_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_negative_values_percent
        ```
...
Please expand the section below to see the DQOps command-line examples to run or activate the monthly partition negative values percent data quality check.
...
??? example "Managing monthly partition negative values percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_negative_values_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_partition_negative_values_percent
        ```
