...
|----------|----------|----------|-----------|-------------|
|valid_latitude_percent|adhoc| |[valid_latitude_percent](../../../../reference/sensors/column/numeric%20column%20sensors/#valid-latitude-percent)|[max_percent](../../../../reference/rules/comparison/#max-percent)|
...
=== "Rendered SQL for PostgreSQL"
    ...
    SELECT
        100.0 * SUM(
            CASE
                WHEN "target_column" >= -90.0 AND "target_column" <= 90.0 THEN 1
                ELSE 0
            END
        )/COUNT(*) AS actual_value,
