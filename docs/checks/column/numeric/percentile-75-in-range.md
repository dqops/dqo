...
??? example "Managing profile percentile 75 in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_percentile_75_in_range
        ```
...
??? example "Managing daily percentile 75 in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_percentile_75_in_range
        ```
...
Verifies that the percentile 75 of all values in a column is not outside the set range. Stores the most recent value for each month when the data quality check was evaluated.
...
??? example "Managing monthly percentile 75 in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_percentile_75_in_range
        ```
...
??? example "Managing daily partition percentile 75 in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_percentile_75_in_range
        ```
...
??? example "Managing monthly partition percentile 75 in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_percentile_75_in_range
        ```
