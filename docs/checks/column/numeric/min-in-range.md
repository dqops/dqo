...
??? example "Managing profile min in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_min_in_range
        ```
...
??? example "Managing daily min in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_min_in_range
        ```
...
??? example "Managing monthly min in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_min_in_range
        ```
...
??? example "Managing daily partition min in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_min_in_range
        ```
...
??? example "Managing monthly partition min in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_min_in_range
        ```
