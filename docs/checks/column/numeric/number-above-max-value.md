...
|----------|----------|----------|-----------------|-----------------|------------|
|profile_number_above_max_value|profiling| |Validity|[number_above_max_value_count](../../../reference/sensors/column/numeric-column-sensors.md#number-above-max-value-count)|[max_count](../../../reference/rules/Comparison.md#max-count)|

**Command-line examples**

Please expand the section below to see the DQOps command-line examples to run or activate the profile number above max value data quality check.
...
??? example "Managing profile number above max value check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_number_above_max_value
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_number_above_max_value
        ```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_number_above_max_value|monitoring|daily|Validity|[number_above_max_value_count](../../../reference/sensors/column/numeric-column-sensors.md#number-above-max-value-count)|[max_count](../../../reference/rules/Comparison.md#max-count)|

**Command-line examples**

Please expand the section below to see the DQOps command-line examples to run or activate the daily number above max value data quality check.
...
??? example "Managing daily number above max value check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_number_above_max_value
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_number_above_max_value
        ```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|monthly_number_above_max_value|monitoring|monthly|Validity|[number_above_max_value_count](../../../reference/sensors/column/numeric-column-sensors.md#number-above-max-value-count)|[max_count](../../../reference/rules/Comparison.md#max-count)|

**Command-line examples**

Please expand the section below to see the DQOps command-line examples to run or activate the monthly number above max value data quality check.
...
??? example "Managing monthly number above max value check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_number_above_max_value
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_number_above_max_value
        ```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_partition_number_above_max_value|partitioned|daily|Validity|[number_above_max_value_count](../../../reference/sensors/column/numeric-column-sensors.md#number-above-max-value-count)|[max_count](../../../reference/rules/Comparison.md#max-count)|

**Command-line examples**

Please expand the section below to see the DQOps command-line examples to run or activate the daily partition number above max value data quality check.
...
??? example "Managing daily partition number above max value check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_number_above_max_value
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_number_above_max_value
        ```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|monthly_partition_number_above_max_value|partitioned|monthly|Validity|[number_above_max_value_count](../../../reference/sensors/column/numeric-column-sensors.md#number-above-max-value-count)|[max_count](../../../reference/rules/Comparison.md#max-count)|

**Command-line examples**

Please expand the section below to see the DQOps command-line examples to run or activate the monthly partition number above max value data quality check.
...
??? example "Managing monthly partition number above max value check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_number_above_max_value
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_partition_number_above_max_value
        ```
