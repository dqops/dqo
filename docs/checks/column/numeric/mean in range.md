...
|----------|----------|----------|-----------|-------------|
|mean_in_range|adhoc| |[mean](../../../../reference/sensors/column/numeric%20column%20sensors/#mean)|[between_floats](../../../../reference/rules/comparison/#between-floats)|
...
=== "Rendered SQL for PostgreSQL"
    ...
    ```
    SELECT
        AVG("target_column") AS actual_value,
...
## **daily checkpoint mean in range**  
  
**Check description**  
Verifies that the average (mean) of all values in a column is not outside the set range. Stores the most recent row count for each day when the data quality check was evaluated.  
  
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|daily_checkpoint_mean_in_range|checkpoint|daily|[mean](../../../../reference/sensors/column/numeric%20column%20sensors/#mean)|[between_floats](../../../../reference/rules/comparison/#between-floats)|
  
**Run check (Shell)**  
To run this check provide check name in [check run command](../../../../command_line_interface/check/#dqo-check-run)
```
dqo.ai> check run -ch=daily_checkpoint_mean_in_range
```
It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below
```
dqo.ai> check run -c=connection_name -ch=daily_checkpoint_mean_in_range
```
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo.ai> check run -c=connection_name -t=table_name -ch=daily_checkpoint_mean_in_range
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
...
## **monthly checkpoint mean in range**  
...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|monthly_checkpoint_mean_in_range|checkpoint|monthly|[mean](../../../../reference/sensors/column/numeric%20column%20sensors/#mean)|[between_floats](../../../../reference/rules/comparison/#between-floats)|
  
**Run check (Shell)**  
To run this check provide check name in [check run command](../../../../command_line_interface/check/#dqo-check-run)
```
dqo.ai> check run -ch=monthly_checkpoint_mean_in_range
```
It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below
```
dqo.ai> check run -c=connection_name -ch=monthly_checkpoint_mean_in_range
```
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo.ai> check run -c=connection_name -t=table_name -ch=monthly_checkpoint_mean_in_range
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
...
```yaml
      checkpoints:
        monthly:
          numeric:
            monthly_checkpoint_mean_in_range:
              error:
                from: 10.0
                to: 20.5
              warning:
...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|daily_partition_mean_in_range|partitioned|daily|[mean](../../../../reference/sensors/column/numeric%20column%20sensors/#mean)|[between_floats](../../../../reference/rules/comparison/#between-floats)|
...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|monthly_partition_mean_in_range|partitioned|monthly|[mean](../../../../reference/sensors/column/numeric%20column%20sensors/#mean)|[between_floats](../../../../reference/rules/comparison/#between-floats)|
