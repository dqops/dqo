...
??? example "Managing profile median in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_median_in_range
        ```
...
Verifies that the median of all values in a column is not outside the set range. Stores the most recent value for each month when the data quality check was evaluated.
...
??? example "Managing daily median in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_median_in_range
        ```
...
??? example "Managing monthly median in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_median_in_range
        ```
...
??? example "Managing daily partition median in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_median_in_range
        ```
...
??? example "Managing monthly partition median in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_median_in_range
        ```
