...
|----------|----------|----------|-----------|-------------|
|invalid_longitude_count|adhoc| |[invalid_longitude_count](../../../../reference/sensors/column/numeric%20column%20sensors/#invalid-longitude-count)|[max_count](../../../../reference/rules/comparison/#max-count)|
...
=== "Rendered SQL for PostgreSQL"
    ...
    SELECT
        SUM(
            CASE
                WHEN "target_column" >= -180.0 AND "target_column" <= 180.0 THEN 0
                ELSE 1
            END
        ) AS actual_value,
