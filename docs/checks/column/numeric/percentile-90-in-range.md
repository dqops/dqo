...
??? example "Managing profile percentile 90 in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_percentile_90_in_range
        ```
...
??? example "Managing daily percentile 90 in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_percentile_90_in_range
        ```
...
??? example "Managing monthly percentile 90 in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_percentile_90_in_range
        ```
...
??? example "Managing daily partition percentile 90 in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_percentile_90_in_range
        ```
...
??? example "Managing monthly partition percentile 90 in range check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_percentile_90_in_range
        ```
