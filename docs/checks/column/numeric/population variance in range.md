...
|----------|----------|----------|-----------|-------------|
|population_variance_in_range|adhoc| |[population_variance](../../../../reference/sensors/column/numeric%20column%20sensors/#population-variance)|[between_floats](../../../../reference/rules/comparison/#between-floats)|
...
=== "Rendered SQL for PostgreSQL"
    ...
    ```
    SELECT
        VAR_POP("target_column") AS actual_value,
...
## **daily checkpoint population variance in range**  
...
To run this check provide check name in [check run command](../../../../command_line_interface/check/#dqo-check-run)
```
dqo.ai> check run -ch=daily_checkpoint_population_variance_in_range
```
It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below
```
dqo.ai> check run -c=connection_name -ch=daily_checkpoint_population_variance_in_range
```
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo.ai> check run -c=connection_name -t=table_name -ch=daily_checkpoint_population_variance_in_range
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
...
```yaml
      checkpoints:
        daily:
          numeric:
            daily_checkpoint_population_variance_in_range:
              error:
                from: 10.0
                to: 20.5
              warning:
...
## **monthly checkpoint population variance in range**  
...
To run this check provide check name in [check run command](../../../../command_line_interface/check/#dqo-check-run)
```
dqo.ai> check run -ch=monthly_checkpoint_population_variance_in_range
```
It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below
```
dqo.ai> check run -c=connection_name -ch=monthly_checkpoint_population_variance_in_range
```
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo.ai> check run -c=connection_name -t=table_name -ch=monthly_checkpoint_population_variance_in_range
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
...
```yaml
      checkpoints:
        monthly:
          numeric:
            monthly_checkpoint_population_variance_in_range:
              error:
                from: 10.0
                to: 20.5
              warning:
