...
|----------|----------|----------|-----------------|-----------------|------------|
|profile_non_negative_percent|profiling| |Validity|[non_negative_percent](../../../../reference/sensors/column/numeric-column-sensors.md#non-negative-percent)|[max_percent](../../../../reference/rules/Comparison.md#max-percent)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=profile_non_negative_percent
```
...
```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=profile_non_negative_percent
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_non_negative_percent|monitoring|daily|Validity|[non_negative_percent](../../../../reference/sensors/column/numeric-column-sensors.md#non-negative-percent)|[max_percent](../../../../reference/rules/Comparison.md#max-percent)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=daily_non_negative_percent
```
...
```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=daily_non_negative_percent
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|monthly_non_negative_percent|monitoring|monthly|Validity|[non_negative_percent](../../../../reference/sensors/column/numeric-column-sensors.md#non-negative-percent)|[max_percent](../../../../reference/rules/Comparison.md#max-percent)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=monthly_non_negative_percent
```
...
```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=monthly_non_negative_percent
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_partition_non_negative_percent|partitioned|daily|Validity|[non_negative_percent](../../../../reference/sensors/column/numeric-column-sensors.md#non-negative-percent)|[max_percent](../../../../reference/rules/Comparison.md#max-percent)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=daily_partition_non_negative_percent
```
...
```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=daily_partition_non_negative_percent
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|monthly_partition_non_negative_percent|partitioned|monthly|Validity|[non_negative_percent](../../../../reference/sensors/column/numeric-column-sensors.md#non-negative-percent)|[max_percent](../../../../reference/rules/Comparison.md#max-percent)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=monthly_partition_non_negative_percent
```
...
```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=monthly_partition_non_negative_percent
```
