...
??? example "Managing profile sql aggregate expression on column check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_sql_aggregate_expression_on_column
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_sql_aggregate_expression_on_column
        ```
...
??? example "Managing daily sql aggregate expression on column check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_sql_aggregate_expression_on_column
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_sql_aggregate_expression_on_column
        ```
...
??? example "Managing monthly sql aggregate expression on column check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_sql_aggregate_expression_on_column
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_sql_aggregate_expression_on_column
        ```
...
??? example "Managing daily partition sql aggregate expression on column check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_sql_aggregate_expression_on_column
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_sql_aggregate_expression_on_column
        ```
...
??? example "Managing monthly partition sql aggregate expression on column check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_sql_aggregate_expression_on_column
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_partition_sql_aggregate_expression_on_column
        ```
