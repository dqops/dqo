...
??? example "Managing profile distinct percent change 30 days check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_distinct_percent_change_30_days
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_distinct_percent_change_30_days
        ```
...
??? example "Managing daily distinct percent change 30 days check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_distinct_percent_change_30_days
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_distinct_percent_change_30_days
        ```
...
??? example "Managing daily partition distinct percent change 30 days check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_distinct_percent_change_30_days
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_distinct_percent_change_30_days
        ```
