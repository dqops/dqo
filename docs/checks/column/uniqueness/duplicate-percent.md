...
??? example "Managing profile duplicate percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_duplicate_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_duplicate_percent
        ```
...
??? example "Managing daily duplicate percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_duplicate_percent
        ```
...
??? example "Managing monthly duplicate percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_duplicate_percent
        ```
...
??? example "Managing daily partition duplicate percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_duplicate_percent
        ```
...
??? example "Managing monthly partition duplicate percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_duplicate_percent
        ```
