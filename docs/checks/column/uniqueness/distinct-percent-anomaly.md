...
??? example "Managing profile distinct percent anomaly check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_distinct_percent_anomaly
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_distinct_percent_anomaly
        ```
...
??? example "Managing daily distinct percent anomaly check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_distinct_percent_anomaly
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_distinct_percent_anomaly
        ```
...
??? example "Managing daily partition distinct percent anomaly check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_distinct_percent_anomaly
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_distinct_percent_anomaly
        ```
