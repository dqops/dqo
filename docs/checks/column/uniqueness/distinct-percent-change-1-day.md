...
Please expand the section below to see the DQOps command-line examples to run or activate the profile distinct percent change 1 day data quality check.
...
??? example "Managing profile distinct percent change 1 day check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_distinct_percent_change_1_day
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_distinct_percent_change_1_day
        ```
...
Please expand the section below to see the DQOps command-line examples to run or activate the daily distinct percent change 1 day data quality check.
...
??? example "Managing daily distinct percent change 1 day check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_distinct_percent_change_1_day
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_distinct_percent_change_1_day
        ```
...
Please expand the section below to see the DQOps command-line examples to run or activate the daily partition distinct percent change 1 day data quality check.
...
??? example "Managing daily partition distinct percent change 1 day check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_distinct_percent_change_1_day
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_distinct_percent_change_1_day
        ```
