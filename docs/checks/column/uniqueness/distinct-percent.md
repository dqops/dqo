...
```
dqo> check activate -c=connection_name -ch=profile_distinct_percent
```
...
```
dqo> check activate -c=connection_name -ch=daily_distinct_percent
```
...
```
dqo> check activate -c=connection_name -ch=monthly_distinct_percent
```
...
```
dqo> check activate -c=connection_name -ch=daily_partition_distinct_percent
```
...
```
dqo> check activate -c=connection_name -ch=monthly_partition_distinct_percent
```
