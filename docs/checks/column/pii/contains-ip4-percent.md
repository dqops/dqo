...
|----------|----------|----------|-----------------|-----------------|------------|
|profile_contains_ip4_percent|profiling| |Validity|[contains_ip4_percent](../../../../reference/sensors/column/pii-column-sensors/#contains-ip4-percent)|[max_percent](../../../../reference/rules/Comparison/#max-percent)|
  
**Enable check (Shell)**  
To enable this check provide connection name and check name in [check enable command](../../../../command-line-interface/check/#dqo-check-enable)
```
dqo> check enable -c=connection_name -ch=profile_contains_ip4_percent
```
**Run check (Shell)**  
To run this check provide check name in [check run command](../../../../command-line-interface/check/#dqo-check-run)
```
dqo> check run -ch=profile_contains_ip4_percent
```
It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below
```
dqo> check run -c=connection_name -ch=profile_contains_ip4_percent
```
...
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=profile_contains_ip4_percent
```
...
[contains_ip4_percent](../../../../reference/sensors/column/pii-column-sensors/#contains-ip4-percent)
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_contains_ip4_percent|monitoring|daily|Validity|[contains_ip4_percent](../../../../reference/sensors/column/pii-column-sensors/#contains-ip4-percent)|[max_percent](../../../../reference/rules/Comparison/#max-percent)|
...
It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below
```
dqo> check run -c=connection_name -ch=daily_contains_ip4_percent
```
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
...
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=daily_contains_ip4_percent
```
**Check structure (YAML)**
```yaml
      monitoring_checks:
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|monthly_contains_ip4_percent|monitoring|monthly|Validity|[contains_ip4_percent](../../../../reference/sensors/column/pii-column-sensors/#contains-ip4-percent)|[max_percent](../../../../reference/rules/Comparison/#max-percent)|
...
It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below
```
dqo> check run -c=connection_name -ch=monthly_contains_ip4_percent
```
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
...
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=monthly_contains_ip4_percent
```
**Check structure (YAML)**
```yaml
      monitoring_checks:
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_partition_contains_ip4_percent|partitioned|daily|Validity|[contains_ip4_percent](../../../../reference/sensors/column/pii-column-sensors/#contains-ip4-percent)|[max_percent](../../../../reference/rules/Comparison/#max-percent)|
...
It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below
```
dqo> check run -c=connection_name -ch=daily_partition_contains_ip4_percent
```
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
...
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=daily_partition_contains_ip4_percent
```
**Check structure (YAML)**
```yaml
      partitioned_checks:
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|monthly_partition_contains_ip4_percent|partitioned|monthly|Validity|[contains_ip4_percent](../../../../reference/sensors/column/pii-column-sensors/#contains-ip4-percent)|[max_percent](../../../../reference/rules/Comparison/#max-percent)|
...
It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below
```
dqo> check run -c=connection_name -ch=monthly_partition_contains_ip4_percent
```
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
...
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=monthly_partition_contains_ip4_percent
```
**Check structure (YAML)**
```yaml
      partitioned_checks:
