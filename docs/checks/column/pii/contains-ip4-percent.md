...
??? example "Managing profile contains ip4 percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_contains_ip4_percent
        ```
...
??? example "Managing daily contains ip4 percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_contains_ip4_percent
        ```
...
??? example "Managing monthly contains ip4 percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_contains_ip4_percent
        ```
...
??? example "Managing daily partition contains ip4 percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_contains_ip4_percent
        ```
...
??? example "Managing monthly partition contains ip4 percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_contains_ip4_percent
        ```
