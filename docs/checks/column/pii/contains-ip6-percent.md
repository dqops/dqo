...
??? example "Managing profile contains ip6 percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_contains_ip6_percent
        ```
...
??? example "Managing daily contains ip6 percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_contains_ip6_percent
        ```
...
??? example "Managing monthly contains ip6 percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_contains_ip6_percent
        ```
...
??? example "Managing daily partition contains ip6 percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_contains_ip6_percent
        ```
...
??? example "Managing monthly partition contains ip6 percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_contains_ip6_percent
        ```
