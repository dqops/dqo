...
|----------|----------|----------|-----------|-------------|
|valid_ip6_address_percent|profiling| |[valid_ip6_address_percent](../../../../reference/sensors/column/pii%20column%20sensors/#valid-ip6-address-percent)|[min_percent](../../../../reference/rules/comparison/#min-percent)|
  
**Run check (Shell)**  
To run this check provide check name in [check run command](../../../../command_line_interface/check/#dqo-check-run)
```
dqo.ai> check run -ch=valid_ip6_address_percent
```
It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below
```
dqo.ai> check run -c=connection_name -ch=valid_ip6_address_percent
```
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo.ai> check run -c=connection_name -t=table_name -ch=valid_ip6_address_percent
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo.ai> check run -c=connection_name -t=table_name -col=column_name -ch=valid_ip6_address_percent
```
...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|daily_checkpoint_valid_ip6_address_percent|checkpoint|daily|[valid_ip6_address_percent](../../../../reference/sensors/column/pii%20column%20sensors/#valid-ip6-address-percent)|[min_percent](../../../../reference/rules/comparison/#min-percent)|
  
**Run check (Shell)**  
To run this check provide check name in [check run command](../../../../command_line_interface/check/#dqo-check-run)
```
dqo.ai> check run -ch=daily_checkpoint_valid_ip6_address_percent
```
It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below
```
dqo.ai> check run -c=connection_name -ch=daily_checkpoint_valid_ip6_address_percent
```
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo.ai> check run -c=connection_name -t=table_name -ch=daily_checkpoint_valid_ip6_address_percent
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo.ai> check run -c=connection_name -t=table_name -col=column_name -ch=daily_checkpoint_valid_ip6_address_percent
```
**Check structure (Yaml)**
```yaml
      checkpoints:
...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|monthly_checkpoint_valid_ip6_address_percent|checkpoint|monthly|[valid_ip6_address_percent](../../../../reference/sensors/column/pii%20column%20sensors/#valid-ip6-address-percent)|[min_percent](../../../../reference/rules/comparison/#min-percent)|
  
**Run check (Shell)**  
To run this check provide check name in [check run command](../../../../command_line_interface/check/#dqo-check-run)
```
dqo.ai> check run -ch=monthly_checkpoint_valid_ip6_address_percent
```
It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below
```
dqo.ai> check run -c=connection_name -ch=monthly_checkpoint_valid_ip6_address_percent
```
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo.ai> check run -c=connection_name -t=table_name -ch=monthly_checkpoint_valid_ip6_address_percent
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo.ai> check run -c=connection_name -t=table_name -col=column_name -ch=monthly_checkpoint_valid_ip6_address_percent
```
**Check structure (Yaml)**
```yaml
      checkpoints:
...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|daily_partition_valid_ip6_address_percent|partitioned|daily|[valid_ip6_address_percent](../../../../reference/sensors/column/pii%20column%20sensors/#valid-ip6-address-percent)|[min_percent](../../../../reference/rules/comparison/#min-percent)|
  
**Run check (Shell)**  
To run this check provide check name in [check run command](../../../../command_line_interface/check/#dqo-check-run)
```
dqo.ai> check run -ch=daily_partition_valid_ip6_address_percent
```
It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below
```
dqo.ai> check run -c=connection_name -ch=daily_partition_valid_ip6_address_percent
```
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo.ai> check run -c=connection_name -t=table_name -ch=daily_partition_valid_ip6_address_percent
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo.ai> check run -c=connection_name -t=table_name -col=column_name -ch=daily_partition_valid_ip6_address_percent
```
**Check structure (Yaml)**
```yaml
      partitioned_checks:
...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|monthly_partition_valid_ip6_address_percent|partitioned|monthly|[valid_ip6_address_percent](../../../../reference/sensors/column/pii%20column%20sensors/#valid-ip6-address-percent)|[min_percent](../../../../reference/rules/comparison/#min-percent)|
  
**Run check (Shell)**  
To run this check provide check name in [check run command](../../../../command_line_interface/check/#dqo-check-run)
```
dqo.ai> check run -ch=monthly_partition_valid_ip6_address_percent
```
It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below
```
dqo.ai> check run -c=connection_name -ch=monthly_partition_valid_ip6_address_percent
```
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo.ai> check run -c=connection_name -t=table_name -ch=monthly_partition_valid_ip6_address_percent
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo.ai> check run -c=connection_name -t=table_name -col=column_name -ch=monthly_partition_valid_ip6_address_percent
```
**Check structure (Yaml)**
```yaml
      partitioned_checks:
