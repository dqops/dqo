...
??? example "Managing profile contains usa zipcode percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_contains_usa_zipcode_percent
        ```
...
??? example "Managing daily contains usa zipcode percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_contains_usa_zipcode_percent
        ```
...
??? example "Managing monthly contains usa zipcode percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_contains_usa_zipcode_percent
        ```
...
??? example "Managing daily partition contains usa zipcode percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_contains_usa_zipcode_percent
        ```
...
??? example "Managing monthly partition contains usa zipcode percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_contains_usa_zipcode_percent
        ```
