...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|daily_checkpoint_string_length_above_max_length_percent|checkpoint|daily|[string_length_above_max_length_percent](../../../../reference/sensors/column/strings-column-sensors/#string-length-above-max-length-percent)|[min_percent](../../../../reference/rules/comparison/#min-percent)|
...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|monthly_checkpoint_string_length_above_max_length_percent|checkpoint|monthly|[string_length_above_max_length_percent](../../../../reference/sensors/column/strings-column-sensors/#string-length-above-max-length-percent)|[min_percent](../../../../reference/rules/comparison/#min-percent)|
