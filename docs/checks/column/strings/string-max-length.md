...
|----------|----------|----------|-----------------|-----------------|------------|
|profile_string_max_length|profiling| |Reasonableness|[string_max_length](../../../../reference/sensors/column/strings-column-sensors.md#string-max-length)|[max_value](../../../../reference/rules/Comparison.md#max-value)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=profile_string_max_length
```
...
```
dqo> check run -ch=profile_string_max_length
```

It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below

```
dqo> check run -c=connection_name -ch=profile_string_max_length
```

It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below

```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=profile_string_max_length
```
...
[string_max_length](../../../../reference/sensors/column/strings-column-sensors.md#string-max-length)
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_string_max_length|monitoring|daily|Reasonableness|[string_max_length](../../../../reference/sensors/column/strings-column-sensors.md#string-max-length)|[max_value](../../../../reference/rules/Comparison.md#max-value)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=daily_string_max_length
```
...
```
dqo> check run -ch=daily_string_max_length
```

It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below

```
dqo> check run -c=connection_name -ch=daily_string_max_length
```

It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below

```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=daily_string_max_length
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|monthly_string_max_length|monitoring|monthly|Reasonableness|[string_max_length](../../../../reference/sensors/column/strings-column-sensors.md#string-max-length)|[max_value](../../../../reference/rules/Comparison.md#max-value)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=monthly_string_max_length
```
...
```
dqo> check run -ch=monthly_string_max_length
```

It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below

```
dqo> check run -c=connection_name -ch=monthly_string_max_length
```

It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below

```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=monthly_string_max_length
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_partition_string_max_length|partitioned|daily|Reasonableness|[string_max_length](../../../../reference/sensors/column/strings-column-sensors.md#string-max-length)|[max_value](../../../../reference/rules/Comparison.md#max-value)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=daily_partition_string_max_length
```
...
```
dqo> check run -ch=daily_partition_string_max_length
```

It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below

```
dqo> check run -c=connection_name -ch=daily_partition_string_max_length
```

It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below

```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=daily_partition_string_max_length
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|monthly_partition_string_max_length|partitioned|monthly|Reasonableness|[string_max_length](../../../../reference/sensors/column/strings-column-sensors.md#string-max-length)|[max_value](../../../../reference/rules/Comparison.md#max-value)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=monthly_partition_string_max_length
```
...
```
dqo> check run -ch=monthly_partition_string_max_length
```

It is also possible to run this check on a specific connection. In order to do this, add the connection name to the below

```
dqo> check run -c=connection_name -ch=monthly_partition_string_max_length
```

It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below

```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=monthly_partition_string_max_length
```
