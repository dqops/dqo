...
|----------|----------|----------|-----------------|-----------------|------------|
|profile_string_invalid_ip6_address_count|profiling| |Validity|[string_invalid_ip6_address_count](../../../../reference/sensors/column/strings-column-sensors.md#string-invalid-ip6-address-count)|[max_count](../../../../reference/rules/Comparison.md#max-count)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=profile_string_invalid_ip6_address_count
```
...
[string_invalid_ip6_address_count](../../../../reference/sensors/column/strings-column-sensors.md#string-invalid-ip6-address-count)
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_string_invalid_ip6_address_count|monitoring|daily|Validity|[string_invalid_ip6_address_count](../../../../reference/sensors/column/strings-column-sensors.md#string-invalid-ip6-address-count)|[max_count](../../../../reference/rules/Comparison.md#max-count)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=daily_string_invalid_ip6_address_count
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|monthly_string_invalid_ip6_address_count|monitoring|monthly|Validity|[string_invalid_ip6_address_count](../../../../reference/sensors/column/strings-column-sensors.md#string-invalid-ip6-address-count)|[max_count](../../../../reference/rules/Comparison.md#max-count)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=monthly_string_invalid_ip6_address_count
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_partition_string_invalid_ip6_address_count|partitioned|daily|Validity|[string_invalid_ip6_address_count](../../../../reference/sensors/column/strings-column-sensors.md#string-invalid-ip6-address-count)|[max_count](../../../../reference/rules/Comparison.md#max-count)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=daily_partition_string_invalid_ip6_address_count
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|monthly_partition_string_invalid_ip6_address_count|partitioned|monthly|Validity|[string_invalid_ip6_address_count](../../../../reference/sensors/column/strings-column-sensors.md#string-invalid-ip6-address-count)|[max_count](../../../../reference/rules/Comparison.md#max-count)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=monthly_partition_string_invalid_ip6_address_count
```
