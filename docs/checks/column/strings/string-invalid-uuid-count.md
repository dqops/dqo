...
|----------|----------|----------|-----------------|-----------------|------------|
|profile_string_invalid_uuid_count|profiling| |Validity|[string_invalid_uuid_count](../../../../reference/sensors/column/strings-column-sensors.md#string-invalid-uuid-count)|[max_count](../../../../reference/rules/Comparison.md#max-count)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=profile_string_invalid_uuid_count
```
...
[string_invalid_uuid_count](../../../../reference/sensors/column/strings-column-sensors.md#string-invalid-uuid-count)
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_string_invalid_uuid_count|monitoring|daily|Validity|[string_invalid_uuid_count](../../../../reference/sensors/column/strings-column-sensors.md#string-invalid-uuid-count)|[max_count](../../../../reference/rules/Comparison.md#max-count)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=daily_string_invalid_uuid_count
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|monthly_string_invalid_uuid_count|monitoring|monthly|Validity|[string_invalid_uuid_count](../../../../reference/sensors/column/strings-column-sensors.md#string-invalid-uuid-count)|[max_count](../../../../reference/rules/Comparison.md#max-count)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=monthly_string_invalid_uuid_count
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_partition_string_invalid_uuid_count|partitioned|daily|Validity|[string_invalid_uuid_count](../../../../reference/sensors/column/strings-column-sensors.md#string-invalid-uuid-count)|[max_count](../../../../reference/rules/Comparison.md#max-count)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=daily_partition_string_invalid_uuid_count
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|monthly_partition_string_invalid_uuid_count|partitioned|monthly|Validity|[string_invalid_uuid_count](../../../../reference/sensors/column/strings-column-sensors.md#string-invalid-uuid-count)|[max_count](../../../../reference/rules/Comparison.md#max-count)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=monthly_partition_string_invalid_uuid_count
```
