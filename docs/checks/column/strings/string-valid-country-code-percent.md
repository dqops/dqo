...
|----------|----------|----------|-----------------|-----------------|------------|
|profile_string_valid_country_code_percent|profiling| |Validity|[string_valid_country_code_percent](../../../../reference/sensors/column/strings-column-sensors/#string-valid-country-code-percent)|[min_percent](../../../../reference/rules/Comparison/#min-percent)|
...
```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=profile_string_valid_country_code_percent
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=profile_string_valid_country_code_percent
```
...
[string_valid_country_code_percent](../../../../reference/sensors/column/strings-column-sensors/#string-valid-country-code-percent)
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_string_valid_country_code_percent|monitoring|daily|Validity|[string_valid_country_code_percent](../../../../reference/sensors/column/strings-column-sensors/#string-valid-country-code-percent)|[min_percent](../../../../reference/rules/Comparison/#min-percent)|
...
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=daily_string_valid_country_code_percent
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=daily_string_valid_country_code_percent
```
**Check structure (YAML)**
```yaml
      monitoring_checks:
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|monthly_string_valid_country_code_percent|monitoring|monthly|Validity|[string_valid_country_code_percent](../../../../reference/sensors/column/strings-column-sensors/#string-valid-country-code-percent)|[min_percent](../../../../reference/rules/Comparison/#min-percent)|
...
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=monthly_string_valid_country_code_percent
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=monthly_string_valid_country_code_percent
```
**Check structure (YAML)**
```yaml
      monitoring_checks:
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_partition_string_valid_country_code_percent|partitioned|daily|Validity|[string_valid_country_code_percent](../../../../reference/sensors/column/strings-column-sensors/#string-valid-country-code-percent)|[min_percent](../../../../reference/rules/Comparison/#min-percent)|
...
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=daily_partition_string_valid_country_code_percent
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=daily_partition_string_valid_country_code_percent
```
**Check structure (YAML)**
```yaml
      partitioned_checks:
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|monthly_partition_string_valid_country_code_percent|partitioned|monthly|Validity|[string_valid_country_code_percent](../../../../reference/sensors/column/strings-column-sensors/#string-valid-country-code-percent)|[min_percent](../../../../reference/rules/Comparison/#min-percent)|
...
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=monthly_partition_string_valid_country_code_percent
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=monthly_partition_string_valid_country_code_percent
```
**Check structure (YAML)**
```yaml
      partitioned_checks:
