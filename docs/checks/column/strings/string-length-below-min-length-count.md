...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|daily_checkpoint_string_length_below_min_length_count|checkpoint|daily|[string_length_below_min_length_count](../../../../reference/sensors/column/strings-column-sensors/#string-length-below-min-length-count)|[max_count](../../../../reference/rules/comparison/#max-count)|
...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|monthly_checkpoint_string_length_below_min_length_count|checkpoint|monthly|[string_length_below_min_length_count](../../../../reference/sensors/column/strings-column-sensors/#string-length-below-min-length-count)|[max_count](../../../../reference/rules/comparison/#max-count)|
