...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|daily_checkpoint_string_match_name_regex_percent|checkpoint|daily|[string_match_name_regex_percent](../../../../reference/sensors/column/strings-column-sensors/#string-match-name-regex-percent)|[min_percent](../../../../reference/rules/comparison/#min-percent)|
...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|monthly_checkpoint_string_match_name_regex_percent|checkpoint|monthly|[string_match_name_regex_percent](../../../../reference/sensors/column/strings-column-sensors/#string-match-name-regex-percent)|[min_percent](../../../../reference/rules/comparison/#min-percent)|
