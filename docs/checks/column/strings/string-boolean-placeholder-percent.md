...
|----------|----------|----------|-----------|-------------|
|profile_string_boolean_placeholder_percent|profiling| |[string_boolean_placeholder_percent](../../../../reference/sensors/Column/strings-column-sensors/#string-boolean-placeholder-percent)|[min_percent](../../../../reference/rules/Comparison/#min-percent)|
...
=== "Rendered SQL for Oracle"
    ...
    SELECT
        CASE
            ...
            ELSE 100.0 * SUM(
                CASE
                    WHEN LOWER(grouping_table."target_column") IN ('true', 'false', 't', 'f', 'y', 'n', 'yes', 'no', '1', '0')
                        THEN 1
                    ELSE 0
                END
            ) / COUNT(*)
