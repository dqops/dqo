...
**Check description**  
The check counts those strings with length above those provided by the user in the column. Stores the most recent row count for each month when the data quality check was evaluated.  
