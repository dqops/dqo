...
```
dqo> check enable -c=connection_name -ch=profile_string_whitespace_percent
```
**Run check (Shell)**  
...
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=profile_string_whitespace_percent
```
...
[string_whitespace_percent](../../../../reference/sensors/column/strings-column-sensors/#string-whitespace-percent)
...
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=daily_string_whitespace_percent
```
**Check structure (YAML)**
```yaml
      monitoring_checks:
...
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=monthly_string_whitespace_percent
```
**Check structure (YAML)**
```yaml
      monitoring_checks:
...
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=daily_partition_string_whitespace_percent
```
**Check structure (YAML)**
```yaml
      partitioned_checks:
...
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=monthly_partition_string_whitespace_percent
```
**Check structure (YAML)**
```yaml
      partitioned_checks:
