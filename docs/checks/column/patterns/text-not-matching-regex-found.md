...
??? example "Managing profile text not matching regex found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_text_not_matching_regex_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_text_not_matching_regex_found
        ```
...
??? example "Managing daily text not matching regex found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_text_not_matching_regex_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_text_not_matching_regex_found
        ```
...
??? example "Managing monthly text not matching regex found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_text_not_matching_regex_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_text_not_matching_regex_found
        ```
...
??? example "Managing daily partition text not matching regex found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_text_not_matching_regex_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_text_not_matching_regex_found
        ```
...
??? example "Managing monthly partition text not matching regex found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_text_not_matching_regex_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_partition_text_not_matching_regex_found
        ```
