---
title: Invalid usa zipcode format found data quality checks, SQL examples
---
# Invalid usa zipcode format found data quality checks, SQL examples
...
___
The **invalid usa zipcode format found** data quality check has the following variants for each
[type of data quality](../../../dqo-concepts/definition-of-data-quality-checks/index.md#types-of-checks) checks supported by DQOps.


## profile invalid usa zipcode format found


**Check description**

Verifies that the number of invalid zip codes in a text column does not exceed the maximum accepted count.
...
Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the profile invalid usa zipcode format found data quality check.

??? example "Managing profile invalid usa zipcode format found check from DQOps shell"
    ...
    === "Activate the check with a warning rule"
        ...
        ```
        dqo> check activate -c=connection_name -t=schema_name.table_name -col=column_name -ch=profile_invalid_usa_zipcode_format_found --enable-warning
        ```
    ...
    === "Activate the check with an error rule"
        ...
        ```
        dqo> check activate -c=connection_name -t=schema_name.table_name -col=column_name -ch=profile_invalid_usa_zipcode_format_found --enable-error
        ```
    ...
    === "Run all configured checks"
        ...
        The following example shows how to run the *profile_invalid_usa_zipcode_format_found* check on all tables and columns on a single data source.

        ```
        dqo> check run -c=data_source_name -ch=profile_invalid_usa_zipcode_format_found
        ```

        It is also possible to run this check on a specific connection and table. In order to do this, use the connection name and the full table name parameters.

        ```
        dqo> check run -c=connection_name -t=schema_name.table_name -ch=profile_invalid_usa_zipcode_format_found
        ```

        You can also run this check on all tables (and columns)  on which the *profile_invalid_usa_zipcode_format_found* check is enabled
        using patterns to find tables.

        ```
        dqo> check run -c=connection_name -t=schema_prefix*.fact_* -col=column_name_* -ch=profile_invalid_usa_zipcode_format_found
        ```
...
??? info "Samples of generated SQL queries for each data source type"
    ...
    [invalid_usa_zipcode_count](../../../reference/sensors/column/patterns-column-sensors.md#invalid-usa-zipcode-count)
...
## daily invalid usa zipcode format found
...
Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the daily invalid usa zipcode format found data quality check.

??? example "Managing daily invalid usa zipcode format found check from DQOps shell"
    ...
    === "Activate the check with a warning rule"
        ...
        ```
        dqo> check activate -c=connection_name -t=schema_name.table_name -col=column_name -ch=daily_invalid_usa_zipcode_format_found --enable-warning
        ```
    ...
    === "Activate the check with an error rule"
        ...
        ```
        dqo> check activate -c=connection_name -t=schema_name.table_name -col=column_name -ch=daily_invalid_usa_zipcode_format_found --enable-error
        ```
    ...
    === "Run all configured checks"
        ...
        Run this data quality check using the [check run](../../../command-line-interface/check.md#dqo-check-run) CLI command by providing the check name and all other targeting filters.
        The following example shows how to run the *daily_invalid_usa_zipcode_format_found* check on all tables and columns on a single data source.

        ```
        dqo> check run -c=data_source_name -ch=daily_invalid_usa_zipcode_format_found
        ```

        It is also possible to run this check on a specific connection and table. In order to do this, use the connection name and the full table name parameters.

        ```
        dqo> check run -c=connection_name -t=schema_name.table_name -ch=daily_invalid_usa_zipcode_format_found
        ```

        You can also run this check on all tables (and columns)  on which the *daily_invalid_usa_zipcode_format_found* check is enabled
        using patterns to find tables.

        ```
        dqo> check run -c=connection_name -t=schema_prefix*.fact_* -col=column_name_* -ch=daily_invalid_usa_zipcode_format_found
        ```
...
## monthly invalid usa zipcode format found
...
Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the monthly invalid usa zipcode format found data quality check.

??? example "Managing monthly invalid usa zipcode format found check from DQOps shell"
    ...
    === "Activate the check with a warning rule"
        ...
        ```
        dqo> check activate -c=connection_name -t=schema_name.table_name -col=column_name -ch=monthly_invalid_usa_zipcode_format_found --enable-warning
        ```
    ...
    === "Activate the check with an error rule"
        ...
        ```
        dqo> check activate -c=connection_name -t=schema_name.table_name -col=column_name -ch=monthly_invalid_usa_zipcode_format_found --enable-error
        ```
    ...
    === "Run all configured checks"
        ...
        Run this data quality check using the [check run](../../../command-line-interface/check.md#dqo-check-run) CLI command by providing the check name and all other targeting filters.
        The following example shows how to run the *monthly_invalid_usa_zipcode_format_found* check on all tables and columns on a single data source.

        ```
        dqo> check run -c=data_source_name -ch=monthly_invalid_usa_zipcode_format_found
        ```

        It is also possible to run this check on a specific connection and table. In order to do this, use the connection name and the full table name parameters.

        ```
        dqo> check run -c=connection_name -t=schema_name.table_name -ch=monthly_invalid_usa_zipcode_format_found
        ```

        You can also run this check on all tables (and columns)  on which the *monthly_invalid_usa_zipcode_format_found* check is enabled
        using patterns to find tables.

        ```
        dqo> check run -c=connection_name -t=schema_prefix*.fact_* -col=column_name_* -ch=monthly_invalid_usa_zipcode_format_found
        ```
...
## daily partition invalid usa zipcode format found
...
Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the daily partition invalid usa zipcode format found data quality check.

??? example "Managing daily partition invalid usa zipcode format found check from DQOps shell"
    ...
    === "Activate the check with a warning rule"
        ...
        ```
        dqo> check activate -c=connection_name -t=schema_name.table_name -col=column_name -ch=daily_partition_invalid_usa_zipcode_format_found --enable-warning
        ```
    ...
    === "Activate the check with an error rule"
        ...
        ```
        dqo> check activate -c=connection_name -t=schema_name.table_name -col=column_name -ch=daily_partition_invalid_usa_zipcode_format_found --enable-error
        ```
    ...
    === "Run all configured checks"
        ...
        Run this data quality check using the [check run](../../../command-line-interface/check.md#dqo-check-run) CLI command by providing the check name and all other targeting filters.
        The following example shows how to run the *daily_partition_invalid_usa_zipcode_format_found* check on all tables and columns on a single data source.

        ```
        dqo> check run -c=data_source_name -ch=daily_partition_invalid_usa_zipcode_format_found
        ```

        It is also possible to run this check on a specific connection and table. In order to do this, use the connection name and the full table name parameters.

        ```
        dqo> check run -c=connection_name -t=schema_name.table_name -ch=daily_partition_invalid_usa_zipcode_format_found
        ```

        You can also run this check on all tables (and columns)  on which the *daily_partition_invalid_usa_zipcode_format_found* check is enabled
        using patterns to find tables.

        ```
        dqo> check run -c=connection_name -t=schema_prefix*.fact_* -col=column_name_* -ch=daily_partition_invalid_usa_zipcode_format_found
        ```
...
## monthly partition invalid usa zipcode format found
...
Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the monthly partition invalid usa zipcode format found data quality check.

??? example "Managing monthly partition invalid usa zipcode format found check from DQOps shell"
    ...
    === "Activate the check with a warning rule"
        ...
        ```
        dqo> check activate -c=connection_name -t=schema_name.table_name -col=column_name -ch=monthly_partition_invalid_usa_zipcode_format_found --enable-warning
        ```
    ...
    === "Activate the check with an error rule"
        ...
        ```
        dqo> check activate -c=connection_name -t=schema_name.table_name -col=column_name -ch=monthly_partition_invalid_usa_zipcode_format_found --enable-error
        ```
    ...
    === "Run all configured checks"
        ...
        Run this data quality check using the [check run](../../../command-line-interface/check.md#dqo-check-run) CLI command by providing the check name and all other targeting filters.
        The following example shows how to run the *monthly_partition_invalid_usa_zipcode_format_found* check on all tables and columns on a single data source.

        ```
        dqo> check run -c=data_source_name -ch=monthly_partition_invalid_usa_zipcode_format_found
        ```

        It is also possible to run this check on a specific connection and table. In order to do this, use the connection name and the full table name parameters.

        ```
        dqo> check run -c=connection_name -t=schema_name.table_name -ch=monthly_partition_invalid_usa_zipcode_format_found
        ```

        You can also run this check on all tables (and columns)  on which the *monthly_partition_invalid_usa_zipcode_format_found* check is enabled
        using patterns to find tables.

        ```
        dqo> check run -c=connection_name -t=schema_prefix*.fact_* -col=column_name_* -ch=monthly_partition_invalid_usa_zipcode_format_found
        ```
