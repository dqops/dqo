...
??? example "Managing profile invalid uuid format found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_invalid_uuid_format_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_invalid_uuid_format_found
        ```
...
??? example "Managing daily invalid uuid format found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_invalid_uuid_format_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_invalid_uuid_format_found
        ```
...
??? example "Managing monthly invalid uuid format found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_invalid_uuid_format_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_invalid_uuid_format_found
        ```
...
??? example "Managing daily partition invalid uuid format found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_invalid_uuid_format_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_invalid_uuid_format_found
        ```
...
??? example "Managing monthly partition invalid uuid format found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_invalid_uuid_format_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_partition_invalid_uuid_format_found
        ```
