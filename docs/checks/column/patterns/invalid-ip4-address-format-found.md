...
___
The **invalid ip4 address format found** data quality check has the following variants for each
[type of data quality](../../../dqo-concepts/definition-of-data-quality-checks/index.md#types-of-checks) checks supported by DQOps.


## profile invalid ip4 address format found


**Check description**

Verifies that the number of invalid IP4 addresses in a text column does not exceed the maximum accepted count.

|Data quality check name|Friendly name|Category|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|Standard|
|-----------------------|-------------|--------|----------|----------|-----------------|-----------------|------------|--------|
|<span class="no-wrap-code">`profile_invalid_ip4_address_format_found`</span>|Maximum count of rows containing invalid IP4 address values|[patterns](../../../categories-of-data-quality-checks/how-to-detect-bad-values-not-matching-patterns.md)|[profiling](../../../dqo-concepts/definition-of-data-quality-checks/data-profiling-checks.md)| |[Validity](../../../dqo-concepts/data-quality-dimensions.md#data-validity)|[*invalid_ip4_address_format_count*](../../../reference/sensors/column/patterns-column-sensors.md#invalid-ip4-address-format-count)|[*max_count*](../../../reference/rules/Comparison.md#max-count)| |

**Command-line examples**

Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the profile invalid ip4 address format found data quality check.

??? example "Managing profile invalid ip4 address format found check from DQOps shell"
    ...
    === "Run all configured checks"
        ...
        The following example shows how to run the *profile_invalid_ip4_address_format_found* check on all tables and columns on a single data source.

        ```
        dqo> check run -c=data_source_name -ch=profile_invalid_ip4_address_format_found
        ```

        It is also possible to run this check on a specific connection and table. In order to do this, use the connection name and the full table name parameters.

        ```
        dqo> check run -c=connection_name -t=schema_name.table_name -ch=profile_invalid_ip4_address_format_found
        ```

        You can also run this check on all tables (and columns)  on which the *profile_invalid_ip4_address_format_found* check is enabled
...
??? info "Samples of generated SQL queries for each data source type"
    ...
    [invalid_ip4_address_format_count](../../../reference/sensors/column/patterns-column-sensors.md#invalid-ip4-address-format-count)
    ...
    ??? example "BigQuery"
        ...
        === "Rendered SQL for BigQuery"
            ...
            SELECT
                SUM(
                    CASE
                        WHEN NOT REGEXP_CONTAINS(CAST(analyzed_table.`target_column` AS STRING), r"^((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])[.]){3}(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])$")
                            THEN 1
                        ELSE 0
                    END
                ) AS actual_value
    ...
    ??? example "ClickHouse"
        ...
        === "Sensor template for ClickHouse"
            ...
            SELECT
                SUM(
                    CASE
                        WHEN NOT match(toString({{ lib.render_target_column('analyzed_table') }}), '^((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])[.]){3}(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])$')
                            THEN 1
                        ELSE 0
                    END
                ) AS actual_value
        ...
        === "Rendered SQL for ClickHouse"
            ...
            SELECT
                SUM(
                    CASE
                        WHEN NOT match(toString(analyzed_table."target_column"), '^((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])[.]){3}(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])$')
                            THEN 1
                        ELSE 0
                    END
                ) AS actual_value
    ...
    ??? example "HANA"
        ...
        === "Sensor template for HANA"
            ...
            SELECT
                SUM(
                    CASE
                        WHEN CAST({{ lib.render_target_column('analyzed_table') }} AS VARCHAR) NOT LIKE_REGEXPR '^((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])[.]){3}(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])$'
                            THEN 1
                        ELSE 0
                    END
                ) AS actual_value
        ...
        === "Rendered SQL for HANA"
            ...
            SELECT
                SUM(
                    CASE
                        WHEN CAST(analyzed_table."target_column" AS VARCHAR) NOT LIKE_REGEXPR '^((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])[.]){3}(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])$'
                            THEN 1
                        ELSE 0
                    END
                ) AS actual_value
    ...
    ??? example "Presto"
        ...
        === "Rendered SQL for Presto"
            ...
            SELECT
                SUM(
                    CASE
                        WHEN NOT REGEXP_LIKE(CAST(analyzed_table."target_column" AS VARCHAR), '^((25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])[.]){3}(25[0-5]|2[0-4][0-9]|1[0-9][0-9]|[0-9][0-9]|[0-9])$')
                            THEN 1
                        ELSE 0
                    END
                ) AS actual_value
                ...
                SUM(
                    CASE
                        WHEN NOT (
                                 ...
                                 OR analyzed_table.[target_column] LIKE '[0-9][0-9][0-9].[0-9][0-9][0-9].[0-9][0-9][0-9].[0-9][0-9][0-9]'
                                 OR analyzed_table.[target_column] LIKE '[0-9][0-9][0-9].[0-9][0-9][0-9].[0-9][0-9][0-9].[0-9][0-9]')
                                 AND (PATINDEX('%[^0-9.]%', analyzed_table.[target_column]) = 0
                                 OR PATINDEX('%[^0-9.]%', analyzed_table.[target_column]) = 0
                                 OR PATINDEX('%[^0-9.]%', analyzed_table.[target_column]) = 0)
                            ) THEN 1
                        ELSE 0
                    END
...
## daily invalid ip4 address format found
...
|Data quality check name|Friendly name|Category|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|Standard|
|-----------------------|-------------|--------|----------|----------|-----------------|-----------------|------------|--------|
|<span class="no-wrap-code">`daily_invalid_ip4_address_format_found`</span>|Maximum count of rows containing invalid IP4 address values|[patterns](../../../categories-of-data-quality-checks/how-to-detect-bad-values-not-matching-patterns.md)|[monitoring](../../../dqo-concepts/definition-of-data-quality-checks/data-observability-monitoring-checks.md)|daily|[Validity](../../../dqo-concepts/data-quality-dimensions.md#data-validity)|[*invalid_ip4_address_format_count*](../../../reference/sensors/column/patterns-column-sensors.md#invalid-ip4-address-format-count)|[*max_count*](../../../reference/rules/Comparison.md#max-count)| |

**Command-line examples**

Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the daily invalid ip4 address format found data quality check.

??? example "Managing daily invalid ip4 address format found check from DQOps shell"
    ...
    === "Run all configured checks"
        ...
        Run this data quality check using the [check run](../../../command-line-interface/check.md#dqo-check-run) CLI command by providing the check name and all other targeting filters.
        The following example shows how to run the *daily_invalid_ip4_address_format_found* check on all tables and columns on a single data source.

        ```
        dqo> check run -c=data_source_name -ch=daily_invalid_ip4_address_format_found
        ```

        It is also possible to run this check on a specific connection and table. In order to do this, use the connection name and the full table name parameters.

        ```
        dqo> check run -c=connection_name -t=schema_name.table_name -ch=daily_invalid_ip4_address_format_found
        ```

        You can also run this check on all tables (and columns)  on which the *daily_invalid_ip4_address_format_found* check is enabled
        using patterns to find tables.
...
## monthly invalid ip4 address format found
...
|Data quality check name|Friendly name|Category|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|Standard|
|-----------------------|-------------|--------|----------|----------|-----------------|-----------------|------------|--------|
|<span class="no-wrap-code">`monthly_invalid_ip4_address_format_found`</span>|Maximum count of rows containing invalid IP4 address values|[patterns](../../../categories-of-data-quality-checks/how-to-detect-bad-values-not-matching-patterns.md)|[monitoring](../../../dqo-concepts/definition-of-data-quality-checks/data-observability-monitoring-checks.md)|monthly|[Validity](../../../dqo-concepts/data-quality-dimensions.md#data-validity)|[*invalid_ip4_address_format_count*](../../../reference/sensors/column/patterns-column-sensors.md#invalid-ip4-address-format-count)|[*max_count*](../../../reference/rules/Comparison.md#max-count)| |

**Command-line examples**

Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the monthly invalid ip4 address format found data quality check.

??? example "Managing monthly invalid ip4 address format found check from DQOps shell"
    ...
    === "Run all configured checks"
        ...
        Run this data quality check using the [check run](../../../command-line-interface/check.md#dqo-check-run) CLI command by providing the check name and all other targeting filters.
        The following example shows how to run the *monthly_invalid_ip4_address_format_found* check on all tables and columns on a single data source.

        ```
        dqo> check run -c=data_source_name -ch=monthly_invalid_ip4_address_format_found
        ```

        It is also possible to run this check on a specific connection and table. In order to do this, use the connection name and the full table name parameters.

        ```
        dqo> check run -c=connection_name -t=schema_name.table_name -ch=monthly_invalid_ip4_address_format_found
        ```

        You can also run this check on all tables (and columns)  on which the *monthly_invalid_ip4_address_format_found* check is enabled
        using patterns to find tables.
...
## daily partition invalid ip4 address format found
...
|Data quality check name|Friendly name|Category|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|Standard|
|-----------------------|-------------|--------|----------|----------|-----------------|-----------------|------------|--------|
|<span class="no-wrap-code">`daily_partition_invalid_ip4_address_format_found`</span>|Maximum count of rows containing invalid IP4 address values|[patterns](../../../categories-of-data-quality-checks/how-to-detect-bad-values-not-matching-patterns.md)|[partitioned](../../../dqo-concepts/definition-of-data-quality-checks/partition-checks.md)|daily|[Validity](../../../dqo-concepts/data-quality-dimensions.md#data-validity)|[*invalid_ip4_address_format_count*](../../../reference/sensors/column/patterns-column-sensors.md#invalid-ip4-address-format-count)|[*max_count*](../../../reference/rules/Comparison.md#max-count)| |

**Command-line examples**

Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the daily partition invalid ip4 address format found data quality check.

??? example "Managing daily partition invalid ip4 address format found check from DQOps shell"
    ...
    === "Run all configured checks"
        ...
        Run this data quality check using the [check run](../../../command-line-interface/check.md#dqo-check-run) CLI command by providing the check name and all other targeting filters.
        The following example shows how to run the *daily_partition_invalid_ip4_address_format_found* check on all tables and columns on a single data source.

        ```
        dqo> check run -c=data_source_name -ch=daily_partition_invalid_ip4_address_format_found
        ```

        It is also possible to run this check on a specific connection and table. In order to do this, use the connection name and the full table name parameters.

        ```
        dqo> check run -c=connection_name -t=schema_name.table_name -ch=daily_partition_invalid_ip4_address_format_found
        ```

        You can also run this check on all tables (and columns)  on which the *daily_partition_invalid_ip4_address_format_found* check is enabled
        using patterns to find tables.
...
## monthly partition invalid ip4 address format found
...
Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the monthly partition invalid ip4 address format found data quality check.

??? example "Managing monthly partition invalid ip4 address format found check from DQOps shell"
    ...
    === "Run all configured checks"
        ...
        Run this data quality check using the [check run](../../../command-line-interface/check.md#dqo-check-run) CLI command by providing the check name and all other targeting filters.
        The following example shows how to run the *monthly_partition_invalid_ip4_address_format_found* check on all tables and columns on a single data source.

        ```
        dqo> check run -c=data_source_name -ch=monthly_partition_invalid_ip4_address_format_found
        ```

        It is also possible to run this check on a specific connection and table. In order to do this, use the connection name and the full table name parameters.

        ```
        dqo> check run -c=connection_name -t=schema_name.table_name -ch=monthly_partition_invalid_ip4_address_format_found
        ```

        You can also run this check on all tables (and columns)  on which the *monthly_partition_invalid_ip4_address_format_found* check is enabled
        using patterns to find tables.
