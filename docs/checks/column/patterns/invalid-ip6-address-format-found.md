...
??? example "Managing profile invalid ip6 address format found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_invalid_ip6_address_format_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_invalid_ip6_address_format_found
        ```
...
??? example "Managing daily invalid ip6 address format found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_invalid_ip6_address_format_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_invalid_ip6_address_format_found
        ```
...
??? example "Managing monthly invalid ip6 address format found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_invalid_ip6_address_format_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_invalid_ip6_address_format_found
        ```
...
??? example "Managing daily partition invalid ip6 address format found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_invalid_ip6_address_format_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_invalid_ip6_address_format_found
        ```
...
??? example "Managing monthly partition invalid ip6 address format found check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_invalid_ip6_address_format_found
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_partition_invalid_ip6_address_format_found
        ```
