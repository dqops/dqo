...
??? example "Managing profile nulls percent change 1 day check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_nulls_percent_change_1_day
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_nulls_percent_change_1_day
        ```
...
??? example "Managing daily nulls percent change 1 day check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_nulls_percent_change_1_day
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_nulls_percent_change_1_day
        ```
...
??? example "Managing daily partition nulls percent change 1 day check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_nulls_percent_change_1_day
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_nulls_percent_change_1_day
        ```
