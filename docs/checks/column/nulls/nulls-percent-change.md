...
??? example "Managing profile nulls percent change check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_nulls_percent_change
        ```
...
??? example "Managing daily nulls percent change check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_nulls_percent_change
        ```
...
??? example "Managing daily partition nulls percent change check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_nulls_percent_change
        ```
