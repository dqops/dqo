...
```
dqo> check activate -c=connection_name -ch=profile_median_change_30_days
```
...
```
dqo> check activate -c=connection_name -ch=daily_median_change_30_days
```
...
```
dqo> check activate -c=connection_name -ch=daily_partition_median_change_30_days
```
