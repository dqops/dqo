...
|----------|----------|----------|-----------------|-----------------|------------|
|profile_mean_change_yesterday|profiling| |Consistency|[mean](../../../../reference/sensors/column/numeric-column-sensors/#mean)|[change_percent_1_day](../../../../reference/rules/Change/#change-percent-1-day)|
...
```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=profile_mean_change_yesterday
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=profile_mean_change_yesterday
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_mean_change_yesterday|monitoring|daily|Consistency|[mean](../../../../reference/sensors/column/numeric-column-sensors/#mean)|[change_percent_1_day](../../../../reference/rules/Change/#change-percent-1-day)|
...
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=daily_mean_change_yesterday
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=daily_mean_change_yesterday
```
**Check structure (YAML)**
```yaml
      monitoring_checks:
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_partition_mean_change_yesterday|partitioned|daily|Consistency|[mean](../../../../reference/sensors/column/numeric-column-sensors/#mean)|[change_percent_1_day](../../../../reference/rules/Change/#change-percent-1-day)|
...
It is additionally feasible to run this check on a specific table. In order to do this, add the table name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -ch=daily_partition_mean_change_yesterday
```
It is furthermore viable to combine run this check on a specific column. In order to do this, add the column name to the below
```
dqo> check run -c=connection_name -t=schema_name.table_name -col=column_name -ch=daily_partition_mean_change_yesterday
```
**Check structure (YAML)**
```yaml
      partitioned_checks:
