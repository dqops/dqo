...
|----------|----------|----------|-----------------|-----------------|------------|
|profile_median_change_1_day|profiling| |Consistency|[percentile](../../../reference/sensors/column/numeric-column-sensors.md#percentile)|[change_percent_1_day](../../../reference/rules/Change.md#change-percent-1-day)|

**Command-line examples**

Please expand the section below to see the DQOps command-line examples to run or activate the profile median change 1 day data quality check.
...
??? example "Managing profile median change 1 day check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_median_change_1_day
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_median_change_1_day
        ```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_median_change_1_day|monitoring|daily|Consistency|[percentile](../../../reference/sensors/column/numeric-column-sensors.md#percentile)|[change_percent_1_day](../../../reference/rules/Change.md#change-percent-1-day)|

**Command-line examples**

Please expand the section below to see the DQOps command-line examples to run or activate the daily median change 1 day data quality check.
...
??? example "Managing daily median change 1 day check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_median_change_1_day
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_median_change_1_day
        ```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_partition_median_change_1_day|partitioned|daily|Consistency|[percentile](../../../reference/sensors/column/numeric-column-sensors.md#percentile)|[change_percent_1_day](../../../reference/rules/Change.md#change-percent-1-day)|

**Command-line examples**

Please expand the section below to see the DQOps command-line examples to run or activate the daily partition median change 1 day data quality check.
...
??? example "Managing daily partition median change 1 day check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_median_change_1_day
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_median_change_1_day
        ```
