...
??? example "Managing profile median change 7 days check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_median_change_7_days
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_median_change_7_days
        ```
...
??? example "Managing daily median change 7 days check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_median_change_7_days
        ```
...
??? example "Managing daily partition median change 7 days check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_median_change_7_days
        ```
