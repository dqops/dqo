...
Column-level check that ensures that the percentage of texts in the monitored column with a length above the length defined by the user as a parameter does not fall below set thresholds.
...
Please expand the section below to see the DQOps command-line examples to run or activate the profile text length above max length percent data quality check.
...
??? example "Managing profile text length above max length percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_text_length_above_max_length_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_text_length_above_max_length_percent
        ```
...
Please expand the section below to see the DQOps command-line examples to run or activate the daily text length above max length percent data quality check.
...
??? example "Managing daily text length above max length percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_text_length_above_max_length_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_text_length_above_max_length_percent
        ```
...
Please expand the section below to see the DQOps command-line examples to run or activate the monthly text length above max length percent data quality check.
...
??? example "Managing monthly text length above max length percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_text_length_above_max_length_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_text_length_above_max_length_percent
        ```
...
Please expand the section below to see the DQOps command-line examples to run or activate the daily partition text length above max length percent data quality check.
...
??? example "Managing daily partition text length above max length percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_text_length_above_max_length_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_text_length_above_max_length_percent
        ```
...
Please expand the section below to see the DQOps command-line examples to run or activate the monthly partition text length above max length percent data quality check.
...
??? example "Managing monthly partition text length above max length percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_text_length_above_max_length_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_partition_text_length_above_max_length_percent
        ```
