---
title: Text length below min length data quality checks, SQL examples
---
# Text length below min length data quality checks, SQL examples
    ...
    ??? example "ClickHouse"
        ...
        === "Rendered SQL for ClickHouse"
            ...
            SELECT
                SUM(
                    CASE
                        WHEN LENGTH(toString(analyzed_table."target_column")) < 5
                            THEN 1
                        ELSE 0
                    END
                ) AS actual_value
