...
Column-level check that ensures that the percentage of texts that are valid country codes in the monitored column does not fall below set thresholds.
...
??? example "Managing profile text valid country code percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_text_valid_country_code_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_text_valid_country_code_percent
        ```
...
??? example "Managing daily text valid country code percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_text_valid_country_code_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_text_valid_country_code_percent
        ```
...
??? example "Managing monthly text valid country code percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_text_valid_country_code_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_text_valid_country_code_percent
        ```
...
??? example "Managing daily partition text valid country code percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_text_valid_country_code_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_text_valid_country_code_percent
        ```
...
??? example "Managing monthly partition text valid country code percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_text_valid_country_code_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_partition_text_valid_country_code_percent
        ```
