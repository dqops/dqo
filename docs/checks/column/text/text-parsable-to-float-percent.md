...
??? example "Managing profile text parsable to float percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_text_parsable_to_float_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_text_parsable_to_float_percent
        ```
...
??? example "Managing daily text parsable to float percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_text_parsable_to_float_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_text_parsable_to_float_percent
        ```
...
??? example "Managing monthly text parsable to float percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_text_parsable_to_float_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_text_parsable_to_float_percent
        ```
...
Please expand the section below to see the DQOps command-line examples to run or activate the daily partition text parsable to float percent data quality check.
...
??? example "Managing daily partition text parsable to float percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_text_parsable_to_float_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_text_parsable_to_float_percent
        ```
...
Please expand the section below to see the DQOps command-line examples to run or activate the monthly partition text parsable to float percent data quality check.
...
??? example "Managing monthly partition text parsable to float percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_text_parsable_to_float_percent
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=monthly_partition_text_parsable_to_float_percent
        ```
