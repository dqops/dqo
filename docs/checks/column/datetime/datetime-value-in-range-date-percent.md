...
```
dqo> check activate -c=connection_name -ch=profile_datetime_value_in_range_date_percent
```
...
```
dqo> check activate -c=connection_name -ch=daily_datetime_value_in_range_date_percent
```
...
```
dqo> check activate -c=connection_name -ch=monthly_datetime_value_in_range_date_percent
```
...
```
dqo> check activate -c=connection_name -ch=daily_partition_datetime_value_in_range_date_percent
```
...
```
dqo> check activate -c=connection_name -ch=monthly_partition_datetime_value_in_range_date_percent
```
