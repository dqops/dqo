...
___
The **text match date format percent** data quality check has the following variants for each
...
|-----------------------|--------|----------|----------|-----------------|-----------------|------------|--------|
|<span class="no-wrap-code">`profile_text_match_date_format_percent`</span>|[datetime](../../../categories-of-data-quality-checks/how-to-detect-invalid-dates.md)|[profiling](../../../dqo-concepts/definition-of-data-quality-checks/data-profiling-checks.md)| |Validity|[*text_match_date_format_percent*](../../../reference/sensors/column/datetime-column-sensors.md#text-match-date-format-percent)|[*min_percent*](../../../reference/rules/Comparison.md#min-percent)|:material-check-bold:|

**Command-line examples**

Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the profile text match date format percent data quality check.

??? example "Managing profile text match date format percent check from DQOps shell"
    ...
    === "Run all configured checks"
        ...
        The following example shows how to run the *profile_text_match_date_format_percent* check on all tables and columns on a single data source.
        ...
        You can also run this check on all tables (and columns)  on which the *profile_text_match_date_format_percent* check is enabled
...
??? info "Samples of generated SQL queries for each data source type"
    ...
    [text_match_date_format_percent](../../../reference/sensors/column/datetime-column-sensors.md#text-match-date-format-percent)
        ...
        === "Sensor template for DuckDB"
            ...
            SELECT
                CASE
                    ...
                    ELSE 100.0 * SUM(
                        CASE
                            WHEN CAST({{lib.render_target_column('analyzed_table')}} AS VARCHAR) ~ {{ lib.render_date_formats(parameters.date_formats) }} IS NOT NULL
                                THEN 1
                            ELSE 0
                        END
                    ) / COUNT(*)
        ...
        === "Rendered SQL for DuckDB"
            ...
            SELECT
                CASE
                    ...
                    ELSE 100.0 * SUM(
                        CASE
                            WHEN CAST(analyzed_table."target_column" AS VARCHAR) ~  IS NOT NULL
                                THEN 1
                            ELSE 0
                        END
                    ) / COUNT(*)
...
|Data quality check name|Category|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|Standard|
|-----------------------|--------|----------|----------|-----------------|-----------------|------------|--------|
|<span class="no-wrap-code">`daily_text_match_date_format_percent`</span>|[datetime](../../../categories-of-data-quality-checks/how-to-detect-invalid-dates.md)|[monitoring](../../../dqo-concepts/definition-of-data-quality-checks/data-observability-monitoring-checks.md)|daily|Validity|[*text_match_date_format_percent*](../../../reference/sensors/column/datetime-column-sensors.md#text-match-date-format-percent)|[*min_percent*](../../../reference/rules/Comparison.md#min-percent)|:material-check-bold:|

**Command-line examples**

Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the daily text match date format percent data quality check.

??? example "Managing daily text match date format percent check from DQOps shell"
    ...
    === "Run all configured checks"
        ...
        Run this data quality check using the [check run](../../../command-line-interface/check.md#dqo-check-run) CLI command by providing the check name and all other targeting filters.
        The following example shows how to run the *daily_text_match_date_format_percent* check on all tables and columns on a single data source.
        ...
        You can also run this check on all tables (and columns)  on which the *daily_text_match_date_format_percent* check is enabled
        using patterns to find tables.
...
|Data quality check name|Category|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|Standard|
|-----------------------|--------|----------|----------|-----------------|-----------------|------------|--------|
|<span class="no-wrap-code">`monthly_text_match_date_format_percent`</span>|[datetime](../../../categories-of-data-quality-checks/how-to-detect-invalid-dates.md)|[monitoring](../../../dqo-concepts/definition-of-data-quality-checks/data-observability-monitoring-checks.md)|monthly|Validity|[*text_match_date_format_percent*](../../../reference/sensors/column/datetime-column-sensors.md#text-match-date-format-percent)|[*min_percent*](../../../reference/rules/Comparison.md#min-percent)|:material-check-bold:|

**Command-line examples**

Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the monthly text match date format percent data quality check.

??? example "Managing monthly text match date format percent check from DQOps shell"
    ...
    === "Run all configured checks"
        ...
        Run this data quality check using the [check run](../../../command-line-interface/check.md#dqo-check-run) CLI command by providing the check name and all other targeting filters.
        The following example shows how to run the *monthly_text_match_date_format_percent* check on all tables and columns on a single data source.
        ...
        You can also run this check on all tables (and columns)  on which the *monthly_text_match_date_format_percent* check is enabled
        using patterns to find tables.
...
|Data quality check name|Category|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|Standard|
|-----------------------|--------|----------|----------|-----------------|-----------------|------------|--------|
|<span class="no-wrap-code">`daily_partition_text_match_date_format_percent`</span>|[datetime](../../../categories-of-data-quality-checks/how-to-detect-invalid-dates.md)|[partitioned](../../../dqo-concepts/definition-of-data-quality-checks/partition-checks.md)|daily|Validity|[*text_match_date_format_percent*](../../../reference/sensors/column/datetime-column-sensors.md#text-match-date-format-percent)|[*min_percent*](../../../reference/rules/Comparison.md#min-percent)|:material-check-bold:|

**Command-line examples**

Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the daily partition text match date format percent data quality check.

??? example "Managing daily partition text match date format percent check from DQOps shell"
    ...
    === "Run all configured checks"
        ...
        Run this data quality check using the [check run](../../../command-line-interface/check.md#dqo-check-run) CLI command by providing the check name and all other targeting filters.
        The following example shows how to run the *daily_partition_text_match_date_format_percent* check on all tables and columns on a single data source.
        ...
        You can also run this check on all tables (and columns)  on which the *daily_partition_text_match_date_format_percent* check is enabled
        using patterns to find tables.
...
|Data quality check name|Category|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|Standard|
|-----------------------|--------|----------|----------|-----------------|-----------------|------------|--------|
|<span class="no-wrap-code">`monthly_partition_text_match_date_format_percent`</span>|[datetime](../../../categories-of-data-quality-checks/how-to-detect-invalid-dates.md)|[partitioned](../../../dqo-concepts/definition-of-data-quality-checks/partition-checks.md)|monthly|Validity|[*text_match_date_format_percent*](../../../reference/sensors/column/datetime-column-sensors.md#text-match-date-format-percent)|[*min_percent*](../../../reference/rules/Comparison.md#min-percent)|:material-check-bold:|

**Command-line examples**

Please expand the section below to see the [DQOps command-line](../../../dqo-concepts/command-line-interface.md) examples to run or activate the monthly partition text match date format percent data quality check.

??? example "Managing monthly partition text match date format percent check from DQOps shell"
    ...
    === "Run all configured checks"
        ...
        Run this data quality check using the [check run](../../../command-line-interface/check.md#dqo-check-run) CLI command by providing the check name and all other targeting filters.
        The following example shows how to run the *monthly_partition_text_match_date_format_percent* check on all tables and columns on a single data source.
        ...
        You can also run this check on all tables (and columns)  on which the *monthly_partition_text_match_date_format_percent* check is enabled
        using patterns to find tables.
