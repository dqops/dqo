...
??? example "Managing profile date match format percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_date_match_format_percent
        ```
...
??? example "Managing daily date match format percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_date_match_format_percent
        ```
...
??? example "Managing monthly date match format percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_date_match_format_percent
        ```
...
??? example "Managing daily partition date match format percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_date_match_format_percent
        ```
...
??? example "Managing monthly partition date match format percent check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=monthly_partition_date_match_format_percent
        ```
