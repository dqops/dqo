...
|----------|----------|----------|-----------|-------------|
|row_count_match_percent|profiling| |[not_null_count_match_percent](../../../../reference/sensors/column/accuracy-column-sensors/#not-null-count-match-percent)|[diff_percent](../../../../reference/rules/comparison/#diff-percent)|
...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|daily_row_count_match_percent|recurring|daily|[not_null_count_match_percent](../../../../reference/sensors/column/accuracy-column-sensors/#not-null-count-match-percent)|[diff_percent](../../../../reference/rules/comparison/#diff-percent)|
...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|monthly_row_count_match_percent|recurring|monthly|[not_null_count_match_percent](../../../../reference/sensors/column/accuracy-column-sensors/#not-null-count-match-percent)|[diff_percent](../../../../reference/rules/comparison/#diff-percent)|
