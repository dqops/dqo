...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|daily_total_min_match_percent|monitoring|daily|[total_min_match_percent](../../../../reference/sensors/column/accuracy-column-sensors/#total-min-match-percent)|[diff_percent](../../../../reference/rules/Comparison/#diff-percent)|
...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|monthly_total_min_match_percent|monitoring|monthly|[total_min_match_percent](../../../../reference/sensors/column/accuracy-column-sensors/#total-min-match-percent)|[diff_percent](../../../../reference/rules/Comparison/#diff-percent)|
