...
??? example "Managing profile row count change 30 days check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_row_count_change_30_days
        ```
...
??? example "Managing daily row count change 30 days check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_row_count_change_30_days
        ```
...
??? example "Managing daily partition row count change 30 days check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_row_count_change_30_days
        ```
