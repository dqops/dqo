...
|----------|----------|----------|-----------|-------------|
|row_count_anomaly_7_days|profiling| |[row_count](../../../../reference/sensors/Table/volume-table-sensors/#row-count)|[change_percentile_moving_within_7_days](../../../../reference/rules/Percentile/#change-percentile-moving-within-7-days)|
...
|Check name|Check type|Time scale|Sensor definition|Quality rule|
|----------|----------|----------|-----------|-------------|
|daily_row_count_anomaly_7_days|recurring|daily|[row_count](../../../../reference/sensors/Table/volume-table-sensors/#row-count)|[change_percentile_moving_within_7_days](../../../../reference/rules/Percentile/#change-percentile-moving-within-7-days)|
