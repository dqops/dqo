...
??? example "Managing profile row count anomaly check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=profile_row_count_anomaly
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=profile_row_count_anomaly
        ```
...
??? example "Managing daily row count anomaly check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_row_count_anomaly
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_row_count_anomaly
        ```
...
??? example "Managing daily partition row count anomaly check from DQOps shell"
    ...
    === "Activate check"
        ...
        ```
        dqo> check activate -c=connection_name -ch=daily_partition_row_count_anomaly
        ```
    ...
    === "Run check on connection"
        ...
        ```
        dqo> check run -c=connection_name -ch=daily_partition_row_count_anomaly
        ```
