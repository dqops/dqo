...
|----------|----------|----------|-----------------|-----------------|------------|
|profile_row_count_change_yesterday|profiling| |Consistency|[row_count](../../../../reference/sensors/table/volume-table-sensors.md#row-count)|[change_percent_1_day](../../../../reference/rules/Change.md#change-percent-1-day)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=profile_row_count_change_yesterday
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_row_count_change_yesterday|monitoring|daily|Consistency|[row_count](../../../../reference/sensors/table/volume-table-sensors.md#row-count)|[change_percent_1_day](../../../../reference/rules/Change.md#change-percent-1-day)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=daily_row_count_change_yesterday
```
...
|Check name|Check type|Time scale|Quality dimension|Sensor definition|Quality rule|
|----------|----------|----------|-----------------|-----------------|------------|
|daily_partition_row_count_change_yesterday|partitioned|daily|Consistency|[row_count](../../../../reference/sensors/table/volume-table-sensors.md#row-count)|[change_percent_1_day](../../../../reference/rules/Change.md#change-percent-1-day)|

**Activate check (Shell)**
Activate this data quality using the [check activate](../../../../command-line-interface/check.md#dqo-check-activate) CLI command, providing the connection name, check name, and all other filters.

```
dqo> check activate -c=connection_name -ch=daily_partition_row_count_change_yesterday
```
