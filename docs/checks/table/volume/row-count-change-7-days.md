...
```
dqo> check activate -c=connection_name -ch=profile_row_count_change_7_days
```
...
```
dqo> check activate -c=connection_name -ch=daily_row_count_change_7_days
```
...
```
dqo> check activate -c=connection_name -ch=daily_partition_row_count_change_7_days
```
