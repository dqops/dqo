...
| check_time_scale  | Time scale filter for monitoring and partition checks (values: CheckTimeScale.DAILY, CheckTimeScale.MONTHLY).                                                                                                                                                                                                                                                                                           | Union[Unset, None, [CheckTimeScale](../../client/models/#CheckTimeScale)] |
