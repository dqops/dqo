...
!!! info "Wait for job operator usage"
    ...
    This operator can be safely removed when you are sure that your table is lightweight and the DQOps' checks execution last less than the default 120 seconds timeout.
