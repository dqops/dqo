...
- **DqopsRunProfilingChecksOperator**: Run checks operator for running [profiling type of checks](../../dqo-concepts/definition-of-data-quality-checks/data-profiling-checks.md).
- **DqopsRunMonitoringChecksOperator**: Run checks operator for running [monitoring type of checks](../../dqo-concepts/definition-of-data-quality-checks/data-observability-monitoring-checks.md).
- **DqopsRunPartitionedChecksOperator**: Run checks operator for running [partition type of checks](../../dqo-concepts/definition-of-data-quality-checks/partition-checks.md).
...
| column_data_type      | The column data type that was imported from the data source and is stored in the [columns -> column_name -> type_snapshot -> column_type](../../reference/yaml/TableYaml.md#columntypesnapshotspec) field in the *.dqotable.yaml* file.                                                                                                                                               | Union[Unset, str]                                                                                                       |
