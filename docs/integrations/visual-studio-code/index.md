...
| [Default table-level data observability checks](../../reference/yaml/TableDefaultChecksPatternYaml.md)    | *patterns/&lt;pattern_name&gt;.dqotablepattern.yaml*       | [https://cloud.dqops.com/dqo-yaml-schema/TableDefaultChecksPatternYaml-schema.json](https://cloud.dqops.com/dqo-yaml-schema/TableDefaultChecksPatternYaml-schema.json)   |
| [Default column-level data observability checks](../../reference/yaml/ColumnDefaultChecksPatternYaml.md)  | *pattern/&lt;pattern_name&gt;.dqocolumnpattern.yaml*       | [https://cloud.dqops.com/dqo-yaml-schema/ColumnDefaultChecksPatternYaml-schema.json](https://cloud.dqops.com/dqo-yaml-schema/ColumnDefaultChecksPatternYaml-schema.json) |
