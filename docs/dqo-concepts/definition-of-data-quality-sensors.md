...
| **Column**                                                                                      |                                                                                                                                                                                                           |
| [accepted values column sensors](../reference/sensors/column/accepted_values-column-sensors.md) | Verify that values in a column are only from an accepted list of values.                                                                                                                                  |
...
| [blanks column sensors](../reference/sensors/column/blanks-column-sensors.md)                   | Detect columns that are storing blank values, such as 'None', 'n/a', ''.                                                                                                                                  |
...
| [patterns column sensors](../reference/sensors/column/patterns-column-sensors.md)               | Verify text columns by maching the values to custom or predefined patterns (regular expressions)                                                                                                          |
