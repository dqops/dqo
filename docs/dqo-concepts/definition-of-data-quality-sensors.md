---
title: What is a Data Quality Sensor? Definition and Examples
---
# What is a Data Quality Sensor? Definition and Examples
Read this guide to understand how data quality sensors capture metrics about monitored data sources for detecting data quality issues with data quality rules.
...
| [conversion column sensors](../reference/sensors/column/conversions-column-sensors.md)          | Detects text value that cannot be parsed and converted to boolean, numeric or date types.                                                                                                                      |
...
| [whitespace column sensors](../reference/sensors/column/whitespace-column-sensors.md)           | Detects columns storing blank and whitespace values, such as 'None', 'n/a', ''.                                                                                                                                |
