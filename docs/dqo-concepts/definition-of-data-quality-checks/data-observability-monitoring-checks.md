...
at *2024-10-07 12:44:14* (October 7th, 2024). 

DQOps stored one result for October 2024, truncating the value of the *Checkpoint date* (`time_period` parquet column) to the beginning of the month.

![Monthly monitoring data quality checks editor](https://dqops.com/docs/images/concepts/types-of-data-quality-checks/monthly-monitoring-checks-editor2.png){ loading=lazy; width="1200px" }
