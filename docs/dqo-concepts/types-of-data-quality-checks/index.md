...
| [PII values](how-to-detect-pii-data-quality-issues.md)                                           | <span class="no-wrap-code">`pii`</span>             | Find PII values (Personally Identifiable Information) in text columns.                                                                                                           | [column-level](../../checks/column/pii/index.md)                                                                       |
