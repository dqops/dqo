...
|-------------------------|------------------------|-------------|-------|
|[row_count_match](../../checks/table/comparisons/row-count-match.md)|Accuracy|Table level comparison check compares the row count of the current (parent) table to the row count of the reference table.|:material-check-bold:|
|[column_count_match](../../checks/table/comparisons/column-count-match.md)|Accuracy|Table level comparison check compares the column count of the current (parent) table to the column count in the reference table.|:material-check-bold:|
