...
| <span class="no-wrap-code">**`id`**</span>          | Primary key of the row. Calculated as as hash value of the `time_series_id`, `check_hash`, and the `time_period` columns, that identify each data quality result within a time series by the time period.                                          | ef606aaf-dec8-5207-4d54-db2f5669c32d |
