...
After navigating to the Redshift connection settings, you will need to fill in the connection details.
...
The complete documentation of all connection parameters used in the `spec.redshift` node is
described in the reference of the [RedshiftParametersSpec](../reference/yaml/ConnectionYaml.md#redshiftparametersspec)
