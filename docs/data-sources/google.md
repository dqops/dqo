...
To navigate to the Google connection settings:
...
After navigating to the Google connection settings, you will need to fill in its details.
...
Change the **Files location** to **Google Cloud Storage**, to work with files located in Google.

Select the **File Format** suitable to your files located in Google. You can choose from CSV, JSON or Parquet file format.
