...
The format properties of a CSV file are detected automatically based on a data sample from the file. The default sample size is 20480 rows.

For a very specific CSV format the following properties can be configured.

| CSV format specific settings | Property name in YAML configuration file | Description                                                                                                                                                                                   |
|------------------------------|------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
