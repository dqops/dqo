...
2. Select Teradata database type.

    ![Selecting Teradata database type](https://dqops.com/docs/images/working-with-dqo/adding-connections/adding-connection-teradata.png){ loading=lazy; width="1200px" }
...
![Adding connection settings](https://dqops.com/docs/images/working-with-dqo/adding-connections/connection-settings-teradata.png){ loading=lazy; width="1200px" }
...
| Host                      | `host`                                   | Teradata host name. Supports also a ${TERADATA_HOST} configuration with a custom environment variable.                                                                                                                                    |
| Port                      | `port`                                   | Teradata port name. The default port is 1025. Supports also a ${TERADATA_PORT} configuration with a custom environment variable.                                                                                                          |
| User name                 | `user`                                   | Teradata user name. The value can be in the ${TERADATA_USER} format to use dynamic substitution.                                                                                                                                          |
| Password                  | `password`                               | Teradata database password. The value can be in the ${TERADATA_PASSWORD} format to use dynamic substitution.                                                                                                                              |
...
Complete documentation of all connection parameters used in the `spec.teradata` node is
described in the reference section of the [TeradataParametersSpec](../reference/yaml/ConnectionYaml.md#teradataparametersspec)
YAML file format.
