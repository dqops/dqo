...
export const ROUTES = {
  ...
  TABLE_PROFILINGS: (checkTypes: string, connection: string, schema: string, table: string) => `/${checkTypes}/connection/${connection}/schema/${schema}/table/${table}/checks/profiling`,
  TABLE_PROFILINGS_UI_FILTER: (checkTypes: string, connection: string, schema: string, table: string, category: string, checkName: string) => `/${checkTypes}/connection/${connection}/schema/${schema}/table/${table}/checks/profiling/${category}/${checkName}`,
  ...
  COLUMN_PROFILINGS: (checkTypes: string, connection: string, schema: string, table: string, column: string) => `/${checkTypes}/connection/${connection}/schema/${schema}/table/${table}/columns/${column}/checks/profiling`,
  COLUMN_PROFILINGS_UI_FILTER: (checkTypes: string, connection: string, schema: string, table: string, column: string, category: string, checkName: string) => `/${checkTypes}/connection/${connection}/schema/${schema}/table/${table}/columns/${column}/checks/profiling/${category}/${checkName}`,
  ...
  PATTERNS: {
    ...
    TABLE_PROFILINGS: '/:checkTypes/connection/:connection/schema/:schema/table/:table/checks/profiling',
    TABLE_PROFILINGS_FILTER: '/:checkTypes/connection/:connection/schema/:schema/table/:table/checks/profiling/:category/:checkName',
    ...
    COLUMN_PROFILINGS: '/:checkTypes/connection/:connection/schema/:schema/table/:table/columns/:column/checks/profiling',
    COLUMN_PROFILINGS_FILTER: '/:checkTypes/connection/:connection/schema/:schema/table/:table/columns/:column/checks/profiling/:category/:checkName',
