...
export enum COLUMN_ACTION {
  ...
  GET_COLUMN_DAILY_RECURRING = 'COLUMN_ACTION/GET_COLUMN_DAILY_RECURRING',
  GET_COLUMN_DAILY_RECURRING_SUCCESS = 'COLUMN_ACTION/GET_COLUMN_DAILY_RECURRING_SUCCESS',
  GET_COLUMN_DAILY_RECURRING_ERROR = 'COLUMN_ACTION/GET_COLUMN_DAILY_RECURRING_ERROR',
  UPDATE_COLUMN_DAILY_RECURRING = 'COLUMN_ACTION/UPDATE_COLUMN_DAILY_RECURRING',
  UPDATE_COLUMN_DAILY_RECURRING_SUCCESS = 'COLUMN_ACTION/UPDATE_COLUMN_DAILY_RECURRING_SUCCESS',
  UPDATE_COLUMN_DAILY_RECURRING_ERROR = 'COLUMN_ACTION/UPDATE_COLUMN_DAILY_RECURRING_ERROR',
  GET_COLUMN_MONTHLY_RECURRING = 'COLUMN_ACTION/GET_COLUMN_MONTHLY_RECURRING',
  GET_COLUMN_MONTHLY_RECURRING_SUCCESS = 'COLUMN_ACTION/GET_COLUMN_MONTHLY_RECURRING_SUCCESS',
  GET_COLUMN_MONTHLY_RECURRING_ERROR = 'COLUMN_ACTION/GET_COLUMN_MONTHLY_RECURRING_ERROR',
  UPDATE_COLUMN_MONTHLY_RECURRING = 'COLUMN_ACTION/UPDATE_COLUMN_MONTHLY_RECURRING',
  UPDATE_COLUMN_MONTHLY_RECURRING_SUCCESS = 'COLUMN_ACTION/UPDATE_COLUMN_MONTHLY_RECURRING_SUCCESS',
  UPDATE_COLUMN_MONTHLY_RECURRING_ERROR = 'COLUMN_ACTION/UPDATE_COLUMN_MONTHLY_RECURRING_ERROR',
  ...
  SET_COLUMN_DAILY_RECURRING = 'COLUMN_ACTION/SET_COLUMN_DAILY_RECURRING',
  SET_COLUMN_MONTHLY_RECURRING = 'COLUMN_ACTION/SET_COLUMN_MONTHLY_RECURRING',
  ...
  GET_COLUMN_RECURRING_UI_FILTER = 'COLUMN_ACTION/GET_COLUMN_RECURRING_UI_FILTER',
  GET_COLUMN_RECURRING_UI_FILTER_SUCCESS = 'COLUMN_ACTION/GET_COLUMN_RECURRING_UI_FILTER_SUCCESS',
  GET_COLUMN_RECURRING_UI_FILTER_ERROR = 'COLUMN_ACTION/GET_COLUMN_RECURRING_UI_FILTER_ERROR',
  ...
  SET_UPDATED_RECURRING_UI_FILTER = 'COLUMN_ACTION/SET_UPDATED_RECURRING_UI_FILTER',
