...
export enum COLUMN_ACTION {
  ...
  GET_COLUMN_DAILY_CHECKPOINTS = 'COLUMN_ACTION/GET_COLUMN_DAILY_CHECKPOINTS',
  GET_COLUMN_DAILY_CHECKPOINTS_SUCCESS = 'COLUMN_ACTION/GET_COLUMN_DAILY_CHECKPOINTS_SUCCESS',
  GET_COLUMN_DAILY_CHECKPOINTS_ERROR = 'COLUMN_ACTION/GET_COLUMN_DAILY_CHECKPOINTS_ERROR',
  UPDATE_COLUMN_DAILY_CHECKPOINTS = 'COLUMN_ACTION/UPDATE_COLUMN_DAILY_CHECKPOINTS',
  UPDATE_COLUMN_DAILY_CHECKPOINTS_SUCCESS = 'COLUMN_ACTION/UPDATE_COLUMN_DAILY_CHECKPOINTS_SUCCESS',
  UPDATE_COLUMN_DAILY_CHECKPOINTS_ERROR = 'COLUMN_ACTION/UPDATE_COLUMN_DAILY_CHECKPOINTS_ERROR',
  GET_COLUMN_MONTHLY_CHECKPOINTS = 'COLUMN_ACTION/GET_COLUMN_MONTHLY_CHECKPOINTS',
  GET_COLUMN_MONTHLY_CHECKPOINTS_SUCCESS = 'COLUMN_ACTION/GET_COLUMN_MONTHLY_CHECKPOINTS_SUCCESS',
  GET_COLUMN_MONTHLY_CHECKPOINTS_ERROR = 'COLUMN_ACTION/GET_COLUMN_MONTHLY_CHECKPOINTS_ERROR',
  UPDATE_COLUMN_MONTHLY_CHECKPOINTS = 'COLUMN_ACTION/UPDATE_COLUMN_MONTHLY_CHECKPOINTS',
  UPDATE_COLUMN_MONTHLY_CHECKPOINTS_SUCCESS = 'COLUMN_ACTION/UPDATE_COLUMN_MONTHLY_CHECKPOINTS_SUCCESS',
  UPDATE_COLUMN_MONTHLY_CHECKPOINTS_ERROR = 'COLUMN_ACTION/UPDATE_COLUMN_MONTHLY_CHECKPOINTS_ERROR',
  ...
  SET_COLUMN_DAILY_CHECKPOINTS = 'COLUMN_ACTION/SET_COLUMN_DAILY_CHECKPOINTS',
  SET_COLUMN_MONTHLY_CHECKPOINTS = 'COLUMN_ACTION/SET_COLUMN_MONTHLY_CHECKPOINTS',
  ...
  GET_COLUMN_ADHOCS_CHECKS_UI_FILTER = 'COLUMN_ACTION/GET_COLUMN_ADHOCS_CHECKS_UI_FILTER',
  GET_COLUMN_ADHOCS_CHECKS_UI_FILTER_SUCCESS = 'COLUMN_ACTION/GET_COLUMN_ADHOCS_CHECKS_UI_FILTER_SUCCESS',
  GET_COLUMN_ADHOCS_CHECKS_UI_FILTER_ERROR = 'COLUMN_ACTION/GET_COLUMN_ADHOCS_CHECKS_UI_FILTER_ERROR',
  GET_COLUMN_CHECKPOINTS_UI_FILTER = 'COLUMN_ACTION/GET_COLUMN_CHECKPOINTS_UI_FILTER',
  GET_COLUMN_CHECKPOINTS_UI_FILTER_SUCCESS = 'COLUMN_ACTION/GET_COLUMN_CHECKPOINTS_UI_FILTER_SUCCESS',
  GET_COLUMN_CHECKPOINTS_UI_FILTER_ERROR = 'COLUMN_ACTION/GET_COLUMN_CHECKPOINTS_UI_FILTER_ERROR',
  ...
  SET_UPDATED_CHECKPOINTS_UI_FILTER = 'COLUMN_ACTION/SET_UPDATED_CHECKPOINTS_UI_FILTER',
