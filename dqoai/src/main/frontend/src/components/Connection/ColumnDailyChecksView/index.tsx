...
interface IColumnDailyChecksViewProps {
    ...
    <div className="">
      <div className="flex justify-between px-4 py-2 border-b border-gray-300 mb-2 min-h-14">
        <div className="flex items-center space-x-2">
          ...
          <div className="text-xl font-semibold">{`Daily Checkpoints for ${connectionName}.${schemaName}.${tableName}.${columnName}`}</div>
        </div>
        <Button
