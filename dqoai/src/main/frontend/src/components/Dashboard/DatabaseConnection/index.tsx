    ...
    <div>
      <div className="flex justify-between mb-4">
        <div>
          ...
          <div>{type === DATABASE_TYPE.BIGQUERY ? 'Google Bigquery' : 'Snowflake'} Connection Settings</div>
        </div>
        <img src={type === DATABASE_TYPE.BIGQUERY ? '/bigQuery.png' : '/snowflake.png'} className="h-16" alt="db logo" />
      </div>
