...
const BigqueryConnection = () => {
  const [authenticationMode, setAuthenticationMode] = useState<BigQueryAuthenticationMode>(
  ...
  return (
    <SectionWrapper title='BigQuery connection parameters' className='mb-4'>
      <Input label='Source GCP project ID' className='mb-4' name='sourceProjectId' />
      <Input label='Billing GCP project ID' className='mb-4' name='billingProjectId' />
      <Select
      ...
      {authenticationMode === BigQueryAuthenticationMode.json_key_content && (
        <Input label='JSON key content' className='mb-4' name='jsonKeyContent' />
      )}
      {authenticationMode === BigQueryAuthenticationMode.json_key_path && (
        <Input label='A path to the JSON key file' className='mb-4' name='jsonKeyPath' />
      )}
