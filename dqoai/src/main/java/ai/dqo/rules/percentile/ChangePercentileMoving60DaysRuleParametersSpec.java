...
public class ChangePercentileMoving60DaysRuleParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<ChangePercentileMoving60DaysRuleParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public ChangePercentileMoving60DaysRuleParametersSpec() {
    ...
    public String getRuleDefinitionName() {
        return "percentile/change_percentile_moving_60_days";
    }
}
