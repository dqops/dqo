...
public class MaxDiffPercentRule5ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MaxDiffPercentRule5ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
    ...
    private Double maxDiffPercent = 5.0;

    /**
     * Default constructor, the minimum accepted value is 5.
     */
    public MaxDiffPercentRule5ParametersSpec() {
    }
     ...
     */
    public MaxDiffPercentRule5ParametersSpec(Double maxDiffPercent) {
