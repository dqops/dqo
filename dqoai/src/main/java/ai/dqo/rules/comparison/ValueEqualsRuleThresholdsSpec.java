...
public class ValueEqualsRuleThresholdsSpec extends AbstractRuleThresholdsSpec<ValueEqualsRuleParametersSpec> {
     ...
     */
    @Override
    public ValueEqualsRuleParametersSpec getLow() { return low; }

    /**
     * Sets a LOW severity alert rule set.
     * @param low Low severity alert rules.
     */
    public void setLow(ValueEqualsRuleParametersSpec low) {
     ...
     */
    @Override
    public ValueEqualsRuleParametersSpec getMedium() {
        return medium;
    }
     ...
     */
    public void setMedium(ValueEqualsRuleParametersSpec medium) {
     ...
     */
    @Override
    public ValueEqualsRuleParametersSpec getHigh() {
        return high;
    }
     ...
     */
    public void setHigh(ValueEqualsRuleParametersSpec high) {
