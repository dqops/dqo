...
public class MaxPercentRule2ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MaxPercentRule2ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     */
    public MaxPercentRule2ParametersSpec() {
    }
     ...
     */
    public MaxPercentRule2ParametersSpec(Double maxPercent) {
