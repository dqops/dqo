...
public class BelowStdevMultiply60DaysRule3ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<BelowStdevMultiply60DaysRule3ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
    ...
    private Double stdevMultiplierBelow = 3.0;

    /**
     * Default constructor.
     */
    public BelowStdevMultiply60DaysRule3ParametersSpec() {
