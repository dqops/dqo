...
public class BelowStdevMultiply30DaysRule3ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<BelowStdevMultiply30DaysRule3ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public BelowStdevMultiply30DaysRule3ParametersSpec() {
