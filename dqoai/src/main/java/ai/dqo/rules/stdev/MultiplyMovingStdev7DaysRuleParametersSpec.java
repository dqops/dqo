...
public class MultiplyMovingStdev7DaysRuleParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MultiplyMovingStdev7DaysRuleParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
    ...
    public String getRuleDefinitionName() {
        return "stdev/multiply_moving_stdev_7_days";
    }
}
