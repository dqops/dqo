...
public class BelowPercentPopulationStdev7DaysRule5ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<BelowPercentPopulationStdev7DaysRule5ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public BelowPercentPopulationStdev7DaysRule5ParametersSpec() {
