...
public class ChangeMultiplyMovingStdevWithin7DaysRuleParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<ChangeMultiplyMovingStdevWithin7DaysRuleParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
    ...
    public String getRuleDefinitionName() {
        return "stdev/change_multiply_moving_stdev_within_7_days";
    }
}
