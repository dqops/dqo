...
public class ChangePercentileMoving30DaysRuleParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<ChangePercentileMoving30DaysRuleParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
    ...
    @JsonPropertyDescription("Probability that the current sensor readout will achieve values greater" +
            ...
            " levels (warning, error, fatal) at once. The default is a 30 time periods (days, etc.)" +
     ...
     * Default constructor.
     */
    public ChangePercentileMoving30DaysRuleParametersSpec() {
    ...
    public String getRuleDefinitionName() {
        return "stdev/change_percentile_moving_30_days";
    }
}
