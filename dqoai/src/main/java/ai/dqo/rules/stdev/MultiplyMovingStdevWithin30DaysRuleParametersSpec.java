...
public class MultiplyMovingStdevWithin30DaysRuleParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MultiplyMovingStdevWithin30DaysRuleParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
    ...
    public String getRuleDefinitionName() {
        return "stdev/multiply_moving_stdev_within_30_days";
    }
}
