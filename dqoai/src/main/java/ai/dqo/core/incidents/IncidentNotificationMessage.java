...
public class IncidentNotificationMessage {
    ...
    /**
     * Creates a new incident notification message from a single row of the "incidents" table. The column names are defined in {@link ai.dqo.data.incidents.factory.IncidentsColumnNames} class.
