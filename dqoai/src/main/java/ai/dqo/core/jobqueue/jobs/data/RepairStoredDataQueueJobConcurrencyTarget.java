 ...
 */
public class RepairStoredDataQueueJobConcurrencyTarget {
    private String connectionName;

    public RepairStoredDataQueueJobConcurrencyTarget() {
    }
     ...
     */
    public RepairStoredDataQueueJobConcurrencyTarget(String connectionName) {
    ...
    public boolean equals(Object o) {
        ...
        RepairStoredDataQueueJobConcurrencyTarget that = (RepairStoredDataQueueJobConcurrencyTarget) o;
