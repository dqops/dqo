...
public class FileSystemChangeSet {
    private DqoFileSystem fileSystem;
     ...
     */
    public FileSystemChangeSet(DqoFileSystem fileSystem, FolderMetadata storedFileIndex, Optional<FolderMetadata> currentFileIndex) {
     ...
     */
    public DqoFileSystem getFileSystem() {
        return fileSystem;
    }
