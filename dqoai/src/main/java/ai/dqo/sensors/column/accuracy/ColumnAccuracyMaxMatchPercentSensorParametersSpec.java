...
public class ColumnAccuracyMaxMatchPercentSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAccuracyMaxMatchPercentSensorParametersSpec> FIELDS =
