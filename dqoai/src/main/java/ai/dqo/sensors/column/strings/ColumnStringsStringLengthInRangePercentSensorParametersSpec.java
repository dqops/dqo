...
public class ColumnStringsStringLengthInRangePercentSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnStringsStringLengthInRangePercentSensorParametersSpec> FIELDS =
