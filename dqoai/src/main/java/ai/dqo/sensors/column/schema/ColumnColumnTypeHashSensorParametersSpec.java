...
public class ColumnColumnTypeHashSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnColumnTypeHashSensorParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractSensorParametersSpec.FIELDS) {
        {
        }
    };
    ...
    public String getSensorDefinitionName() {
        return "column/schema/column_type_hash";
    }
    ...
    public Class<?> getSensorRunnerClass() {
        return ColumnColumnTypeHashSensorRunner.class;
    }
