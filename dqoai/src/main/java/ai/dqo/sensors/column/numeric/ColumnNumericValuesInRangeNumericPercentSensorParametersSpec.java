...
public class ColumnNumericValuesInRangeNumericPercentSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnNumericValuesInRangeNumericPercentSensorParametersSpec> FIELDS =
