...
public class ColumnSqlConditionFailedCountSensorParametersSpec extends AbstractColumnSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnSqlConditionFailedCountSensorParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractColumnSensorParametersSpec.FIELDS) {
        {
        }
    };
    ...
    public String getSensorDefinitionName() {
        return "column/sql/sql_condition_failed_count";
    }
}
