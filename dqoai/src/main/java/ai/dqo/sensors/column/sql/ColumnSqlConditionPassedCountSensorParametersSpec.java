...
public class ColumnSqlConditionPassedCountSensorParametersSpec extends AbstractTableSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnSqlConditionPassedCountSensorParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractTableSensorParametersSpec.FIELDS) {
        {
        }
    };
