...
public class ColumnNumericValueAboveMaxValuePercentSensorParametersSpec extends AbstractColumnSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnNumericValueAboveMaxValuePercentSensorParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractColumnSensorParametersSpec.FIELDS) {
        {
        }
    };
    ...
    public String getSensorDefinitionName() {
        return "column/numeric/value_above_max_value_percent";
    }
