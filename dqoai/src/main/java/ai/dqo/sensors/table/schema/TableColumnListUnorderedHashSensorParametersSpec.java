...
public class TableColumnListUnorderedHashSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<TableColumnListUnorderedHashSensorParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractSensorParametersSpec.FIELDS) {
        {
        }
    };
    ...
    public String getSensorDefinitionName() {
        return "table/schema/column_list_unordered_hash";
    }
    ...
    public Class<?> getSensorRunnerClass() {
        return TableColumnListUnorderedHashSensorRunner.class;
    }
