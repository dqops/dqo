...
/**
 * Controller that returns the data (check results, errors) at a table level.
 */
@RestController
@RequestMapping("/api/connections")
@ResponseStatus(HttpStatus.OK)
@Api(value = "TablesData", description = "Manages the data (check results) for tables")
public class TableDataController {
     ...
     */
    @Autowired
    public TableDataController(UserHomeContextFactory userHomeContextFactory,
    ...
    @ApiOperation(value = "getTableCheckpointsOverview", notes = "Returns an overview of the most recent checkpoint executions for the checkpoints at a requested time scale",
            response = CheckResultsOverviewDataModel[].class)
    @ResponseStatus(HttpStatus.OK)
    @ApiResponses(value = {
    ...
    @ApiOperation(value = "getTablePartitionedChecksOverview", notes = "Returns an overview of the most recent partitioned checks executions for a requested time scale",
            response = CheckResultsOverviewDataModel[].class)
    @ResponseStatus(HttpStatus.OK)
    @ApiResponses(value = {
