...
public class CheckResultsOverviewController {
     ...
     */
    @GetMapping(value = "/{connectionName}/schemas/{schemaName}/tables/{tableName}/profiling/overview", consumes = "application/json", produces = "application/json")
     ...
     */
    @GetMapping(value = "/{connectionName}/schemas/{schemaName}/tables/{tableName}/recurring/{timeScale}/overview", consumes = "application/json", produces = "application/json")
     ...
     */
    @GetMapping(value = "/{connectionName}/schemas/{schemaName}/tables/{tableName}/partitioned/{timeScale}/overview", consumes = "application/json", produces = "application/json")
     ...
     * @return Overview of the most recent check results.
     */
    @GetMapping(value = "/{connectionName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/profiling/overview", consumes = "application/json", produces = "application/json")
     ...
     * @return Overview of the most recent recurring results.
     */
    @GetMapping(value = "/{connectionName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/recurring/{timeScale}/overview", consumes = "application/json", produces = "application/json")
     ...
     * @return Overview of the most recent partitioned checks results.
     */
    @GetMapping(value = "/{connectionName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/partitioned/{timeScale}/overview", consumes = "application/json", produces = "application/json")
