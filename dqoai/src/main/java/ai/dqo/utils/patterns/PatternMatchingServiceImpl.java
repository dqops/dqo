...
public class PatternMatchingServiceImpl implements PatternMatchingService {
    ...
    @Autowired
    public PatternMatchingServiceImpl() {
     ...
     */
    @Override
    public boolean matchConnectionName(String connectionPattern, String connectionName) {
        return false;
    }
     ...
     */
    @Override
    public boolean matchSchemaTableName(String schemaTablePattern, PhysicalTableName schemaTableName) {
        return false;
    }
     ...
     */
    @Override
    public boolean matchColumnName(String columnPattern, String columnName) {
        return false;
    }
     ...
     */
    @Override
    public boolean matchCheckName(String checkPattern, String checkName) {
        return false;
    }
}
