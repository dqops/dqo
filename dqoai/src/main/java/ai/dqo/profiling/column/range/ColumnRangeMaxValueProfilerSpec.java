...
public class ColumnRangeMaxValueProfilerSpec extends AbstractProfilerSpec<ColumnRangeMaxValueSensorParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnRangeMaxValueProfilerSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractProfilerSpec.FIELDS) {
        {
        }
    };
