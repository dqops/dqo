...
public class ColumnRangeMinValueProfilerSpec extends AbstractProfilerSpec<ColumnRangeMinValueSensorParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnRangeMinValueProfilerSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractProfilerSpec.FIELDS) {
        {
        }
    };
