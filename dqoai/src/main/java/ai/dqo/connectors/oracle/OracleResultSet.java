...
/**
 * Custom implementation of ResultSet interface for Oracle.
 */
public class OracleResultSet implements ResultSet {
    ...
    /**
     * Returns the Object.
     * If the object is of type DateTimeOffset,
    ...
    public Object getObject(int columnIndex) throws SQLException {
        ...
        if (value instanceof oracle.sql.TIMESTAMPTZ) {
            oracle.sql.TIMESTAMPTZ dateTimeOffset = (oracle.sql.TIMESTAMPTZ) value;
            ZonedDateTime zonedDateTime = dateTimeOffset.toZonedDateTime();
