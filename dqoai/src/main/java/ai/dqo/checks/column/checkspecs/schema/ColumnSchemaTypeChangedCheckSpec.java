...
import ai.dqo.sensors.column.schema.ColumnColumnTypeHashSensorParametersSpec;
...
public class ColumnSchemaTypeChangedCheckSpec extends AbstractCheckSpec<ColumnColumnTypeHashSensorParametersSpec, ValueChangedParametersSpec, ValueChangedParametersSpec, ValueChangedParametersSpec> {
    ...
    @JsonPropertyDescription("Column data type hash sensor parameters")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private ColumnColumnTypeHashSensorParametersSpec parameters = new ColumnColumnTypeHashSensorParametersSpec();
     ...
     */
    @Override
    public ColumnColumnTypeHashSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnColumnTypeHashSensorParametersSpec parameters) {
