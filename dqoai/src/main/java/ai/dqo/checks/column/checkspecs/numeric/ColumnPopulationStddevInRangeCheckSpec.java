...
public class ColumnPopulationStddevInRangeCheckSpec
        extends AbstractCheckSpec<ColumnNumericPopulationStddevInRangeSensorParametersSpec, BetweenFloatsRuleParametersSpec, BetweenFloatsRuleParametersSpec, BetweenFloatsRuleParametersSpec> {
     ...
     */
    @Override
    public ColumnNumericPopulationStddevInRangeSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnNumericPopulationStddevInRangeSensorParametersSpec parameters) {
