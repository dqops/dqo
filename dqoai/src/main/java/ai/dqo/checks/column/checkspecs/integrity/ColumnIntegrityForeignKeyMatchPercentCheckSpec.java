...
public class ColumnIntegrityForeignKeyMatchPercentCheckSpec
        extends AbstractCheckSpec<ColumnIntegrityForeignKeyMatchPercentSensorParametersSpec, MinPercentRule99ParametersSpec, MinPercentRule98ParametersSpec, MinPercentRule95ParametersSpec> {
     ...
     */
    @Override
    public ColumnIntegrityForeignKeyMatchPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnIntegrityForeignKeyMatchPercentSensorParametersSpec parameters) {
