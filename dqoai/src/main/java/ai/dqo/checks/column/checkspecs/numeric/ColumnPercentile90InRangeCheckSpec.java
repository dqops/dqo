...
public class ColumnPercentile90InRangeCheckSpec
        extends AbstractCheckSpec<ColumnNumericPercentile90InRangeSensorParametersSpec, BetweenFloatsRuleParametersSpec, BetweenFloatsRuleParametersSpec, BetweenFloatsRuleParametersSpec> {
    ...
    private ColumnNumericPercentile90InRangeSensorParametersSpec parameters = new ColumnNumericPercentile90InRangeSensorParametersSpec();
     ...
     */
    @Override
    public ColumnNumericPercentile90InRangeSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnNumericPercentile90InRangeSensorParametersSpec parameters) {
