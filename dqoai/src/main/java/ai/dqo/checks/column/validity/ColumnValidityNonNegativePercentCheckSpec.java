...
public class ColumnValidityNonNegativePercentCheckSpec extends AbstractCheckSpec {
    ...
    private ColumnValidityNonNegativePercentSensorParametersSpec parameters = new ColumnValidityNonNegativePercentSensorParametersSpec();
     ...
     */
    public ColumnValidityNonNegativePercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnValidityNonNegativePercentSensorParametersSpec parameters) {
