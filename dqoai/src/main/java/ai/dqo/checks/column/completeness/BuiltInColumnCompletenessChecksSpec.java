...
/**
 * Container of built-in preconfigured completeness checks executed on a column level.
 */
...
public class BuiltInColumnCompletenessChecksSpec extends AbstractSpec {
    ...
    private ColumnCompletenessMissingDatesCountCheckSpec missingDatesCount;

    /**
     * Returns a minimum row count check.
     * @return Minimum row count check.
     */
    public ColumnCompletenessMissingDatesCountCheckSpec getMissingDatesCount() {
        return missingDatesCount;
    }

    /**
     * Sets a new definition of a row count check.
     * @param missingDatesCount Row count check.
     */
    public void setMissingDatesCount(ColumnCompletenessMissingDatesCountCheckSpec missingDatesCount) {
        this.setDirtyIf(!Objects.equals(this.missingDatesCount, missingDatesCount));
        this.missingDatesCount = missingDatesCount;
        propagateHierarchyIdToField(missingDatesCount, "missing_dates_count");
    }
