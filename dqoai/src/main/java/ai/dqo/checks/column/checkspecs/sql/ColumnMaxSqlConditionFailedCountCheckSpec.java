...
/**
 * Column level check that ensures that there are no more than a maximum number of rows fail a custom SQL condition (expression) evaluated for a given column.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
public class ColumnMaxSqlConditionFailedCountCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnMaxSqlConditionFailedCountCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
