...
public class ColumnMinStringsInSetPercentCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnMinStringsInSetPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
