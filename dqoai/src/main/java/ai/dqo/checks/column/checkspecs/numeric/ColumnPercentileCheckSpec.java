...
public class ColumnPercentileCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnPercentileCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
