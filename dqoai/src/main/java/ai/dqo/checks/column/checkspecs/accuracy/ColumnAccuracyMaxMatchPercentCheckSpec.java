...
public class ColumnAccuracyMaxMatchPercentCheckSpec
        extends AbstractCheckSpec<ColumnAccuracyMaxMatchPercentSensorParametersSpec, MaxDiffPercentRule0ParametersSpec, MaxDiffPercentRule1ParametersSpec, MaxDiffPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAccuracyMaxMatchPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnAccuracyMaxMatchPercentSensorParametersSpec parameters = new ColumnAccuracyMaxMatchPercentSensorParametersSpec();
    ...
    @JsonPropertyDescription("Default alerting threshold for a maximum percentage of difference of max of a table column and of a max of another table column that raises a data quality error (alert).")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
     ...
     */
    @Override
    public ColumnAccuracyMaxMatchPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnAccuracyMaxMatchPercentSensorParametersSpec parameters) {
