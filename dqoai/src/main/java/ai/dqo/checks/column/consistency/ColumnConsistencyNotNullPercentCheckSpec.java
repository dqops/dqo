...
@Deprecated
public class ColumnConsistencyNotNullPercentCheckSpec extends AbstractCheckDeprecatedSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnConsistencyNotNullPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckDeprecatedSpec.FIELDS) {
        {
    ...
    private ColumnConsistencyNotNullPercentSensorParametersSpec parameters = new ColumnConsistencyNotNullPercentSensorParametersSpec();
    @JsonPropertyDescription("Not null values counts validation rules at various alert severity levels (thresholds)")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private ColumnConsistencyNotNullPercentRulesSpec rules = new ColumnConsistencyNotNullPercentRulesSpec();
    /**
     * Returns the parameters of the sensor.
     * @return Sensor parameters.
     */
    public ColumnConsistencyNotNullPercentSensorParametersSpec getParameters() {
        return parameters;
    }
    /**
     ...
     */
    public void setParameters(ColumnConsistencyNotNullPercentSensorParametersSpec parameters) {
     ...
     */
    public ColumnConsistencyNotNullPercentRulesSpec getRules() {
        return rules;
    }
    /**
     ...
     */
    public void setRules(ColumnConsistencyNotNullPercentRulesSpec rules) {
