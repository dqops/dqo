...
import ai.dqo.rules.comparison.DatatypeEqualsRuleParametersSpec;
import ai.dqo.rules.comparison.EqualsRuleParametersSpec;
...
public class ColumnStringDatatypeDetectedCheckSpec extends AbstractCheckSpec<ColumnStringsStringDatatypeDetectSensorParametersSpec, DatatypeEqualsRuleParametersSpec, DatatypeEqualsRuleParametersSpec, DatatypeEqualsRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnStringDatatypeDetectedCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
