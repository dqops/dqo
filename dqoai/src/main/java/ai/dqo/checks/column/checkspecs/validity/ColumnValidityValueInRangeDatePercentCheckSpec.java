...
@Deprecated
public class ColumnValidityValueInRangeDatePercentCheckSpec extends AbstractCheckDeprecatedSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnValidityValueInRangeDatePercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckDeprecatedSpec.FIELDS) {
        {
    ...
    private ColumnValidityValueInRangeDatePercentSensorParametersSpec parameters = new ColumnValidityValueInRangeDatePercentSensorParametersSpec();

    @JsonPropertyDescription("Non-negative percent validation rules at various alert severity levels (thresholds)")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private ColumnValidityValueInRangeDatePercentRulesSpec rules = new ColumnValidityValueInRangeDatePercentRulesSpec();
     ...
     */
    public ColumnValidityValueInRangeDatePercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnValidityValueInRangeDatePercentSensorParametersSpec parameters) {
     ...
     */
    public ColumnValidityValueInRangeDatePercentRulesSpec getRules() {
        return rules;
    }
     ...
     */
    public void setRules(ColumnValidityValueInRangeDatePercentRulesSpec rules) {
