...
import ai.dqo.rules.percentile.PercentileMovingWithin7DaysRuleParametersSpec;
...
public class ColumnAnomalyMean7DaysCheckSpec
        extends AbstractCheckSpec<ColumnNumericMeanSensorParametersSpec, PercentileMovingWithin7DaysRuleParametersSpec, PercentileMovingWithin7DaysRuleParametersSpec, PercentileMovingWithin7DaysRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAnomalyMean7DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
