...
public class CustomColumnCheckSpec extends AbstractCheckSpec {
    public static final ChildHierarchyNodeFieldMapImpl<CustomColumnCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
