...
public class ColumnStringNotMatchRegexCountCheckSpec
        extends AbstractCheckSpec<ColumnStringsStringNotMatchRegexCountSensorParametersSpec, MaxCountRule0ParametersSpec, MaxCountRule10ParametersSpec, MaxCountRule0ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnStringNotMatchRegexCountCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnStringsStringNotMatchRegexCountSensorParametersSpec parameters = new ColumnStringsStringNotMatchRegexCountSensorParametersSpec();
     ...
     */
    @Override
    public ColumnStringsStringNotMatchRegexCountSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnStringsStringNotMatchRegexCountSensorParametersSpec parameters) {
