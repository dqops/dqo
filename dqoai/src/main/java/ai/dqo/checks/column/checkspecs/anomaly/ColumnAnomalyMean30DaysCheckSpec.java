...
import ai.dqo.rules.percentile.PercentileMovingWithin30DaysRuleParametersSpec;
...
public class ColumnAnomalyMean30DaysCheckSpec
        extends AbstractCheckSpec<ColumnNumericMeanSensorParametersSpec, PercentileMovingWithin30DaysRuleParametersSpec, PercentileMovingWithin30DaysRuleParametersSpec, PercentileMovingWithin30DaysRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAnomalyMean30DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
