...
@Deprecated
public class ColumnValidityRegexMatchPercentCheckSpec extends AbstractCheckDeprecatedSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnValidityRegexMatchPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckDeprecatedSpec.FIELDS) {
        {
    ...
    private ColumnValidityRegexMatchPercentSensorParametersSpec parameters = new ColumnValidityRegexMatchPercentSensorParametersSpec();

    @JsonPropertyDescription("Numerical value in range percent validation rules at various alert severity levels (thresholds)")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private ColumnValidityRegexMatchPercentRulesSpec rules = new ColumnValidityRegexMatchPercentRulesSpec();
     ...
     */
    public ColumnValidityRegexMatchPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnValidityRegexMatchPercentSensorParametersSpec parameters) {
     ...
     */
    public ColumnValidityRegexMatchPercentRulesSpec getRules() {
        return rules;
    }
     ...
     */
    public void setRules(ColumnValidityRegexMatchPercentRulesSpec rules) {
