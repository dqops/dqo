...
import ai.dqo.sensors.column.strings.ColumnStringsStringSurroundedByWhitespacePercentSensorParametersSpec;
...
public class ColumnStringSurroundedByWhitespacePercentCheckSpec extends AbstractCheckSpec<ColumnStringsStringSurroundedByWhitespacePercentSensorParametersSpec, MaxPercentRule1ParametersSpec, MaxPercentRule2ParametersSpec, MaxPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnStringSurroundedByWhitespacePercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
