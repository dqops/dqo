...
public class ColumnMaxStringSurroundedByWhitespacePercentCheckSpec extends AbstractCheckSpec<ColumnStringsStringMaxSurroundedByWhitespacePercentSensorParametersSpec, MaxPercentRule0ParametersSpec> {
     ...
     */
    @Override
    public ColumnStringsStringMaxSurroundedByWhitespacePercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnStringsStringMaxSurroundedByWhitespacePercentSensorParametersSpec parameters) {
