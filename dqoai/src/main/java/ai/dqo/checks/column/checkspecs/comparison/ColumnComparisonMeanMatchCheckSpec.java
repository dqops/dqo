...
import ai.dqo.sensors.column.numeric.ColumnNumericMeanSensorParametersSpec;
...
public class ColumnComparisonMeanMatchCheckSpec
        extends AbstractCheckSpec<ColumnNumericMeanSensorParametersSpec, MaxDiffPercentRule1ParametersSpec, MaxDiffPercentRule2ParametersSpec, MaxDiffPercentRule5ParametersSpec> {
    ...
    @JsonPropertyDescription("Warning level threshold to raise a data quality incident with a warning severity level when the mean (average) of the values in the column in the parent table " +
            "and the mean (average) of values in the compared column (in the reference table) do not match. The alert is generated for every compared group of rows (when data grouping is enabled).")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private MaxDiffPercentRule1ParametersSpec warning;

    @JsonPropertyDescription("Error level threshold to raise a data quality incident with an error severity level when the mean (average) of the values in the column in the parent table " +
            "and the mean (average) of values in the compared column (in the reference table) do not match. The alert is generated for every compared group of rows (when data grouping is enabled).")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private MaxDiffPercentRule2ParametersSpec error;

    @JsonPropertyDescription("Fatal level threshold to raise a data quality incident with a fatal severity level when the mean (average) of the values in the column in the parent table " +
            "and the mean (average) of values in the compared column (in the reference table) do not match. The alert is generated for every compared group of rows (when data grouping is enabled).")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
