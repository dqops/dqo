...
public class ColumnChangeMeanSince30DaysCheckSpec
        extends AbstractCheckSpec<ColumnNumericMeanSensorParametersSpec, WithinChange30DaysRuleParametersSpec, WithinChange30DaysRuleParametersSpec, WithinChange30DaysRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnChangeMeanSince30DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
