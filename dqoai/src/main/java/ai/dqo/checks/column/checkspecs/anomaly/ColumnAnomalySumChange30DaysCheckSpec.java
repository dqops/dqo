...
public class ColumnAnomalySumChange30DaysCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAnomalySumChange30DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
