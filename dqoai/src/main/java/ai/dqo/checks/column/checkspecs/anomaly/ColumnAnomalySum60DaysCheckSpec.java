...
public class ColumnAnomalySum60DaysCheckSpec
        extends AbstractCheckSpec<ColumnNumericSumSensorParametersSpec, PercentileMovingWithin60DaysRuleParametersSpec, PercentileMovingWithin60DaysRuleParametersSpec, PercentileMovingWithin60DaysRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAnomalySum60DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
