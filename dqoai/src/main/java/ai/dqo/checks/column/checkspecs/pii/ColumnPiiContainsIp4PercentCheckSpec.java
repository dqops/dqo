...
public class ColumnPiiContainsIp4PercentCheckSpec
        extends AbstractCheckSpec<ColumnPiiContainsIp4PercentSensorParametersSpec, MinPercentRule99ParametersSpec, MinPercentRule98ParametersSpec, MinPercentRule95ParametersSpec> {
    ...
    private ColumnPiiContainsIp4PercentSensorParametersSpec parameters = new ColumnPiiContainsIp4PercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnPiiContainsIp4PercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnPiiContainsIp4PercentSensorParametersSpec parameters) {
