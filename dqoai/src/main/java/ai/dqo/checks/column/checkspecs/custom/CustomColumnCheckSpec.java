 ...
 */
package ai.dqo.checks.column.checkspecs.custom;
...
/**
 * Custom column check that accepts any built-in sensor (that reads a value) and any rule to validate the result.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
public class CustomColumnCheckSpec extends AbstractCheckDeprecatedSpec {
    public static final ChildHierarchyNodeFieldMapImpl<CustomColumnCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckDeprecatedSpec.FIELDS) {
        {
    ...
    @JsonPropertyDescription("Selection of all builtin column level sensors. Just configure only one and it will be the enabled sensor.")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private AllColumnSensorsSpec builtin = new AllColumnSensorsSpec();
    ...
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private CustomColumnSensorParametersSpec custom;
     ...
     */
    public AllColumnSensorsSpec getBuiltin() {
        return builtin;
    }
     ...
     */
    public void setBuiltin(AllColumnSensorsSpec builtInSensors) {
     ...
     */
    public CustomColumnSensorParametersSpec getCustom() {
        return custom;
    }
     ...
     */
    public void setCustom(CustomColumnSensorParametersSpec custom) {
