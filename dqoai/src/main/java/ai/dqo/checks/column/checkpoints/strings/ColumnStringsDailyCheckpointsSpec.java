...
public class ColumnStringsDailyCheckpointsSpec extends AbstractCheckCategorySpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnStringsDailyCheckpointsSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckCategorySpec.FIELDS) {
        {
            ...
            put("daily_checkpoint_string_length_below_min_length_count", o -> o.dailyCheckpointStringLengthBelowMinLengthCount);
            ...
            put("daily_checkpoint_string_value_below_min_value_count", o -> o.dailyCheckpointStringValueBelowMinValueCount);
    ...
    private ColumnStringLengthBelowMinLengthCountCheckSpec dailyCheckpointStringLengthBelowMinLengthCount;
    ...
    private ColumnStringLengthAboveMaxLengthCountCheckSpec dailyCheckpointStringLengthAboveMaxLengthCount;
    ...
    @JsonPropertyDescription("The check counts those strings with value below the one provided by the user in a column. Stores the most recent row count for each day when the data quality check was evaluated.")
    private ColumnStringValueBelowMinValueCountCheckSpec dailyCheckpointStringValueBelowMinValueCount;
     ...
     */
    public ColumnStringLengthAboveMaxLengthCountCheckSpec getDailyCheckpointStringLengthAboveMaxLengthCount() {
        return dailyCheckpointStringLengthAboveMaxLengthCount;
    }

    /**
     * Sets a new definition of a string length above max length count check.
     * @param dailyCheckpointStringLengthAboveMaxLengthCount String length above max length count check.
     */
    public void setDailyCheckpointStringLengthAboveMaxLengthCount(ColumnStringLengthAboveMaxLengthCountCheckSpec dailyCheckpointStringLengthAboveMaxLengthCount) {
        this.setDirtyIf(!Objects.equals(this.dailyCheckpointStringLengthAboveMaxLengthCount, dailyCheckpointStringLengthAboveMaxLengthCount));
        this.dailyCheckpointStringLengthAboveMaxLengthCount = dailyCheckpointStringLengthAboveMaxLengthCount;
        propagateHierarchyIdToField(dailyCheckpointStringLengthAboveMaxLengthCount, "daily_checkpoint_string_length_above_max_length_count");
    }
     ...
     */
    public ColumnStringLengthAboveMaxLengthPercentCheckSpec getDailyCheckpointStringLengthAboveMaxLengthPercent() {
        return dailyCheckpointStringLengthAboveMaxLengthPercent;
    }

    /**
     * Sets a new definition of a string length above max length percent check.
     * @param dailyCheckpointStringLengthAboveMaxLengthPercent String length above max length percent check.
     */
    public void setDailyCheckpointStringLengthAboveMaxLengthPercent(ColumnStringLengthAboveMaxLengthPercentCheckSpec dailyCheckpointStringLengthAboveMaxLengthPercent) {
     ...
     */
    public ColumnStringValueBelowMinValueCountCheckSpec getDailyCheckpointStringValueBelowMinValueCount() {
        return dailyCheckpointStringValueBelowMinValueCount;
    }

    /**
     * Sets a new definition of a string value below min value count check.
     * @param dailyCheckpointStringValueBelowMinValueCount String value below min value count check.
     */
    public void setDailyCheckpointStringValueBelowMinValueCount(ColumnStringValueBelowMinValueCountCheckSpec dailyCheckpointStringValueBelowMinValueCount) {
        this.setDirtyIf(!Objects.equals(this.dailyCheckpointStringValueBelowMinValueCount, dailyCheckpointStringValueBelowMinValueCount));
        this.dailyCheckpointStringValueBelowMinValueCount = dailyCheckpointStringValueBelowMinValueCount;
        propagateHierarchyIdToField(dailyCheckpointStringValueBelowMinValueCount, "daily_checkpoint_string_value_below_min_value_count");
    }
