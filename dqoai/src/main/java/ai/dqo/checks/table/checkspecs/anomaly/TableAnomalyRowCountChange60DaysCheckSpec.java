...
public class TableAnomalyRowCountChange60DaysCheckSpec
        extends AbstractCheckSpec<TableStandardRowCountSensorParametersSpec, ChangePercentileMovingWithin60DaysRuleParametersSpec, ChangePercentileMovingWithin60DaysRuleParametersSpec, ChangePercentileMovingWithin60DaysRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<TableAnomalyRowCountChange60DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
