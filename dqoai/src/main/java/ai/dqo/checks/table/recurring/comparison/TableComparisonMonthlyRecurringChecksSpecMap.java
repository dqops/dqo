 ...
 */
public class TableComparisonMonthlyRecurringChecksSpecMap extends AbstractTableComparisonCheckCategorySpecMap<TableComparisonMonthlyRecurringChecksSpec> {
    /**
     ...
     */
    @Override
    public TableComparisonMonthlyRecurringChecksSpec getOrAdd(String comparisonName) {
        TableComparisonMonthlyRecurringChecksSpec checksSpec = this.get(comparisonName);
        if (checksSpec == null) {
            checksSpec = new TableComparisonMonthlyRecurringChecksSpec();
