 ...
 */
package ai.dqo.checks.table.validity;
...
@Deprecated
public class TableValidityRowCountCheckSpec extends AbstractCheckDeprecatedSpec {
    public static final ChildHierarchyNodeFieldMapImpl<TableValidityRowCountCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckDeprecatedSpec.FIELDS) {
        {
    ...
    private TableValidityRowCountSensorParametersSpec parameters = new TableValidityRowCountSensorParametersSpec();

    @JsonPropertyDescription("Row counts validation rules at various alert severity levels (thresholds)")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private TableValidityRowCountRulesSpec rules = new TableValidityRowCountRulesSpec();

    /**
     * Returns the parameters of the sensor.
     * @return Sensor parameters.
     */
    public TableValidityRowCountSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(TableValidityRowCountSensorParametersSpec parameters) {
     ...
     */
    public TableValidityRowCountRulesSpec getRules() {
        return rules;
    }
     ...
     */
    public void setRules(TableValidityRowCountRulesSpec rules) {
