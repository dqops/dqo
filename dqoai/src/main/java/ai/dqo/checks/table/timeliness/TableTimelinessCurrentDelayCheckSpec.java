...
/**
 * Table current delay check that shows the difference between current timestamp and last record in a column.
 */
...
public class TableTimelinessCurrentDelayCheckSpec extends AbstractCheckSpec {
    ...
    @JsonPropertyDescription("Current delay sensor parameters")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private TableTimelinessCurrentDelaySensorParametersSpec parameters = new TableTimelinessCurrentDelaySensorParametersSpec();

    @JsonPropertyDescription("Current delay validation rules at various alert severity levels (thresholds)")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private TableTimelinessCurrentDelayRulesSpec rules = new TableTimelinessCurrentDelayRulesSpec();

    /**
     * Returns the parameters of the sensor.
     * @return Sensor parameters.
     */
    public TableTimelinessCurrentDelaySensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(TableTimelinessCurrentDelaySensorParametersSpec parameters) {
     ...
     */
    public TableTimelinessCurrentDelayRulesSpec getRules() {
        return rules;
    }
     ...
     */
    public void setRules(TableTimelinessCurrentDelayRulesSpec rules) {
