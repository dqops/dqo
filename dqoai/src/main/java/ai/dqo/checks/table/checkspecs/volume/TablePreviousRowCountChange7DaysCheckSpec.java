...
public class TablePreviousRowCountChange7DaysCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<TablePreviousRowCountChange7DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
