...
public class TableRowCountChangeWithinStdevCheckSpec extends AbstractCheckSpec<TableStandardRowCountSensorParametersSpec, MinCountRuleWarningParametersSpec, MinCountRule0ParametersSpec, MinCountRuleFatalParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<TableRowCountChangeWithinStdevCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
