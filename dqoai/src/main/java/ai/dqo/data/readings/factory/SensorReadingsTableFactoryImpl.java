...
public class SensorReadingsTableFactoryImpl implements SensorReadingsTableFactory {
     ...
     */
    public Table createEmptySensorReadingsTable(String tableName) {
        ...
        table.addColumns(
                ...
                StringColumn.create(SensorNormalizedResult.DIMENSION_COLUMN_NAME_PREFIX + "1"),
                StringColumn.create(SensorNormalizedResult.DIMENSION_COLUMN_NAME_PREFIX + "2"),
                StringColumn.create(SensorNormalizedResult.DIMENSION_COLUMN_NAME_PREFIX + "3"),
                StringColumn.create(SensorNormalizedResult.DIMENSION_COLUMN_NAME_PREFIX + "4"),
                StringColumn.create(SensorNormalizedResult.DIMENSION_COLUMN_NAME_PREFIX + "5"),
                StringColumn.create(SensorNormalizedResult.DIMENSION_COLUMN_NAME_PREFIX + "6"),
                StringColumn.create(SensorNormalizedResult.DIMENSION_COLUMN_NAME_PREFIX + "7"),
                StringColumn.create(SensorNormalizedResult.DIMENSION_COLUMN_NAME_PREFIX + "8"),
                StringColumn.create(SensorNormalizedResult.DIMENSION_COLUMN_NAME_PREFIX + "9"),
                LongColumn.create(SensorNormalizedResult.DIMENSION_ID_COLUMN_NAME),
