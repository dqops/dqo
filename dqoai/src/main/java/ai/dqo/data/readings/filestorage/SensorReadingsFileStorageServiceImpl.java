 ...
 */
@Service
public class SensorReadingsFileStorageServiceImpl implements SensorReadingsFileStorageService {
     ...
     */
    @Autowired
    public SensorReadingsFileStorageServiceImpl(DqoStorageConfigurationProperties storageConfigurationProperties,
    ...
    public String makeHivePartitionPath(String connectionName, PhysicalTableName tableName, LocalDate month) {
        ...
        stringBuilder.append(SensorReadingsPartitioningKeys.CONNECTION);
        ...
        stringBuilder.append(SensorReadingsPartitioningKeys.TARGET);
        stringBuilder.append('=');
        String encodedTable = URLEncoder.encode(tableName.toString(), StandardCharsets.UTF_8);
        stringBuilder.append(encodedTable);
        stringBuilder.append('/');

        stringBuilder.append(SensorReadingsPartitioningKeys.MONTH);
        stringBuilder.append('=');
    ...
    public void saveTableMonth(Table data, String connectionName, PhysicalTableName tableName, LocalDate month) {
        try {
            ...
            Path targetParquetFilePath = partitionPath.resolve(SensorReadingsFileStorageService.PARQUET_FILE_NAME);
