...
public class ProfilerResultsNormalizeException extends DqoRuntimeException {
     ...
     */
    public ProfilerResultsNormalizeException(Table resultsTable) {
     ...
     */
    public ProfilerResultsNormalizeException(Table resultsTable, String message) {
        super(message);
        this.resultsTable = resultsTable;
    }
     ...
     * @since 1.4
     */
    public ProfilerResultsNormalizeException(Table resultsTable, String message, Throwable cause) {
        super(message, cause);
        this.resultsTable = resultsTable;
    }

    /**
     * Result table returned by a profiler that was invalid.
