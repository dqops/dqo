...
/**
 * Constants with the column names of the "profiles" table that contains the results of table and column profiling.
 */
public final class ProfilingResultsColumnNames {
    /**
     * Column name for a profiler result id (primary key), it is a uuid of the profiler hash, executed at and the data stream id. This value identifies a single row.
     */
    public static final String ID_COLUMN_NAME = CommonColumnNames.ID_COLUMN_NAME;

    /**
     * Column name for the time when the profile was executed. All profiling results started as part of the same profiling session will share the same time. The parquet files are time partitioned by this column.
     */
    public static final String PROFILED_AT_COLUMN_NAME = "profiled_at";

    /**
     * Column name for a profiler status ('success' or 'error').
     */
    public static final String STATUS_COLUMN_NAME = "status";

    /**
     * Column name for a profiler result data type.
     */
    public static final String RESULT_TYPE_COLUMN_NAME = "result_type";

    /**
     * Column name for a profiler result when it is a string value.
     */
    public static final String RESULT_STRING_COLUMN_NAME = "result_string";

    /**
     * Column name for a profiler result when it is an integer value. It is a long (64 bit) value where we store all short, integer, long values.
     */
    public static final String RESULT_INTEGER_COLUMN_NAME = "result_integer";

    /**
     * Column name for a profiler result when it is a numeric value with. It is a double value where we store all double, float, numeric and decimal values.
     */
    public static final String RESULT_FLOAT_COLUMN_NAME = "result_float";

    /**
     * Column name for a profiler result when it is a boolean value.
     */
    public static final String RESULT_BOOLEAN_COLUMN_NAME = "result_boolean";

    /**
     * Column name for a profiler result when it is a local date value.
     */
    public static final String RESULT_DATE_COLUMN_NAME = "result_date";

    /**
     * Column name for a profiler result when it is a local date time value.
     */
    public static final String RESULT_DATE_TIME_COLUMN_NAME = "result_date_time";

    /**
     * Column name for a profiler result when it is an absolute (UTC timezone) instant.
     */
    public static final String RESULT_INSTANT_COLUMN_NAME = "result_instant";

    /**
     * Column name for a profiler result when it is time value.
     */
    public static final String RESULT_TIME_COLUMN_NAME = "result_time";

    /**
     * Column name for a profiler executed at timestamp.
     */
    ...
    /**
     * Column name for a profiler hash.
     */
    public static final String PROFILER_HASH_COLUMN_NAME = "profiler_hash";

    /**
     * Column name for a profiler name.
     */
    public static final String PROFILER_NAME_COLUMN_NAME = "profiler_name";

    /**
     * Column name for a profiler type (table, column).
     */
    public static final String PROFILER_TYPE_COLUMN_NAME = "profiler_type";

    /**
     * Column name for a profiler category.
     */
    public static final String PROFILER_CATEGORY_COLUMN_NAME = "profiler_category";
