...
public class DataStorageIOException extends DqoRuntimeException {
     ...
     */
    public DataStorageIOException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public DataStorageIOException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public DataStorageIOException(Throwable cause) {
        super(cause);
    }
}
