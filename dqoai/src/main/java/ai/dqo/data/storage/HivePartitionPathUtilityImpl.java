...
@Component
public class HivePartitionPathUtilityImpl implements HivePartitionPathUtility {
    private final Pattern HIVE_PARTITION_CONNECTION_PATTERN =
            Pattern.compile(ParquetPartitioningKeys.CONNECTION + "=(.*)");
    private final Pattern HIVE_PARTITION_TABLE_PATTERN =
    ...
    @Autowired
    public HivePartitionPathUtilityImpl() {}
     ...
     */
    @Override
    public boolean validHivePartitionConnectionFolderName(String folderName) {
     ...
     */
    @Override
    public boolean validHivePartitionTableFolderName(String folderName) {
     ...
     */
    @Override
    public boolean validHivePartitionMonthFolderName(String folderName) {
     ...
     */
    @Override
    public String connectionFromHivePartitionFolderName(String connectionFolderName) {
     ...
     */
    @Override
    public PhysicalTableName tableFromHivePartitionFolderName(String tableFolderName) {
     ...
     */
    @Override
    public LocalDate monthFromHivePartitionFolderName(String monthFolderName) {
