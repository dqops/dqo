...
/**
 * Constants with the partitioning column names used to store the sensor readouts in a hive compliant partition folders.
 */
public class SensorReadoutsPartitioningKeys {
    /**
