...
/**
 * Constants with the partitioning column names used to store the rule evaluation results (issues) in a hive compliant partition folders.
 */
public class RuleResultsPartitioningKeys {
    /**
