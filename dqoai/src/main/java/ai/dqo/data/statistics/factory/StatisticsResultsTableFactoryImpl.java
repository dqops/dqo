...
public class StatisticsResultsTableFactoryImpl implements StatisticsResultsTableFactory {
    ...
    public Table createEmptyStatisticsTable(String tableName) {
        ...
        table.addColumns(
                ...
                TextColumn.create(StatisticsColumnNames.DATA_STREAM_LEVEL_COLUMN_NAME_PREFIX + "3"),
                TextColumn.create(StatisticsColumnNames.DATA_STREAM_LEVEL_COLUMN_NAME_PREFIX + "4"),
                TextColumn.create(StatisticsColumnNames.DATA_STREAM_LEVEL_COLUMN_NAME_PREFIX + "5"),
                TextColumn.create(StatisticsColumnNames.DATA_STREAM_LEVEL_COLUMN_NAME_PREFIX + "6"),
                TextColumn.create(StatisticsColumnNames.DATA_STREAM_LEVEL_COLUMN_NAME_PREFIX + "7"),
                TextColumn.create(StatisticsColumnNames.DATA_STREAM_LEVEL_COLUMN_NAME_PREFIX + "8"),
