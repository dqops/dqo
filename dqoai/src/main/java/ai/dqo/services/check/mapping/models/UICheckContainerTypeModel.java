...
public class UICheckContainerTypeModel {

    public UICheckContainerTypeModel(@NotNull CheckType checkType, CheckTimeScale checkTimeScale) {
    ...
    public boolean equals(Object o) {
        ...
        UICheckContainerTypeModel that = (UICheckContainerTypeModel) o;
