...
public class InvalidSpecificationException extends DqoRuntimeException {
    ...
    /**
     * Metadata node that is invalid.
     * @return Invalid metadata node.
     */
     ...
     * initialized by a call to {@link #initCause}.
     */
    public InvalidSpecificationException(HierarchyNode node) {
        this.node = node;
    }
     ...
     *                later retrieval by the {@link #getMessage()} method.
     */
    public InvalidSpecificationException(String message, HierarchyNode node) {
        super(message);
        this.node = node;
    }
     ...
     * @since 1.4
     */
    public InvalidSpecificationException(String message, Throwable cause, HierarchyNode node) {
        super(message, cause);
        this.node = node;
    }
     ...
     * @since 1.4
     */
    public InvalidSpecificationException(Throwable cause, HierarchyNode node) {
        super(cause);
        this.node = node;
    }
     ...
     * @since 1.7
     */
    public InvalidSpecificationException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace, HierarchyNode node) {
        super(message, cause, enableSuppression, writableStackTrace);
        this.node = node;
    }
}
