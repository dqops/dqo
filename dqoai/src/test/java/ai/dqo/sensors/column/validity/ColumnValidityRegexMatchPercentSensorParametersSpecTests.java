...
@SpringBootTest
public class ColumnValidityRegexMatchPercentSensorParametersSpecTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/validity/regex_match_percent", this.sut.getSensorDefinitionName());
    }
}
