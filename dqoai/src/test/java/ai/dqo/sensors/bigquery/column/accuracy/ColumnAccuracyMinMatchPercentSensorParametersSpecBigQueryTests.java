...
import ai.dqo.sensors.column.accuracy.ColumnAccuracyMinMatchPercentSensorParametersSpec;
...
@SpringBootTest
public class ColumnAccuracyMinMatchPercentSensorParametersSpecBigQueryTests extends BaseTest {
    private ColumnAccuracyMinMatchPercentSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnAccuracyMinMatchPercentCheckSpec checkSpec;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new ColumnAccuracyMinMatchPercentSensorParametersSpec();
        ...
        this.checkSpec = new ColumnAccuracyMinMatchPercentCheckSpec();
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/accuracy/min_match_percent", this.sut.getSensorDefinitionName());
    }
