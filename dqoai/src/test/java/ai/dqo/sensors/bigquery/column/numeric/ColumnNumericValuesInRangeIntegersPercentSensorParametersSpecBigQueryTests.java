...
import ai.dqo.checks.column.checkspecs.numeric.ColumnValuesInRangeIntegersPercentCheckSpec;
...
@SpringBootTest
public class ColumnNumericValuesInRangeIntegersPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    private SensorExecutionRunParameters getRunParametersAdHoc() {
        return SensorExecutionRunParametersObjectMother.createForTableColumnForAdHocCheck(this.sampleTableMetadata, "negative", this.checkSpec);
    }

    private SensorExecutionRunParameters getRunParametersCheckpoint(CheckTimeScale timeScale) {
        return SensorExecutionRunParametersObjectMother.createForTableColumnForCheckpointCheck(this.sampleTableMetadata, "negative", this.checkSpec, timeScale);
    }
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/numeric/values_in_range_integers_percent", this.sut.getSensorDefinitionName());
    }
