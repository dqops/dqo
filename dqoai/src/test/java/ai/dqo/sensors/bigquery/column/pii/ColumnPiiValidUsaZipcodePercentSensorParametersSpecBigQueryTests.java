...
@SpringBootTest
public class ColumnPiiValidUsaZipcodePercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/pii/valid_usa_zipcode_percent", this.sut.getSensorDefinitionName());
    }
