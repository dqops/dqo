...
import ai.dqo.checks.column.checkspecs.strings.ColumnStringValidUsaPhonePercentCheckSpec;
...
@SpringBootTest
public class ColumnStringsStringValidUsaPhonePercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/strings/string_valid_usa_phone_percent", this.sut.getSensorDefinitionName());
    }
