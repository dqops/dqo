 ...
 */
package ai.dqo.sensors.bigquery.column.bool;
...
@SpringBootTest
public class ColumnBoolFalsePercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    private SensorExecutionRunParameters getRunParametersAdHoc() {
        return SensorExecutionRunParametersObjectMother.createForTableColumnForAdHocCheck(this.sampleTableMetadata, "correct", this.checkSpec);
    }

    private SensorExecutionRunParameters getRunParametersCheckpoint(CheckTimeScale timeScale) {
        return SensorExecutionRunParametersObjectMother.createForTableColumnForCheckpointCheck(this.sampleTableMetadata, "correct", this.checkSpec, timeScale);
    }

    private SensorExecutionRunParameters getRunParametersPartitioned(CheckTimeScale timeScale, String timeSeriesColumn) {
        return SensorExecutionRunParametersObjectMother.createForTableColumnForPartitionedCheck(this.sampleTableMetadata, "correct", this.checkSpec, timeScale, timeSeriesColumn);
    }
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/bool/false_percent", this.sut.getSensorDefinitionName());
    }
        ...
        String target_query = """
            SELECT
                CASE
                    ...
                    ELSE 100.0 * SUM(
                        CASE
                            WHEN SAFE_CAST(SAFE_CAST(%s AS STRING) AS BOOL) IS FALSE
                                THEN 1
                            ELSE 0
                        END
                    ) / COUNT(*)
