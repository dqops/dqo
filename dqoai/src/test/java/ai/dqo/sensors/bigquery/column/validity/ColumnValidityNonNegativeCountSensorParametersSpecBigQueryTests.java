                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, 'DE''s' AS level_1
                        FROM %s AS analyzed_table
                        GROUP BY level_1
                        ORDER BY level_1""",
                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, 'DE' AS level_1, 'PL' AS level_2
                        FROM %s AS analyzed_table
                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, 'DE' AS level_1, 'PL' AS level_2, 'UK' AS level_3
                        FROM %s AS analyzed_table
                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, 'PL' AS level_2, 'UK' AS level_3
                        FROM %s AS analyzed_table
                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, 'US' AS level_1, 'PL' AS level_2, CAST(CURRENT_TIMESTAMP() AS date) AS time_period
                        FROM %s AS analyzed_table
                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, analyzed_table.`country` AS level_1, 'UK' AS level_2
                        FROM %s AS analyzed_table
                        GROUP BY level_1, level_2
                        ORDER BY level_1, level_2""",
