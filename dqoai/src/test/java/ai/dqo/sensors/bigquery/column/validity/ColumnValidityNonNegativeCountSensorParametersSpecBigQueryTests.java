...
import ai.dqo.checks.column.validity.ColumnValidityNonNegativeCountCheckSpec;
...
@SpringBootTest
public class ColumnValidityNonNegativeCountSensorParametersSpecBigQueryTests extends BaseTest {
    private ColumnValidityNonNegativeCountSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private SensorExecutionRunParameters runParameters;
    private ColumnValidityNonNegativeCountCheckSpec checkSpec;
                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, 'FR' AS dimension_1
                        FROM %s AS analyzed_table
                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, 'IT' AS dimension_1
                        FROM %s AS analyzed_table
                        GROUP BY dimension_1
                        ORDER BY dimension_1""",
                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, 'DE' AS dimension_1
                        FROM %s AS analyzed_table
                        GROUP BY dimension_1
                        ORDER BY dimension_1""",
                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, 'DE''s' AS dimension_1
                        FROM %s AS analyzed_table
                        GROUP BY dimension_1
                        ORDER BY dimension_1""",
                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, 'DE' AS dimension_1, 'PL' AS dimension_2
                        FROM %s AS analyzed_table
                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, 'DE' AS dimension_1, 'PL' AS dimension_2, 'UK' AS dimension_3
                        FROM %s AS analyzed_table
                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, 'PL' AS dimension_2, 'UK' AS dimension_3
                        FROM %s AS analyzed_table
                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, 'US' AS dimension_1, 'PL' AS dimension_2, CAST(CURRENT_TIMESTAMP() AS date) AS time_period
                        FROM %s AS analyzed_table
                        ...
                        SELECT
                            SUM(
                                CASE
                                    ...
                                    ELSE 1
                                END
                            ) AS actual_value, analyzed_table.`country` AS dimension_1, 'UK' AS dimension_2
                        FROM %s AS analyzed_table
                        GROUP BY dimension_1, dimension_2
                        ORDER BY dimension_1, dimension_2""",
