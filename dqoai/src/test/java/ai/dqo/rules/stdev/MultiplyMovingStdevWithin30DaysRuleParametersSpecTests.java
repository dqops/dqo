...
@SpringBootTest
public class MultiplyMovingStdevWithin30DaysRuleParametersSpecTests extends BaseTest {
    private MultiplyMovingStdevWithin30DaysRuleParametersSpec sut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new MultiplyMovingStdevWithin30DaysRuleParametersSpec();
