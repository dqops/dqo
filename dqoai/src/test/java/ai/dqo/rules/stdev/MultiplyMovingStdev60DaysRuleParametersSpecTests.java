...
@SpringBootTest
public class MultiplyMovingStdev60DaysRuleParametersSpecTests extends BaseTest {
    private MultiplyMovingStdev60DaysRuleParametersSpec sut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new MultiplyMovingStdev60DaysRuleParametersSpec();
