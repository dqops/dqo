...
public class BetweenPercentChangeRuleParametersSpecTests extends BaseTest {
    ...
    @Test
    void executeRule_whenPreviousReadoutIsNegativeAndActualValueIsPositiveAndInsideAbsoluteBounds_thenReturnsTrue() {
        this.sut.setFromPercent(10.0);
    ...
    @Test
    void executeRule_whenPreviousReadoutIsNegativeAndActualValueIsPositiveAndOutsideAbsoluteBounds_thenReturnsTrue() {
        this.sut.setFromPercent(10.0);
        this.sut.setToPercent(300.0);
