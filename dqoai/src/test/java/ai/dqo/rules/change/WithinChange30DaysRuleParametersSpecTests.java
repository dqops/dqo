...
@SpringBootTest
public class WithinChange30DaysRuleParametersSpecTests extends BaseTest {
    private WithinChange30DaysRuleParametersSpec sut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new WithinChange30DaysRuleParametersSpec();
