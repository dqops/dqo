...
public class SensorReadoutsTableFactoryImplTests extends BaseTest {
    ...
    void createEmptySensorReadoutsTable_whenCalled_thenCreatesTableWithSchema() {
        ...
        Assertions.assertEquals(SensorReadoutsColumnNames.DATA_STREAM_LEVEL_COLUMN_NAME_PREFIX + "3", table.column(columnIndex++).name());
        Assertions.assertEquals(SensorReadoutsColumnNames.DATA_STREAM_LEVEL_COLUMN_NAME_PREFIX + "4", table.column(columnIndex++).name());
        Assertions.assertEquals(SensorReadoutsColumnNames.DATA_STREAM_LEVEL_COLUMN_NAME_PREFIX + "5", table.column(columnIndex++).name());
        Assertions.assertEquals(SensorReadoutsColumnNames.DATA_STREAM_LEVEL_COLUMN_NAME_PREFIX + "6", table.column(columnIndex++).name());
        Assertions.assertEquals(SensorReadoutsColumnNames.DATA_STREAM_LEVEL_COLUMN_NAME_PREFIX + "7", table.column(columnIndex++).name());
        Assertions.assertEquals(SensorReadoutsColumnNames.DATA_STREAM_LEVEL_COLUMN_NAME_PREFIX + "8", table.column(columnIndex++).name());
