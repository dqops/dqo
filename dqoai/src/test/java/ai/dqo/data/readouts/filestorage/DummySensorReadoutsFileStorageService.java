...
/**
 * Dummy sensor readout file storage service that does nothing.
 */
public class DummySensorReadoutsFileStorageService implements SensorReadoutsFileStorageService {
    ...
    /**
     * Loads readouts cover the time period between <code>start</code> and <code>end</code>.
