...
@SpringBootTest
public class SensorReadingsSnapshotTests extends BaseTest {
    private SensorReadingsSnapshot sut;
    ...
    private SensorReadingsFileStorageServiceImpl sensorReadingsFileStorageService;
    ...
    protected void setUp() throws Throwable {
        ...
        sensorReadingsFileStorageService = new SensorReadingsFileStorageServiceImpl(storageConfigurationProperties, localUserHomeProviderStub);
		tableName = new PhysicalTableName("sch2", "tab2");
        Table newRows = SensorReadingTableFactoryObjectMother.createEmptyNormalizedTable("new_rows");
		this.sut = new SensorReadingsSnapshot("conn", tableName, this.sensorReadingsFileStorageService, newRows);
    }
    ...
    void saveThreeMonthsData() {
        ...
        SensorNormalizedResult normalizedResults = SensorNormalizedResultObjectMother.createEmptyNormalizedResults();
		...
		this.sensorReadingsFileStorageService.saveTableInMonthsRange(sourceTable, this.sut.getConnection(), tableName, start, end);
    }
    ...
    void ensureMonthsAreLoaded_whenCalledOnceToLoadTwoMonths_thenLoadsThoseMonths() {
        ...
        Assertions.assertEquals(20.5, table.column(SensorNormalizedResult.ACTUAL_VALUE_COLUMN_NAME).get(0));
        Assertions.assertEquals(LocalDateTime.of(2022, 2, 10, 14, 20, 55),
                table.column(SensorNormalizedResult.TIME_PERIOD_COLUMN_NAME).get(0));
        Assertions.assertEquals(30.5, table.column(SensorNormalizedResult.ACTUAL_VALUE_COLUMN_NAME).get(1));
        Assertions.assertEquals(LocalDateTime.of(2022, 3, 10, 14, 30, 55),
                table.column(SensorNormalizedResult.TIME_PERIOD_COLUMN_NAME).get(1));
    }
    ...
    void ensureMonthsAreLoaded_whenCalledAgainToLoadPreviousMonth_thenLoadsThoseMonths() {
        ...
        Assertions.assertEquals(LocalDateTime.of(2022, 3, 10, 14, 30, 55),
                table.column(SensorNormalizedResult.TIME_PERIOD_COLUMN_NAME).get(1));
        Assertions.assertEquals(10.5, table.column(SensorNormalizedResult.ACTUAL_VALUE_COLUMN_NAME).get(2));
        Assertions.assertEquals(LocalDateTime.of(2022, 1, 10, 14, 10, 55),
                table.column(SensorNormalizedResult.TIME_PERIOD_COLUMN_NAME).get(2));
    }
    ...
    void ensureMonthsAreLoaded_whenCalledAgainToLoadFollowingMonth_thenLoadsThoseMonths() {
        ...
        Assertions.assertEquals(10.5, table.column(SensorNormalizedResult.ACTUAL_VALUE_COLUMN_NAME).get(0));
        Assertions.assertEquals(LocalDateTime.of(2022, 1, 10, 14, 10, 55),
                table.column(SensorNormalizedResult.TIME_PERIOD_COLUMN_NAME).get(0));
        Assertions.assertEquals(20.5, table.column(SensorNormalizedResult.ACTUAL_VALUE_COLUMN_NAME).get(1));
        Assertions.assertEquals(LocalDateTime.of(2022, 2, 10, 14, 20, 55),
                table.column(SensorNormalizedResult.TIME_PERIOD_COLUMN_NAME).get(1));
        Assertions.assertEquals(30.5, table.column(SensorNormalizedResult.ACTUAL_VALUE_COLUMN_NAME).get(2));
        Assertions.assertEquals(LocalDateTime.of(2022, 3, 10, 14, 30, 55),
                table.column(SensorNormalizedResult.TIME_PERIOD_COLUMN_NAME).get(2));
    }
