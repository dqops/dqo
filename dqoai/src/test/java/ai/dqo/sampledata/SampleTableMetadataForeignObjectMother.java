 ...
 */
public class SampleTableMetadataForeignObjectMother {
    /**
     ...
     */
    public static SampleTableMetadataForeign createSampleTableMetadataForeignForCsvFile(String csvFileName, ProviderType providerType) {
        ...
        return new SampleTableMetadataForeign(connectionName, connectionSpec, tableSpec, sampleTable);
    }
}
