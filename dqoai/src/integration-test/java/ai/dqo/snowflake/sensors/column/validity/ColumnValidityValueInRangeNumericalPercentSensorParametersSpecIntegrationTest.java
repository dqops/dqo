...
@SpringBootTest
public class ColumnValidityValueInRangeNumericalPercentSensorParametersSpecIntegrationTest extends BaseSnowflakeIntegrationTest {
    ...
    void runSensor_whenSensorExecutedOnColumnWithNegativeValuesAndFourInvalidValuesAndIncludeUpperLowerBound_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(84.0F, resultTable.column(0).get(0));
    }
}
