...
@SpringBootTest
public class SnowflakeColumnNumericPercentile75InRangeSensorParametersSpecIntegrationTest extends BaseSnowflakeIntegrationTest {
    ...
    void runSensor_whenSensorExecutedAdHoc_thenReturnsValues() {
        ...
        Assertions.assertEquals(15.25F, resultTable.column(0).get(0));
    }
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(11.5F, resultTable.column(0).get(0));
    }
