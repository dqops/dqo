...
@SpringBootTest
public class SnowflakeColumnNumericMinInRangeSensorParametersSpecIntegrationTest extends BaseSnowflakeIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(-83L, resultTable.column(0).get(0));
    }
