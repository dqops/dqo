 ...
 */
package ai.dqo.snowflake.sensors.column.range;
...
@SpringBootTest
public class SnowflakeColumnNumericMaxInRangeSensorParametersSpecIntegrationTest extends BaseSnowflakeIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(495L, resultTable.column(0).get(0));
    }
