...
@SpringBootTest
public class SnowflakeColumnNumericPercentile10SensorParametersSpecIntegrationTest extends BaseSnowflakeIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(2.9F, resultTable.column(0).get(0));
    }
