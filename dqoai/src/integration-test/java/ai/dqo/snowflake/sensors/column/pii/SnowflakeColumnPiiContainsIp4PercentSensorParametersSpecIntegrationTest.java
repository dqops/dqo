...
@SpringBootTest
public class SnowflakeColumnPiiContainsIp4PercentSensorParametersSpecIntegrationTest extends BaseSnowflakeIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip4_test, ProviderType.snowflake);
