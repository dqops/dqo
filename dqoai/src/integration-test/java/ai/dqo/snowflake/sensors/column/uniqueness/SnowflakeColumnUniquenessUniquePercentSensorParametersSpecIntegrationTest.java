...
@SpringBootTest
public class SnowflakeColumnUniquenessUniquePercentSensorParametersSpecIntegrationTest extends BaseSnowflakeIntegrationTest {
    ...
    void runSensor_whenSensorExecutedAdHoc_thenReturnsValues() {
        ...
        Assertions.assertEquals(6.666666666666667F, resultTable.column(0).get(0));
    }
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(33.333333333333336F, resultTable.column(0).get(0));
    }
