...
@SpringBootTest
public class SnowflakeColumnNumericMeanInRangeSensorParametersSpecIntegrationTest extends BaseSnowflakeIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(38.48F, resultTable.column(0).get(0));
    }
