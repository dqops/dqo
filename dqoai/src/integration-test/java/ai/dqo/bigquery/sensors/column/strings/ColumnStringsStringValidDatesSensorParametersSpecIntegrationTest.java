...
@SpringBootTest
public class ColumnStringsStringValidDatesSensorParametersSpecIntegrationTest extends BaseBigQueryIntegrationTest {
    private ColumnStringsStringValidDatesSensorParametersSpec sut;
    ...
    protected void setUp() throws Throwable {
		...
		this.sut = new ColumnStringsStringValidDatesSensorParametersSpec();
