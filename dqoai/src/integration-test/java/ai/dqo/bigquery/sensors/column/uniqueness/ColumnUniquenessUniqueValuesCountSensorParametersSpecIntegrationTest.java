...
@SpringBootTest
public class ColumnUniquenessUniqueValuesCountSensorParametersSpecIntegrationTest extends BaseBigQueryIntegrationTest {
    private ColumnUniquenessUniqueValuesCountSensorParametersSpec sut;
    ...
    protected void setUp() throws Throwable {
		...
		this.sut = new ColumnUniquenessUniqueValuesCountSensorParametersSpec();
