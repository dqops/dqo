...
import ai.dqo.checks.column.checkspecs.pii.ColumnPiiContainsIp6PercentCheckSpec;
...
@SpringBootTest
public class BigQueryColumnPiiContainsIp6PercentSensorParametersSpecIntegrationTest extends BaseBigQueryIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, ProviderType.bigquery);
