...
@SpringBootTest
public class ColumnSqlAggregatedExpressionSensorParametersSpecIntegrationTest extends BaseBigQueryIntegrationTest {
    private ColumnSqlAggregatedExpressionSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnSqlAggregatedExpressionMaxValueCheckSpec checkSpec;
    ...
    protected void setUp() throws Throwable {
		...
		this.checkSpec = new ColumnSqlAggregatedExpressionMaxValueCheckSpec();
