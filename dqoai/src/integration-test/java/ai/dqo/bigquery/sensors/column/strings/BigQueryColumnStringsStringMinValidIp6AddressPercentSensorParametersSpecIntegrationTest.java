...
import ai.dqo.checks.column.checkspecs.strings.ColumnStringValidIp6AddressPercentCheckSpec;
...
@SpringBootTest
public class BigQueryColumnStringsStringMinValidIp6AddressPercentSensorParametersSpecIntegrationTest extends BaseBigQueryIntegrationTest {
    private ColumnStringsStringValidIp6AddressPercentSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnStringValidIp6AddressPercentCheckSpec checkSpec;
    ...
    void setUp() {
        ...
        this.sut = new ColumnStringsStringValidIp6AddressPercentSensorParametersSpec();
        this.checkSpec = new ColumnStringValidIp6AddressPercentCheckSpec();
