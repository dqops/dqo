...
@SpringBootTest
public class ColumnValidityRegexMatchPercentSensorParametersSpecIntegrationTest extends BaseBigQueryIntegrationTest {
    ...
    void runSensor_whenSensorExecutedOnColumnWithMixedValuesAndSetEmailRegex_thenReturnsValues() {
        ...
        Assertions.assertEquals(40.0, Math.round((double) resultTable.column(0).get(0)));
    }
    ...
    void runSensor_whenSensorExecutedOnColumnWithMixedValuesAndSetCustomRegex_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(60.0, Math.round((double) resultTable.column(0).get(0)));
    }
    ...
    void runSensor_whenSensorExecutedOnColumnWithMixedValuesAndSetPhoneNumberRegex_Where_Correct1() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(100.0, Math.round((double) resultTable.column(0).get(0)));
    }
    ...
    void runSensor_whenSensorExecutedOnColumnWithMixedValuesAndSetPhoneNumberRegex_Where_Correct0() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(0.0, Math.round((double) resultTable.column(0).get(0)));
    }
