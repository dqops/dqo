...
@SpringBootTest
public class ColumnStringsStringMaxEmptyPercentSensorParametersSpecIntegrationTest extends BaseBigQueryIntegrationTest {
    private ColumnStringsStringMaxEmptyPercentSensorParametersSpec sut;
    ...
    protected void setUp() throws Throwable {
		...
		this.sut = new ColumnStringsStringMaxEmptyPercentSensorParametersSpec();
