...
@SpringBootTest
public class BigQueryColumnNumericPercentile10InRangeSensorParametersSpecIntegrationTest extends BaseBigQueryIntegrationTest {
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(2.4, resultTable.column(0).get(0));
    }
