...
@SpringBootTest
public class ColumnStringsMaxStringEmptyCountSensorParametersSpecIntegrationTest extends BaseBigQueryIntegrationTest {
    private ColumnStringsMaxStringEmptyCountSensorParametersSpec sut;
    ...
    protected void setUp() throws Throwable {
		...
		this.sut = new ColumnStringsMaxStringEmptyCountSensorParametersSpec();
