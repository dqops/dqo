...
@SpringBootTest
public class BigQueryColumnStringsStringMaxNotMatchRegexCountSensorParametersSpecIntegrationTest extends BaseBigQueryIntegrationTest {
    ...
    void runSensor_whenSensorExecutedCheckpointDaily_thenReturnsValues() {
        this.sut.setRegex("r\"^[A-Za-z]+[A-Za-z0-9.]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,4}$\"");
