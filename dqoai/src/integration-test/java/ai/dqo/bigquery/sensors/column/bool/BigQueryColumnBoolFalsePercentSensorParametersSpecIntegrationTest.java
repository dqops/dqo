 ...
 */
package ai.dqo.bigquery.sensors.column.bool;
...
@SpringBootTest
public class BigQueryColumnBoolFalsePercentSensorParametersSpecIntegrationTest extends BaseBigQueryIntegrationTest {
    ...
    void runSensor_whenSensorExecutedAdHoc_thenReturnsValues() {
        ...
        Assertions.assertEquals(6.666666666666667, resultTable.column(0).get(0));
    }
