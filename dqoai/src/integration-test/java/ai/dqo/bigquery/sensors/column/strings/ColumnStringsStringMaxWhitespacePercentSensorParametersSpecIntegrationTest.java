...
@SpringBootTest
public class ColumnStringsStringMaxWhitespacePercentSensorParametersSpecIntegrationTest extends BaseBigQueryIntegrationTest {
    private ColumnStringsStringMaxWhitespacePercentSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnMaxStringWhitespacePercentCheckSpec checkSpec;
    ...
    protected void setUp() throws Throwable {
		...
		this.sut = new ColumnStringsStringMaxWhitespacePercentSensorParametersSpec();
		this.checkSpec = new ColumnMaxStringWhitespacePercentCheckSpec();
