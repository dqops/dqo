...
@SpringBootTest
public class SqlServerColumnNumericPopulationStddevInRangeSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(109.049,(double) resultTable.column(0).get(0), 0.001);
    }
