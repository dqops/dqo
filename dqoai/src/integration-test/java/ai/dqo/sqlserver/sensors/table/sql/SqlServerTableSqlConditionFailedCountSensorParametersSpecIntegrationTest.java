 ...
 */
package ai.dqo.sqlserver.sensors.table.sql;
...
@SpringBootTest
public class SqlServerTableSqlConditionFailedCountSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
