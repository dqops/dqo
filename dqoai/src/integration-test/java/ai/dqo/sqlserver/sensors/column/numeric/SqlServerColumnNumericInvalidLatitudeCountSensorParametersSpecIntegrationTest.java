...
@SpringBootTest
public class SqlServerColumnNumericInvalidLatitudeCountSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(13, resultTable.column(0).get(0));
    }
