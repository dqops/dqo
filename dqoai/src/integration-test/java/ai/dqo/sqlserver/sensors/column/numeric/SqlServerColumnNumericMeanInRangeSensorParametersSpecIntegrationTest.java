...
@SpringBootTest
public class SqlServerColumnNumericMeanInRangeSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(38, resultTable.column(0).get(0));
    }
