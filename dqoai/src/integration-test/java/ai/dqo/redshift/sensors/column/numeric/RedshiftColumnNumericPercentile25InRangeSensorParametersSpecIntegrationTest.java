...
@SpringBootTest
public class RedshiftColumnNumericPercentile25InRangeSensorParametersSpecIntegrationTest extends BaseRedshiftIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(5.75f, resultTable.column(0).get(0));
    }
