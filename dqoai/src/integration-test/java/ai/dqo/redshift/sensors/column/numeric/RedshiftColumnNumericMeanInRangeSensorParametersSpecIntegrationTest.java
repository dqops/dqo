...
@SpringBootTest
public class RedshiftColumnNumericMeanInRangeSensorParametersSpecIntegrationTest extends BaseRedshiftIntegrationTest {
    ...
    void runSensor_whenSensorExecutedAdHoc_thenReturnsValues() {
        ...
        Assertions.assertEquals(38L, resultTable.column(0).get(0));
    }
