...
@SpringBootTest
public class RedshiftColumnNumericPopulationVarianceSensorParametersSpecIntegrationTest extends BaseRedshiftIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(11416.089, (double) resultTable.column(0).get(0), 0.001);
    }
