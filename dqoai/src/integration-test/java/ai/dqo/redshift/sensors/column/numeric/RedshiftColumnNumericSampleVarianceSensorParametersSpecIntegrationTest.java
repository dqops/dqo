...
@SpringBootTest
public class RedshiftColumnNumericSampleVarianceSensorParametersSpecIntegrationTest extends BaseRedshiftIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(11891.759, (double) resultTable.column(0).get(0), 0.001);
    }
