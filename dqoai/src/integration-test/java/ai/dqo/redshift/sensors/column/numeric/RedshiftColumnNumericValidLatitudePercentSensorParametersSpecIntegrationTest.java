...
@SpringBootTest
public class RedshiftColumnNumericValidLatitudePercentSensorParametersSpecIntegrationTest extends BaseRedshiftIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.geographic_coordinate_system_test, ProviderType.redshift);
