 ...
 */
package ai.dqo.redshift.sensors.table.sql;
...
@SpringBootTest
public class RedshiftTableSqlConditionFailedCountSensorParametersSpecIntegrationTest extends BaseRedshiftIntegrationTest {
