...
import ai.dqo.checks.column.checkspecs.numeric.ColumnValueAboveMaxValueCountCheckSpec;
...
import ai.dqo.sensors.column.numeric.ColumnNumericValueAboveMaxValueCountSensorParametersSpec;
...
@SpringBootTest
public class MysqlColumnNumericValueAboveMaxValueCountSensorParametersSpecIntegrationTest extends BaseMysqlIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(4f, resultTable.column(0).get(0));
    }
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(1f, resultTable.column(0).get(0));
    }
