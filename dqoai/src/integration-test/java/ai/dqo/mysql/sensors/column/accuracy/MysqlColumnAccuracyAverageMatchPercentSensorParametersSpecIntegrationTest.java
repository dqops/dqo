 ...
 */
package ai.dqo.mysql.sensors.column.accuracy;
...
@SpringBootTest
public class MysqlColumnAccuracyAverageMatchPercentSensorParametersSpecIntegrationTest extends BaseMysqlIntegrationTest {
    private ColumnAccuracyAverageMatchPercentSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnAccuracyAverageMatchPercentCheckSpec checkSpec;
    ...
    void setUp() {
        ...
        this.sut = new ColumnAccuracyAverageMatchPercentSensorParametersSpec();
        this.checkSpec = new ColumnAccuracyAverageMatchPercentCheckSpec();
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(0.75f, resultTable.column(0).get(0));
        Assertions.assertEquals(0.75f, resultTable.column(1).get(0));
    }
