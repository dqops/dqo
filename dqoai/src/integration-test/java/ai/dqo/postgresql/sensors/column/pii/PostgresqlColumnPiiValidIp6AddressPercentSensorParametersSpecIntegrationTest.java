 ...
 */
package ai.dqo.postgresql.sensors.column.pii;
...
@SpringBootTest
public class PostgresqlColumnPiiValidIp6AddressPercentSensorParametersSpecIntegrationTest extends BasePostgresqlIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, ProviderType.postgresql);
