...
@SpringBootTest
public class PostgresqlColumnNumericPercentile90InRangeSensorParametersSpecIntegrationTest extends BasePostgresqlIntegrationTest {
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(13.6, resultTable.column(0).get(0));
    }
