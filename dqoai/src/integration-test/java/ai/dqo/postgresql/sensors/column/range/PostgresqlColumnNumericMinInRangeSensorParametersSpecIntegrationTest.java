 ...
 */
package ai.dqo.postgresql.sensors.column.range;

import ai.dqo.checks.CheckTimeScale;
import ai.dqo.checks.column.checkspecs.numeric.ColumnMinInRangeCheckSpec;
...
@SpringBootTest
public class PostgresqlColumnNumericMinInRangeSensorParametersSpecIntegrationTest extends BasePostgresqlIntegrationTest {
    private ColumnNumericMinInRangeSensorParametersSpec sut;
    ...
    void setUp() {
		...
		this.sut = new ColumnNumericMinInRangeSensorParametersSpec();
