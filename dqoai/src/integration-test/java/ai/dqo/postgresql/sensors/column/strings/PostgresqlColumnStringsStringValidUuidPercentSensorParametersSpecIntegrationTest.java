...
@SpringBootTest
public class PostgresqlColumnStringsStringValidUuidPercentSensorParametersSpecIntegrationTest extends BasePostgresqlIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.uuid_test, ProviderType.postgresql);
