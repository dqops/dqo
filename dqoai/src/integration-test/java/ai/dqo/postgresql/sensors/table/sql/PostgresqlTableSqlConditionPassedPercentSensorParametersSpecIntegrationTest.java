 ...
 */
package ai.dqo.postgresql.sensors.table.sql;
...
@SpringBootTest
public class PostgresqlTableSqlConditionPassedPercentSensorParametersSpecIntegrationTest extends BasePostgresqlIntegrationTest {
