...
//
//@SpringBootTest
//public class ColumnStringsStringLengthInRangePercentSensorParametersSpecIntegrationTest extends BasePostgresqlIntegrationTest {
...
//        super.setUp();
//		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.test_data_regex_sensor, ProviderType.postgresql);
