...
@SpringBootTest
public class PostgresqlColumnNumericPercentile10InRangeSensorParametersSpecIntegrationTest extends BasePostgresqlIntegrationTest {
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(2.4000000000000004, resultTable.column(0).get(0));
    }
