...
@SpringBootTest
class RedshiftColumnPiiContainsIp6PercentSensorParametersSpecIntegrationTest extends BaseRedshiftIntegrationTest {
    ...
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother
                .createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, ProviderType.redshift);
