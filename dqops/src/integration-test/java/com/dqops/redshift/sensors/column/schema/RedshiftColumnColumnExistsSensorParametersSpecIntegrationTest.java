 ...
 */
package com.dqops.redshift.sensors.column.schema;
...
@SpringBootTest
public class RedshiftColumnColumnExistsSensorParametersSpecIntegrationTest extends BaseRedshiftIntegrationTest {
    ...
    void setUp(){
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(
                SampleCsvFileNames.continuous_days_one_row_per_day, ProviderType.bigquery);
