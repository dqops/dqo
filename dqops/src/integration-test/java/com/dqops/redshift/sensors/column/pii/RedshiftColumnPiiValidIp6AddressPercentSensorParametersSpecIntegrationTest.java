...
import com.dqops.checks.column.checkspecs.pii.ColumnPiiValidIp6AddressPercentCheckSpec;
...
import com.dqops.sensors.column.pii.ColumnPiiValidIp6AddressPercentSensorParametersSpec;
...
@SpringBootTest
public class RedshiftColumnPiiValidIp6AddressPercentSensorParametersSpecIntegrationTest extends BaseRedshiftIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, ProviderType.redshift);
