...
@SpringBootTest
public class RedshiftColumnNumericPercentile90SensorParametersSpecIntegrationTest extends BaseRedshiftIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(18.1f, resultTable.column(0).get(0));
    }
