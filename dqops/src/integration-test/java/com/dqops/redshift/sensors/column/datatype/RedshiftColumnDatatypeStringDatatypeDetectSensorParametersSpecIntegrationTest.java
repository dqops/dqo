 ...
 */
package com.dqops.redshift.sensors.column.datatype;
...
@SpringBootTest
public class RedshiftColumnDatatypeStringDatatypeDetectSensorParametersSpecIntegrationTest extends BaseRedshiftIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.detect_datatype_test, ProviderType.redshift);
