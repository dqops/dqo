 ...
 */
package com.dqops.spark.sensors.table.sql;
...
@SpringBootTest
public class SparkTableSqlConditionPassedPercentSensorParametersSpecIntegrationTest extends BaseSparkIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.test_average_delay, ProviderType.spark);
