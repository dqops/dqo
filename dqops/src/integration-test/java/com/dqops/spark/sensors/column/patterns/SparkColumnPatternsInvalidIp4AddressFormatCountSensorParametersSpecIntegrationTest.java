...
@SpringBootTest
public class SparkColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpecIntegrationTest extends BaseSparkIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip4_test, ProviderType.spark);
