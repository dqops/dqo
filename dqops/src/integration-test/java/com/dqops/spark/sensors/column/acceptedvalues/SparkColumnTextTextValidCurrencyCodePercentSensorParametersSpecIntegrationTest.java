...
@SpringBootTest
public class SparkColumnTextTextValidCurrencyCodePercentSensorParametersSpecIntegrationTest extends BaseSparkIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.nulls_and_uniqueness, ProviderType.spark);
