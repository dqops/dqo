 ...
 */
package com.dqops.spark.sensors.column.datatype;
...
@SpringBootTest
public class SparkColumnDatatypeStringDatatypeDetectSensorParametersSpecIntegrationTest extends BaseSparkIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.detect_datatype_test, ProviderType.spark);
