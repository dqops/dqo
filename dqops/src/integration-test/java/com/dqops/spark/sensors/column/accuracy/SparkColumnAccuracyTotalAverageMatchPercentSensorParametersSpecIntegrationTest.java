 ...
 */
package com.dqops.spark.sensors.column.accuracy;
...
@SpringBootTest
public class SparkColumnAccuracyTotalAverageMatchPercentSensorParametersSpecIntegrationTest extends BaseSparkIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadataReferenced = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, ProviderType.spark);
