...
@SpringBootTest
public class SparkColumnPatternsInvalidUuidFormatPercentSensorParametersSpecIntegrationTest extends BaseSparkIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.uuid_test, ProviderType.spark);
