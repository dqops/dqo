...
@SpringBootTest
public class SnowflakeColumnNumericValidLatitudePercentSensorParametersSpecIntegrationTest extends BaseSnowflakeIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.geographic_coordinate_system_test, ProviderType.snowflake);
