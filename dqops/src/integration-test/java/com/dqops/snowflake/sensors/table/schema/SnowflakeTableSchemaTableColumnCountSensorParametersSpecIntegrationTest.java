 ...
 */
package com.dqops.snowflake.sensors.table.schema;
...
@SpringBootTest
public class SnowflakeTableSchemaTableColumnCountSensorParametersSpecIntegrationTest extends BaseSnowflakeIntegrationTest {
    ...
    void setUp(){
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(
                SampleCsvFileNames.continuous_days_one_row_per_day, ProviderType.snowflake);
