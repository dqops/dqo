 ...
 */
package com.dqops.snowflake.sensors.column.datatype;
...
@SpringBootTest
public class SnowflakeColumnDatatypeStringDatatypeDetectSensorParametersSpecIntegrationTest extends BaseSnowflakeIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.detect_datatype_test, ProviderType.snowflake);
