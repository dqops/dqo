...
@SpringBootTest
public class SnowflakeColumnBlanksBlankNullPlaceholderTextPercentSensorParametersSpecIntegrationTest extends BaseSnowflakeIntegrationTest {
    private ColumnBlanksBlankNullPlaceholderTextPercentSensorParametersSpec sut;
    ...
    void setUp() {
		...
		this.sut = new ColumnBlanksBlankNullPlaceholderTextPercentSensorParametersSpec();
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals((float)37.03704071044922, (float) resultTable.column(0).get(0), 0.001);
    }
