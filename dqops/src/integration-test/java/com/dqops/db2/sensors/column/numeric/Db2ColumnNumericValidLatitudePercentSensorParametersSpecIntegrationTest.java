...
@SpringBootTest
public class Db2ColumnNumericValidLatitudePercentSensorParametersSpecIntegrationTest extends BaseDb2IntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.geographic_coordinate_system_test, ProviderType.db2);
