...
@SpringBootTest
class Db2ColumnPiiContainsIp6PercentSensorParametersSpecIntegrationTest extends BaseDb2IntegrationTest {
    ...
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother
                .createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, ProviderType.db2);
