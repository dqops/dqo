...
@SpringBootTest
public class Db2ColumnPatternsInvalidUuidFormatPercentSensorParametersSpecIntegrationTest extends BaseDb2IntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.uuid_test, ProviderType.db2);
