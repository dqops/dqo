...
@SpringBootTest
public class Db2ColumnPatternsTextNotMatchingNamePatternPercentSensorParametersSpecIntegrationTest extends BaseDb2IntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.full_name_test, ProviderType.db2);
