...
@SpringBootTest
public class Db2ColumnTextTextLengthInRangePercentSensorParametersSpecIntegrationTest extends BaseDb2IntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.string_min_length_test, ProviderType.db2);
