...
@SpringBootTest
public class SqlServerColumnPiiContainsEmailPercentSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals( 90.0, (double) resultTable.column(0).get(0),0.001);
    }
