...
@SpringBootTest
public class SqlServerColumnAccuracyTotalSumMatchPercentSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    void runSensor_onNullDataInPrimaryTable_thenReturnsValues() {
        ...
        Assertions.assertEquals(15, ValueConverter.toLong(resultTable.column(0).get(0)));
    ...
    void runSensor_onNullDataInForeignTable_thenReturnsValues() {
        ...
        Assertions.assertEquals(15, ValueConverter.toLong(resultTable.column(1).get(0)));
    }
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(15, resultTable.column(1).get(0));
    }
