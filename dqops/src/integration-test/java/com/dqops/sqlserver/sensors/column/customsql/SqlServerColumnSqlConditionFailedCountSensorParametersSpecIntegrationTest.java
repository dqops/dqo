 ...
 */
package com.dqops.sqlserver.sensors.column.customsql;
...
@SpringBootTest
public class SqlServerColumnSqlConditionFailedCountSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(14, resultTable.column(0).get(0));
    }
