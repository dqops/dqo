...
@SpringBootTest
public class SqlServerColumnPatternsTextNotMatchingRegexCountSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(2.0, ValueConverter.toDouble(resultTable.column(0).get(0)));
    }
