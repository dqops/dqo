...
@SpringBootTest
class SqlServerColumnPiiContainsIp6PercentSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother
                .createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, ProviderType.sqlserver);
