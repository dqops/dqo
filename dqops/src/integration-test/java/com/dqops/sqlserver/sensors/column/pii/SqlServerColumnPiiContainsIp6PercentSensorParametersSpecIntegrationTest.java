...
@SpringBootTest
public class SqlServerColumnPiiContainsIp6PercentSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, ProviderType.sqlserver);
