 ...
 */
package com.dqops.sqlserver.sensors.column.whitespace;
...
@SpringBootTest
public class SqlServerColumnWhitespaceBlankNullPlaceholderTextPercentSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(37.037, Precision.round((double)resultTable.column(0).get(0),3));
    }
