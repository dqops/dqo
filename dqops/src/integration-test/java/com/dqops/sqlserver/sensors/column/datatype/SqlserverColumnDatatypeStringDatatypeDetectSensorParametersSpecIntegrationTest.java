 ...
 */
package com.dqops.sqlserver.sensors.column.datatype;
...
@SpringBootTest
public class SqlserverColumnDatatypeStringDatatypeDetectSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.detect_datatype_test, ProviderType.sqlserver);
