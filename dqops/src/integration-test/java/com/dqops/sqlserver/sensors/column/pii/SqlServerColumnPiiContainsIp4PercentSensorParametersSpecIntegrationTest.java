 ...
 */
package com.dqops.sqlserver.sensors.column.pii;
...
@SpringBootTest
public class SqlServerColumnPiiContainsIp4PercentSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip4_test, ProviderType.sqlserver);
