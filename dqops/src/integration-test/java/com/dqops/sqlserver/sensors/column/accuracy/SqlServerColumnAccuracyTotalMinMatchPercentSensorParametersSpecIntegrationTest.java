...
@SpringBootTest
public class SqlServerColumnAccuracyTotalMinMatchPercentSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    void runSensor_onNullDataInForeignTable_thenReturnsValues() {
        ...
        Assertions.assertEquals(0, ValueConverter.toLong(resultTable.column(1).get(0)));
    }
