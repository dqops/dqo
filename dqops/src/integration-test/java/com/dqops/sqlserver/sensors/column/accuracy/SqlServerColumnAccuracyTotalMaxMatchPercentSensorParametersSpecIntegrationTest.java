 ...
 */
package com.dqops.sqlserver.sensors.column.accuracy;
...
@SpringBootTest
public class SqlServerColumnAccuracyTotalMaxMatchPercentSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadataReferenced = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, ProviderType.sqlserver);
    ...
    void runSensor_onNullDataInPrimaryTable_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, ValueConverter.toLong(resultTable.column(0).get(0)));
    ...
    void runSensor_onNullDataInForeignTable_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, ValueConverter.toLong(resultTable.column(1).get(0)));
    }
