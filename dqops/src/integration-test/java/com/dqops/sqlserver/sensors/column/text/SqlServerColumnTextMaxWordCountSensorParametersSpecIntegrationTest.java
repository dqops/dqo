...
import com.dqops.checks.column.checkspecs.text.ColumnTextMaxWordCountCheckSpec;
...
@SpringBootTest
public class SqlServerColumnTextMaxWordCountSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    private ColumnTextMaxWordCountSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnTextMaxWordCountCheckSpec checkSpec;
    ...
    void setUp() {
        ...
        this.sut = new ColumnTextMaxWordCountSensorParametersSpec();
        this.checkSpec = new ColumnTextMaxWordCountCheckSpec();
