...
@SpringBootTest
public class SqlServerColumnNumericSumSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(962, resultTable.column(0).get(0));
    }
