...
import com.dqops.checks.column.checkspecs.patterns.ColumnTextsNotMatchingRegexPercentCheckSpec;
...
@SpringBootTest
public class SqlServerColumnPatternsTextsNotMatchingRegexPercentSensorParametersSpecIntegrationTest extends BaseSqlServerIntegrationTest {
    private ColumnPatternsTextsNotMatchingRegexPercentSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnTextsNotMatchingRegexPercentCheckSpec checkSpec;
    ...
    void setUp() {
		...
		this.sut = new ColumnPatternsTextsNotMatchingRegexPercentSensorParametersSpec();
		this.checkSpec = new ColumnTextsNotMatchingRegexPercentCheckSpec();
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(10.0, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.001);
    }
