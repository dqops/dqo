 ...
 */
package com.dqops.bigquery.sensors.column.integrity;
...
public class BigQueryColumnIntegrityForeignKeyMatchPercentSensorParametersSpecIntegrationTest extends BaseBigQueryIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadataForeign = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.value_match_left_table, ProviderType.bigquery);
