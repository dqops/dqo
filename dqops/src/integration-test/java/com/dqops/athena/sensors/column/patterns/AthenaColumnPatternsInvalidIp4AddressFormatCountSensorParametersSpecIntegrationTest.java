 ...
 */
package com.dqops.athena.sensors.column.patterns;
...
@SpringBootTest
public class AthenaColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpecIntegrationTest extends BaseAthenaIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip4_test, connectionSpec);
