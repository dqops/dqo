...
@SpringBootTest
public class AthenaColumnTextTextMeanLengthSensorParametersSpecIntegrationTest extends BaseAthenaIntegrationTest {
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(5.666, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.001);
    }
    ...
    void runSensor_whenRunOnIntegerColumn_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(5.259, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.001);
    }
