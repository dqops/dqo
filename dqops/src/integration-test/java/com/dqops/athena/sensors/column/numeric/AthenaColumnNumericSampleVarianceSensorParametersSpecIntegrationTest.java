...
@SpringBootTest
public class AthenaColumnNumericSampleVarianceSensorParametersSpecIntegrationTest extends BaseAthenaIntegrationTest {
    ...
    // todo: actual_value of the sensor result has empty values in the column, shouldn't it?
    @Test
