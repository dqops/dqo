 ...
 */
package com.dqops.hana.sensors.table.timeliness;
...
@SpringBootTest
public class HanaTableTimelinessDataIngestionDelaySensorParametersSpecIntegrationTest extends BaseHanaIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.test_average_delay, ProviderType.hana);
