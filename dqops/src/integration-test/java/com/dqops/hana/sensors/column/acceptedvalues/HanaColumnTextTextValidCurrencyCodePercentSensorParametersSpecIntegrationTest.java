 ...
 */
package com.dqops.hana.sensors.column.acceptedvalues;
...
@SpringBootTest
public class HanaColumnTextTextValidCurrencyCodePercentSensorParametersSpecIntegrationTest extends BaseHanaIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.nulls_and_uniqueness, ProviderType.hana);
