...
@SpringBootTest
public class HanaColumnPatternsInvalidIp6AddressFormatCountSensorParametersSpecIntegrationTest extends BaseHanaIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, ProviderType.hana);
