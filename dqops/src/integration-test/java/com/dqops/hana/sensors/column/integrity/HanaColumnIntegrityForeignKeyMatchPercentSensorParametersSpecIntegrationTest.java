 ...
 */
package com.dqops.hana.sensors.column.integrity;
...
@SpringBootTest
public class HanaColumnIntegrityForeignKeyMatchPercentSensorParametersSpecIntegrationTest extends BaseHanaIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.value_match_right_table, ProviderType.hana);
        this.sampleTableMetadataForeign = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.value_match_left_table, ProviderType.hana);
