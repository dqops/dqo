 ...
 */
package com.dqops.hana.sensors.table.availability;
...
@SpringBootTest
public class HanaTableAvailabilitySensorParametersSpecIntegrationTest extends BaseHanaIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.continuous_days_one_row_per_day, ProviderType.hana);
    ...
    void runSensor_whenSensorExecutedOnNonExistingTable_thenReturnsFailedValue() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataWithNonExistingTable("schema", "table", ProviderType.hana);
        this.userHomeContext = UserHomeContextObjectMother.createInMemoryFileHomeContextForSampleTable(sampleTableMetadata);
