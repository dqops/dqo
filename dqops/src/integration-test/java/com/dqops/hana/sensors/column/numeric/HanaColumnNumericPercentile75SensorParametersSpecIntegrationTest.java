...
@SpringBootTest
public class HanaColumnNumericPercentile75SensorParametersSpecIntegrationTest extends BaseHanaIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(15.25, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.001);
    }
