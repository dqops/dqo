...
@SpringBootTest
public class HanaColumnNumericPercentile90SensorParametersSpecIntegrationTest extends BaseHanaIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(18.1, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.001);
    }
