...
@SpringBootTest
class HanaColumnPiiContainsIp6PercentSensorParametersSpecIntegrationTest extends BaseHanaIntegrationTest {
    ...
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother
                .createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, ProviderType.hana);
