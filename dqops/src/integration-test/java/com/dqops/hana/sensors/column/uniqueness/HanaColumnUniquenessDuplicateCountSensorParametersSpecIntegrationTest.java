 ...
 */
package com.dqops.hana.sensors.column.uniqueness;
...
import com.dqops.sensors.column.uniqueness.ColumnUniquenessDuplicateCountSensorParametersSpec;
...
@SpringBootTest
public class HanaColumnUniquenessDuplicateCountSensorParametersSpecIntegrationTest extends BaseHanaIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(7L, ValueConverter.toLong(resultTable.column(0).get(0)));
    }
