...
@SpringBootTest
public class HanaColumnNumericPercentile25SensorParametersSpecIntegrationTest extends BaseHanaIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(5.75, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.001);
    }
