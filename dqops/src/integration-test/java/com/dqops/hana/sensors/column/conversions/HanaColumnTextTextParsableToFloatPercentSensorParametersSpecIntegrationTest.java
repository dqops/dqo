...
@SpringBootTest
public class HanaColumnTextTextParsableToFloatPercentSensorParametersSpecIntegrationTest extends BaseHanaIntegrationTest {
    private ColumnTextTextParsableToFloatPercentSensorParametersSpec sut;
    ...
    void setUp() {
		...
		this.sut = new ColumnTextTextParsableToFloatPercentSensorParametersSpec();
    ...
    void runSensor_whenErrorSamplingSensorExecutedWithNoGroupingAndNoIdColumns_thenReturnsErrorSamples() {
        ...
        Table resultTable = sensorResult.getResultTable();
        Assertions.assertEquals(22, resultTable.rowCount());
