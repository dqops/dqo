 ...
 */
package com.dqops.timescale.sensors.column.text;
...
@SpringBootTest
public class TimescaleColumnTextTextMeanLengthSensorParametersSpecIntegrationTest extends BaseTimescaleIntegrationTest {
    private ColumnTextTextMeanLengthSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnTextMeanLengthCheckSpec checkSpec;
    ...
    void setUp() {
		...
		this.checkSpec = new ColumnTextMeanLengthCheckSpec();
    ...
    void runSensor_whenRunOnIntegerColumn_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(5.633, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.001);
    }
