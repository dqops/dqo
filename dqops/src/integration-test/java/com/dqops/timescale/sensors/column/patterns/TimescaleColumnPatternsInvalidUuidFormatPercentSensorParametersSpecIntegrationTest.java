 ...
 */
package com.dqops.timescale.sensors.column.patterns;
...
@SpringBootTest
public class TimescaleColumnPatternsInvalidUuidFormatPercentSensorParametersSpecIntegrationTest extends BaseTimescaleIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.uuid_test, this.connectionSpec);
