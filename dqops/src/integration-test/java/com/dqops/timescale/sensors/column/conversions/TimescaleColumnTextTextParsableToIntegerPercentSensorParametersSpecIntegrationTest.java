 ...
 */
package com.dqops.timescale.sensors.column.conversions;
...
@SpringBootTest
public class TimescaleColumnTextTextParsableToIntegerPercentSensorParametersSpecIntegrationTest extends BaseTimescaleIntegrationTest {
    ...
    void setUp() {
		...
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.test_data_values_in_set, this.connectionSpec);
