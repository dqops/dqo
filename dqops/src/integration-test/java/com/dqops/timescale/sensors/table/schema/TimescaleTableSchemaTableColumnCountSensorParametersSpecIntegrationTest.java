 ...
 */
package com.dqops.timescale.sensors.table.schema;
...
@SpringBootTest
public class TimescaleTableSchemaTableColumnCountSensorParametersSpecIntegrationTest extends BaseTimescaleIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(
                SampleCsvFileNames.continuous_days_one_row_per_day, this.connectionSpec);
