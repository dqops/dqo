...
@SpringBootTest
public class TimescaleColumnNumericNumberFoundInSetPercentSensorParametersSpecIntegrationTest extends BaseTimescaleIntegrationTest {
    private ColumnNumericNumberFoundInSetPercentSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnNumberFoundInSetPercentCheckSpec checkSpec;
