 ...
 */
package com.dqops.timescale.sensors.column.datetime;
...
@SpringBootTest
public class TimescaleColumnDatetimeDateInRangePercentSensorParametersSpecIntegrationTest extends BaseTimescaleIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.continuous_days_different_time_data_types, this.connectionSpec);
