...
@SpringBootTest
public class TrinoColumnPatternsInvalidIp6AddressFormatCountSensorParametersSpecIntegrationTest extends BaseTrinoIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, ProviderType.trino);
