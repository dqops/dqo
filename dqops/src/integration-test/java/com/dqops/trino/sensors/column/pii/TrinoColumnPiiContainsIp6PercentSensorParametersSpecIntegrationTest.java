...
@SpringBootTest
class TrinoColumnPiiContainsIp6PercentSensorParametersSpecIntegrationTest extends BaseTrinoIntegrationTest {
    ...
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother
                .createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, ProviderType.trino);
