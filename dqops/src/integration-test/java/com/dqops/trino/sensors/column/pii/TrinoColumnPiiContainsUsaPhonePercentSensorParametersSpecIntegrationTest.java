...
@SpringBootTest
public class TrinoColumnPiiContainsUsaPhonePercentSensorParametersSpecIntegrationTest extends BaseTrinoIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(69.56521739130434, resultTable.column(0).get(0));
    }
