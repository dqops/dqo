 ...
 */
package com.dqops.trino.sensors.column.datatype;
...
@SpringBootTest
public class TrinoColumnDatatypeStringDatatypeDetectSensorParametersSpecIntegrationTest extends BaseTrinoIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.detect_datatype_test, ProviderType.trino);
