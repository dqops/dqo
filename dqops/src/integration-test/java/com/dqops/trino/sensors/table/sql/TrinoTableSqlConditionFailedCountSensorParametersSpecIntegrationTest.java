 ...
 */
package com.dqops.trino.sensors.table.sql;
...
@SpringBootTest
public class TrinoTableSqlConditionFailedCountSensorParametersSpecIntegrationTest extends BaseTrinoIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.test_average_delay, ProviderType.trino);
