...
@SpringBootTest
public class TrinoColumnNumericPercentile90SensorParametersSpecIntegrationTest extends BaseTrinoIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(19.0, resultTable.column(0).get(0));
    }
