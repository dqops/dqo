 ...
 */
package com.dqops.trino.sensors.column.conversions;
...
@SpringBootTest
public class TrinoColumnTextTextParsableToIntegerPercentSensorParametersSpecIntegrationTest extends BaseTrinoIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.test_data_values_in_set, ProviderType.trino);
