...
@SpringBootTest
public class TrinoColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpecIntegrationTest extends BaseTrinoIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip4_test, ProviderType.trino);
