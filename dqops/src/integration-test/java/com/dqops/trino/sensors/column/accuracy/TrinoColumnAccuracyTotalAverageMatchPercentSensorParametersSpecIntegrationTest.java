 ...
 */
package com.dqops.trino.sensors.column.accuracy;
...
@SpringBootTest
public class TrinoColumnAccuracyTotalAverageMatchPercentSensorParametersSpecIntegrationTest extends BaseTrinoIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadataReferenced = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, ProviderType.trino);
