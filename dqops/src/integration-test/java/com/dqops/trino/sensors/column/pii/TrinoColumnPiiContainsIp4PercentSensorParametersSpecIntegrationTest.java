 ...
 */
package com.dqops.trino.sensors.column.pii;
...
@SpringBootTest
public class TrinoColumnPiiContainsIp4PercentSensorParametersSpecIntegrationTest extends BaseTrinoIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip4_test, ProviderType.trino);
