...
@SpringBootTest
public class TrinoColumnTextTextParsableToBooleanPercentSensorParametersSpecIntegrationTest extends BaseTrinoIntegrationTest {
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(83.33333333333333, (double) resultTable.column(0).get(0), 0.001);
    }
