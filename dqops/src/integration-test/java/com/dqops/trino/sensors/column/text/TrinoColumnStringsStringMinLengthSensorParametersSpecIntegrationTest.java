...
@SpringBootTest
public class TrinoColumnStringsStringMinLengthSensorParametersSpecIntegrationTest extends BaseTrinoIntegrationTest {
    ...
    void setUp() {
		...
		this.sut = new ColumnStringsStringMinLengthSensorParametersSpec();
