...
@SpringBootTest
public class OracleColumnNumericValueAboveMaxValueCountSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals((double)4L, resultTable.column(0).get(0));
    }
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals((double)1L, resultTable.column(0).get(0));
    }
