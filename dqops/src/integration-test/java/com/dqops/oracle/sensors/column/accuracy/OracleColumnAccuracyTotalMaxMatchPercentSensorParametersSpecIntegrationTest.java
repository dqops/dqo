...
@SpringBootTest
public class OracleColumnAccuracyTotalMaxMatchPercentSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1f, resultTable.column(1).get(0));
    }
