...
@SpringBootTest
public class OracleColumnStringsStringLengthBelowMinLengthPercentSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(25.0, (float) resultTable.column(0).get(0));
    }
