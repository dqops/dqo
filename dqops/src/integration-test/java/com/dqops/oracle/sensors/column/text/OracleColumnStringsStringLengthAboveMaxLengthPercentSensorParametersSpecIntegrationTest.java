...
@SpringBootTest
public class OracleColumnStringsStringLengthAboveMaxLengthPercentSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(95.0, (float) resultTable.column(0).get(0));
    }
