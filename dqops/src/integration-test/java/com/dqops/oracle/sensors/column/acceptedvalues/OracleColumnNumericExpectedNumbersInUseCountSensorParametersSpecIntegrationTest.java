...
@SpringBootTest
public class OracleColumnNumericExpectedNumbersInUseCountSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(0L, ((Number) resultTable.column(0).get(0)).longValue());
    }
    ...
    void runSensor_whenSensorExecutedMonitoringDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(5L, ((Number) resultTable.column(0).get(0)).longValue());
    }
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(4L, ((Number) resultTable.column(0).get(0)).longValue());
    }
    ...
    void runSensor_whenSensorExecutedPartitionedMonthly_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(3L, ((Number) resultTable.column(0).get(0)).longValue());
    }
}
