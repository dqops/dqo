 ...
 */
package com.dqops.oracle.sensors.column.customsql;
...
@SpringBootTest
public class OracleColumnSqlInvalidValueCountSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    void runSensor_onNullData_thenReturnsValues() {
        ...
        this.sut.setSqlQuery("SELECT {column} AS actual_value FROM {table} analyzed_table WHERE {column} IS NOT NULL");
    ...
    void runSensor_whenSensorExecutedProfilingWithJinjaVariables_thenReturnsValues() {
        this.sut.setSqlQuery("SELECT {column} AS actual_value FROM {table} analyzed_table WHERE {column} = 'married'");
