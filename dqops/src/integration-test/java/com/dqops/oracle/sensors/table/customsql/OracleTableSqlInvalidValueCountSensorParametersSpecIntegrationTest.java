...
@SpringBootTest
public class OracleTableSqlInvalidValueCountSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    void runSensor_onNullData_thenReturnsValues() {
        ...
        this.sut.setSqlQuery("SELECT \"string_nulls\" AS actual_value FROM {table} analyzed_table WHERE \"string_nulls\" IS NOT NULL");
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        this.sut.setSqlQuery("SELECT \"null_placeholder\" AS actual_value FROM {table} analyzed_table WHERE \"null_placeholder\" = 'married'");
