...
@SpringBootTest
public class OracleColumnPiiContainsEmailPercentSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(86.666664f, (float) resultTable.column(0).get(0), 3);
    }
