...
import com.dqops.checks.column.checkspecs.strings.ColumnStringInvalidIp6AddressCountCheckSpec;
...
@SpringBootTest
public class OracleColumnStringsStringInvalidIp6AddressCountSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, ProviderType.oracle);
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(5d, resultTable.column(0).get(0));
    }
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(1d, resultTable.column(0).get(0));
    }
