 ...
 */
package com.dqops.oracle.sensors.column.datatype;
...
@SpringBootTest
public class OracleColumnDatatypeStringDatatypeDetectSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.detect_datatype_test, ProviderType.oracle);
