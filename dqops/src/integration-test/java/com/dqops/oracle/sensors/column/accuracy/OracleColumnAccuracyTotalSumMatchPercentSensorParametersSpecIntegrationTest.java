...
@SpringBootTest
public class OracleColumnAccuracyTotalSumMatchPercentSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(15d, resultTable.column(0).get(0));
        Assertions.assertEquals(15f, resultTable.column(1).get(0));
    }
