...
@SpringBootTest
public class OracleColumnAccuracyTotalNotNullCountMatchPercentSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(20d, resultTable.column(0).get(0));
        Assertions.assertEquals(20f, resultTable.column(1).get(0));
    }
