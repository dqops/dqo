...
@SpringBootTest
public class OracleColumnUniquenessDistinctCountSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(2d, resultTable.column(0).get(0));
    }
