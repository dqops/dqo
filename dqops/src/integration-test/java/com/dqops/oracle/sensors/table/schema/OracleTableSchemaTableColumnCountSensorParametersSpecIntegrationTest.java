 ...
 */
package com.dqops.oracle.sensors.table.schema;
...
@SpringBootTest
public class OracleTableSchemaTableColumnCountSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    void setUp(){
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(
                SampleCsvFileNames.continuous_days_one_row_per_day, ProviderType.oracle);
