 ...
 */
package com.dqops.oracle.sensors.column.patterns;
...
@SpringBootTest
public class OracleColumnPatternsTextMatchingNamePatternPercentSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    private ColumnPatternsTextMatchingNamePatternPercentSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnTextMatchingNamePatternPercentCheckSpec checkSpec;
    ...
    void setUp() {
        ...
        this.checkSpec = new ColumnTextMatchingNamePatternPercentCheckSpec();
    ...
    void runSensor_onNullData_thenReturnsValues() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(
                csvFileName, ProviderType.oracle);
        IntegrationTestSampleDataObjectMother.ensureTableExists(sampleTableMetadata);
        this.userHomeContext = UserHomeContextObjectMother.createInMemoryFileHomeContextForSampleTable(sampleTableMetadata);
