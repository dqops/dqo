...
@SpringBootTest
public class OracleColumnPiiContainsIp4PercentSensorParametersSpecIntegrationTest extends BaseOracleIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip4_test, ProviderType.oracle);
