...
@SpringBootTest
public class PostgresqlColumnStringsStringMeanLengthSensorParametersSpecIntegrationTest extends BasePostgresqlIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(2.067, Precision.round((double) resultTable.column(0).get(0),3));
    }
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(1.5, resultTable.column(0).get(0));
    }
