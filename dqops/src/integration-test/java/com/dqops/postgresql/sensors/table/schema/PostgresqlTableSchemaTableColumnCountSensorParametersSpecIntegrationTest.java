 ...
 */
package com.dqops.postgresql.sensors.table.schema;
...
@SpringBootTest
public class PostgresqlTableSchemaTableColumnCountSensorParametersSpecIntegrationTest extends BasePostgresqlIntegrationTest {
    ...
    void setUp(){
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(
                SampleCsvFileNames.continuous_days_one_row_per_day, ProviderType.postgresql);
