...
@SpringBootTest
class PostgresqlColumnPiiContainsIp6PercentSensorParametersSpecIntegrationTest extends BasePostgresqlIntegrationTest {
    ...
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother
                .createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, ProviderType.postgresql);
