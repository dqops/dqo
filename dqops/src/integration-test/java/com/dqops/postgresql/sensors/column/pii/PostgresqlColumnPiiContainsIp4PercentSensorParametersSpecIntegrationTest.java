...
@SpringBootTest
public class PostgresqlColumnPiiContainsIp4PercentSensorParametersSpecIntegrationTest extends BasePostgresqlIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip4_test, ProviderType.postgresql);
