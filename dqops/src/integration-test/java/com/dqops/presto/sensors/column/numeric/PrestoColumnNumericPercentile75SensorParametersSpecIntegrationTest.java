...
@SpringBootTest
public class PrestoColumnNumericPercentile75SensorParametersSpecIntegrationTest extends BasePrestoIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(16.0, resultTable.column(0).get(0));
    }
