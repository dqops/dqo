 ...
 */
package com.dqops.presto.sensors.column.pii;
...
@SpringBootTest
public class PrestoColumnPiiContainsIp4PercentSensorParametersSpecIntegrationTest extends BasePrestoIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip4_test, ProviderType.presto);
