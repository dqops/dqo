...
@SpringBootTest
class PrestoColumnPiiContainsIp6PercentSensorParametersSpecIntegrationTest extends BasePrestoIntegrationTest {
    ...
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother
                .createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, ProviderType.presto);
