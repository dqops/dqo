 ...
 */
package com.dqops.presto.sensors.table.sql;
...
import com.dqops.sensors.table.sql.TableSqlConditionPassedPercentSensorParametersSpec;
...
@SpringBootTest
public class PrestoTableSqlConditionPassedPercentSensorParametersSpecIntegrationTest extends BasePrestoIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.test_average_delay, ProviderType.presto);
