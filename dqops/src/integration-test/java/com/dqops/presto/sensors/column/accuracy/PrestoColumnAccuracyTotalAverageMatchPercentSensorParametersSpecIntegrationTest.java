 ...
 */
package com.dqops.presto.sensors.column.accuracy;
...
@SpringBootTest
public class PrestoColumnAccuracyTotalAverageMatchPercentSensorParametersSpecIntegrationTest extends BasePrestoIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadataReferenced = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, ProviderType.presto);
