 ...
 */
package com.dqops.presto.sensors.column.datatype;
...
@SpringBootTest
public class PrestoColumnDatatypeStringDatatypeDetectSensorParametersSpecIntegrationTest extends BasePrestoIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.detect_datatype_test, ProviderType.presto);
