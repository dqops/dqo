...
@SpringBootTest
public class PrestoColumnBoolTruePercentSensorParametersSpecIntegrationTest extends BasePrestoIntegrationTest {
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(16.7F, resultTable.column(0).get(0));
    }
