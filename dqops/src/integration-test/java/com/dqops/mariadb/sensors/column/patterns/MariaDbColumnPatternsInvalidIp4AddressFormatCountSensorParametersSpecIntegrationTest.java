 ...
 */
package com.dqops.mariadb.sensors.column.patterns;

import com.dqops.checks.CheckTimeScale;
import com.dqops.checks.column.checkspecs.patterns.ColumnInvalidIp4AddressFormatFoundCheckSpec;
...
@SpringBootTest
public class MariaDbColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpecIntegrationTest extends BaseMariaDbIntegrationTest {
    private ColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnInvalidIp4AddressFormatFoundCheckSpec checkSpec;
    private SampleTableMetadata sampleTableMetadata;

    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip4_test, ProviderType.mariadb);
        IntegrationTestSampleDataObjectMother.ensureTableExists(sampleTableMetadata);
        this.userHomeContext = UserHomeContextObjectMother.createInMemoryFileHomeContextForSampleTable(sampleTableMetadata);
        this.sut = new ColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpec();
        this.checkSpec = new ColumnInvalidIp4AddressFormatFoundCheckSpec();
    ...
    void runSensor_whenErrorSamplingSensorExecutedWithNoGroupingAndNoIdColumns_thenReturnsErrorSamples() {
        ...
        Assertions.assertTrue(sampleValues.contains("256.212.62.31"));
    }
