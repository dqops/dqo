...
@SpringBootTest
public class MariaDbColumnPatternsInvalidIp6AddressFormatCountSensorParametersSpecIntegrationTest extends BaseMariaDbIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, ProviderType.mariadb);
    ...
    void runSensor_whenErrorSamplingSensorExecutedWithNoGroupingAndNoIdColumns_thenReturnsErrorSamples() {
        ...
        Assertions.assertTrue(sampleValues.contains("b972:ed68:6911:5212:0884:9395:387g:8ad5"));
    }
