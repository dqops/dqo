 ...
 */
package com.dqops.mariadb.sensors.column.numeric;

import com.dqops.checks.CheckTimeScale;
import com.dqops.checks.column.checkspecs.numeric.ColumnInvalidLongitudeCountCheckSpec;
...
import com.dqops.sensors.column.numeric.ColumnNumericInvalidLongitudeCountSensorParametersSpec;
...
@SpringBootTest
public class MariaDbColumnNumericInvalidLongitudeCountSensorParametersSpecIntegrationTest extends BaseMariaDbIntegrationTest {
    private ColumnNumericInvalidLongitudeCountSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnInvalidLongitudeCountCheckSpec checkSpec;
    private SampleTableMetadata sampleTableMetadata;

    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.geographic_coordinate_system_test, ProviderType.mariadb);
        IntegrationTestSampleDataObjectMother.ensureTableExists(sampleTableMetadata);
        this.userHomeContext = UserHomeContextObjectMother.createInMemoryFileHomeContextForSampleTable(sampleTableMetadata);
        this.sut = new ColumnNumericInvalidLongitudeCountSensorParametersSpec();
        this.checkSpec = new ColumnInvalidLongitudeCountCheckSpec();
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(5, (double) resultTable.column(0).get(0));
    }
