...
@SpringBootTest
public class MariaDbColumnPatternsTextNotMatchingNamePatternPercentSensorParametersSpecIntegrationTest extends BaseMariaDbIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.full_name_test, ProviderType.mariadb);
