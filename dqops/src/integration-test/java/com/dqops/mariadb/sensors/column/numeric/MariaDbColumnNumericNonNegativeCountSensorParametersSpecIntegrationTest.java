...
@SpringBootTest
public class MariaDbColumnNumericNonNegativeCountSensorParametersSpecIntegrationTest extends BaseMariaDbIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.nulls_and_uniqueness, ProviderType.mariadb);
