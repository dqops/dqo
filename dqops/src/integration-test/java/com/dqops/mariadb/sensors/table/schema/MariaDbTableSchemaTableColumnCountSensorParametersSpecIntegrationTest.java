 ...
 */
package com.dqops.mariadb.sensors.table.schema;
...
@SpringBootTest
public class MariaDbTableSchemaTableColumnCountSensorParametersSpecIntegrationTest extends BaseMariaDbIntegrationTest {
    ...
    void setUp(){
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(
                SampleCsvFileNames.continuous_days_one_row_per_day, ProviderType.mariadb);
