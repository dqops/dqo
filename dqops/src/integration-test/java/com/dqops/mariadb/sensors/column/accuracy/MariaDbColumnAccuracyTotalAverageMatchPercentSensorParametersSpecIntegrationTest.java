 ...
 */
package com.dqops.mariadb.sensors.column.accuracy;
...
@SpringBootTest
public class MariaDbColumnAccuracyTotalAverageMatchPercentSensorParametersSpecIntegrationTest extends BaseMariaDbIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadataReferenced = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, ProviderType.mariadb);
