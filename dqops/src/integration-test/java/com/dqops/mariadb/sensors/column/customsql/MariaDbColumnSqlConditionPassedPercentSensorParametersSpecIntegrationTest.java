 ...
 */
package com.dqops.mariadb.sensors.column.customsql;
...
import com.dqops.sensors.column.customsql.ColumnSqlConditionPassedPercentSensorParametersSpec;
...
@SpringBootTest
public class MariaDbColumnSqlConditionPassedPercentSensorParametersSpecIntegrationTest extends BaseMariaDbIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(100f, resultTable.column(0).get(0));
    }
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(50f, resultTable.column(0).get(0));
    }
