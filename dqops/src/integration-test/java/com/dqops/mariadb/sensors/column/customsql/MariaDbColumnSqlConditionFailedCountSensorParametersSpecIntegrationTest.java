...
@SpringBootTest
public class MariaDbColumnSqlConditionFailedCountSensorParametersSpecIntegrationTest extends BaseMariaDbIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(16, ValueConverter.toInteger(resultTable.column(0).get(0)));
    }
