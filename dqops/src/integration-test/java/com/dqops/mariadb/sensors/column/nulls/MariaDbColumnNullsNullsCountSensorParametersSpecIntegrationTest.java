 ...
 */
package com.dqops.mariadb.sensors.column.nulls;
...
@SpringBootTest
public class MariaDbColumnNullsNullsCountSensorParametersSpecIntegrationTest extends BaseMariaDbIntegrationTest {
    ...
    void setUp() {
        ...
        ColumnNullsNullsCountSensorParametersSpec sut = new ColumnNullsNullsCountSensorParametersSpec();
		this.checkSpec = new ColumnNullsCountCheckSpec();
        this.checkSpec.setParameters(sut);
    }
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(14.0, ValueConverter.toDouble(resultTable.column(0).get(0)));
    }
    ...
    void runSensor_whenSensorExecutedPartitionedMonthly_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(14, ValueConverter.toDouble(resultTable.column(0).get(0)));
    }
