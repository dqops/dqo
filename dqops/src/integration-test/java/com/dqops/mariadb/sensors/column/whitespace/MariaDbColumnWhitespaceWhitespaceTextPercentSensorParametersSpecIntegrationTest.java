 ...
 */
package com.dqops.mariadb.sensors.column.whitespace;

import com.dqops.checks.CheckTimeScale;
import com.dqops.checks.column.checkspecs.whitespace.ColumnWhitespaceWhitespaceTextPercentCheckSpec;
...
@SpringBootTest
public class MariaDbColumnWhitespaceWhitespaceTextPercentSensorParametersSpecIntegrationTest extends BaseMariaDbIntegrationTest {
    private ColumnWhitespaceWhitespaceTextPercentSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnWhitespaceWhitespaceTextPercentCheckSpec checkSpec;
    private SampleTableMetadata sampleTableMetadata;

    @BeforeEach
    void setUp() {
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.string_test_data, ProviderType.mariadb);
        IntegrationTestSampleDataObjectMother.ensureTableExists(sampleTableMetadata);
		this.userHomeContext = UserHomeContextObjectMother.createInMemoryFileHomeContextForSampleTable(sampleTableMetadata);
		this.sut = new ColumnWhitespaceWhitespaceTextPercentSensorParametersSpec();
		this.checkSpec = new ColumnWhitespaceWhitespaceTextPercentCheckSpec();
...
//        Assertions.assertTrue(sampleValues.contains("blank"));
        Assertions.assertTrue(sampleValues.size() == 0);
    }
...
//                .collect(Collectors.toList());
//        Assertions.assertTrue(rowId1Values.contains(4));
    }
