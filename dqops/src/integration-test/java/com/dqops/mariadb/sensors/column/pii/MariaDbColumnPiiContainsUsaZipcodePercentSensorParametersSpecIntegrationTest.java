 ...
 */
package com.dqops.mariadb.sensors.column.pii;

import com.dqops.checks.CheckTimeScale;
import com.dqops.checks.column.checkspecs.pii.ColumnPiiContainsUsaZipcodePercentCheckSpec;
...
import com.dqops.sensors.column.pii.ColumnPiiContainsUsaZipcodePercentSensorParametersSpec;
...
@SpringBootTest
public class MariaDbColumnPiiContainsUsaZipcodePercentSensorParametersSpecIntegrationTest extends BaseMariaDbIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(75.0, (float) resultTable.column(0).get(0));
    }
    ...
    void runSensor_whenErrorSamplingSensorExecutedWithNoGroupingAndNoIdColumns_thenReturnsErrorSamples() {
        ...
        Assertions.assertTrue(sampleValues.contains("21531"));
    }
