 ...
 */
package com.dqops.mariadb.sensors.column.text;
...
@SpringBootTest
public class MariaDbColumnTextTextLengthAboveMaxLengthCountSensorParametersSpecIntegrationTest extends BaseMariaDbIntegrationTest {
    private ColumnTextTextLengthAboveMaxLengthCountSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnTextLengthAboveMaxLengthCheckSpec checkSpec;
    private SampleTableMetadata sampleTableMetadata;

    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.test_data_values_in_set, ProviderType.mariadb);
        IntegrationTestSampleDataObjectMother.ensureTableExists(sampleTableMetadata);
        this.userHomeContext = UserHomeContextObjectMother.createInMemoryFileHomeContextForSampleTable(sampleTableMetadata);
        this.sut = new ColumnTextTextLengthAboveMaxLengthCountSensorParametersSpec();
        this.checkSpec = new ColumnTextLengthAboveMaxLengthCheckSpec();
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(13L, ValueConverter.toLong(resultTable.column(0).get(0)));
    }
    ...
    void runSensor_whenRunOnIntegerColumn_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(21L, ValueConverter.toLong(resultTable.column(0).get(0)));
    }
