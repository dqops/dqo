...
@SpringBootTest
class MariaDbColumnPiiContainsIp6PercentSensorParametersSpecIntegrationTest extends BaseMariaDbIntegrationTest {
    ...
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother
                .createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, ProviderType.mariadb);
