...
@SpringBootTest
public class MysqlColumnStringsStringInvalidIp6AddressCountSensorParametersSpecIntegrationTest extends BaseMysqlIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, ProviderType.mysql);
