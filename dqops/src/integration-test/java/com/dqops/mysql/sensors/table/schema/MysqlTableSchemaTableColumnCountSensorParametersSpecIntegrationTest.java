 ...
 */
package com.dqops.mysql.sensors.table.schema;
...
@SpringBootTest
public class MysqlTableSchemaTableColumnCountSensorParametersSpecIntegrationTest extends BaseMysqlIntegrationTest {
    ...
    void setUp(){
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(
                SampleCsvFileNames.continuous_days_one_row_per_day, ProviderType.mysql);
