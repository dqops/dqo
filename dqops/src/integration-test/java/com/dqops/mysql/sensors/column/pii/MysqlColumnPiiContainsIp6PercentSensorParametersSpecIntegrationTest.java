...
@SpringBootTest
class MysqlColumnPiiContainsIp6PercentSensorParametersSpecIntegrationTest extends BaseMysqlIntegrationTest {
    ...
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother
                .createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, ProviderType.mysql);
