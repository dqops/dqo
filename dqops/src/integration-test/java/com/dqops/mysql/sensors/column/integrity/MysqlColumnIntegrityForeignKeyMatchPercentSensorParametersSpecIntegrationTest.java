 ...
 */
package com.dqops.mysql.sensors.column.integrity;
...
@SpringBootTest
public class MysqlColumnIntegrityForeignKeyMatchPercentSensorParametersSpecIntegrationTest extends BaseMysqlIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.value_match_right_table, ProviderType.mysql);
        this.sampleTableMetadataForeign = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.value_match_left_table, ProviderType.mysql);
