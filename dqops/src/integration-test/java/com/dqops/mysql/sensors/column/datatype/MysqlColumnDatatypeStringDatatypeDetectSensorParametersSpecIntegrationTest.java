 ...
 */
package com.dqops.mysql.sensors.column.datatype;
...
@SpringBootTest
public class MysqlColumnDatatypeStringDatatypeDetectSensorParametersSpecIntegrationTest extends BaseMysqlIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.detect_datatype_test, ProviderType.mysql);
