...
@SpringBootTest
public class DuckdbColumnNumericPopulationVarianceSensorParametersSpecIntegrationTest extends BaseDuckdbIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(11416.0896, Double.valueOf(String.valueOf(resultTable.column(0).get(0))), 0.01);
    }
