...
@SpringBootTest
public class DuckdbJsonTableVolumeRowCountSensorParametersSpecIntegrationTest extends BaseDuckdbIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        ConnectionSpec connectionSpec = DuckdbConnectionSpecObjectMother.createForFiles(DuckdbFilesFormatType.json);
        String fileName = SampleJsonFileNames.continuous_days_one_row_per_day;
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForExplicitJsonFile(
