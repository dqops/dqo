...
@SpringBootTest
public class DuckdbColumnPatternsTextsMatchingRegexPercentSensorParametersSpecIntegrationTest extends BaseDuckdbIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        this.sut.setRegex("^[a-zA-Z0-9.!#$%&''*+/=?^_`{|}~-]+@[a-zA-Z0-9-]+(?:\\.[a-zA-Z0-9-]+)*$");
