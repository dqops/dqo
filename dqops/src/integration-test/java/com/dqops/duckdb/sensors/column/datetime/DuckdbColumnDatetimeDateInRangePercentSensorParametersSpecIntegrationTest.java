...
@SpringBootTest
public class DuckdbColumnDatetimeDateInRangePercentSensorParametersSpecIntegrationTest extends BaseDuckdbIntegrationTest {
    ...
    void setUp() {
        ...
        String csvFileName = SampleCsvFileNames.continuous_days_different_time_data_types;
