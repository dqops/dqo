...
@SpringBootTest
public class DuckdbColumnNumericPercentile25SensorParametersSpecIntegrationTest extends BaseDuckdbIntegrationTest {
    ...
    void setUp() {
        ...
        String csvFileName = SampleCsvFileNames.below_above_value_test;
