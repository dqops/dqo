...
@SpringBootTest
public class DuckdbColumnPiiContainsEmailPercentSensorParametersSpecIntegrationTest extends BaseDuckdbIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(86.666, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.001);
    }
