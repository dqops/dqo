...
@SpringBootTest
public class DuckdbColumnPiiContainsIp4PercentSensorParametersSpecIntegrationTest extends BaseDuckdbIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip4_test, ProviderType.duckdb);
