...
@SpringBootTest
public class DuckdbTableTimelinessPartitionReloadLagSensorParametersSpecIntegrationTest extends BaseDuckdbIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.test_average_delay, ProviderType.duckdb);
