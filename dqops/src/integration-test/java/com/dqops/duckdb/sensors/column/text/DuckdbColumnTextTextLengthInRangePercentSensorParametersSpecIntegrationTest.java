...
@SpringBootTest
public class DuckdbColumnTextTextLengthInRangePercentSensorParametersSpecIntegrationTest extends BaseDuckdbIntegrationTest {
    ...
    void setUp() {
        ...
        String csvFileName = SampleCsvFileNames.string_min_length_test;
