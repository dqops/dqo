...
@SpringBootTest
public class QuestDbColumnNumericSampleVarianceSensorParametersSpecIntegrationTest extends BaseQuestDbIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(11891.76, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.001);
    }
