...
@SpringBootTest
public class QuestDbColumnNumericPercentile90SensorParametersSpecIntegrationTest extends BaseQuestDbIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(18.1, ValueConverter.toDouble(resultTable.column(0).get(0)), 1.0);
    }
