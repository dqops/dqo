...
@SpringBootTest
class QuestDbColumnPiiContainsIp6PercentSensorParametersSpecIntegrationTest extends BaseQuestDbIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother
                .createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, this.connectionSpec);
