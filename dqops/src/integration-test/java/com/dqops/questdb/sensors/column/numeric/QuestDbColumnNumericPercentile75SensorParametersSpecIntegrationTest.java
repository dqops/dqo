...
import com.dqops.checks.column.checkspecs.numeric.ColumnPercentile75InRangeCheckSpec;
...
import com.dqops.sensors.column.numeric.ColumnNumericPercentile75SensorParametersSpec;
...
@SpringBootTest
public class QuestDbColumnNumericPercentile75SensorParametersSpecIntegrationTest extends BaseQuestDbIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(15.25, ValueConverter.toDouble(resultTable.column(0).get(0)), 1.0);
    }
