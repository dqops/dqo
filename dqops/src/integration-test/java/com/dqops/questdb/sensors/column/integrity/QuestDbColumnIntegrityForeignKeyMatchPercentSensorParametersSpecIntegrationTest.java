 ...
 */
package com.dqops.questdb.sensors.column.integrity;
...
@SpringBootTest
public class QuestDbColumnIntegrityForeignKeyMatchPercentSensorParametersSpecIntegrationTest extends BaseQuestDbIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.value_match_right_table, this.connectionSpec);
        this.sampleTableMetadataForeign = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.value_match_left_table, this.connectionSpec);
