 ...
 */
package com.dqops.questdb.sensors.column.datetime;
...
@SpringBootTest
public class QuestDbColumnDatetimeDateMatchFormatPercentSensorParametersSpecIntegrationTest extends BaseQuestDbIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(40.0, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.001);
    }
