 ...
 */
package com.dqops.questdb.sensors.column.customsql;
...
@SpringBootTest
public class QuestDbColumnSqlInvalidValueCountSensorParametersSpecIntegrationTest extends BaseQuestDbIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.string_test_data, ProviderType.questdb);
    ...
    void runSensor_onNullData_thenReturnsValues() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(
                csvFileName, ProviderType.questdb);
        IntegrationTestSampleDataObjectMother.ensureTableExists(sampleTableMetadata);
        this.userHomeContext = UserHomeContextObjectMother.createInMemoryFileHomeContextForSampleTable(sampleTableMetadata);
