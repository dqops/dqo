...
@SpringBootTest
public class QuestDbColumnPatternsTextNotMatchingNamePatternPercentSensorParametersSpecIntegrationTest extends BaseQuestDbIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.full_name_test, this.connectionSpec);
