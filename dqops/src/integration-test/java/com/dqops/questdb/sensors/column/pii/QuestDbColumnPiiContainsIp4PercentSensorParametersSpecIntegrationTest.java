...
@SpringBootTest
public class QuestDbColumnPiiContainsIp4PercentSensorParametersSpecIntegrationTest extends BaseQuestDbIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip4_test, this.connectionSpec);
