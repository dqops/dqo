 ...
 */
package com.dqops.questdb.sensors.table.volume;
...
@SpringBootTest
public class QuestDbTableVolumeRowCountSensorParametersSpecQuestDbIntegrationTest extends BaseQuestDbIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.continuous_days_one_row_per_day, this.connectionSpec);
