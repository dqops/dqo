...
@SpringBootTest
public class TeradataColumnNumericPercentile10SensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(2.9, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.1);
    }
