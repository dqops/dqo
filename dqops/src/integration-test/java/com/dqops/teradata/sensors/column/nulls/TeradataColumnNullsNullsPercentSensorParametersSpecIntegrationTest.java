...
@SpringBootTest
public class TeradataColumnNullsNullsPercentSensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(53.846, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.1);
    }
