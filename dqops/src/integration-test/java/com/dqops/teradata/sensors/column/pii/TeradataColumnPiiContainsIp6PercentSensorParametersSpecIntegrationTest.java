...
@SpringBootTest
class TeradataColumnPiiContainsIp6PercentSensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    ...
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother
                .createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, ProviderType.teradata);
