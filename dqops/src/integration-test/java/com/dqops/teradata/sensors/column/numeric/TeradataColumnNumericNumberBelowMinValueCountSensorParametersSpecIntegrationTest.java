...
@SpringBootTest
public class TeradataColumnNumericNumberBelowMinValueCountSensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.below_above_value_test, ProviderType.teradata);
