 ...
 */
package com.dqops.teradata.sensors.table.volume;
...
@SpringBootTest
public class TeradataTableVolumeRowCountSensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    ...
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother
                .createSampleTableMetadataForCsvFile(SampleCsvFileNames.continuous_days_one_row_per_day,
