...
import com.dqops.checks.column.checkspecs.patterns.ColumnInvalidUsaZipcodePercentCheckSpec;
...
@SpringBootTest
public class TeradataColumnPatternsInvalidUsaZipcodePercentSensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    private ColumnPatternsInvalidUsaZipcodeFormatPercentSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnInvalidUsaZipcodePercentCheckSpec checkSpec;
    ...
    void setUp() {
        ...
        this.sut = new ColumnPatternsInvalidUsaZipcodeFormatPercentSensorParametersSpec();
        this.checkSpec = new ColumnInvalidUsaZipcodePercentCheckSpec();
