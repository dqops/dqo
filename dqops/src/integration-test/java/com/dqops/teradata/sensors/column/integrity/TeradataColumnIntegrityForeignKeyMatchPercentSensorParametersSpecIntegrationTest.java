 ...
 */
package com.dqops.teradata.sensors.column.integrity;
...
@SpringBootTest
public class TeradataColumnIntegrityForeignKeyMatchPercentSensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.value_match_right_table, ProviderType.teradata);
        this.sampleTableMetadataForeign = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.value_match_left_table, ProviderType.teradata);
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(75.0, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.001);
    }
