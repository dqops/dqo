...
import com.dqops.sensors.column.numeric.ColumnNumericNegativeCountSensorParametersSpec;
...
@SpringBootTest
public class TeradataColumnNumericNegativeCountSensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(9L, ValueConverter.toLong(resultTable.column(0).get(0)));
    }
