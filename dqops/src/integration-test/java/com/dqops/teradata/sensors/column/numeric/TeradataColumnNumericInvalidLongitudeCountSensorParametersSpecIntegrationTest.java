 ...
 */
package com.dqops.teradata.sensors.column.numeric;
...
@SpringBootTest
public class TeradataColumnNumericInvalidLongitudeCountSensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.geographic_coordinate_system_test, ProviderType.teradata);
