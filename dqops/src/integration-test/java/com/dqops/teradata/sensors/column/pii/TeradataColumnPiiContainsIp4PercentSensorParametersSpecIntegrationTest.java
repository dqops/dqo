...
@SpringBootTest
public class TeradataColumnPiiContainsIp4PercentSensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip4_test, ProviderType.teradata);
