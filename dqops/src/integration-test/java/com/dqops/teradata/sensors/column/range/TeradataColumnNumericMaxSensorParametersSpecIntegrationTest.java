 ...
 */
package com.dqops.teradata.sensors.column.range;

import com.dqops.teradata.BaseTeradataIntegrationTest;
import com.dqops.checks.CheckTimeScale;
import com.dqops.checks.column.checkspecs.numeric.ColumnMaxInRangeCheckSpec;
...
@SpringBootTest
public class TeradataColumnNumericMaxSensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    private ColumnNumericMaxSensorParametersSpec sut;
    ...
    void setUp() {
		...
		this.sut = new ColumnNumericMaxSensorParametersSpec();
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(495, resultTable.column(0).get(0));
    }
