 ...
 */
package com.dqops.teradata.sensors.column.nulls;
...
@SpringBootTest
public class TeradataColumnNullsNotNullsPercentSensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(46.153, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.1);
    }
