...
@SpringBootTest
public class TeradataColumnWhitespaceWhitespaceTextPercentSensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(3.571, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.1);
    }
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(0.0d, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.1);
    }
