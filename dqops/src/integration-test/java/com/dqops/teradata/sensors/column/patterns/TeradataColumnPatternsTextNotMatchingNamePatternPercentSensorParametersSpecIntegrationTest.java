 ...
 */
package com.dqops.teradata.sensors.column.patterns;
...
@SpringBootTest
public class TeradataColumnPatternsTextNotMatchingNamePatternPercentSensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.full_name_test, ProviderType.teradata);
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(25.0d, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.001);
    }
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(100.0d, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.001);
    }
