 ...
 */
package com.dqops.teradata.sensors.column.acceptedvalues;
...
@SpringBootTest
public class TeradataColumnAcceptedValuesTextFoundInSetPercentSensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    ...
    void runSensor_whenSensorExecutedPartitionedDaily_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(50.0d, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.001);
    }
