...
@SpringBootTest
public class TeradataColumnNumericPercentile75SensorParametersSpecIntegrationTest extends BaseTeradataIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(15.25, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.1);
    }
