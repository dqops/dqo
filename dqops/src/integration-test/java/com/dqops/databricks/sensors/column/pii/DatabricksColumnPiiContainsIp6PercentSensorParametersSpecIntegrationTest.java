...
@SpringBootTest
class DatabricksColumnPiiContainsIp6PercentSensorParametersSpecIntegrationTest extends BaseDatabricksIntegrationTest {
    ...
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother
                .createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, ProviderType.databricks);
