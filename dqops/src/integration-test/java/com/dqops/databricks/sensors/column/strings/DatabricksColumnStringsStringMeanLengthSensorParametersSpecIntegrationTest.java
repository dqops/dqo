...
@SpringBootTest
public class DatabricksColumnStringsStringMeanLengthSensorParametersSpecIntegrationTest extends BaseDatabricksIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1.0d, resultTable.column(0).get(0));
    }
