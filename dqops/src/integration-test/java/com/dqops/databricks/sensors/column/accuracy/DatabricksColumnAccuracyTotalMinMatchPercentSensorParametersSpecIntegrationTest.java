 ...
 */
package com.dqops.databricks.sensors.column.accuracy;
...
@SpringBootTest
public class DatabricksColumnAccuracyTotalMinMatchPercentSensorParametersSpecIntegrationTest extends BaseDatabricksIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadataReferenced = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, ProviderType.databricks);
