 ...
 */
package com.dqops.databricks.sensors.column.datatype;
...
@SpringBootTest
public class DatabricksColumnDatatypeStringDatatypeDetectSensorParametersSpecIntegrationTest extends BaseDatabricksIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.detect_datatype_test, ProviderType.databricks);
