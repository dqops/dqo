...
@SpringBootTest
public class DatabricksColumnPiiContainsIp4PercentSensorParametersSpecIntegrationTest extends BaseDatabricksIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip4_test, ProviderType.databricks);
