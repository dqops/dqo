 ...
 */
package com.dqops.databricks.sensors.table.sql;
...
import com.dqops.sensors.table.sql.TableSqlConditionFailedCountSensorParametersSpec;
...
@SpringBootTest
public class DatabricksTableSqlConditionFailedCountSensorParametersSpecIntegrationTest extends BaseDatabricksIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.test_average_delay, ProviderType.databricks);
