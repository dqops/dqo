 ...
 */
package com.dqops.databricks.sensors.table.availability;
...
@SpringBootTest
public class DatabricksTableAvailabilitySensorParametersSpecIntegrationTest extends BaseDatabricksIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.continuous_days_one_row_per_day, ProviderType.databricks);
    ...
    void runSensor_whenSensorExecutedOnNonExistingTable_thenReturnsFailedValue() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataWithNonExistingTable("schema", "table", ProviderType.databricks);
        this.userHomeContext = UserHomeContextObjectMother.createInMemoryFileHomeContextForSampleTable(sampleTableMetadata);
