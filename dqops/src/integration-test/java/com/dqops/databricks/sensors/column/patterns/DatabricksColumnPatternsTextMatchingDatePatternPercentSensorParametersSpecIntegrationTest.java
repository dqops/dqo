...
@SpringBootTest
public class DatabricksColumnPatternsTextMatchingDatePatternPercentSensorParametersSpecIntegrationTest extends BaseDatabricksIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.continuous_days_date_and_string_formats, ProviderType.databricks);
    ...
    void runSensor_whenSensorExecutedPartitionedMonthly_thenReturnsValues() {
        ...
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(60.0d, resultTable.column(0).get(0));
    }
}
