...
@SpringBootTest
public class DatabricksColumnStringsStringLengthBelowMinLengthCountSensorParametersSpecIntegrationTest extends BaseDatabricksIntegrationTest {
    ...
    void setUp() {
        ...
        this.sut = new ColumnStringsStringLengthBelowMinLengthCountSensorParametersSpec();
