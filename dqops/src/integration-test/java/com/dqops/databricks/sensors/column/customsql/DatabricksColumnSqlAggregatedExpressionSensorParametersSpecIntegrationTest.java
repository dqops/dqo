 ...
 */
package com.dqops.databricks.sensors.column.customsql;
...
@SpringBootTest
public class DatabricksColumnSqlAggregatedExpressionSensorParametersSpecIntegrationTest extends BaseDatabricksIntegrationTest {
    ...
    void runSensor_whenErrorSamplingSensorExecutedWithNoGroupingAndNoIdColumns_thenReturnsDataSamples() {
        ...
        Table resultTable = sensorResult.getResultTable();
        Assertions.assertEquals(28, resultTable.rowCount());
