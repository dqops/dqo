...
import com.dqops.sensors.column.blanks.ColumnTextTextSurroundedByWhitespacePercentSensorParametersSpec;
...
@SpringBootTest
public class DatabricksColumnTextTextSurroundedByWhitespacePercentSensorParametersSpecIntegrationTest extends BaseDatabricksIntegrationTest {
    private ColumnTextTextSurroundedByWhitespacePercentSensorParametersSpec sut;
    ...
    void setUp() {
		...
		this.sut = new ColumnTextTextSurroundedByWhitespacePercentSensorParametersSpec();
