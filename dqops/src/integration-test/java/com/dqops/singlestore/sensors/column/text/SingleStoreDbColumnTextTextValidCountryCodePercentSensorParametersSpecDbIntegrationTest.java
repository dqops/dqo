...
@SpringBootTest
public class SingleStoreDbColumnTextTextValidCountryCodePercentSensorParametersSpecDbIntegrationTest extends BaseSingleStoreDbIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(72.0f, resultTable.column(0).get(0));
    }
