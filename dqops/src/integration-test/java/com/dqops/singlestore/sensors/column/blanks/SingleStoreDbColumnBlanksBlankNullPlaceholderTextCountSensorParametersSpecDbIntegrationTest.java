...
@SpringBootTest
public class SingleStoreDbColumnBlanksBlankNullPlaceholderTextCountSensorParametersSpecDbIntegrationTest extends BaseSingleStoreDbIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(10, (double) resultTable.column(0).get(0));
    }
