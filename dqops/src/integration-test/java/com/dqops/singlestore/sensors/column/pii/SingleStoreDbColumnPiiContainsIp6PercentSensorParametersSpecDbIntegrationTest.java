...
@SpringBootTest
class SingleStoreDbColumnPiiContainsIp6PercentSensorParametersSpecDbIntegrationTest extends BaseSingleStoreDbIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother
                .createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip6_test, connectionSpec);
