...
@SpringBootTest
public class SingleStoreDbColumnPiiContainsUsaZipcodePercentSensorParametersSpecDbIntegrationTest extends BaseSingleStoreDbIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(96.0, (float) resultTable.column(0).get(0));
    }
