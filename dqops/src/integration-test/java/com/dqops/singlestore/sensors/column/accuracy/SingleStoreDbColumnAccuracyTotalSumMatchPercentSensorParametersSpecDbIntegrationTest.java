...
@SpringBootTest
public class SingleStoreDbColumnAccuracyTotalSumMatchPercentSensorParametersSpecDbIntegrationTest extends BaseSingleStoreDbIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(15.0, resultTable.column(1).get(0));
    }
