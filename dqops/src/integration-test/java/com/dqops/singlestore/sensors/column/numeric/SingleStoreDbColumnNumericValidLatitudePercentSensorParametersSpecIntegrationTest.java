...
@SpringBootTest
public class SingleStoreDbColumnNumericValidLatitudePercentSensorParametersSpecIntegrationTest extends BaseSingleStoreDbIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.geographic_coordinate_system_test, connectionSpec);
