 ...
 */
package com.dqops.singlestore.sensors.column.accuracy;
...
@SpringBootTest
public class SingleStoreDbColumnAccuracyTotalAverageMatchPercentSensorParametersSpecDbIntegrationTest extends BaseSingleStoreDbIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadataReferenced = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, connectionSpec);
