 ...
 */
package com.dqops.singlestore.sensors.column.pii;

import com.dqops.checks.CheckTimeScale;
import com.dqops.checks.column.checkspecs.pii.ColumnPiiContainsIp4PercentCheckSpec;
...
@SpringBootTest
public class SingleStoreDbColumnPiiContainsIp4PercentSensorParametersSpecIntegrationTest extends BaseSingleStoreDbIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip4_test, connectionSpec);
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(60.0, (float) resultTable.column(0).get(0));
    }
    ...
    void runSensor_whenErrorSamplingSensorExecutedWithNoGroupingAndNoIdColumns_thenReturnsErrorSamples() {
        ...
        Assertions.assertTrue(sampleValues.contains("150.238.182.105"));
    }
