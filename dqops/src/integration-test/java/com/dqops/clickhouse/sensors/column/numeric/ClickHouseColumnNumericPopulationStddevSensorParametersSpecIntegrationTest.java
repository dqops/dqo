...
import com.dqops.checks.column.checkspecs.numeric.ColumnPopulationStddevInRangeCheckSpec;
...
@SpringBootTest
public class ClickHouseColumnNumericPopulationStddevSensorParametersSpecIntegrationTest extends BaseClickHouseIntegrationTest {
    private ColumnNumericPopulationStddevSensorParametersSpec sut;
    ...
    void setUp() {
		...
		this.sut = new ColumnNumericPopulationStddevSensorParametersSpec();
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(106.84610240902566, ValueConverter.toDouble(resultTable.column(0).get(0)), 0.1);
    }
