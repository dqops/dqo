 ...
 */
package com.dqops.clickhouse.sensors.column.patterns;

import com.dqops.clickhouse.BaseClickHouseIntegrationTest;
import com.dqops.checks.CheckTimeScale;
import com.dqops.checks.column.checkspecs.patterns.ColumnInvalidUsaPhonePercentCheckSpec;
...
import com.dqops.sensors.column.patterns.ColumnPatternsInvalidUsaPhoneFormatPercentSensorParametersSpec;
...
@SpringBootTest
public class ClickHouseColumnPatternsInvalidUsaPhonePercentSensorParametersSpecIntegrationTest extends BaseClickHouseIntegrationTest {
    private ColumnPatternsInvalidUsaPhoneFormatPercentSensorParametersSpec sut;
    private UserHomeContext userHomeContext;
    private ColumnInvalidUsaPhonePercentCheckSpec checkSpec;
    private SampleTableMetadata sampleTableMetadata;

    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.nulls_and_uniqueness, ProviderType.clickhouse);
        IntegrationTestSampleDataObjectMother.ensureTableExists(sampleTableMetadata);
        this.userHomeContext = UserHomeContextObjectMother.createInMemoryFileHomeContextForSampleTable(sampleTableMetadata);
        this.sut = new ColumnPatternsInvalidUsaPhoneFormatPercentSensorParametersSpec();
        this.checkSpec = new ColumnInvalidUsaPhonePercentCheckSpec();
