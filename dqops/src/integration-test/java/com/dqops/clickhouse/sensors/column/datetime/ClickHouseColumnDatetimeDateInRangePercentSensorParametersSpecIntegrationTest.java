 ...
 */
package com.dqops.clickhouse.sensors.column.datetime;
...
@SpringBootTest
public class ClickHouseColumnDatetimeDateInRangePercentSensorParametersSpecIntegrationTest extends BaseClickHouseIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.continuous_days_different_time_data_types, ProviderType.clickhouse);
