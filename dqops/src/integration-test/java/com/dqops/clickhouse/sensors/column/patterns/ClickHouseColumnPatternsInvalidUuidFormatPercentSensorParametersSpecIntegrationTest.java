...
@SpringBootTest
public class ClickHouseColumnPatternsInvalidUuidFormatPercentSensorParametersSpecIntegrationTest extends BaseClickHouseIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.uuid_test, ProviderType.clickhouse);
