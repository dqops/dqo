 ...
 */
package com.dqops.clickhouse.sensors.table.availability;
...
@SpringBootTest
public class ClickHouseTableAvailabilitySensorParametersSpecIntegrationTest extends BaseClickHouseIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.continuous_days_one_row_per_day, ProviderType.clickhouse);
    ...
    void runSensor_whenSensorExecutedOnNonExistingTable_thenReturnsFailedValue() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataWithNonExistingTable("schema", "table", ProviderType.clickhouse);
        this.userHomeContext = UserHomeContextObjectMother.createInMemoryFileHomeContextForSampleTable(sampleTableMetadata);
