...
@SpringBootTest
public class ClickHouseColumnNumericNumberBelowMinValuePercentSensorParametersSpecIntegrationTest extends BaseClickHouseIntegrationTest {
    ...
    void runSensor_whenErrorSamplingSensorExecutedWithNoGroupingButWithIdColumns_thenReturnsErrorSamples() {
        ...
        List<Integer> rowId1Values = List.of(resultTable.column("row_id_1").asObjectArray())
                ...
                .collect(Collectors.toList());
        Assertions.assertTrue(rowId1Values.contains(15));
    }
