 ...
 */
package com.dqops.clickhouse.sensors.table.schema;
...
@SpringBootTest
public class ClickHouseTableSchemaTableColumnCountSensorParametersSpecIntegrationTest extends BaseClickHouseIntegrationTest {
    ...
    void setUp(){
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(
                SampleCsvFileNames.continuous_days_one_row_per_day, ProviderType.clickhouse);
