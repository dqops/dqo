 ...
 */
package com.dqops.clickhouse.sensors.column.numeric;

import com.dqops.clickhouse.BaseClickHouseIntegrationTest;
import com.dqops.checks.CheckTimeScale;
import com.dqops.checks.column.checkspecs.numeric.ColumnNonNegativeCountCheckSpec;
...
@SpringBootTest
public class ClickHouseColumnNumericNonNegativeCountSensorParametersSpecIntegrationTest extends BaseClickHouseIntegrationTest {
    ...
    @Test
    void runSensor_onIntsAndNullsMixedData_thenReturnValueFromNonNullData() {
        SensorExecutionRunParameters runParameters = SensorExecutionRunParametersObjectMother.createForTableColumnForProfilingCheck(
                sampleTableMetadata, "ints_nulls_mix", this.checkSpec);
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(10L, ValueConverter.toLong(resultTable.column(0).get(0)));
    }
    ...
    void runSensor_whenErrorSamplingSensorExecutedWithNoGroupingAndNoIdColumns_thenReturnsErrorSamples() {
        ...
        Assertions.assertTrue(sampleValues.contains(-67.0));
    }
