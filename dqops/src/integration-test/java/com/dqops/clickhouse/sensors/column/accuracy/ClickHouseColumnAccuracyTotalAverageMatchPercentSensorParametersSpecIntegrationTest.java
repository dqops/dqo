 ...
 */
package com.dqops.clickhouse.sensors.column.accuracy;
...
@SpringBootTest
public class ClickHouseColumnAccuracyTotalAverageMatchPercentSensorParametersSpecIntegrationTest extends BaseClickHouseIntegrationTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadataReferenced = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip6_test, ProviderType.clickhouse);
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals("expected_value", resultTable.column(0).name());
        Assertions.assertEquals("actual_value", resultTable.column(1).name());
        Assertions.assertEquals(0.7500000000000001, resultTable.column(0).get(0));
        Assertions.assertEquals(0.7500000000000001, resultTable.column(1).get(0));
    }
