...
@SpringBootTest
public class ClickHouseColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpecIntegrationTest extends BaseClickHouseIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.ip4_test, ProviderType.clickhouse);
