 ...
 */
package com.dqops.clickhouse.sensors.column.datatype;
...
@SpringBootTest
public class ClickHouseColumnDatatypeStringDatatypeDetectSensorParametersSpecIntegrationTest extends BaseClickHouseIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
		this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.detect_datatype_test, ProviderType.clickhouse);
