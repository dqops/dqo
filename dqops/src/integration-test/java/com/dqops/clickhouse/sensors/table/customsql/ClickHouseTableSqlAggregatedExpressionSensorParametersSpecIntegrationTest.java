...
@SpringBootTest
public class ClickHouseTableSqlAggregatedExpressionSensorParametersSpecIntegrationTest extends BaseClickHouseIntegrationTest {
    ...
    @BeforeEach
    void setUp() {
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.test_average_delay, ProviderType.clickhouse);
