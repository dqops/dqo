 ...
 */
package com.dqops.clickhouse.sensors.column.range;
...
@SpringBootTest
public class ClickHouseColumnNumericMaxSensorParametersSpecIntegrationTest extends BaseClickHouseIntegrationTest {
    ...
    void runSensor_whenSensorExecutedProfiling_thenReturnsValues() {
        ...
        Assertions.assertEquals(1, resultTable.rowCount());
        Assertions.assertEquals("actual_value", resultTable.column(0).name());
        Assertions.assertEquals(495L, ValueConverter.toLong(resultTable.column(0).get(0)));
    }
