...
public class ErrorSamplesTableFactoryImpl implements ErrorSamplesTableFactory {
    ...
    public Table createEmptyErrorSamplesTable(String tableName) {
        ...
        table.addColumns(
                ...
                TextColumn.create(ErrorSamplesColumnNames.TIME_GRADIENT_COLUMN_NAME),
                ...
                TextColumn.create(ErrorSamplesColumnNames.TABLE_COMPARISON_NAME_COLUMN_NAME),
                ...
                TextColumn.create(ErrorSamplesColumnNames.ROW_ID_COLUMN_NAME_PREFIX + "1"),
                TextColumn.create(ErrorSamplesColumnNames.ROW_ID_COLUMN_NAME_PREFIX + "2"),
                TextColumn.create(ErrorSamplesColumnNames.ROW_ID_COLUMN_NAME_PREFIX + "3"),
                TextColumn.create(ErrorSamplesColumnNames.ROW_ID_COLUMN_NAME_PREFIX + "4"),
                TextColumn.create(ErrorSamplesColumnNames.ROW_ID_COLUMN_NAME_PREFIX + "5"),
