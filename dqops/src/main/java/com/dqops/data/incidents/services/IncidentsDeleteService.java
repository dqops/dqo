...
/**
 * Service that deletes incidents.
 */
public interface IncidentsDeleteService {
     ...
     */
    DeleteStoredDataResult deleteSelectedIncidentsFragment(IncidentsFragmentFilter filter, UserDomainIdentity userIdentity);
}
