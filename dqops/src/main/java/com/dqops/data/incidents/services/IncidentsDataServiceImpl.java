...
public class IncidentsDataServiceImpl implements IncidentsDataService {
     ...
     */
    @Override
    public IncidentModel loadIncident(String connectionName, int year, int month, String incidentId, DqoUserPrincipal principal) {
        IncidentsSnapshot incidentsSnapshot = this.incidentsSnapshotFactory.createSnapshot(connectionName);
    ...
    public CheckResultEntryModel[] loadCheckResultsForIncident(String connectionName,
        ...
        IncidentModel incidentModel = this.loadIncident(connectionName, year, month, incidentId, principal);
     ...
     */
    @Override
    public Collection<IncidentsPerConnectionModel> findConnectionIncidentStats(DqoUserPrincipal principal) {
        ...
        List<IncidentsPerConnectionModel> resultList = connectionWrappers.stream()
                ...
                .sorted()
                .map(connectionName -> loadConnectionStats(connectionName, principal))
     ...
     */
    public IncidentsPerConnectionModel loadConnectionStats(String connectionName, DqoUserPrincipal principal) {
