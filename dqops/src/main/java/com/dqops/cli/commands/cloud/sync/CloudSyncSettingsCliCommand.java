...
public class CloudSyncSettingsCliCommand extends BaseCommand implements ICommand {
    ...
    public CloudSyncSettingsCliCommand() {
    }

    @Autowired
    public CloudSyncSettingsCliCommand(CloudSynchronizationCliService cloudSynchronizationCliService,
    ...
    public Integer call() throws Exception {
        try {
            ...
            return this.cloudSynchronizationCliService.synchronizeRoot(
                    DqoRoot.settings, this.mode, this.direction, false, this.isHeadless(), true, principal);
        }
