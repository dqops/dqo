...
/**
 * 3st level CLI command "cloud sync dictionaries" to synchronize the "dictionaries" folder in the DQOps user home.
 */
@Component
...
public class CloudSyncDictionariesCliCommand extends BaseCommand implements ICommand {
    ...
    public CloudSyncDictionariesCliCommand() {
    }

    @Autowired
    public CloudSyncDictionariesCliCommand(CloudSynchronizationCliService cloudSynchronizationCliService,
    ...
    public Integer call() throws Exception {
        try {
            ...
            return this.cloudSynchronizationCliService.synchronizeRoot(
                    DqoRoot.dictionaries, this.mode, this.direction, false, this.isHeadless(), true, principal);
        }
