...
public class CloudSyncRulesCliCommand extends BaseCommand implements ICommand {
    ...
    @Autowired
    public CloudSyncRulesCliCommand(CloudSynchronizationCliService cloudSynchronizationCliService,
    ...
    public Integer call() throws Exception {
        try {
            ...
            return this.cloudSynchronizationCliService.synchronizeRoot(
                    DqoRoot.rules, this.mode, this.direction, false, this.isHeadless(), true, principal);
        }
