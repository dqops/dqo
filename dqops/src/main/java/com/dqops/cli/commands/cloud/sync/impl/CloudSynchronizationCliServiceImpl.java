...
public class CloudSynchronizationCliServiceImpl implements CloudSynchronizationCliService {
    ...
    public int synchronizeRoot(DqoRoot rootType,
        ...
        DqoCloudApiKey apiKey = this.apiKeyProvider.getApiKey(userPrincipal.getIdentity());
        if (apiKey == null) {
        ...
        if (runOnBackgroundQueue) {
            ...
            this.dqoCloudSynchronizationService.synchronizeFolder(rootType, principal.getIdentity(), synchronizationDirection, forceRefreshNativeTable, synchronizationListener);
        }
