...
/**
 * Column profiler that finds the maximum text length.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
public class ColumnTextTextMaxLengthStatisticsCollectorSpec extends AbstractStatisticsCollectorSpec<ColumnTextTextMaxLengthSensorParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextTextMaxLengthStatisticsCollectorSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractStatisticsCollectorSpec.FIELDS) {
        {
        }
    };

    /**
     * Sensor parameters used by this statistics collector.
     */
    public static final String SENSOR_NAME = ColumnTextTextMaxLengthSensorParametersSpec.SENSOR_NAME;
