...
/**
 * Column profiler that finds the minimum length of a text in a text column.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
public class ColumnTextTextMinLengthStatisticsCollectorSpec extends AbstractStatisticsCollectorSpec<ColumnTextTextMinLengthSensorParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextTextMinLengthStatisticsCollectorSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractStatisticsCollectorSpec.FIELDS) {
        {
        }
    };
     ...
     */
    public static final String SENSOR_NAME = ColumnTextTextMinLengthSensorParametersSpec.SENSOR_NAME;
