...
/**
 * Column profiler that finds the mean length of text values in a column.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
public class ColumnTextTextMeanLengthStatisticsCollectorSpec extends AbstractStatisticsCollectorSpec<ColumnTextTextMeanLengthSensorParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextTextMeanLengthStatisticsCollectorSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractStatisticsCollectorSpec.FIELDS) {
        {
        }
    };
