...
/**
 * Column profiler that measure the percentage of duplicate column values.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
public class ColumnUniquenessDuplicatePercentStatisticsCollectorSpec extends AbstractStatisticsCollectorSpec<ColumnUniquenessDuplicatePercentSensorParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnUniquenessDuplicatePercentStatisticsCollectorSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractStatisticsCollectorSpec.FIELDS) {
        {
        }
    };
