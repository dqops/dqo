...
public class ColumnTextTextDatatypeDetectStatisticsCollectorSpec extends AbstractStatisticsCollectorSpec<ColumnDatatypeStringDatatypeDetectSensorParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextTextDatatypeDetectStatisticsCollectorSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractStatisticsCollectorSpec.FIELDS) {
        {
        }
    };
