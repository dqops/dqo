...
public class ColumnNullsNotNullsCountStatisticsCollectorSpec extends AbstractStatisticsCollectorSpec<ColumnNullsNotNullsCountSensorParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnNullsNotNullsCountStatisticsCollectorSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractStatisticsCollectorSpec.FIELDS) {
        {
        }
    };
