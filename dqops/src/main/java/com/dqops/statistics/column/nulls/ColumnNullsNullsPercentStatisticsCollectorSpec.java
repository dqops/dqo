...
public class ColumnNullsNullsPercentStatisticsCollectorSpec extends AbstractStatisticsCollectorSpec<ColumnNullsNullsPercentSensorParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnNullsNullsPercentStatisticsCollectorSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractStatisticsCollectorSpec.FIELDS) {
        {
        }
    };
