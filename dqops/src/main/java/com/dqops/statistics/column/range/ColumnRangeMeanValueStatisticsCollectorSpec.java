...
/**
 * Column profiler that finds the mean (average) value in the column.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
public class ColumnRangeMeanValueStatisticsCollectorSpec extends AbstractStatisticsCollectorSpec<ColumnNumericMeanSensorParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnRangeMeanValueStatisticsCollectorSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractStatisticsCollectorSpec.FIELDS) {
        {
        }
    };
     ...
     */
    public static final String SENSOR_NAME = ColumnNumericMeanSensorParametersSpec.SENSOR_NAME;
