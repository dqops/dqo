...
@ApiModel(value = "CheckBasicModel", description = "Simplistic model that returns a single data quality check, it's name and \"configured\" flag")
public class CheckBasicModel implements Comparable<CheckBasicModel> {
     ...
     */
    @Override
    public int compareTo(@NotNull CheckBasicModel o) {
