...
public class ColumnSqlConditionFailedCountSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnSqlConditionFailedCountSensorParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractSensorParametersSpec.FIELDS) {
        {
        }
    };
    ...
    public String getSensorDefinitionName() {
        return "column/custom_sql/sql_condition_failed_count";
    }
}
