...
public class ColumnAccuracyMinMatchPercentSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAccuracyMinMatchPercentSensorParametersSpec> FIELDS =
    ...
    public String getSensorDefinitionName() {
        return "column/accuracy/min_match_percent";
    }
