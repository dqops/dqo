...
public class ColumnAccuracyTotalMinMatchPercentSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAccuracyTotalMinMatchPercentSensorParametersSpec> FIELDS =
    ...
    public String getSensorDefinitionName() {
        return "column/accuracy/total_min_match_percent";
    }
