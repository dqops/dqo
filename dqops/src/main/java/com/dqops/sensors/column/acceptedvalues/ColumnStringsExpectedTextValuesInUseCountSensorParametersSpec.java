...
public class ColumnStringsExpectedTextValuesInUseCountSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnStringsExpectedTextValuesInUseCountSensorParametersSpec> FIELDS =
    ...
    public String getSensorDefinitionName() {
        return "column/accepted_values/expected_text_values_in_use_count";
    }
}