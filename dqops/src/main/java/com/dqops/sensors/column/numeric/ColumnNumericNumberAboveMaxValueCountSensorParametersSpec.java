...
public class ColumnNumericNumberAboveMaxValueCountSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnNumericNumberAboveMaxValueCountSensorParametersSpec> FIELDS =
    ...
    public String getSensorDefinitionName() {
        return "column/numeric/number_above_max_value_count";
    }
