...
public class ColumnNumericNumberFoundInSetPercentSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnNumericNumberFoundInSetPercentSensorParametersSpec> FIELDS =
    ...
    public String getSensorDefinitionName() {
        return "column/accepted_values/number_found_in_set_percent";
    }
}