...
public class ColumnTextTextLengthBelowMinLengthPercentSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextTextLengthBelowMinLengthPercentSensorParametersSpec> FIELDS =
    ...
    public String getSensorDefinitionName() {
        return "column/text/text_length_below_min_length_percent";
    }
