...
public class ColumnNumericValueBelowMinValuePercentSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnNumericValueBelowMinValuePercentSensorParametersSpec> FIELDS =
    ...
    public String getSensorDefinitionName() {
        return "column/numeric/value_below_min_value_percent";
    }
