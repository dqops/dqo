...
public class ColumnStringsStringMatchDateRegexPercentSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnStringsStringMatchDateRegexPercentSensorParametersSpec> FIELDS =
    ...
    public String getSensorDefinitionName() {
        return "column/strings/string_match_date_regex_percent";
    }
}
