 ...
 */
package com.dqops.sensors.table.sql;
...
public class TableSqlConditionFailedPercentSensorParametersSpec extends AbstractSensorParametersSpec {
    public static final ChildHierarchyNodeFieldMapImpl<TableSqlConditionFailedPercentSensorParametersSpec> FIELDS =
    ...
    public String getSensorDefinitionName() {
        return "table/sql/sql_condition_failed_percent";
    }
}
