...
public class TableAccuracyTotalRowCountMatchPercentSensorParametersSpec extends AbstractSensorParametersSpec
        implements ReferencedTableParameters {
    public static final ChildHierarchyNodeFieldMapImpl<TableAccuracyTotalRowCountMatchPercentSensorParametersSpec> FIELDS =
    ...
    public String getSensorDefinitionName() {
        return "table/accuracy/total_row_count_match_percent";
    }
