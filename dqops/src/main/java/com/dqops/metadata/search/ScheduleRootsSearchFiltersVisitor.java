...
public class ScheduleRootsSearchFiltersVisitor extends AbstractSearchVisitor<FoundResultsCollector<ScheduleRootResult>> {
     ...
     */
    @Override
    public TreeNodeTraversalResult accept(DefaultIncidentNotificationsWrapper defaultIncidentNotificationsWrapper, FoundResultsCollector<ScheduleRootResult> parameter) {
        return TreeNodeTraversalResult.SKIP_CHILDREN;
    }
     ...
     */
    @Override
    public TreeNodeTraversalResult accept(TableQualityPolicyList tableDefaultChecksPatternWrappers, FoundResultsCollector<ScheduleRootResult> parameter) {
        return TreeNodeTraversalResult.SKIP_CHILDREN;
    }
