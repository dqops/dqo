 ...
 */
public class SourceColumnsSetSpec extends AbstractSet<String> implements HierarchyNode, YamlNotRenderWhenDefault {
    @JsonIgnore
    private LinkedHashSet<String> columnNames = new LinkedHashSet<>();
    @JsonIgnore
    ...
    public boolean contains(Object o) {
        return this.columnNames.contains(o);
    }
    ...
    public boolean remove(Object o) {
        boolean removed = this.columnNames.remove(o);
        if (removed) {
			setDirty();
        }
        return removed;
     ...
     */
    @Override
    public SourceColumnsSetSpec deepClone() {
        SourceColumnsSetSpec cloned = new SourceColumnsSetSpec();
        cloned.columnNames = (LinkedHashSet<String>) this.columnNames.clone();
