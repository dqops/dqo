...
public class SecretExpandFailedException extends DqoRuntimeException {
     ...
     */
    public SecretExpandFailedException() {
    }
     ...
     */
    public SecretExpandFailedException(String message) {
        super(message);
    }
     ...
     * @since 1.4
     */
    public SecretExpandFailedException(String message, Throwable cause) {
        super(message, cause);
    }
     ...
     * @since 1.4
     */
    public SecretExpandFailedException(Throwable cause) {
        super(cause);
    }
}
