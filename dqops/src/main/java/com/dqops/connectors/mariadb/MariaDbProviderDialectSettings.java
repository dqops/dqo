...
/**
 * Provider dialect settings that are specific to MariaDB.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
@Component
public class MariaDbProviderDialectSettings extends ProviderDialectSettings {
    public MariaDbProviderDialectSettings() {
        super("`", "`", "\"\"", false);
    }
