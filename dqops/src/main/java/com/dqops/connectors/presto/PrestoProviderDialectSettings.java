...
/**
 * Provider dialect settings that are specific to Presto.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
@Component
public class PrestoProviderDialectSettings extends ProviderDialectSettings {
    public PrestoProviderDialectSettings() {
        super("\"", "\"", "\"\"", true);
    }
