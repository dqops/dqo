...
/**
 * Custom implementation of ResultSet interface for ClickHouse.
 */
public class ClickHouseResultSet implements ResultSet {

    private final ResultSet resultSet;

    public ClickHouseResultSet(ResultSet resultSet) {
