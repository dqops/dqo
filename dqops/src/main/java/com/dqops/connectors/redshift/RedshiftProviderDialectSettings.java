...
/**
 * Provider dialect settings that are specific to Redshift.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
@Component
public class RedshiftProviderDialectSettings extends ProviderDialectSettings {
    public RedshiftProviderDialectSettings() {
        super("\"", "\"", "\"\"", false);
    }
