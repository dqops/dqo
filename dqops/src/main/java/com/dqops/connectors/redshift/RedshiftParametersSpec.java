...
public class RedshiftParametersSpec extends BaseProviderParametersSpec
        implements ConnectionProviderSpecificParameters {
    private static final ChildHierarchyNodeFieldMapImpl<RedshiftParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(BaseProviderParametersSpec.FIELDS) {
        {
        }
    };
    ...
    @CommandLine.Option(names = {"--redshift-password"}, description = "Redshift database password. The value can be in the ${ENVIRONMENT_VARIABLE_NAME} format to use dynamic substitution.")
     ...
     */
    @Override
    public RedshiftParametersSpec deepClone() {
        RedshiftParametersSpec cloned = (RedshiftParametersSpec)super.deepClone();
        return cloned;
    }
