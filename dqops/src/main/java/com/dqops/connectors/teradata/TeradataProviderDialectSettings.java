...
/**
 * Provider dialect settings that are specific to Teradata.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
@Component
public class TeradataProviderDialectSettings extends ProviderDialectSettings {
    public TeradataProviderDialectSettings() {
        super("\"", "\"", "\"\"", true);
