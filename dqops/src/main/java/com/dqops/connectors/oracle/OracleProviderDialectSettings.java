...
/**
 * Provider dialect settings that are specific to Oracle.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
@Component
public class OracleProviderDialectSettings extends ProviderDialectSettings {
    public OracleProviderDialectSettings() {
        super("\"", "\"", "\"\"", false);
    }
