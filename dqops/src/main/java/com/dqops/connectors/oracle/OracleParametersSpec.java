...
public class OracleParametersSpec extends BaseProviderParametersSpec
    ...
    @CommandLine.Option(names = {"--oracle-host"}, description = "Oracle host name")
    ...
    @JsonPropertyDescription("Oracle database name. The value can be in the ${ENVIRONMENT_VARIABLE_NAME} format to use dynamic substitution.")
    private String database;

    @CommandLine.Option(names = {"--oracle-user"}, description = "Oracle user name. The value can be in the ${ENVIRONMENT_VARIABLE_NAME} format to use dynamic substitution.")
    @JsonPropertyDescription("Oracle user name. The value can be in the ${ENVIRONMENT_VARIABLE_NAME} format to use dynamic substitution.")
    private String user;

    @CommandLine.Option(names = {"--oracle-password"}, description = "Oracle database password. The value can be in the ${ENVIRONMENT_VARIABLE_NAME} format to use dynamic substitution.")
     ...
     */
    @Override
    public OracleParametersSpec deepClone() {
        OracleParametersSpec cloned = (OracleParametersSpec)super.deepClone();
        return cloned;
    }
