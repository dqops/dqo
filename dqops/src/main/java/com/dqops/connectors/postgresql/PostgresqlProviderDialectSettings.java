...
/**
 * Provider dialect settings that are specific to Postgresql.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
@Component
public class PostgresqlProviderDialectSettings extends ProviderDialectSettings {
    public PostgresqlProviderDialectSettings() {
        super("\"", "\"", "\"\"", false);
    }
