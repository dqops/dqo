...
/**
 * Provider dialect settings that are specific to QuestDB.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
@Component
public class QuestDbProviderDialectSettings extends ProviderDialectSettings {
    public QuestDbProviderDialectSettings() {
        super("\"", "\"", "\"\"", false);
    }
