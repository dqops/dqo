...
/**
 * Provider dialect settings that are specific to Snowflake.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
@Component
public class SnowflakeProviderDialectSettings extends ProviderDialectSettings {
    public SnowflakeProviderDialectSettings() {
        super("\"", "\"", "\"\"", true);
    }
    ...
    public DataTypeCategory detectColumnType(ColumnTypeSnapshotSpec columnTypeSnapshot) {
        ...
        if (StringCheckUtility.containsAny(columnType, "timestamp_ltz", "timestamp_tz")) {
            return DataTypeCategory.datetime_timestamp;
        }

        if (StringCheckUtility.containsAny(columnType, "timestamp_ntz")) {
