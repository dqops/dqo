...
public class MultiplyMovingStdev30DaysRuleParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MultiplyMovingStdev30DaysRuleParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
    ...
    public String getRuleDefinitionName() {
        return "stdev/multiply_moving_stdev_30_days";
    }
}
