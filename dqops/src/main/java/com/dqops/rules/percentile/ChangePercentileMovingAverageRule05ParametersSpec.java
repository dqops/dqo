...
public class ChangePercentileMovingAverageRule05ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<ChangePercentileMovingAverageRule05ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public ChangePercentileMovingAverageRule05ParametersSpec() {
