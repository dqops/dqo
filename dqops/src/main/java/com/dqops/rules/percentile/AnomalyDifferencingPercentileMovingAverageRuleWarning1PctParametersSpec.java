...
public class AnomalyDifferencingPercentileMovingAverageRuleWarning1PctParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<AnomalyDifferencingPercentileMovingAverageRuleWarning1PctParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public AnomalyDifferencingPercentileMovingAverageRuleWarning1PctParametersSpec() {
    }

    /**
     * Constructor that configures a custom anomaly percent value.
     * @param anomalyPercent Anomaly percent value.
     */
    public AnomalyDifferencingPercentileMovingAverageRuleWarning1PctParametersSpec(Double anomalyPercent) {
