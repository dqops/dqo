...
public class ChangePercentileMovingAverage30DaysRule1ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<ChangePercentileMovingAverage30DaysRule1ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public ChangePercentileMovingAverage30DaysRule1ParametersSpec() {
    ...
    public String getRuleDefinitionName() {
        return "percentile/change_percentile_moving_average_30_days";
    }
}
