...
public class AnomalyPartitionDistinctCountRuleFatal01PctParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<AnomalyPartitionDistinctCountRuleFatal01PctParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public AnomalyPartitionDistinctCountRuleFatal01PctParametersSpec() {
    }
