...
public class AnomalyTimelinessDelayRuleError05PctParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<AnomalyTimelinessDelayRuleError05PctParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public AnomalyTimelinessDelayRuleError05PctParametersSpec() {
    }
