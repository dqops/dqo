...
public class AnomalyPartitionRowCountRuleWarning1PctParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<AnomalyPartitionRowCountRuleWarning1PctParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public AnomalyPartitionRowCountRuleWarning1PctParametersSpec() {
    }
     ...
     */
    public AnomalyPartitionRowCountRuleWarning1PctParametersSpec(Double anomalyPercent) {
