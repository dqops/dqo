...
public class AnomalyStationaryPercentValuesRuleError05PctParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<AnomalyStationaryPercentValuesRuleError05PctParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public AnomalyStationaryPercentValuesRuleError05PctParametersSpec() {
    }
