...
public class AnomalyStationaryPercentileMovingAverageRule01ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<AnomalyStationaryPercentileMovingAverageRule01ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public AnomalyStationaryPercentileMovingAverageRule01ParametersSpec() {
    }
