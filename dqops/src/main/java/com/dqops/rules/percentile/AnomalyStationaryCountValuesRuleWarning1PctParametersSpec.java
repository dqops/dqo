...
public class AnomalyStationaryCountValuesRuleWarning1PctParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<AnomalyStationaryCountValuesRuleWarning1PctParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };


    @JsonPropertyDescription("The probability (in percent) that the count of values (records) is an anomaly because the value is outside" +
            " the regular range of counts." +
     ...
     * Default constructor.
     */
    public AnomalyStationaryCountValuesRuleWarning1PctParametersSpec() {
    }
     ...
     */
    public AnomalyStationaryCountValuesRuleWarning1PctParametersSpec(Double anomalyPercent) {
    ...
    public String getRuleDefinitionName() {
        return "percentile/anomaly_stationary_count_values";
    }
