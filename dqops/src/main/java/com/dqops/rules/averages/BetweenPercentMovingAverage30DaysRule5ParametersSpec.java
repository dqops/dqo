...
public class BetweenPercentMovingAverage30DaysRule5ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<BetweenPercentMovingAverage30DaysRule5ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public BetweenPercentMovingAverage30DaysRule5ParametersSpec() {
    }
    ...
    private Double maxPercentAbove = 5.0;
    ...
    private Double maxPercentBelow = 5.0;
