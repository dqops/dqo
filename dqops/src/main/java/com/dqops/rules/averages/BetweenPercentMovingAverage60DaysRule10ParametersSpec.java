...
public class BetweenPercentMovingAverage60DaysRule10ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<BetweenPercentMovingAverage60DaysRule10ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public BetweenPercentMovingAverage60DaysRule10ParametersSpec() {
    }
    ...
    private Double maxPercentAbove = 10.0;
    ...
    private Double maxPercentBelow = 10.0;
