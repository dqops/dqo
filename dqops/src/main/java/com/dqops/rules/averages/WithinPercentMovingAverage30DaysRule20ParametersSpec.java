...
public class WithinPercentMovingAverage30DaysRule20ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<WithinPercentMovingAverage30DaysRule20ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public WithinPercentMovingAverage30DaysRule20ParametersSpec() {
    }
    ...
    public String getRuleDefinitionName() {
        return "averages/within_percent_moving_average_30_days";
    }
}
