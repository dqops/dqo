...
public class MaxMissingRule0ErrorParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MaxMissingRule0ErrorParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     */
    public MaxMissingRule0ErrorParametersSpec() {
    }
     ...
     */
    public MaxMissingRule0ErrorParametersSpec(Long maxMissing) {
     ...
     * @param maxMissing Maximum accepted value.
     */
    public MaxMissingRule0ErrorParametersSpec(int maxMissing) {
