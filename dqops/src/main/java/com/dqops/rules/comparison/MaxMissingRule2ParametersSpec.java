...
public class MaxMissingRule2ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MaxMissingRule2ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
    ...
    @SampleValues(values = "2")
    private Long maxMissing = 2L;

    /**
     * Default constructor, the minimum accepted value is 0.
     */
    public MaxMissingRule2ParametersSpec() {
    }
     ...
     */
    public MaxMissingRule2ParametersSpec(Long maxMissing) {
     ...
     * @param maxMissing Maximum accepted value.
     */
    public MaxMissingRule2ParametersSpec(int maxMissing) {
