...
public class MaxDiffPercentRule2ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MaxDiffPercentRule2ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
    ...
    @RequiredField
    private Double maxDiffPercent = 2.0;

    /**
     * Default constructor, the minimum accepted value is 2.
     */
    public MaxDiffPercentRule2ParametersSpec() {
    }
     ...
     */
    public MaxDiffPercentRule2ParametersSpec(Double maxDiffPercent) {
    ...
    public void decreaseRuleSensitivity(CheckResultsNormalizedResult checkResultsSingleCheck) {
        ...
        this.maxDiffPercent = this.maxDiffPercent * 1.3;
    }
}