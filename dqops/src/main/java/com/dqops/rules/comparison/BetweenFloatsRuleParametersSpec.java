...
public class BetweenFloatsRuleParametersSpec extends AbstractRuleParametersSpec implements RuleMiningRule {
    ...
    public BetweenFloatsRuleParametersSpec() {
    }
     ...
     */
    public BetweenFloatsRuleParametersSpec(Double from, Double to) {
        this.from = from;
        this.to = to;
    }
    ...
    public AbstractRuleParametersSpec proposeCheckConfiguration(ProfilingCheckResult sourceProfilingCheck,
        ...
        double delta = Math.abs(sourceProfilingCheck.getActualValue()) * checkMiningConfigurationProperties.getMinMaxValueRateDelta();
        double expectedMin = DoubleRounding.roundToKeepEffectiveDigits(sourceProfilingCheck.getActualValue() - delta);
        double expectedMax = DoubleRounding.roundToKeepEffectiveDigits(sourceProfilingCheck.getActualValue() + delta);

        return new BetweenFloatsRuleParametersSpec(expectedMin, expectedMax);
    }
}
