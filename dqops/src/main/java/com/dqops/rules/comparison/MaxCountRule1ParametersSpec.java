...
public class MaxCountRule1ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MaxCountRule1ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };

    public MaxCountRule1ParametersSpec() {
    }

    public MaxCountRule1ParametersSpec(long maxCount) {
