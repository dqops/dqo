...
public class MaxMissingRule0ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MaxMissingRule0ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     */
    public MaxMissingRule0ParametersSpec() {
    }
     ...
     */
    public MaxMissingRule0ParametersSpec(Long maxMissing) {
     ...
     * @param maxMissing Maximum accepted value.
     */
    public MaxMissingRule0ParametersSpec(int maxMissing) {
