...
public class MinCountRule0ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MinCountRule0ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     */
    public MinCountRule0ParametersSpec() {
    }
     ...
     */
    public MinCountRule0ParametersSpec(Long minCount) {
