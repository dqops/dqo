...
public class MaxCountRule100ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MaxCountRule100ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
    ...
    public MaxCountRule100ParametersSpec() {
        super();
    }

    public MaxCountRule100ParametersSpec(Long maxCount) {
        super();
