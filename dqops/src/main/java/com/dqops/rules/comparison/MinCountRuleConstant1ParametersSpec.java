...
public class MinCountRuleConstant1ParametersSpec extends AbstractRuleParametersSpec implements RuleMiningRule {
    ...
    public AbstractRuleParametersSpec proposeCheckConfiguration(ProfilingCheckResult sourceProfilingCheck,
        ...
        return new MinCountRuleConstant1ParametersSpec(); // always configured with 1
    }
