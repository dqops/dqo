...
public class MinPercentRule99ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MinPercentRule99ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };

    @JsonPropertyDescription("Minimum accepted value for the actual_value returned by the sensor (inclusive).")
    private Double minPercent = 99.0;

    /**
     * Default constructor, the minimum accepted value is 0.
     */
    public MinPercentRule99ParametersSpec() {
    }
     ...
     */
    public MinPercentRule99ParametersSpec(Double minPercent) {
