...
public class MinPercentRule0WarningParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MinPercentRule0WarningParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     */
    public MinPercentRule0WarningParametersSpec() {
    }
     ...
     */
    public MinPercentRule0WarningParametersSpec(Double minPercent) {
