...
public class MaxMissingRule1ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MaxMissingRule1ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
    ...
    private Long maxMissing = 1L;

    /**
     * Default constructor, the minimum accepted value is 0.
     */
    public MaxMissingRule1ParametersSpec() {
    }
     ...
     */
    public MaxMissingRule1ParametersSpec(Long maxMissing) {
     ...
     * @param maxMissing Maximum accepted value.
     */
    public MaxMissingRule1ParametersSpec(int maxMissing) {
