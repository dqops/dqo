...
public class MinPercentRule0ErrorParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MinPercentRule0ErrorParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };

    @JsonPropertyDescription("Minimum accepted value for the actual_value returned by the sensor (inclusive).")
    @SampleValues(values = "2.0")
    private Double minPercent = 0.0;

    /**
     * Default constructor, the minimum accepted value is 0.
     */
    public MinPercentRule0ErrorParametersSpec() {
    }
     ...
     */
    public MinPercentRule0ErrorParametersSpec(Double minPercent) {
