...
public class MinCountRule100FatalParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MinCountRule100FatalParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };

    @JsonPropertyDescription("Minimum accepted value for the actual_value returned by the sensor (inclusive).")
    private Long minCount = 100L;

    /**
     * Default constructor, the minimum accepted value is 0.
     */
    public MinCountRule100FatalParametersSpec() {
    }
     ...
     */
    public MinCountRule100FatalParametersSpec(Long minCount) {
     ...
     * @param minCount Minimum accepted value.
     */
    public MinCountRule100FatalParametersSpec(int minCount) {
