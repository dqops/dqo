...
public class MaxDiffPercentRule0ParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<MaxDiffPercentRule0ParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     */
    public MaxDiffPercentRule0ParametersSpec() {
    }
     ...
     */
    public MaxDiffPercentRule0ParametersSpec(Double maxDiffPercent) {
