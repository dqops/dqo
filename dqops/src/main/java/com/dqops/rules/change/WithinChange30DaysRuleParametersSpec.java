...
public class WithinChange30DaysRuleParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<WithinChange30DaysRuleParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public WithinChange30DaysRuleParametersSpec() {
    }
    ...
    public String getRuleDefinitionName() {
        return "change/within_change_30_days";
    }
}
