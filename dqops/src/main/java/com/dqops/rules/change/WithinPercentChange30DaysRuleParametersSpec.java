...
public class WithinPercentChange30DaysRuleParametersSpec extends AbstractRuleParametersSpec {
    private static final ChildHierarchyNodeFieldMapImpl<WithinPercentChange30DaysRuleParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRuleParametersSpec.FIELDS) {
        {
        }
    };
     ...
     * Default constructor.
     */
    public WithinPercentChange30DaysRuleParametersSpec() {
    }
    ...
    public String getRuleDefinitionName() {
        return "change/within_percent_change_30_days";
    }
}
