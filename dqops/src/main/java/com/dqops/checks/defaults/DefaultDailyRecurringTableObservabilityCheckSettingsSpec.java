...
public class DefaultDailyRecurringTableObservabilityCheckSettingsSpec extends AbstractRootChecksContainerSpec {
    public static final ChildHierarchyNodeFieldMapImpl<DefaultDailyRecurringTableObservabilityCheckSettingsSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractRootChecksContainerSpec.FIELDS) {
        {
     ...
     */
    protected TableDailyRecurringCheckCategoriesSpec getTableCheckCategories(TableSpec targetTable) {
        ...
        TableDailyRecurringCheckCategoriesSpec checkCategoriesSpec = recurringChecksSpec.getDaily();
        if (checkCategoriesSpec == null) {
            checkCategoriesSpec = new TableDailyRecurringCheckCategoriesSpec();
