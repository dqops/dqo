...
public class DefaultMonthlyRecurringObservabilityCheckSettingsSpec extends AbstractSpec {
    public static final ChildHierarchyNodeFieldMapImpl<DefaultMonthlyRecurringObservabilityCheckSettingsSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractSpec.FIELDS) {
        {
            put("table", o -> o.table);
    ...
    @JsonPropertyDescription("The default configuration of monthly recurring checks on a table level.")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private DefaultMonthlyRecurringTableObservabilityCheckSettingsSpec table = new DefaultMonthlyRecurringTableObservabilityCheckSettingsSpec();

    @JsonPropertyDescription("The default configuration of monthly recurring checks on a column level.")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private DefaultMonthlyRecurringColumnObservabilityCheckSettingsSpec column = new DefaultMonthlyRecurringColumnObservabilityCheckSettingsSpec();

    /**
     * Returns the container of default table level checks.
     * @return Table level checks.
     */
    public DefaultMonthlyRecurringTableObservabilityCheckSettingsSpec getTable() {
        return table;
    }
     ...
     */
    public void setTable(DefaultMonthlyRecurringTableObservabilityCheckSettingsSpec table) {
     ...
     */
    public DefaultMonthlyRecurringColumnObservabilityCheckSettingsSpec getColumn() {
        return column;
    }
     ...
     */
    public void setColumn(DefaultMonthlyRecurringColumnObservabilityCheckSettingsSpec column) {
