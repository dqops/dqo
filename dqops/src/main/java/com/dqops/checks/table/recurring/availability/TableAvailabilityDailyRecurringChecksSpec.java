 ...
 */
package com.dqops.checks.table.recurring.availability;
...
public class TableAvailabilityDailyRecurringChecksSpec extends AbstractCheckCategorySpec {
    public static final ChildHierarchyNodeFieldMapImpl<TableAvailabilityDailyRecurringChecksSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckCategorySpec.FIELDS) {
        {
     ...
     */
    @Override
    public TableAvailabilityDailyRecurringChecksSpec deepClone() {
        return (TableAvailabilityDailyRecurringChecksSpec)super.deepClone();
    }
}