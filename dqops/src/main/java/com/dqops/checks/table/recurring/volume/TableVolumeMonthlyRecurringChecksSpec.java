 ...
 */
package com.dqops.checks.table.recurring.volume;
...
public class TableVolumeMonthlyRecurringChecksSpec extends AbstractCheckCategorySpec {
     ...
     */
    @Override
    public TableVolumeMonthlyRecurringChecksSpec deepClone() {
        return (TableVolumeMonthlyRecurringChecksSpec)super.deepClone();
    }
}
