 ...
 */
package com.dqops.checks.table.checkspecs.accuracy;
...
import com.dqops.sensors.table.accuracy.TableAccuracyRowCountMatchPercentSensorParametersSpec;
...
public class TableAccuracyRowCountMatchPercentCheckSpec
        extends AbstractCheckSpec<TableAccuracyRowCountMatchPercentSensorParametersSpec, MaxDiffPercentRule0ParametersSpec, MaxDiffPercentRule1ParametersSpec, MaxDiffPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<TableAccuracyRowCountMatchPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private TableAccuracyRowCountMatchPercentSensorParametersSpec parameters = new TableAccuracyRowCountMatchPercentSensorParametersSpec();
     ...
     */
    @Override
    public TableAccuracyRowCountMatchPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(TableAccuracyRowCountMatchPercentSensorParametersSpec parameters) {
