...
public class TableRowCountChangeCheckSpec
        extends AbstractCheckSpec<TableVolumeRowCountSensorParametersSpec, ChangePercentRule10ParametersSpec, ChangePercentRule20ParametersSpec, ChangePercentRule50ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<TableRowCountChangeCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    public String getFriendlyName() {
        return "Maximum relative change in the row count since the last known value";
    }
