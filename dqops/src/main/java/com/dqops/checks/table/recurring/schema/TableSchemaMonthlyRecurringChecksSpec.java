 ...
 */
package com.dqops.checks.table.recurring.schema;
...
public class TableSchemaMonthlyRecurringChecksSpec extends AbstractCheckCategorySpec {
     ...
     */
    @Override
    public TableSchemaMonthlyRecurringChecksSpec deepClone() {
        return (TableSchemaMonthlyRecurringChecksSpec)super.deepClone();
    }
}
