 ...
 */
public class TableComparisonDailyMonitoringChecksSpecMap extends AbstractTableComparisonCheckCategorySpecMap<TableComparisonDailyMonitoringChecksSpec> {
    /**
     ...
     */
    @Override
    public TableComparisonDailyMonitoringChecksSpec getOrAdd(String comparisonName) {
        TableComparisonDailyMonitoringChecksSpec checksSpec = this.get(comparisonName);
        if (checksSpec == null) {
            checksSpec = new TableComparisonDailyMonitoringChecksSpec();
