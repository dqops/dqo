...
public class TableCustomSqlProfilingChecksSpec extends AbstractCheckCategorySpec {
    public static final ChildHierarchyNodeFieldMapImpl<TableCustomSqlProfilingChecksSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckCategorySpec.FIELDS) {
        {
            ...
            put("profile_sql_invalid_record_count_on_table", o -> o.profileSqlInvalidRecordCountOnTable);
    ...
    private TableSqlInvalidRecordCountCheckSpec profileSqlInvalidRecordCountOnTable;
     ...
     * @return New check specification.
     */
    public TableSqlInvalidRecordCountCheckSpec getProfileSqlInvalidRecordCountOnTable() {
        return profileSqlInvalidRecordCountOnTable;
    }

    /**
     * Sets a new check specification.
     * @param profileSqlInvalidRecordCountOnTable Check specification.
     */
    public void setProfileSqlInvalidRecordCountOnTable(TableSqlInvalidRecordCountCheckSpec profileSqlInvalidRecordCountOnTable) {
        this.setDirtyIf(!Objects.equals(this.profileSqlInvalidRecordCountOnTable, profileSqlInvalidRecordCountOnTable));
        this.profileSqlInvalidRecordCountOnTable = profileSqlInvalidRecordCountOnTable;
        propagateHierarchyIdToField(profileSqlInvalidRecordCountOnTable, "profile_sql_invalid_record_count_on_table");
    }
