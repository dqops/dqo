...
import com.dqops.sensors.table.accuracy.TableAccuracyTotalRowCountMatchPercentSensorParametersSpec;
...
public class TableAccuracyTotalRowCountMatchPercentCheckSpec
        extends AbstractCheckSpec<TableAccuracyTotalRowCountMatchPercentSensorParametersSpec, MaxDiffPercentRule0ParametersSpec, MaxDiffPercentRule1ParametersSpec, MaxDiffPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<TableAccuracyTotalRowCountMatchPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
     ...
     */
    @Override
    public TableAccuracyTotalRowCountMatchPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(TableAccuracyTotalRowCountMatchPercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum percentage of difference in total row count between tables";
    }
