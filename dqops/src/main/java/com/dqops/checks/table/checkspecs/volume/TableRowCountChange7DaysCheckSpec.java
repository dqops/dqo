...
public class TableRowCountChange7DaysCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<TableRowCountChange7DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    public String getFriendlyName() {
        return "Maximum relative change in the row count vs 7 days ago";
    }
