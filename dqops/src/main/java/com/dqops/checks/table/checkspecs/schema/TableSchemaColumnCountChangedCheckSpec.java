...
public class TableSchemaColumnCountChangedCheckSpec extends AbstractCheckSpec<TableColumnCountSensorParametersSpec, ValueChangedRuleParametersSpec, ValueChangedRuleParametersSpec, ValueChangedRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<TableSchemaColumnCountChangedCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
