...
public class TableDuplicateRecordCountCheckSpec
        extends AbstractCheckSpec<TableDuplicateRecordCountSensorParametersSpec, MaxCountRule0WarningParametersSpec, MaxCountRule0ErrorParametersSpec, MaxCountRule100ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<TableDuplicateRecordCountCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private TableDuplicateRecordCountSensorParametersSpec parameters = new TableDuplicateRecordCountSensorParametersSpec();
     ...
     */
    @Override
    public TableDuplicateRecordCountSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(TableDuplicateRecordCountSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum count of duplicate records";
    }
    ...
    public static class TableDuplicateRecordCountCheckSpecSampleFactory implements SampleValueFactory<TableDuplicateRecordCountCheckSpec> {
        @Override
        public TableDuplicateRecordCountCheckSpec createSample() {
            return new TableDuplicateRecordCountCheckSpec() {{
                setParameters(new TableDuplicateRecordCountSensorParametersSpec.TableDuplicateRecordCountSensorParametersSpecSampleFactory().createSample());
