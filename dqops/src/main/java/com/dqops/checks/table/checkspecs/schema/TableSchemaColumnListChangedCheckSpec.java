...
import com.dqops.sensors.table.schema.TableColumnListUnorderedHashSensorParametersSpec;
...
public class TableSchemaColumnListChangedCheckSpec extends AbstractCheckSpec<TableColumnListUnorderedHashSensorParametersSpec, ValueChangedRuleParametersSpec, ValueChangedRuleParametersSpec, ValueChangedRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<TableSchemaColumnListChangedCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };

    @JsonPropertyDescription("Column list hash sensor parameters")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private TableColumnListUnorderedHashSensorParametersSpec parameters = new TableColumnListUnorderedHashSensorParametersSpec();
     ...
     */
    @Override
    public TableColumnListUnorderedHashSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(TableColumnListUnorderedHashSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Detect if columns were added or removed";
    }
