...
public class TableSchemaColumnCountCheckSpec extends AbstractCheckSpec<TableColumnCountSensorParametersSpec, EqualsIntegerRuleParametersSpec, EqualsIntegerRuleParametersSpec, EqualsIntegerRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<TableSchemaColumnCountCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    public boolean proposeCheckConfiguration(ProfilingCheckResult sourceProfilingCheck,
        ...
        Long currentColumnCount = actualValue.longValue();

        switch (miningParameters.getSeverityLevel()) {
            case warning:
                this.setWarning(new EqualsIntegerRuleParametersSpec(currentColumnCount));
                break;
            case error:
                this.setError(new EqualsIntegerRuleParametersSpec(currentColumnCount));
                break;
            case fatal:
                this.setFatal(new EqualsIntegerRuleParametersSpec(currentColumnCount));
                break;
        }
