 ...
 */
public class TableComparisonDailyPartitionedChecksSpecMap extends AbstractTableComparisonCheckCategorySpecMap<TableComparisonDailyPartitionedChecksSpec> {
    /**
     ...
     */
    @Override
    public TableComparisonDailyPartitionedChecksSpec getOrAdd(String comparisonName) {
        TableComparisonDailyPartitionedChecksSpec checksSpec = this.get(comparisonName);
        if (checksSpec == null) {
            checksSpec = new TableComparisonDailyPartitionedChecksSpec();
