 ...
 */
package com.dqops.checks.table.checkspecs.uniqueness;
...
public class TableDuplicateRecordPercentCheckSpec
        extends AbstractCheckSpec<TableDuplicateRecordPercentSensorParametersSpec, MaxPercentRule0WarningParametersSpec, MaxPercentRule0ErrorParametersSpec, MaxPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<TableDuplicateRecordPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private TableDuplicateRecordPercentSensorParametersSpec parameters = new TableDuplicateRecordPercentSensorParametersSpec();
     ...
     */
    @Override
    public TableDuplicateRecordPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(TableDuplicateRecordPercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum percentage of duplicate records";
    }
    ...
    public static class TableDuplicateRecordCountCheckSpecSampleFactory implements SampleValueFactory<TableDuplicateRecordPercentCheckSpec> {
        @Override
        public TableDuplicateRecordPercentCheckSpec createSample() {
            return new TableDuplicateRecordPercentCheckSpec() {{
                setParameters(new TableDuplicateRecordPercentSensorParametersSpec.TableDuplicateRecordPercentSensorParametersSpecSampleFactory().createSample());
                setError(new MaxPercentRule0ErrorParametersSpec());
            }};
        }
    }
}
