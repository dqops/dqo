...
public class ColumnTextNotMatchingNamePatternPercentCheckSpec
        extends AbstractCheckSpec<ColumnPatternsTextNotMatchingNamePatternPercentSensorParametersSpec, MaxPercentRule0WarningParametersSpec, MaxPercentRule0ErrorParametersSpec, MaxPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextNotMatchingNamePatternPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnPatternsTextNotMatchingNamePatternPercentSensorParametersSpec parameters = new ColumnPatternsTextNotMatchingNamePatternPercentSensorParametersSpec();
    ...
    @JsonPropertyDescription("Default alerting threshold for a maximum percentage of rows with matching name regex in a column that raises a data quality error (alert).")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
     ...
     */
    @Override
    public ColumnPatternsTextNotMatchingNamePatternPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnPatternsTextNotMatchingNamePatternPercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum percentage of rows not containing texts that are names (e.g. numeric)";
    }
