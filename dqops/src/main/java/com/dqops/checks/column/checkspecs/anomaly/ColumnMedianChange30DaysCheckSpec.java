...
public class ColumnMedianChange30DaysCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnMedianChange30DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    public String getFriendlyName() {
        return "Maximum relative change in the median of numeric values vs 30 days ago";
    }
