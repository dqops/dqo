...
public class ColumnMeanChangeCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnMeanChangeCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
