...
public class ColumnWhitespaceEmptyTextPercentCheckSpec
        extends AbstractCheckSpec<ColumnWhitespaceEmptyTextPercentSensorParametersSpec, MaxPercentRule0WarningParametersSpec, MaxPercentRule0ErrorParametersSpec, MaxPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnWhitespaceEmptyTextPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnWhitespaceEmptyTextPercentSensorParametersSpec parameters = new ColumnWhitespaceEmptyTextPercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnWhitespaceEmptyTextPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnWhitespaceEmptyTextPercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum percentage of empty texts values";
    }
