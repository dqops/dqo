...
public class ColumnExpectedNumbersInUseCountCheckSpec
    ...
    public boolean proposeCheckConfiguration(ProfilingCheckResult sourceProfilingCheck,
        ...
        if (!miningParameters.isProposeValuesInSetChecks()) { // TODO: use a different parameter, because we are here reusing a parameter, adding a new meaning to some checks
            return false;
        }
