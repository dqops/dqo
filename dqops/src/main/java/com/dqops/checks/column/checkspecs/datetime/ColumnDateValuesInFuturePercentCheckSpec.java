...
public class ColumnDateValuesInFuturePercentCheckSpec
        extends AbstractCheckSpec<ColumnDatetimeDateValuesInFuturePercentSensorParametersSpec, MaxPercentRule0WarningParametersSpec, MaxPercentRule0ErrorParametersSpec, MaxPercentRule5ParametersSpec> {
    ...
    public String getFriendlyName() {
        return "Maximum percentage of rows containing dates in future";
    }
