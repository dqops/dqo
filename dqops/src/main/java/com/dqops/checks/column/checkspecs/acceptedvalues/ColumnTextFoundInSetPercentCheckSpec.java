...
public class ColumnTextFoundInSetPercentCheckSpec
        extends AbstractCheckSpec<ColumnAcceptedValuesTextFoundInSetPercentSensorParametersSpec, MinPercentRule100WarningParametersSpec, MinPercentRule100ErrorParametersSpec, MinPercentRule95ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextFoundInSetPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };

    @JsonPropertyDescription("Data quality check parameters that specify a list of expected values that are compared to the values in the tested text column.")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private ColumnAcceptedValuesTextFoundInSetPercentSensorParametersSpec parameters = new ColumnAcceptedValuesTextFoundInSetPercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnAcceptedValuesTextFoundInSetPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnAcceptedValuesTextFoundInSetPercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Minimum percentage of rows having text values outside the list of expected values";
    }
