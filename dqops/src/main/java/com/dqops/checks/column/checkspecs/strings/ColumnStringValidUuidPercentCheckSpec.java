...
public class ColumnStringValidUuidPercentCheckSpec
        extends AbstractCheckSpec<ColumnStringsStringValidUuidPercentSensorParametersSpec, MinPercentRule100WarningParametersSpec, MinPercentRule100ErrorParametersSpec, MinPercentRule95ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnStringValidUuidPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnStringsStringValidUuidPercentSensorParametersSpec parameters = new ColumnStringsStringValidUuidPercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnStringsStringValidUuidPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnStringsStringValidUuidPercentSensorParametersSpec parameters) {
