...
public class ColumnNullPercentChange1DayCheckSpec
        extends AbstractCheckSpec<ColumnNullsNullsPercentSensorParametersSpec, ChangePercent1DayRule10ParametersSpec, ChangePercent1DayRule20ParametersSpec, ChangePercent1DayRule50ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnNullPercentChange1DayCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    public String getFriendlyName() {
        return "Maximum percentage of change in the count of null values vs 1 day ago";
    }
