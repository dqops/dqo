...
public class ColumnWhitespaceEmptyTextFoundCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnWhitespaceEmptyTextFoundCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    public String getFriendlyName() {
        return "Maximum count of empty text values";
    }
