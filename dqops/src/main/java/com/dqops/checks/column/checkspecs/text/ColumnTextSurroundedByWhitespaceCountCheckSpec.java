...
/**
 * Column-level check that ensures that there are no more than a maximum number of texts that are surrounded by whitespace in a monitored column.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
public class ColumnTextSurroundedByWhitespaceCountCheckSpec extends
        AbstractCheckSpec<ColumnStringsStringSurroundedByWhitespaceCountSensorParametersSpec, MaxCountRule0WarningParametersSpec, MaxCountRule0ErrorParametersSpec, MaxCountRule100ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextSurroundedByWhitespaceCountCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
