...
public class ColumnNumberBelowMinValuePercentCheckSpec
        extends AbstractCheckSpec<ColumnNumericNumberBelowMinValuePercentSensorParametersSpec, MaxPercentRule0WarningParametersSpec, MaxPercentRule0ErrorParametersSpec, MaxPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnNumberBelowMinValuePercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnNumericNumberBelowMinValuePercentSensorParametersSpec parameters = new ColumnNumericNumberBelowMinValuePercentSensorParametersSpec();
    ...
    @JsonPropertyDescription("Default alerting threshold for a maximum number of rows with values with a value below the indicated by the user value in a column that raises a data quality error (alert).")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
     ...
     */
    @Override
    public ColumnNumericNumberBelowMinValuePercentSensorParametersSpec getParameters() {
        return parameters;
    }

    /**
     * Sets a new row percent sensor parameter object.
     * @param parameters Row percent parameters.
     */
    public void setParameters(ColumnNumericNumberBelowMinValuePercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum percentage of numeric values below the minimum value";
    }
