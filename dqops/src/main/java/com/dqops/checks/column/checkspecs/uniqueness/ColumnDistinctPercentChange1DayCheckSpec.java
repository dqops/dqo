...
public class ColumnDistinctPercentChange1DayCheckSpec
        extends AbstractCheckSpec<ColumnUniquenessDistinctPercentSensorParametersSpec, ChangePercent1DayRule10ParametersSpec, ChangePercent1DayRule20ParametersSpec, ChangePercent1DayRule50ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnDistinctPercentChange1DayCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
