...
public class ColumnTextMatchingDatePatternPercentCheckSpec
        extends AbstractCheckSpec<ColumnPatternsTextMatchingDatePatternPercentSensorParametersSpec, MinPercentRule100WarningParametersSpec, MinPercentRule100ErrorParametersSpec, MinPercentRule95ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextMatchingDatePatternPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnPatternsTextMatchingDatePatternPercentSensorParametersSpec parameters = new ColumnPatternsTextMatchingDatePatternPercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnPatternsTextMatchingDatePatternPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnPatternsTextMatchingDatePatternPercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Minimum percentage of rows containing texts matching an expected date pattern";
    }
