...
public class ColumnChangeDistinctCountCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnChangeDistinctCountCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
