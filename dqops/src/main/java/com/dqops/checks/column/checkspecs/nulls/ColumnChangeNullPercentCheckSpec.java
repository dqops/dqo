...
public class ColumnChangeNullPercentCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnChangeNullPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
