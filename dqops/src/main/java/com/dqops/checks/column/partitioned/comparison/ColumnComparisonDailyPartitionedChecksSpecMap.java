 ...
 */
public class ColumnComparisonDailyPartitionedChecksSpecMap extends AbstractColumnComparisonCheckCategorySpecMap<ColumnComparisonDailyPartitionedChecksSpec> {
    /**
     ...
     */
    @Override
    public ColumnComparisonDailyPartitionedChecksSpec getOrAdd(String comparisonName) {
        ColumnComparisonDailyPartitionedChecksSpec checksSpec = this.get(comparisonName);
        if (checksSpec == null) {
            checksSpec = new ColumnComparisonDailyPartitionedChecksSpec();
