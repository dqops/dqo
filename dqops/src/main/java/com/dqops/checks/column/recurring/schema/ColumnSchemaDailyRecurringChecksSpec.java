 ...
 */
package com.dqops.checks.column.recurring.schema;
...
public class ColumnSchemaDailyRecurringChecksSpec extends AbstractCheckCategorySpec {
     ...
     */
    @Override
    public ColumnSchemaDailyRecurringChecksSpec deepClone() {
        return (ColumnSchemaDailyRecurringChecksSpec)super.deepClone();
    }
}