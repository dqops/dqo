...
public class ColumnPiiMonthlyRecurringChecksSpec extends AbstractCheckCategorySpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnPiiMonthlyRecurringChecksSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckCategorySpec.FIELDS) {
        {
     ...
     */
    @Override
    public ColumnPiiMonthlyRecurringChecksSpec deepClone() {
        return (ColumnPiiMonthlyRecurringChecksSpec)super.deepClone();
    }
}