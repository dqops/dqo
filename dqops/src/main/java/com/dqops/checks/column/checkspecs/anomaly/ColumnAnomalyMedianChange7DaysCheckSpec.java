...
import com.dqops.rules.percentile.ChangePercentileMovingWithin7DaysRuleParametersSpec;
...
public class ColumnAnomalyMedianChange7DaysCheckSpec
        extends AbstractCheckSpec<ColumnNumericMedianSensorParametersSpec, ChangePercentileMovingWithin7DaysRuleParametersSpec, ChangePercentileMovingWithin7DaysRuleParametersSpec, ChangePercentileMovingWithin7DaysRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAnomalyMedianChange7DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
