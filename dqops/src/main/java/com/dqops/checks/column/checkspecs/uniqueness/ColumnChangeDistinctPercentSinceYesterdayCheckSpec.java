...
public class ColumnChangeDistinctPercentSinceYesterdayCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnChangeDistinctPercentSinceYesterdayCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
