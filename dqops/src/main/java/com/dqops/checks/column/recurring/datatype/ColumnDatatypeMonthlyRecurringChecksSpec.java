...
public class ColumnDatatypeMonthlyRecurringChecksSpec extends AbstractCheckCategorySpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnDatatypeMonthlyRecurringChecksSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckCategorySpec.FIELDS) {
        {
     ...
     */
    @Override
    public ColumnDatatypeMonthlyRecurringChecksSpec deepClone() {
        return (ColumnDatatypeMonthlyRecurringChecksSpec)super.deepClone();
    }
}
