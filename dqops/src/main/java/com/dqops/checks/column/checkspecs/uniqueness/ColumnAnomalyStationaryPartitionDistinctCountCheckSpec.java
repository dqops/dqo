...
public class ColumnAnomalyStationaryPartitionDistinctCountCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAnomalyStationaryPartitionDistinctCountCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
