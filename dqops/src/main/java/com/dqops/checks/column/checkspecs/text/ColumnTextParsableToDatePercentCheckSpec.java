...
public class ColumnTextParsableToDatePercentCheckSpec
        extends AbstractCheckSpec<ColumnTextTextParsableToDatePercentSensorParametersSpec, MinPercentRule100WarningParametersSpec, MinPercentRule100ErrorParametersSpec, MinPercentRule95ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextParsableToDatePercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnTextTextParsableToDatePercentSensorParametersSpec parameters = new ColumnTextTextParsableToDatePercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnTextTextParsableToDatePercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnTextTextParsableToDatePercentSensorParametersSpec parameters) {
