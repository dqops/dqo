...
public class ColumnAnomalyDifferencingDistinctPercentCheckSpec
        extends AbstractCheckSpec<ColumnUniquenessDistinctPercentSensorParametersSpec, AnomalyDifferencingPercentileMovingAverageRule1ParametersSpec, AnomalyDifferencingPercentileMovingAverageRule05ParametersSpec, AnomalyDifferencingPercentileMovingAverageRule01ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnUniquenessDistinctPercentSensorParametersSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnUniquenessDistinctPercentSensorParametersSpec parameters
            = new ColumnUniquenessDistinctPercentSensorParametersSpec();
