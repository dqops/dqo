...
public class ColumnAnomalyStationaryDistinctPercent30DaysCheckSpec
        extends AbstractCheckSpec<ColumnUniquenessDistinctPercentSensorParametersSpec, AnomalyStationaryPercentileMovingAverage30DaysRule1ParametersSpec, AnomalyStationaryPercentileMovingAverage30DaysRule05ParametersSpec, AnomalyStationaryPercentileMovingAverage30DaysRule01ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAnomalyStationaryDistinctPercent30DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
