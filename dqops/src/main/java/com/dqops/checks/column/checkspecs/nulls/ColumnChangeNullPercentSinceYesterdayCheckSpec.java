...
public class ColumnChangeNullPercentSinceYesterdayCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnChangeNullPercentSinceYesterdayCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
