...
public class ColumnAccuracyTotalNotNullCountMatchPercentCheckSpec
        extends AbstractCheckSpec<ColumnAccuracyTotalNotNullCountMatchPercentSensorParametersSpec, MaxDiffPercentRule0ParametersSpec, MaxDiffPercentRule1ParametersSpec, MaxDiffPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAccuracyTotalNotNullCountMatchPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
     ...
     */
    @Override
    public ColumnAccuracyTotalNotNullCountMatchPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnAccuracyTotalNotNullCountMatchPercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "The maximum difference in percent between the count of not null values of this column and the reference column";
    }
