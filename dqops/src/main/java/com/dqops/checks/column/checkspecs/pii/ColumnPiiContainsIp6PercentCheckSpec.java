 ...
 */
package com.dqops.checks.column.checkspecs.pii;
...
public class ColumnPiiContainsIp6PercentCheckSpec
        extends AbstractCheckSpec<ColumnPiiContainsIp6PercentSensorParametersSpec, MaxPercentRule0WarningParametersSpec, MaxPercentRule0ErrorParametersSpec, MaxPercentRule5ParametersSpec> {
    ...
    public String getFriendlyName() {
        return "Detect IP6 addresses inside text columns";
    }
    ...
    public boolean proposeCheckConfiguration(ProfilingCheckResult sourceProfilingCheck,
        ...
        if (!miningParameters.isApplyPiiChecks()) {
            return false;
        }
