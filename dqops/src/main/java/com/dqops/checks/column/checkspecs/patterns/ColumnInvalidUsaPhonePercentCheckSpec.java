...
public class ColumnInvalidUsaPhonePercentCheckSpec
        extends AbstractCheckSpec<ColumnPatternsInvalidUsaPhoneFormatPercentSensorParametersSpec, MaxPercentRule0WarningParametersSpec, MaxPercentRule0ErrorParametersSpec, MaxPercentRule5ParametersSpec> {

    public static final ChildHierarchyNodeFieldMapImpl<ColumnInvalidUsaPhonePercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnPatternsInvalidUsaPhoneFormatPercentSensorParametersSpec parameters = new ColumnPatternsInvalidUsaPhoneFormatPercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnPatternsInvalidUsaPhoneFormatPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnPatternsInvalidUsaPhoneFormatPercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum percentage of rows containing invalid USA phone number values";
    }
