...
public class ColumnChangeMedianSince7DaysCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnChangeMedianSince7DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
