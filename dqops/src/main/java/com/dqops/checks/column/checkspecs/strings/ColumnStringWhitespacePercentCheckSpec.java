...
import com.dqops.sensors.column.strings.ColumnStringsStringWhitespacePercentSensorParametersSpec;
...
public class ColumnStringWhitespacePercentCheckSpec
        extends AbstractCheckSpec<ColumnStringsStringWhitespacePercentSensorParametersSpec, MaxPercentRule1ParametersSpec, MaxPercentRule2ParametersSpec, MaxPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnStringWhitespacePercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnStringsStringWhitespacePercentSensorParametersSpec parameters = new ColumnStringsStringWhitespacePercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnStringsStringWhitespacePercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnStringsStringWhitespacePercentSensorParametersSpec parameters) {
