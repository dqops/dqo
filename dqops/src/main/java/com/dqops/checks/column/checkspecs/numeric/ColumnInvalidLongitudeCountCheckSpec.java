...
public class ColumnInvalidLongitudeCountCheckSpec
        extends AbstractCheckSpec<ColumnNumericInvalidLongitudeCountSensorParametersSpec, MaxCountRule0WarningParametersSpec, MaxCountRule0ErrorParametersSpec, MaxCountRule100ParametersSpec> {
    ...
    public String getFriendlyName() {
        return "Maximum count of rows containing invalid longitude values";
    }
