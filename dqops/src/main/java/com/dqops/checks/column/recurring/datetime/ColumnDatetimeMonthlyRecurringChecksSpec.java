 ...
 */
package com.dqops.checks.column.recurring.datetime;
...
public class ColumnDatetimeMonthlyRecurringChecksSpec extends AbstractCheckCategorySpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnDatetimeMonthlyRecurringChecksSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckCategorySpec.FIELDS) {
        {
     ...
     */
    @Override
    public ColumnDatetimeMonthlyRecurringChecksSpec deepClone() {
        return (ColumnDatetimeMonthlyRecurringChecksSpec)super.deepClone();
    }
}