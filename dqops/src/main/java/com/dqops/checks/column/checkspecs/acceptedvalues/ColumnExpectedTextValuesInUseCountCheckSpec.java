...
public class ColumnExpectedTextValuesInUseCountCheckSpec
        extends AbstractCheckSpec<ColumnStringsExpectedTextValuesInUseCountSensorParametersSpec, MaxMissingRule0WarningParametersSpec, MaxMissingRule0ErrorParametersSpec, MaxMissingRule2ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnExpectedTextValuesInUseCountCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };

    @JsonPropertyDescription("Data quality check parameters that specify a list of expected text values that must be present in the column.")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    private ColumnStringsExpectedTextValuesInUseCountSensorParametersSpec parameters = new ColumnStringsExpectedTextValuesInUseCountSensorParametersSpec();
     ...
     */
    @Override
    public ColumnStringsExpectedTextValuesInUseCountSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnStringsExpectedTextValuesInUseCountSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum number of expected text values that are not in use";
    }
