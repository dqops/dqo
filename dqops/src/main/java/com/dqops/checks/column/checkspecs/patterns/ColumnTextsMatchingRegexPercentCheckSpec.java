...
public class ColumnTextsMatchingRegexPercentCheckSpec
        extends AbstractCheckSpec<ColumnPatternsTextsMatchingRegexPercentSensorParametersSpec, MinPercentRule100WarningParametersSpec, MinPercentRule100ErrorParametersSpec, MinPercentRule95ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextsMatchingRegexPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnPatternsTextsMatchingRegexPercentSensorParametersSpec parameters = new ColumnPatternsTextsMatchingRegexPercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnPatternsTextsMatchingRegexPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnPatternsTextsMatchingRegexPercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Minimum percent of rows containing texts values matching regex";
    }
