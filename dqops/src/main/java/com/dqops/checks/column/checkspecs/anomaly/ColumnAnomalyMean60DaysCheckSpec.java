...
public class ColumnAnomalyMean60DaysCheckSpec
        extends AbstractCheckSpec<ColumnNumericMeanSensorParametersSpec, PercentileMovingWithin60DaysRuleParametersSpec, PercentileMovingWithin60DaysRuleParametersSpec, PercentileMovingWithin60DaysRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAnomalyMean60DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
