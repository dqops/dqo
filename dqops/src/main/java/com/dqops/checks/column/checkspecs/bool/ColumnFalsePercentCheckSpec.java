...
public class ColumnFalsePercentCheckSpec
        extends AbstractCheckSpec<ColumnBoolFalsePercentSensorParametersSpec, BetweenPercentRuleParametersSpec, BetweenPercentRuleParametersSpec, BetweenPercentRuleParametersSpec> {
    ...
    public String getFriendlyName() {
        return "Percentage of false values in bool column";
    }
