...
import com.dqops.rules.percentile.PercentileMovingWithin7DaysRuleParametersSpec;
...
public class ColumnAnomalyMedian7DaysCheckSpec
        extends AbstractCheckSpec<ColumnNumericMedianSensorParametersSpec, PercentileMovingWithin7DaysRuleParametersSpec, PercentileMovingWithin7DaysRuleParametersSpec, PercentileMovingWithin7DaysRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAnomalyMedian7DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
