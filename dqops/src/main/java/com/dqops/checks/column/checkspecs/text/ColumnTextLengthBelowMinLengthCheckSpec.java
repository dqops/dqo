...
public class ColumnTextLengthBelowMinLengthCheckSpec
        extends AbstractCheckSpec<ColumnTextTextLengthBelowMinLengthCountSensorParametersSpec, MaxCountRule0WarningParametersSpec, MaxCountRule0ErrorParametersSpec, MaxCountRule100ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextLengthBelowMinLengthCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnTextTextLengthBelowMinLengthCountSensorParametersSpec parameters = new ColumnTextTextLengthBelowMinLengthCountSensorParametersSpec();
     ...
     */
    @Override
    public ColumnTextTextLengthBelowMinLengthCountSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnTextTextLengthBelowMinLengthCountSensorParametersSpec parameters) {
