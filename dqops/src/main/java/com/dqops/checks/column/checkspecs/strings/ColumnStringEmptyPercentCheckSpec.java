...
public class ColumnStringEmptyPercentCheckSpec
        extends AbstractCheckSpec<ColumnStringsStringEmptyPercentSensorParametersSpec, MaxPercentRule1ParametersSpec, MaxPercentRule2ParametersSpec, MaxPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnStringEmptyPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnStringsStringEmptyPercentSensorParametersSpec parameters = new ColumnStringsStringEmptyPercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnStringsStringEmptyPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnStringsStringEmptyPercentSensorParametersSpec parameters) {
