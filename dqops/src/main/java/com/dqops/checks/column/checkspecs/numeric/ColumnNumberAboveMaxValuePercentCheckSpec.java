...
public class ColumnNumberAboveMaxValuePercentCheckSpec
    ...
    private ColumnNumericNumberAboveMaxValuePercentSensorParametersSpec parameters = new ColumnNumericNumberAboveMaxValuePercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnNumericNumberAboveMaxValuePercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnNumericNumberAboveMaxValuePercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum percentage of numeric values above the maximum value";
    }
