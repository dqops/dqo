...
import com.dqops.sensors.column.whitespace.ColumnWhitespaceWhitespaceTextPercentSensorParametersSpec;
...
public class ColumnWhitespaceWhitespaceTextPercentCheckSpec
        extends AbstractCheckSpec<ColumnWhitespaceWhitespaceTextPercentSensorParametersSpec, MaxPercentRule0WarningParametersSpec, MaxPercentRule0ErrorParametersSpec, MaxPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnWhitespaceWhitespaceTextPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnWhitespaceWhitespaceTextPercentSensorParametersSpec parameters = new ColumnWhitespaceWhitespaceTextPercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnWhitespaceWhitespaceTextPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnWhitespaceWhitespaceTextPercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum percentage of whitespace values";
    }
    ...
    public boolean proposeCheckConfiguration(ProfilingCheckResult sourceProfilingCheck,
        ...
        if (sourceProfilingCheck.getActualValue() == null && miningParameters.getFailChecksAtPercentErrorRows() > 0.0) {
            ...
            Double percentOfWhitespaceTextsInSamples = columnDataAssetProfilingResults.matchPercentageOfSamples(value -> {
                if (!(value instanceof String)) {
                    return false;
                }

                return value.toString().length() != 0 && value.toString().trim().length() == 0;
            });

            if (percentOfWhitespaceTextsInSamples == null || percentOfWhitespaceTextsInSamples == 0.0) {
                return false;
            }
