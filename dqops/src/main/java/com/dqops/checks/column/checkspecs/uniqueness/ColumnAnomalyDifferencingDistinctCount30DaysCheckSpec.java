...
public class ColumnAnomalyDifferencingDistinctCount30DaysCheckSpec
        extends AbstractCheckSpec<ColumnUniquenessDistinctCountSensorParametersSpec, AnomalyDifferencingPercentileMovingAverage30DaysRule1ParametersSpec, AnomalyDifferencingPercentileMovingAverage30DaysRule05ParametersSpec, AnomalyDifferencingPercentileMovingAverage30DaysRule01ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAnomalyDifferencingDistinctCount30DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
