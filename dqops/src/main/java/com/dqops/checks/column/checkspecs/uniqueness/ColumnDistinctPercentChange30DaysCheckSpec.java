...
public class ColumnDistinctPercentChange30DaysCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnDistinctPercentChange30DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    public String getFriendlyName() {
        return "Maximum relative change in the percentage of distinct values vs 30 days ago";
    }
