...
public class ColumnPiiContainsEmailPercentCheckSpec
        extends AbstractCheckSpec<ColumnPiiContainsEmailPercentSensorParametersSpec, MaxPercentRule0WarningParametersSpec, MaxPercentRule0ErrorParametersSpec, MaxPercentRule5ParametersSpec> {
    ...
    private ColumnPiiContainsEmailPercentSensorParametersSpec parameters = new ColumnPiiContainsEmailPercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnPiiContainsEmailPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnPiiContainsEmailPercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Detect emails inside text columns";
    }
