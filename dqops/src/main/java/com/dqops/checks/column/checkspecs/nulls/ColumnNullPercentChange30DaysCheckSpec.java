...
public class ColumnNullPercentChange30DaysCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnNullPercentChange30DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    public String getFriendlyName() {
        return "Maximum percentage of change in the count of null values vs 30 day ago";
    }
