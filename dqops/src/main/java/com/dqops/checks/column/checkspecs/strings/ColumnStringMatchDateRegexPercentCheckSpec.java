...
public class ColumnStringMatchDateRegexPercentCheckSpec
        extends AbstractCheckSpec<ColumnStringsStringMatchDateRegexPercentSensorParametersSpec, MinPercentRule100WarningParametersSpec, MinPercentRule100ErrorParametersSpec, MinPercentRule95ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnStringMatchDateRegexPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnStringsStringMatchDateRegexPercentSensorParametersSpec parameters = new ColumnStringsStringMatchDateRegexPercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnStringsStringMatchDateRegexPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnStringsStringMatchDateRegexPercentSensorParametersSpec parameters) {
