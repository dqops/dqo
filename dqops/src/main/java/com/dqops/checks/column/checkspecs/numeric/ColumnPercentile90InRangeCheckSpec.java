...
public class ColumnPercentile90InRangeCheckSpec
        extends AbstractCheckSpec<ColumnNumericPercentile90SensorParametersSpec, BetweenFloatsRuleParametersSpec, BetweenFloatsRuleParametersSpec, BetweenFloatsRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnPercentile90InRangeCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnNumericPercentile90SensorParametersSpec parameters = new ColumnNumericPercentile90SensorParametersSpec();
    ...
    @JsonPropertyDescription("Default alerting threshold for a percentile 90 in a column that raises a data quality error (alert).")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
     ...
     */
    @Override
    public ColumnNumericPercentile90SensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnNumericPercentile90SensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "The selected 90th percentile of numeric values is in the range";
    }
