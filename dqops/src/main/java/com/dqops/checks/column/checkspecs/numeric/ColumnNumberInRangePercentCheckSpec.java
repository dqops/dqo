...
public class ColumnNumberInRangePercentCheckSpec
        extends AbstractCheckSpec<ColumnNumericNumberInRangePercentSensorParametersSpec, MinPercentRule100WarningParametersSpec, MinPercentRule100ErrorParametersSpec, MinPercentRule95ParametersSpec> {
    ...
    private ColumnNumericNumberInRangePercentSensorParametersSpec parameters = new ColumnNumericNumberInRangePercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnNumericNumberInRangePercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnNumericNumberInRangePercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum percentage of rows containing numeric values in the range";
    }
