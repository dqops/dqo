...
public class ColumnIntegerInRangePercentCheckSpec
        extends AbstractCheckSpec<ColumnNumericIntegerInRangePercentSensorParametersSpec, MinPercentRule100WarningParametersSpec, MinPercentRule100ErrorParametersSpec, MinPercentRule95ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnIntegerInRangePercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnNumericIntegerInRangePercentSensorParametersSpec parameters = new ColumnNumericIntegerInRangePercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnNumericIntegerInRangePercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnNumericIntegerInRangePercentSensorParametersSpec parameters) {
