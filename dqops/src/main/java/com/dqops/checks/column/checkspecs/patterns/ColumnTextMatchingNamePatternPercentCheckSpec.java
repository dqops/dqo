...
public class ColumnTextMatchingNamePatternPercentCheckSpec
        extends AbstractCheckSpec<ColumnPatternsTextMatchingNamePatternPercentSensorParametersSpec, MinPercentRule100WarningParametersSpec, MinPercentRule100ErrorParametersSpec, MinPercentRule95ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextMatchingNamePatternPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnPatternsTextMatchingNamePatternPercentSensorParametersSpec parameters = new ColumnPatternsTextMatchingNamePatternPercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnPatternsTextMatchingNamePatternPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnPatternsTextMatchingNamePatternPercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Minimum percentage of rows containing texts that are valid names (not numeric)";
    }
