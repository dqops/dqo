...
/**
 * Column-level check that ensures that the percentage of boolean placeholder texts in the monitored column does not fall below set thresholds.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
public class ColumnTextBooleanPlaceholderPercentCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextBooleanPlaceholderPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
