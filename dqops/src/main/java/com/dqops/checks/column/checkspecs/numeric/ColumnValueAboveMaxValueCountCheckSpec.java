...
public class ColumnValueAboveMaxValueCountCheckSpec
        extends AbstractCheckSpec<ColumnNumericValueAboveMaxValueCountSensorParametersSpec, MaxCountRule0WarningParametersSpec, MaxCountRule0ErrorParametersSpec, MaxCountRule100ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnValueAboveMaxValueCountCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnNumericValueAboveMaxValueCountSensorParametersSpec parameters = new ColumnNumericValueAboveMaxValueCountSensorParametersSpec();
     ...
     */
    @Override
    public ColumnNumericValueAboveMaxValueCountSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnNumericValueAboveMaxValueCountSensorParametersSpec parameters) {
