...
public class ColumnAnomalySumChange60DaysCheckSpec
        extends AbstractCheckSpec<ColumnNumericSumSensorParametersSpec, ChangePercentileMovingAverageRuleParametersSpec, ChangePercentileMovingAverageRuleParametersSpec, ChangePercentileMovingAverageRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAnomalySumChange60DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
