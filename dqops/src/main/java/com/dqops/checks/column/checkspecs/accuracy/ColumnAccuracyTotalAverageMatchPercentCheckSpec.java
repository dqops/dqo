...
public class ColumnAccuracyTotalAverageMatchPercentCheckSpec
        extends AbstractCheckSpec<ColumnAccuracyTotalAverageMatchPercentSensorParametersSpec, MaxDiffPercentRule0ParametersSpec, MaxDiffPercentRule1ParametersSpec, MaxDiffPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAccuracyTotalAverageMatchPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnAccuracyTotalAverageMatchPercentSensorParametersSpec parameters = new ColumnAccuracyTotalAverageMatchPercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnAccuracyTotalAverageMatchPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnAccuracyTotalAverageMatchPercentSensorParametersSpec parameters) {
