...
public class ColumnStringLengthBelowMinLengthCountCheckSpec
        extends AbstractCheckSpec<ColumnStringsStringLengthBelowMinLengthCountSensorParametersSpec, MaxCountRule0WarningParametersSpec, MaxCountRule10ParametersSpec, MaxCountRule100ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnStringLengthBelowMinLengthCountCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
