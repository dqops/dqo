...
public class ColumnDatatypeDateMatchFormatPercentCheckSpec
        extends AbstractCheckSpec<ColumnDatatypeDateMatchFormatPercentSensorParametersSpec, MinPercentRule100ParametersSpec, MinPercentRule99ParametersSpec, MinPercentRule95ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnDatatypeDateMatchFormatPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnDatatypeDateMatchFormatPercentSensorParametersSpec parameters = new ColumnDatatypeDateMatchFormatPercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnDatatypeDateMatchFormatPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnDatatypeDateMatchFormatPercentSensorParametersSpec parameters) {
