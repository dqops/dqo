...
public class ColumnAnomalyMeanChange7DaysCheckSpec
        extends AbstractCheckSpec<ColumnNumericMeanSensorParametersSpec, ChangePercentileMovingWithin7DaysRuleParametersSpec, ChangePercentileMovingWithin7DaysRuleParametersSpec, ChangePercentileMovingWithin7DaysRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAnomalyMeanChange7DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
