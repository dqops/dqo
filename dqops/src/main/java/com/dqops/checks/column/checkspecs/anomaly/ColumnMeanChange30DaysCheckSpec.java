...
public class ColumnMeanChange30DaysCheckSpec
        extends AbstractCheckSpec<ColumnNumericMeanSensorParametersSpec, ChangePercent30DaysRule10ParametersSpec, ChangePercent30DaysRule20ParametersSpec, ChangePercent30DaysRule50ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnMeanChange30DaysCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    public String getFriendlyName() {
        return "Maximum relative change in the mean (average) of numeric values vs 30 days ago";
    }
