...
public class ColumnMaxAnomalyDifferencingCheckSpec
        extends AbstractCheckSpec<ColumnNumericMaxSensorParametersSpec, AnomalyDifferencingPercentileMovingAverageRuleWarning1PctParametersSpec, AnomalyDifferencingPercentileMovingAverageRuleError05PctParametersSpec, AnomalyDifferencingPercentileMovingAverageRuleFatal01PctParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnMaxAnomalyDifferencingCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
