...
public class ColumnValidUsaZipcodePercentCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnValidUsaZipcodePercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    public String getFriendlyName() {
        return "Minimum percentage of rows containing USA zip code values";
    }
