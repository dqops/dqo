...
public class ColumnInvalidIp4AddressFormatFoundCheckSpec
        extends AbstractCheckSpec<ColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpec, MaxCountRule0WarningParametersSpec, MaxCountRule0ErrorParametersSpec, MaxCountRule100ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnInvalidIp4AddressFormatFoundCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpec parameters = new ColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpec();
     ...
     */
    @Override
    public ColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum count of rows containing invalid IP4 address values";
    }
