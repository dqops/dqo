...
public class ColumnTextNotMatchingRegexFoundCheckSpec
        extends AbstractCheckSpec<ColumnPatternsTextNotMatchingRegexCountSensorParametersSpec, MaxCountRule0WarningParametersSpec, MaxCountRule0ErrorParametersSpec, MaxCountRule100ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextNotMatchingRegexFoundCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnPatternsTextNotMatchingRegexCountSensorParametersSpec parameters = new ColumnPatternsTextNotMatchingRegexCountSensorParametersSpec();
     ...
     */
    @Override
    public ColumnPatternsTextNotMatchingRegexCountSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnPatternsTextNotMatchingRegexCountSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum count of rows containing texts values not matching regex";
    }
