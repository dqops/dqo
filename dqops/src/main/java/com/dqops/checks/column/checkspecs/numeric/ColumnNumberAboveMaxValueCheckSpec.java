...
public class ColumnNumberAboveMaxValueCheckSpec
        extends AbstractCheckSpec<ColumnNumericNumberAboveMaxValueCountSensorParametersSpec, MaxCountRule0WarningParametersSpec, MaxCountRule0ErrorParametersSpec, MaxCountRule100ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnNumberAboveMaxValueCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnNumericNumberAboveMaxValueCountSensorParametersSpec parameters = new ColumnNumericNumberAboveMaxValueCountSensorParametersSpec();
     ...
     */
    @Override
    public ColumnNumericNumberAboveMaxValueCountSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnNumericNumberAboveMaxValueCountSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Find invalid numeric values above an expected maximum value";
    }
