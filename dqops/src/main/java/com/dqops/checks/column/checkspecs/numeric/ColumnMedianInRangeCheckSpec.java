...
public class ColumnMedianInRangeCheckSpec
        extends AbstractCheckSpec<ColumnNumericMedianSensorParametersSpec, BetweenFloatsRuleParametersSpec, BetweenFloatsRuleParametersSpec, BetweenFloatsRuleParametersSpec> {
    ...
    public String getFriendlyName() {
        return "Median of numeric values is in the range";
    }
