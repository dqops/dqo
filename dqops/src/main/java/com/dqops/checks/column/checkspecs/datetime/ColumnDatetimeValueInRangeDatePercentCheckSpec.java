...
public class ColumnDatetimeValueInRangeDatePercentCheckSpec
    ...
    private ColumnDatetimeValueInRangeDatePercentSensorParametersSpec parameters = new ColumnDatetimeValueInRangeDatePercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnDatetimeValueInRangeDatePercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnDatetimeValueInRangeDatePercentSensorParametersSpec parameters) {
