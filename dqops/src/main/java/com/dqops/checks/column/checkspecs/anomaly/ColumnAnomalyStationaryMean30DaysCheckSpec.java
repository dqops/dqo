...
/**
 * Column level check that ensures that the mean value in a monitored column is within a two-tailed percentile from measurements made during the last 30 days.
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonNaming(PropertyNamingStrategies.SnakeCaseStrategy.class)
@EqualsAndHashCode(callSuper = true)
public class ColumnAnomalyStationaryMean30DaysCheckSpec
        extends AbstractCheckSpec<ColumnNumericMeanSensorParametersSpec, AnomalyStationaryPercentileMovingAverage30DaysRule1ParametersSpec, AnomalyStationaryPercentileMovingAverage30DaysRule05ParametersSpec, AnomalyStationaryPercentileMovingAverage30DaysRule01ParametersSpec> {
