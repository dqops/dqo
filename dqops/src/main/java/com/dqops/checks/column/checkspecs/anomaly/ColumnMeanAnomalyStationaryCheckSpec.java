...
public class ColumnMeanAnomalyStationaryCheckSpec
        extends AbstractCheckSpec<ColumnNumericMeanSensorParametersSpec, AnomalyStationaryPercentileMovingAverageRuleWarning1PctParametersSpec, AnomalyStationaryPercentileMovingAverageRuleError05PctParametersSpec, AnomalyStationaryPercentileMovingAverageRuleFatal01PctParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnMeanAnomalyStationaryCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    public String getFriendlyName() {
        return "Abnormal change in the mean (average) of numeric values. Measured as a percentile of anomalous values.";
    }
