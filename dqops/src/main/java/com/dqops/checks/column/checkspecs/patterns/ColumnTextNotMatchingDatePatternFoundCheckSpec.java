...
public class ColumnTextNotMatchingDatePatternFoundCheckSpec
        extends AbstractCheckSpec<ColumnPatternsTextNotMatchingDatePatternCountSensorParametersSpec, MaxCountRule0WarningParametersSpec, MaxCountRule0ErrorParametersSpec, MaxCountRule100ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextNotMatchingDatePatternFoundCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnPatternsTextNotMatchingDatePatternCountSensorParametersSpec parameters = new ColumnPatternsTextNotMatchingDatePatternCountSensorParametersSpec();
     ...
     */
    @Override
    public ColumnPatternsTextNotMatchingDatePatternCountSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnPatternsTextNotMatchingDatePatternCountSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum count of rows containing texts not matching an expected date pattern";
    }
