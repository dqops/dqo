...
public class ColumnInvalidEmailFormatFoundCheckSpec
        extends AbstractCheckSpec<ColumnPatternsInvalidEmailFormatCountSensorParametersSpec, MaxCountRule0WarningParametersSpec, MaxCountRule0ErrorParametersSpec, MaxCountRule100ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnInvalidEmailFormatFoundCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnPatternsInvalidEmailFormatCountSensorParametersSpec parameters = new ColumnPatternsInvalidEmailFormatCountSensorParametersSpec();
     ...
     */
    @Override
    public ColumnPatternsInvalidEmailFormatCountSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnPatternsInvalidEmailFormatCountSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum count of rows containing emails in invalid format";
    }
