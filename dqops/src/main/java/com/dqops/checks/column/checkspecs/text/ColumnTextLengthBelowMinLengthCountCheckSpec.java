...
public class ColumnTextLengthBelowMinLengthCountCheckSpec
        extends AbstractCheckSpec<ColumnStringsStringLengthBelowMinLengthCountSensorParametersSpec, MaxCountRule0WarningParametersSpec, MaxCountRule0ErrorParametersSpec, MaxCountRule100ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnTextLengthBelowMinLengthCountCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnStringsStringLengthBelowMinLengthCountSensorParametersSpec parameters = new ColumnStringsStringLengthBelowMinLengthCountSensorParametersSpec();
    ...
    @JsonPropertyDescription("Default alerting threshold for a maximum number of rows with strings with a length below the indicated by the user length in a column that raises a data quality error (alert).")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
     ...
     */
    @Override
    public ColumnStringsStringLengthBelowMinLengthCountSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnStringsStringLengthBelowMinLengthCountSensorParametersSpec parameters) {
