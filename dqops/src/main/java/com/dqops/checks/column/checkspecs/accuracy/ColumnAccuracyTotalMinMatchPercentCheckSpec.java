 ...
 */
package com.dqops.checks.column.checkspecs.accuracy;
...
public class ColumnAccuracyTotalMinMatchPercentCheckSpec
        extends AbstractCheckSpec<ColumnAccuracyTotalMinMatchPercentSensorParametersSpec, MaxDiffPercentRule0ParametersSpec, MaxDiffPercentRule1ParametersSpec, MaxDiffPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnAccuracyTotalMinMatchPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnAccuracyTotalMinMatchPercentSensorParametersSpec parameters = new ColumnAccuracyTotalMinMatchPercentSensorParametersSpec();
    ...
    @JsonPropertyDescription("Default alerting threshold for a maximum percentage of difference of min of a table column and of a min of another table column that raises a data quality error (alert).")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
     ...
     */
    @Override
    public ColumnAccuracyTotalMinMatchPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnAccuracyTotalMinMatchPercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "The maximum difference in percent between the minimum value of this column and the reference column";
    }
