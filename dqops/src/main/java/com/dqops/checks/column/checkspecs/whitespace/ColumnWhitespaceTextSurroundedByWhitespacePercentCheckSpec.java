...
public class ColumnWhitespaceTextSurroundedByWhitespacePercentCheckSpec
        extends AbstractCheckSpec<ColumnWhitespaceTextSurroundedByWhitespacePercentSensorParametersSpec, MaxPercentRule0WarningParametersSpec, MaxPercentRule0ErrorParametersSpec, MaxPercentRule5ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnWhitespaceTextSurroundedByWhitespacePercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnWhitespaceTextSurroundedByWhitespacePercentSensorParametersSpec parameters = new ColumnWhitespaceTextSurroundedByWhitespacePercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnWhitespaceTextSurroundedByWhitespacePercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnWhitespaceTextSurroundedByWhitespacePercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Maximum percentage of text surrounded by whitespace characters";
    }
    ...
    public boolean proposeCheckConfiguration(ProfilingCheckResult sourceProfilingCheck,
        ...
        if (sourceProfilingCheck.getActualValue() == null && miningParameters.getFailChecksAtPercentErrorRows() > 0.0) {
            ...
            Double percentOfTextsSurroundedWithWhitespaceInSamples = columnDataAssetProfilingResults.matchPercentageOfSamples(value -> {
                if (!(value instanceof String)) {
                    return false;
                }

                return value.toString().length() != value.toString().trim().length();
            });

            if (percentOfTextsSurroundedWithWhitespaceInSamples == null || percentOfTextsSurroundedWithWhitespaceInSamples == 0.0) {
                return false;
            }
