...
import com.dqops.sensors.column.sql.ColumnSqlConditionPassedPercentSensorParametersSpec;
...
public class ColumnSqlConditionPassedPercentCheckSpec
        extends AbstractCheckSpec<ColumnSqlConditionPassedPercentSensorParametersSpec, MinPercentRule100WarningParametersSpec, MinPercentRule100ErrorParametersSpec, MinPercentRule95ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnSqlConditionPassedPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
