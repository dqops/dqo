...
public class ColumnMinAnomalyDifferencingCheckSpec
        extends AbstractCheckSpec<ColumnNumericMinSensorParametersSpec, AnomalyDifferencingPercentileMovingAverageRuleWarning1PctParametersSpec, AnomalyDifferencingPercentileMovingAverageRuleError05PctParametersSpec, AnomalyDifferencingPercentileMovingAverageRuleFatal01PctParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnMinAnomalyDifferencingCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnNumericMinSensorParametersSpec parameters = new ColumnNumericMinSensorParametersSpec();
     ...
     */
    @Override
    public ColumnNumericMinSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnNumericMinSensorParametersSpec parameters) {
