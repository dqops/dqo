 ...
 */
package com.dqops.checks.column.recurring.numeric;
...
public class ColumnNumericDailyRecurringChecksSpec extends AbstractCheckCategorySpec {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnNumericDailyRecurringChecksSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckCategorySpec.FIELDS) {
        {
     ...
     */
    @Override
    public ColumnNumericDailyRecurringChecksSpec deepClone() {
        return (ColumnNumericDailyRecurringChecksSpec)super.deepClone();
    }
}