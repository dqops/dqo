...
public class ColumnWhitespaceNullPlaceholderTextPercentCheckSpec
    ...
    public static final ChildHierarchyNodeFieldMapImpl<ColumnWhitespaceNullPlaceholderTextPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    public String getFriendlyName() {
        return "Maximum percentage of null placeholder values (i.e., None, n/a, null)";
    }
