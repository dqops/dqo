...
public class ColumnComparisonMinMatchCheckSpec
    ...
    @JsonPropertyDescription("Warning level threshold to raise a data quality incident with a warning severity level when the minimum values in the column in the parent table " +
    ...
    public String getFriendlyName() {
        return "Maximum percentage of difference between minimum values of compared columns";
    }
