...
public class ColumnNumberBelowMinValueCheckSpec
        extends AbstractCheckSpec<ColumnNumericNumberBelowMinValueCountSensorParametersSpec, MaxCountRule0WarningParametersSpec, MaxCountRule0ErrorParametersSpec, MaxCountRule100ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnNumberBelowMinValueCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnNumericNumberBelowMinValueCountSensorParametersSpec parameters = new ColumnNumericNumberBelowMinValueCountSensorParametersSpec();
     ...
     */
    @Override
    public ColumnNumericNumberBelowMinValueCountSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnNumericNumberBelowMinValueCountSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Find invalid numeric values below an expected minimum value";
    }
