...
public class ColumnTextLengthBelowMinLengthPercentCheckSpec
        extends AbstractCheckSpec<ColumnTextTextLengthBelowMinLengthPercentSensorParametersSpec, MaxPercentRule0WarningParametersSpec, MaxPercentRule0ErrorParametersSpec, MaxPercentRule5ParametersSpec> {
    ...
    public String getFriendlyName() {
        return "Measure the percentage of rows containing text values shorter than the minimum accepted length";
    }
