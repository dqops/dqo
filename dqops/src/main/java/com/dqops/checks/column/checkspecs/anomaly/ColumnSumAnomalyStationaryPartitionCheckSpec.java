...
public class ColumnSumAnomalyStationaryPartitionCheckSpec
        extends AbstractCheckSpec<ColumnNumericSumSensorParametersSpec, AnomalyStationaryPercentileMovingAverageRuleWarning1PctParametersSpec, AnomalyStationaryPercentileMovingAverageRuleError05PctParametersSpec, AnomalyStationaryPercentileMovingAverageRuleFatal01PctParametersSpec> {
    ...
    public String getFriendlyName() {
        return "Abnormal change in the sum of numeric values. Measured as a percentile of anomalous values.";
    }
