...
public class ColumnValidUuidFormatPercentCheckSpec
        extends AbstractCheckSpec<ColumnPatternsValidUuidFormatPercentSensorParametersSpec, MinPercentRule100WarningParametersSpec, MinPercentRule100ErrorParametersSpec, MinPercentRule95ParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnValidUuidFormatPercentCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    private ColumnPatternsValidUuidFormatPercentSensorParametersSpec parameters = new ColumnPatternsValidUuidFormatPercentSensorParametersSpec();
     ...
     */
    @Override
    public ColumnPatternsValidUuidFormatPercentSensorParametersSpec getParameters() {
        return parameters;
    }
     ...
     */
    public void setParameters(ColumnPatternsValidUuidFormatPercentSensorParametersSpec parameters) {
    ...
    public String getFriendlyName() {
        return "Minimum percentage of rows containing valid UUID values";
    }
