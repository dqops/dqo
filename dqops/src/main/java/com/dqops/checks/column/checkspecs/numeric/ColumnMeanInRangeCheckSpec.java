...
public class ColumnMeanInRangeCheckSpec
        extends AbstractCheckSpec<ColumnNumericMeanSensorParametersSpec, BetweenFloatsRuleParametersSpec, BetweenFloatsRuleParametersSpec, BetweenFloatsRuleParametersSpec> {
    public static final ChildHierarchyNodeFieldMapImpl<ColumnMeanInRangeCheckSpec> FIELDS = new ChildHierarchyNodeFieldMapImpl<>(AbstractCheckSpec.FIELDS) {
        {
        }
    };
    ...
    @JsonPropertyDescription("Default alerting threshold for a mean in range in a column that raises a data quality error (alert).")
    @JsonInclude(JsonInclude.Include.NON_EMPTY)
    @JsonSerialize(using = IgnoreEmptyYamlSerializer.class)
    ...
    public String getFriendlyName() {
        return "Mean (average) of numeric values is in the range";
    }
