...
export default function SharedCredentailTable({sharedCredentialList, deleteSharedCredential} : TSharedCredentialTableProps) {
  ...
  return (
    ...
    <ConfirmDialog open={selectedSharedCredentialToDelete?.length!==0} onClose={() => setSelectedSharedCredentialToDelete('')} onConfirm={() => deleteSharedCredential(selectedSharedCredentialToDelete)} message={`Are you sure you want to delete ${selectedSharedCredentialToDelete} credential?`}/>
    </tbody>
  )
}
