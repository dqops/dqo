  ...
  return (
    ...
    <>
      ...
      <div className='w-100 px-5 '>
        ...
        {incorrectBinaryText ? <div className='text-red-500 pt-5 text-xl px-5'>Invalid base64 text</div> : null}
        <div className='px-5'>
        <TextArea className='w-250 min-h-50 mt-4' value={textAreaValue} onChange={(e) => setTextAreaValue(e.target.value)}/>
        </div>
    </>
    : 
