            ...
            <div className="col-span-2">
              ...
              <div className="mb-6">
                ...
                <ul className="pl-8 list-disc list-outside">
                  ...
                  <li className="mb-2">
                    <div className="inline-flex items-end">
                      In the list of checks on the right, enable the selected
                      data quality checks by clicking the switch{' '}
                      <img
              ...
              <div className="mb-6">
                ...
                <ul className="pl-8 list-disc list-outside">
                  <li className="mb-2 leading-[2]">
                    The square next to the check name will indicate the results
                    of the check run: Valid, Warning, Error or Fatal{' '}
                    <img
