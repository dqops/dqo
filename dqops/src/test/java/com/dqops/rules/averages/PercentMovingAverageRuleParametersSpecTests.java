...
@SpringBootTest
public class PercentMovingAverageRuleParametersSpecTests extends BaseTest {
    private PercentMovingAverageRuleParametersSpec sut;
    ...
    @BeforeEach
    void setUp() {
		this.sut = new PercentMovingAverageRuleParametersSpec();
