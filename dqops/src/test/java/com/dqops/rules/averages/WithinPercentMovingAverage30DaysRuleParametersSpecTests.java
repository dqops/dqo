...
@SpringBootTest
public class WithinPercentMovingAverage30DaysRuleParametersSpecTests extends BaseTest {
    private WithinPercentMovingAverage30DaysRule5ParametersSpec sut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new WithinPercentMovingAverage30DaysRule5ParametersSpec();
