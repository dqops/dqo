...
@SpringBootTest
public class ChangePercent30DaysRuleParametersSpecTests extends BaseTest {
    private ChangePercent30DaysRule10ParametersSpec sut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new ChangePercent30DaysRule10ParametersSpec();
