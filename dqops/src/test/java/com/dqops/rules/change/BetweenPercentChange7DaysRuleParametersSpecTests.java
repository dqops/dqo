...
@SpringBootTest
public class BetweenPercentChange7DaysRuleParametersSpecTests extends BaseTest {
    private BetweenPercentChange7DaysRuleParametersSpec sut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new BetweenPercentChange7DaysRuleParametersSpec();
