...
@SpringBootTest
public class BetweenChange7DaysRuleParametersSpecTests extends BaseTest {
    private BetweenChange7DaysRuleParametersSpec sut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new BetweenChange7DaysRuleParametersSpec();
