...
@SpringBootTest
public class ChangePercentRule10ParametersSpecTests extends BaseTest {
    private ChangePercentRule10ParametersSpec sut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new ChangePercentRule10ParametersSpec();
