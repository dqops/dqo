...
@SpringBootTest
public class BetweenChange1DayRuleParametersSpecTests extends BaseTest {
    private BetweenChange1DayRuleParametersSpec sut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new BetweenChange1DayRuleParametersSpec();
