...
@SpringBootTest
public class ChangeMultiplyMovingStdevWithin7DaysRuleParametersSpecTests extends BaseTest {
    private ChangeMultiplyMovingStdevWithin7DaysRuleParametersSpec sut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new ChangeMultiplyMovingStdevWithin7DaysRuleParametersSpec();
