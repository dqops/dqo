...
@SpringBootTest
public class ChangeMultiplyMovingStdevWithin60DaysRuleParametersSpecTests extends BaseTest {
    private ChangeMultiplyMovingStdevWithin60DaysRuleParametersSpec sut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new ChangeMultiplyMovingStdevWithin60DaysRuleParametersSpec();
    ...
    void executeRule_whenActualValueIsBelowMaxValueAndAllPastValuesArePresentAndEqual_thenReturnsPassed() {
        ...
        Assertions.assertEquals(305.29, ruleExecutionResult.getLowerBound(), 0.1);
        Assertions.assertEquals(310.25, ruleExecutionResult.getUpperBound(), 0.1);
    }
