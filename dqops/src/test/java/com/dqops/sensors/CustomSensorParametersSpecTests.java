...
@SpringBootTest
public class CustomSensorParametersSpecTests extends BaseTest {
    private CustomSensorParametersSpec sut;
    private YamlSerializer yamlSerializer;

    @BeforeEach
    void setUp() {
        this.sut = new CustomSensorParametersSpec();
    ...
    @Test
    void deserializeCustomSensor_whenPropertiesGiven_thenTheyAreVisibleAsAdditionalProperties() {
        String yaml = "field_1: abc\nfield_2: 20";
        CustomSensorParametersSpec deserialized = this.yamlSerializer.deserialize(yaml, CustomSensorParametersSpec.class);
    ...
    @Test
    void serializeCustomSensor_whenAdditionalPropertiesKnown_thenValuesAreSerialized() {
        ...
        Assertions.assertEquals("# yaml-language-server: $schema=https://cloud.dqops.com/dqo-yaml-schema/CustomSensorParametersSpec-schema.json\nfield_1: abc\nfield_2: 30\n", serialized);
    }
}
