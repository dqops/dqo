...
@SpringBootTest
public class ColumnAcceptedValuesTextFoundInSetPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    private ColumnTextFoundInSetPercentCheckSpec altCheckSpec;
    ...
    void setUp() {
        ...
        ColumnAcceptedValuesTextFoundInSetPercentSensorParametersSpec altSut = (ColumnAcceptedValuesTextFoundInSetPercentSensorParametersSpec) this.sut.deepClone();
        ...
        this.altCheckSpec = new ColumnTextFoundInSetPercentCheckSpec();
