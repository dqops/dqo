...
@SpringBootTest
public class ColumnStringsStringParsableToFloatPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/strings/string_parsable_to_float_percent", this.sut.getSensorDefinitionName());
    }
