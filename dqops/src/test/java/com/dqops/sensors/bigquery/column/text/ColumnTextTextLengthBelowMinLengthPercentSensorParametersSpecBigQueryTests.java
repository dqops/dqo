...
@SpringBootTest
public class ColumnTextTextLengthBelowMinLengthPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/text/text_length_below_min_length_percent", this.sut.getSensorDefinitionName());
    }
