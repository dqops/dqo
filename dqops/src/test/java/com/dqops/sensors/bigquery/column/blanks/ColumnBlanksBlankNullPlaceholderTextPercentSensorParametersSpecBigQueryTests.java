...
@SpringBootTest
public class ColumnBlanksBlankNullPlaceholderTextPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/strings/string_null_placeholder_percent", this.sut.getSensorDefinitionName());
    }
