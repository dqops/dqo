...
@SpringBootTest
public class ColumnTextTextLengthBelowMinLengthCountSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    private String getSubstitutedFilter(String tableName) {
        ...
        return this.checkSpec.getParameters().getFilter() != null ? this.checkSpec.getParameters().getFilter().replace("{alias}", "analyzed_table") : null;
    }
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/text/text_length_below_min_length_count", this.sut.getSensorDefinitionName());
    }
