...
import com.dqops.checks.column.checkspecs.pii.ColumnPiiValidEmailPercentCheckSpec;
...
import com.dqops.sensors.column.pii.ColumnPiiValidEmailPercentSensorParametersSpec;
...
@SpringBootTest
public class ColumnPiiValidEmailPercentSensorParametersSpecBigQueryTests extends BaseTest {
    private ColumnPiiValidEmailPercentSensorParametersSpec sut;
    private final String sensorRegex = "r\"^[A-Za-z_]+[A-Za-z0-9._]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,4}$\"";
    private UserHomeContext userHomeContext;
    private ColumnPiiValidEmailPercentCheckSpec checkSpec;
    private SampleTableMetadata sampleTableMetadata;

    @BeforeEach
    void setUp() {
		this.sut = new ColumnPiiValidEmailPercentSensorParametersSpec();
        ...
        this.checkSpec = new ColumnPiiValidEmailPercentCheckSpec();
    ...
    private SensorExecutionRunParameters getRunParametersRecurring(CheckTimeScale timeScale) {
        return SensorExecutionRunParametersObjectMother.createForTableColumnForRecurringCheck(this.sampleTableMetadata, "email", this.checkSpec, timeScale);
    }
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/pii/valid_email_percent", this.sut.getSensorDefinitionName());
    }
