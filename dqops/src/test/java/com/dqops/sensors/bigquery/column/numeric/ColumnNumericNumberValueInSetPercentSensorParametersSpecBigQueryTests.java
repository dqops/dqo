...
import com.dqops.checks.column.checkspecs.numeric.ColumnNumberValueInSetPercentCheckSpec;
...
import com.dqops.sensors.column.numeric.ColumnNumericNumberValueInSetPercentSensorParametersSpec;
...
@SpringBootTest
public class ColumnNumericNumberValueInSetPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    private ColumnNumberValueInSetPercentCheckSpec altCheckSpec;
    ...
    void setUp() {
        ...
        ColumnNumericNumberValueInSetPercentSensorParametersSpec altSut = (ColumnNumericNumberValueInSetPercentSensorParametersSpec) this.sut.deepClone();
        this.sut.setExpectedValues(new ArrayList<>(){{
            add(12345L); add(123456L); add(1234567L);
        }});
        this.sutValuesAsString = this.sut.getExpectedValues().stream().map(Objects::toString).collect(Collectors.joining(", "));

        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.test_data_values_in_set, ProviderType.bigquery);
        this.userHomeContext = UserHomeContextObjectMother.createInMemoryFileHomeContextForSampleTable(sampleTableMetadata);
        this.checkSpec = new ColumnNumberValueInSetPercentCheckSpec();
        this.checkSpec.setParameters(this.sut);
        this.altCheckSpec = new ColumnNumberValueInSetPercentCheckSpec();
    ...
    private SensorExecutionRunParameters getRunParametersProfilingAlt() {
        return SensorExecutionRunParametersObjectMother.createForTableColumnForProfilingCheck(this.sampleTableMetadata, "length_int", this.altCheckSpec);
    }
