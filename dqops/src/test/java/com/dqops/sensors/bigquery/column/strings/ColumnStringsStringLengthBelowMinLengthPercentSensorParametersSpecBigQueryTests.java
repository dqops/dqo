...
@SpringBootTest
public class ColumnStringsStringLengthBelowMinLengthPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/strings/string_length_below_min_length_percent", this.sut.getSensorDefinitionName());
    }
