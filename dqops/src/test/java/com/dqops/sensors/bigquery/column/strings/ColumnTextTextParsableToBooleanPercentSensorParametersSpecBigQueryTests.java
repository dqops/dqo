...
@SpringBootTest
public class ColumnTextTextParsableToBooleanPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/strings/string_boolean_placeholder_percent", this.sut.getSensorDefinitionName());
    }
