...
public class ColumnPiiContainsIp4PercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void setUp() {
        ...
        this.sampleTableMetadata = SampleTableMetadataObjectMother.createSampleTableMetadataForCsvFile(SampleCsvFileNames.contains_ip4_test, ProviderType.bigquery);
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/pii/contains_ip4_percent", this.sut.getSensorDefinitionName());
    }
