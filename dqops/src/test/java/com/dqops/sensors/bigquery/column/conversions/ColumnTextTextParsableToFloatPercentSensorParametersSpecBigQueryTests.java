 ...
 */
package com.dqops.sensors.bigquery.column.conversions;
...
@SpringBootTest
public class ColumnTextTextParsableToFloatPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/conversions/text_parsable_to_float_percent", this.sut.getSensorDefinitionName());
    }
