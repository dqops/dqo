...
import com.dqops.sensors.column.accuracy.ColumnAccuracyAverageMatchPercentSensorParametersSpec;
...
@SpringBootTest
public class ColumnAccuracyAverageMatchPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/accuracy/average_match_percent", this.sut.getSensorDefinitionName());
    }
