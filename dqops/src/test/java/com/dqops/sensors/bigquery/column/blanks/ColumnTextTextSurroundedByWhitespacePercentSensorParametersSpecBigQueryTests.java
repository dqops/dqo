...
@SpringBootTest
public class ColumnTextTextSurroundedByWhitespacePercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/text/text_surrounded_by_whitespace_percent", this.sut.getSensorDefinitionName());
    }
