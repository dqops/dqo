...
import com.dqops.sensors.column.accuracy.ColumnAccuracyMaxMatchPercentSensorParametersSpec;
...
@SpringBootTest
public class ColumnAccuracyMaxMatchPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/accuracy/max_match_percent", this.sut.getSensorDefinitionName());
    }
