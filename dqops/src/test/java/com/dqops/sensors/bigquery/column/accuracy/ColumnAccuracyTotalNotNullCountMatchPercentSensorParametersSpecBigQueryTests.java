...
@SpringBootTest
public class ColumnAccuracyTotalNotNullCountMatchPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/accuracy/total_not_null_count_match_percent", this.sut.getSensorDefinitionName());
    }
