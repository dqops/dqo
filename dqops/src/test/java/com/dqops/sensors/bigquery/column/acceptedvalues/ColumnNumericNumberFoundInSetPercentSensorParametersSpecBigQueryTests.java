...
@SpringBootTest
public class ColumnNumericNumberFoundInSetPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    private ColumnNumberFoundInSetPercentCheckSpec altCheckSpec;
    ...
    void setUp() {
        ...
        ColumnNumericNumberFoundInSetPercentSensorParametersSpec altSut = (ColumnNumericNumberFoundInSetPercentSensorParametersSpec) this.sut.deepClone();
        ...
        this.altCheckSpec = new ColumnNumberFoundInSetPercentCheckSpec();
