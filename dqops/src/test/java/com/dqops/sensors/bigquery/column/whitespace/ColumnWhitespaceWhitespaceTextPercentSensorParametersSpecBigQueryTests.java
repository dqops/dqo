 ...
 */
package com.dqops.sensors.bigquery.column.whitespace;
...
@SpringBootTest
public class ColumnWhitespaceWhitespaceTextPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/whitespace/whitespace_text_percent", this.sut.getSensorDefinitionName());
    }
