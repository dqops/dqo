...
@SpringBootTest
public class ColumnStringsStringMatchDateRegexPercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/strings/string_match_date_regex_percent", this.sut.getSensorDefinitionName());
    }
