...
@SpringBootTest
public class ColumnWhitespaceTextSurroundedByWhitespacePercentSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/whitespace/text_surrounded_by_whitespace_percent", this.sut.getSensorDefinitionName());
    }
