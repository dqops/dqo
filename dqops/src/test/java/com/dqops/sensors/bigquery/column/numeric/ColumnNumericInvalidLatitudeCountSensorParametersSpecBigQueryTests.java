...
@SpringBootTest
public class ColumnNumericInvalidLatitudeCountSensorParametersSpecBigQueryTests extends BaseTest {
    ...
    void getSensorDefinitionName_whenSensorDefinitionRetrieved_thenEqualsExpectedName() {
        Assertions.assertEquals("column/numeric/invalid_latitude_count", this.sut.getSensorDefinitionName());
    }
    ...
    void renderSensor_whenProfilingNoTimeSeriesNoDataStream_thenRendersCorrectSql() {
        ...
        String target_query = """
            SELECT
                SUM(
                    CASE
                        WHEN %1$s < -90.0 OR %1$s > 90.0 THEN 1
                        ELSE 0
                    END
                ) AS actual_value
