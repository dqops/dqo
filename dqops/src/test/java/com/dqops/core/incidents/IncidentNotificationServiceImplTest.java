...
//    test not to be applied, the combination between global and connection notification is done on the loading stage: loadConfiguration from IncidentNotificationsConfigurationLoaderImpl
//    @Test
