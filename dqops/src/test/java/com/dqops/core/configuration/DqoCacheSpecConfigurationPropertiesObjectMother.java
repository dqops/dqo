...
/**
 * Object mother for {@link DqoCacheSpecConfigurationProperties}
 */
public class DqoCacheSpecConfigurationPropertiesObjectMother {
     ...
     */
    public static DqoCacheSpecConfigurationProperties getDefault() {
        return BeanFactoryObjectMother.getBeanFactory().getBean(DqoCacheSpecConfigurationProperties.class).clone();
    }
     ...
     */
    public static DqoCacheSpecConfigurationProperties getWithCacheEnabledButNoFileSystemWatching() {
        DqoCacheSpecConfigurationProperties cacheSpecConfigurationProperties = new DqoCacheSpecConfigurationProperties();
     ...
     */
    public static DqoCacheSpecConfigurationProperties createWithDisabledCache() {
        DqoCacheSpecConfigurationProperties cacheSpecConfigurationProperties = new DqoCacheSpecConfigurationProperties();
