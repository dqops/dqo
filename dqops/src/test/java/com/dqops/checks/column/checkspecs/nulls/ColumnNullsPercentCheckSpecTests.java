...
@SpringBootTest
public class ColumnNullsPercentCheckSpecTests extends BaseTest {
    private ColumnNullsPercentCheckSpec sut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new ColumnNullsPercentCheckSpec();
    ...
    @Test
    void proposeCheckConfiguration_whenNullPercentPresentFromStatisticsButNoProfilingCheckAndValueIsLow_thenProposesRulesWithMultiplier() {
    ...
    @Test
    void proposeCheckConfiguration_whenNullPercentPresentFromStatisticsButNoProfilingCheckAndValueIsNotRound_thenProposesRulesWithRoundValue() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);

        this.profilingCheckResult.setActualValue(12.23456789);
        this.checkMiningConfiguration.setPercentCheckDeltaRate(0.3);
        ...
        Assertions.assertTrue(proposed);
        Assertions.assertNotNull(this.sut.getError());
        Assertions.assertEquals(15.9, this.sut.getError().getMaxPercent());
    }

    @Test
    void proposeCheckConfiguration_whenNullPercentPresentFromStatisticsButNoProfilingCheckAndValueIsCloseTo100_thenProposesRulesWithMultiplierButBelow100() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);

        this.profilingCheckResult.setActualValue(90.0);
        this.checkMiningConfiguration.setPercentCheckDeltaRate(0.3);
        ...
        Assertions.assertTrue(proposed);
        Assertions.assertNotNull(this.sut.getError());
        Assertions.assertEquals(93.0, this.sut.getError().getMaxPercent());
    }

    @Test
    void proposeCheckConfiguration_whenNullPercentPresentFromStatisticsButMiningParametersDisabledCheck_thenNotProposesRules() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
    ...
    @Test
    void proposeCheckConfiguration_whenNullPercentPresentFromProfilingCheckThatHasNoRules_thenProposesRules() {
    ...
    @Test
    void proposeCheckConfiguration_whenNullPercentPresentFromProfilingCheckThatHasNoRulesAndMaxPercentWas0_thenProposesRulesMaxPercent0() {
        CheckModel profilingCheckModel = CheckModelObjectMother.createCheckModel(this.profilingSut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
        this.profilingCheckResult.importCheckModel(profilingCheckModel);
    ...
    @Test
    void proposeCheckConfiguration_whenNullPercentPresentAndProfilingCheckHasRulesAndTargetIsMonitoringCheck_thenCopiesRules() {
        this.profilingSut = new ColumnNullsPercentCheckSpec();
        this.columnSpec.getProfilingChecks().getNulls().setProfileNullsPercent(this.profilingSut);
        ...
        this.columnSpec.getMonitoringChecks().getDaily().getNulls().setDailyNullsPercent(this.sut);
