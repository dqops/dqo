...
@SpringBootTest
public class ColumnDuplicateCountCheckSpecTests extends BaseTest {
    private ColumnDuplicateCountCheckSpec sut;
    private TableSpec tableSpec;
    private ColumnSpec columnSpec;
    private ConnectionSpec connectionSpec;
    private ColumnDuplicateCountCheckSpec profilingSut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new ColumnDuplicateCountCheckSpec();
        ...
        this.columnSpec.getProfilingChecks().getUniqueness().setProfileDuplicateCount(this.profilingSut);
    ...
    @Test
    void proposeCheckConfiguration_whenDuplicateCountPresentFromStatisticsButNoProfilingCheckAndDuplicateCountBelowErrorRateAndFarBelowNotNullCount_thenProposesCheckValueWithMaxCount0() {
    ...
    @Test
    void proposeCheckConfiguration_whenDuplicateCountPresentFromStatisticsButNoProfilingCheckAndDuplicateCountBelowErrorRateAndNotNullsCountNotRepresentative_thenNotProposesCheck() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);

        this.profilingCheckResult.setActualValue(1.0);
        this.dataAssetProfilingResults.setNotNullsCount(90L);
        this.tableProfilingResults.setRowCount(90L);
        this.checkMiningParametersModel.setFailChecksAtPercentErrorRows(2.0);
    ...
    @Test
    void proposeCheckConfiguration_whenDuplicateCountPresentFromStatisticsButNoProfilingCheckAndDuplicateCountAbveErrorRateAndNotNullsCountHing_thenNotProposesCheckToAvoidFailing() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);

        this.profilingCheckResult.setActualValue(100.0);
        this.dataAssetProfilingResults.setNotNullsCount(1001L);
        this.tableProfilingResults.setRowCount(1001L);
        this.checkMiningParametersModel.setFailChecksAtPercentErrorRows(2.0);
    ...
    @Test
    void proposeCheckConfiguration_whenDuplicateCountPresentFromStatisticsButMiningParametersDisabledCheck_thenNotProposesRules() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
    ...
    @Test
    void proposeCheckConfiguration_whenDuplicateCountPresentFromProfilingCheckThatHasNoRules_thenProposesRules() {
    ...
    @Test
    void proposeCheckConfiguration_whenDuplicateCountPresentAndProfilingCheckHasRulesAndTargetIsMonitoringCheck_thenCopiesRules() {
        this.profilingSut = new ColumnDuplicateCountCheckSpec();
        this.columnSpec.getProfilingChecks().getUniqueness().setProfileDuplicateCount(this.profilingSut);
        this.profilingSut.setWarning(new MaxCountRule0WarningParametersSpec(0L));
        this.profilingSut.setError(new MaxCountRule0ErrorParametersSpec(5L));
        ...
        this.columnSpec.getMonitoringChecks().getDaily().getUniqueness().setDailyDuplicateCount(this.sut);
        ...
        Assertions.assertTrue(proposed);
        Assertions.assertNotNull(this.sut.getError());
        Assertions.assertEquals(0L, this.sut.getWarning().getMaxCount());
        Assertions.assertEquals(5L, this.sut.getError().getMaxCount());
    }
}
