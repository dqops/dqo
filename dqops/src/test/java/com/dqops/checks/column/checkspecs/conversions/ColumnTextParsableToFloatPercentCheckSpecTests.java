...
import com.dqops.checks.column.profiling.ColumnConversionsProfilingChecksSpec;
...
@SpringBootTest
public class ColumnTextParsableToFloatPercentCheckSpecTests extends BaseTest {
    private ColumnTextParsableToFloatPercentCheckSpec sut;
    private TableSpec tableSpec;
    private ColumnSpec columnSpec;
    private ConnectionSpec connectionSpec;
    private ColumnTextParsableToFloatPercentCheckSpec profilingSut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new ColumnTextParsableToFloatPercentCheckSpec();
        ...
        this.columnSpec.getProfilingChecks().setConversions(new ColumnConversionsProfilingChecksSpec());
        this.columnSpec.getProfilingChecks().getConversions().setProfileTextParsableToFloatPercent(this.profilingSut);
    ...
    @Test
    void proposeCheckConfiguration_whenTextParsableToFloatPercentWithNoProfilingCheckResultAndRequiresZeroErrorsAndNoSamples_thenNotProposesCheckBecauseNoSamples() {
    ...
    @Test
    void proposeCheckConfiguration_whenTextParsableToFloatPercentWithNoProfilingCheckResultAndAcceptsAboveZeroErrorsErrorsAndNoSamples_thenNotProposesCheckBecauseNoSamples() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
    ...
    @Test
    void proposeCheckConfiguration_whenTextParsableToFloatPercentWithNoProfilingCheckResultAndMaxErrors0PctAndSamplesContainOnlyValidValues_thenProposesCheckSelectedConfiguration() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);

        this.profilingCheckResult.setActualValue(null);
        this.dataAssetProfilingResults.getSampleValues().add(new ProfilingSampleValue("-20.3", 1000L, null));
        this.dataAssetProfilingResults.getSampleValues().add(new ProfilingSampleValue("1", 4000L, null));
        this.dataAssetProfilingResults.setNotNullsCount(5000L);
        this.checkMiningParametersModel.setFailChecksAtPercentErrorRows(0.0);
    ...
    @Test
    void proposeCheckConfiguration_whenTextParsableToFloatPercentWithNoProfilingCheckResultAndMaxErrors0PctAndSamplesContainOnlySomeValidValues_thenNotProposesCheckBecauseErrorsAlreadyFound() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);

        this.profilingCheckResult.setActualValue(null);
        this.dataAssetProfilingResults.getSampleValues().add(new ProfilingSampleValue("34.9", 1000L, null));
    ...
    @Test
    void proposeCheckConfiguration_whenTextParsableToFloatPercentWithNoProfilingCheckResultAndMaxErrors5PctAndSamplesContainEnoughValidValues_thenProposesCheckSelectedConfiguration() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);

        this.profilingCheckResult.setActualValue(null);
        this.dataAssetProfilingResults.getSampleValues().add(new ProfilingSampleValue("-33.422", 1000L, null));
    ...
    @Test
    void proposeCheckConfiguration_whenTextParsableToFloatPercentPresentFromProfilingCheckThatHasNoRulesAndPercentLowAndBelowMaxErrorRate_thenProposesRulesWithMinPercent100() {
    ...
    @Test
    void proposeCheckConfiguration_whenTextParsableToFloatPercentPresentFromProfilingCheckThatHasNoRulesAndPercentBelowMaxPercentErrorsAccepted_thenNotProposesRules() {
        CheckModel profilingCheckModel = CheckModelObjectMother.createCheckModel(this.profilingSut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
        this.profilingCheckResult.importCheckModel(profilingCheckModel);
    ...
    @Test
    void proposeCheckConfiguration_whenTextParsableToFloatPercentPresentFromProfilingCheckThatHasNoRulesAndPercentBelowMaxPercentErrorsAcceptedButAboveMaxExpectedError_thenProposesRulesWithMaxPercentToFit() {
        CheckModel profilingCheckModel = CheckModelObjectMother.createCheckModel(this.profilingSut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
        this.profilingCheckResult.importCheckModel(profilingCheckModel);
    ...
    @Test
    void proposeCheckConfiguration_whenTextParsableToFloatPercentNoProfilingCheckAndValidSampleValueButColumnTypeNotText_thenNotProposesRules() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
    ...
    @Test
    void proposeCheckConfiguration_whenTextParsableToFloatPercentPresentFromProfilingCheckButMiningParametersDisabledCheck_thenNotProposesRules() {
        CheckModel profilingCheckModel = CheckModelObjectMother.createCheckModel(this.profilingSut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
        this.profilingCheckResult.importCheckModel(profilingCheckModel);
        ...
        this.checkMiningParametersModel.setFailChecksAtPercentErrorRows(2.0);
        this.checkMiningParametersModel.setProposeTextConversionChecks(false);
    ...
    @Test
    void proposeCheckConfiguration_whenTextParsableToFloatPercentPresentAndProfilingCheckHasRulesAndTargetIsMonitoringCheck_thenCopiesRules() {
        this.profilingSut = new ColumnTextParsableToFloatPercentCheckSpec();
        this.columnSpec.getProfilingChecks().getConversions().setProfileTextParsableToFloatPercent(this.profilingSut);
        ...
        this.columnSpec.getMonitoringChecks().getDaily().setConversions(new ColumnConversionsDailyMonitoringChecksSpec());
        this.columnSpec.getMonitoringChecks().getDaily().getConversions().setDailyTextParsableToFloatPercent(this.sut);
