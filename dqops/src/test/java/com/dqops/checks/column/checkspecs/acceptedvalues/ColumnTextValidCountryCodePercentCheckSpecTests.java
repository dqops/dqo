...
@SpringBootTest
public class ColumnTextValidCountryCodePercentCheckSpecTests extends BaseTest {
    private ColumnTextValidCountryCodePercentCheckSpec sut;
    private TableSpec tableSpec;
    private ColumnSpec columnSpec;
    private ConnectionSpec connectionSpec;
    private ColumnTextValidCountryCodePercentCheckSpec profilingSut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new ColumnTextValidCountryCodePercentCheckSpec();
        ...
        this.columnSpec.getProfilingChecks().getAcceptedValues().setProfileTextValidCountryCodePercent(this.profilingSut);
    ...
    @Test
    void proposeCheckConfiguration_whenTextValidCountryCodePercentWithNoProfilingCheckResultAndRequiresZeroErrorsAndNoSamples_thenNotProposesCheckBecauseNoSamples() {
    ...
    @Test
    void proposeCheckConfiguration_whenTextValidCountryCodePercentWithNoProfilingCheckResultAndAcceptsAboveZeroErrorsErrorsAndNoSamples_thenNotProposesCheckBecauseNoSamples() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
    ...
    @Test
    void proposeCheckConfiguration_whenTextValidCountryCodePercentWithNoProfilingCheckResultAndMaxErrors0PctAndSamplesContainOnlyValidValues_thenProposesCheckSelectedConfiguration() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);

        this.profilingCheckResult.setActualValue(null);
        this.dataAssetProfilingResults.getSampleValues().add(new ProfilingSampleValue("PL", 1000L, null));
        this.dataAssetProfilingResults.setNotNullsCount(5000L);
        this.checkMiningParametersModel.setFailChecksAtPercentErrorRows(0.0);
    ...
    @Test
    void proposeCheckConfiguration_whenTextValidCountryCodePercentWithNoProfilingCheckResultAndMaxErrors0PctAndSamplesContainOnlySomeValidValues_thenNotProposesCheckBecauseErrorsAlreadyFound() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
    ...
    @Test
    void proposeCheckConfiguration_whenTextValidCountryCodePercentWithNoProfilingCheckResultAndMaxErrors5PctAndSamplesContainEnoughValidValues_thenProposesCheckSelectedConfiguration() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
    ...
    @Test
    void proposeCheckConfiguration_whenTextValidCountryCodePercentPresentFromProfilingCheckThatHasNoRulesAndPercentLowAndBelowMaxErrorRate_thenProposesRulesWithMinPercent100() {
    ...
    @Test
    void proposeCheckConfiguration_whenTextValidCountryCodePercentPresentFromProfilingCheckThatHasNoRulesAndPercentBelowMaxPercentErrorsAccepted_thenNotProposesRules() {
        CheckModel profilingCheckModel = CheckModelObjectMother.createCheckModel(this.profilingSut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
        this.profilingCheckResult.importCheckModel(profilingCheckModel);
    ...
    @Test
    void proposeCheckConfiguration_whenTextValidCountryCodePercentPresentFromProfilingCheckThatHasNoRulesAndPercentBelowMaxPercentErrorsAcceptedButAboveMaxExpectedError_thenProposesRulesWithMaxPercentToFit() {
        CheckModel profilingCheckModel = CheckModelObjectMother.createCheckModel(this.profilingSut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
        this.profilingCheckResult.importCheckModel(profilingCheckModel);
    ...
    @Test
    void proposeCheckConfiguration_whenTextValidCountryCodePercentNoProfilingCheckAndValidSampleValueButColumnTypeNotText_thenNotProposesRules() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
    ...
    @Test
    void proposeCheckConfiguration_whenTextValidCountryCodePercentPresentFromProfilingCheckButMiningParametersDisabledCheck_thenNotProposesRules() {
        CheckModel profilingCheckModel = CheckModelObjectMother.createCheckModel(this.profilingSut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
        this.profilingCheckResult.importCheckModel(profilingCheckModel);
    ...
    @Test
    void proposeCheckConfiguration_whenTextValidCountryCodePercentPresentAndProfilingCheckHasRulesAndTargetIsMonitoringCheck_thenCopiesRules() {
        this.profilingSut = new ColumnTextValidCountryCodePercentCheckSpec();
        this.columnSpec.getProfilingChecks().getAcceptedValues().setProfileTextValidCountryCodePercent(this.profilingSut);
        ...
        this.columnSpec.getMonitoringChecks().getDaily().getAcceptedValues().setDailyTextValidCountryCodePercent(this.sut);
