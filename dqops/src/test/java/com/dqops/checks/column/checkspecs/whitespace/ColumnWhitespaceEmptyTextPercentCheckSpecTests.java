...
@SpringBootTest
public class ColumnWhitespaceEmptyTextPercentCheckSpecTests extends BaseTest {
    private ColumnWhitespaceEmptyTextPercentCheckSpec sut;
    private TableSpec tableSpec;
    private ColumnSpec columnSpec;
    private ConnectionSpec connectionSpec;
    private ColumnWhitespaceEmptyTextPercentCheckSpec profilingSut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new ColumnWhitespaceEmptyTextPercentCheckSpec();
        ...
        this.columnSpec.getProfilingChecks().getWhitespace().setProfileEmptyTextPercent(this.profilingSut);
    ...
    @Test
    void proposeCheckConfiguration_whenEmptyTextPercentWithNoProfilingCheckResultAndRequiresZeroErrorsAndNoSamples_thenNotProposesCheckBecauseNoSamples() {
    ...
    @Test
    void proposeCheckConfiguration_whenEmptyTextPercentWithNoProfilingCheckResultAndAcceptsAboveZeroErrorsErrorsAndNoSamples_thenNotProposesCheckBecauseNoSamples() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
    ...
    @Test
    void proposeCheckConfiguration_whenEmptyTextPercentWithNoProfilingCheckResultAndNoMinTextLengthStatisticsAndMaxErrors0PctAndSamplesContainOnlyValidValues_thenNotProposesCheck() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
    ...
    @Test
    void proposeCheckConfiguration_whenEmptyTextPercentWithNoProfilingCheckResultAndMaxErrors0PctAndSamplesContainOnlySomeInvalidValues_thenNotProposesCheckBecauseErrorsAlreadyFound() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
    ...
    @Test
    void proposeCheckConfiguration_whenEmptyTextPercentWithNoProfilingCheckResultAndMaxErrors5PctAndSamplesContainSomeEmptyValues_thenProposesCheckSelectedConfiguration() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
    ...
    @Test
    void proposeCheckConfiguration_whenEmptyTextPercentWithNoProfilingCheckResultAndMaxErrors5PctAndSamplesContainValidValuesButStatisticsFoundMinTextLength0_thenProposesCheckSelectedConfiguration() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);

        this.profilingCheckResult.setActualValue(null);
        this.dataAssetProfilingResults.getBasicStatisticsForSensor(ColumnTextTextMinLengthStatisticsCollectorSpec.SENSOR_NAME, true)
                .add(new StatisticsMetricModel(0.0, Instant.now(), null));
        this.dataAssetProfilingResults.getSampleValues().add(new ProfilingSampleValue("contact@dqops.com", 1000L, null));
        this.dataAssetProfilingResults.getSampleValues().add(new ProfilingSampleValue("valid", 10L, null));
        this.dataAssetProfilingResults.setNotNullsCount(5000L);
        this.checkMiningParametersModel.setFailChecksAtPercentErrorRows(5.0);
    ...
    @Test
    void proposeCheckConfiguration_whenEmptyTextPercentPresentFromProfilingCheckThatHasNoRulesAndPercentLowAndBelowMaxErrorRate_thenProposesRulesWithMinPercent100() {
    ...
    @Test
    void proposeCheckConfiguration_whenEmptyTextPercentPresentFromProfilingCheckThatHasNoRulesAndPercentBelowMaxPercentErrorsAccepted_thenNotProposesRules() {
        CheckModel profilingCheckModel = CheckModelObjectMother.createCheckModel(this.profilingSut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
        this.profilingCheckResult.importCheckModel(profilingCheckModel);
    ...
    @Test
    void proposeCheckConfiguration_whenEmptyTextPercentPresentFromProfilingCheckThatHasNoRulesAndPercentBelowMaxPercentErrorsAcceptedButAboveMaxExpectedError_thenProposesRulesWithMaxPercentToFit() {
        CheckModel profilingCheckModel = CheckModelObjectMother.createCheckModel(this.profilingSut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
        this.profilingCheckResult.importCheckModel(profilingCheckModel);
    ...
    @Test
    void proposeCheckConfiguration_whenEmptyTextPercentNoProfilingCheckAndValidSampleValueButColumnTypeNotText_thenNotProposesRules() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
    ...
    @Test
    void proposeCheckConfiguration_whenEmptyTextPercentPresentFromProfilingCheckButMiningParametersDisabledCheck_thenNotProposesRules() {
        CheckModel profilingCheckModel = CheckModelObjectMother.createCheckModel(this.profilingSut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
        this.profilingCheckResult.importCheckModel(profilingCheckModel);
    ...
    @Test
    void proposeCheckConfiguration_whenEmptyTextPercentPresentAndProfilingCheckHasRulesAndTargetIsMonitoringCheck_thenCopiesRules() {
        this.profilingSut = new ColumnWhitespaceEmptyTextPercentCheckSpec();
        this.columnSpec.getProfilingChecks().getWhitespace().setProfileEmptyTextPercent(this.profilingSut);
        ...
        this.columnSpec.getMonitoringChecks().getDaily().getWhitespace().setDailyEmptyTextPercent(this.sut);
