...
@SpringBootTest
public class ColumnTruePercentCheckSpecTests extends BaseTest {
    private ColumnTruePercentCheckSpec sut;
    private TableSpec tableSpec;
    private ColumnSpec columnSpec;
    private ConnectionSpec connectionSpec;
    private ColumnTruePercentCheckSpec profilingSut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new ColumnTruePercentCheckSpec();
        ...
        this.columnSpec.getProfilingChecks().getBool().setProfileTruePercent(this.profilingSut);
        this.profilingCheckResult = new ProfilingCheckResult();
        this.profilingCheckResult.setSensorName("column/bool/true_percent");
    ...
    @Test
    void proposeCheckConfiguration_whenTruePercentPresentFromSampleValuesInStatisticsButNoProfilingCheckAndPercentNullsIsLowAndNotNullCountIsVeryLow_thenNotProposesCheckValueBecauseWeKnowTooLittle() {
        ...
        this.dataAssetProfilingResults.getSampleValues().add(new ProfilingSampleValue(true, 10L, null));
        this.dataAssetProfilingResults.getSampleValues().add(new ProfilingSampleValue(false, 80L, null));
    ...
    @Test
    void proposeCheckConfiguration_whenTruePercentPresentFromSamplesInStatisticsButNoProfilingCheckAndPercentBoolIsLowAndNotNulCountJustAboveThreshold_thenProposesCheckCalculatingFromStats() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);

        this.profilingCheckResult.setActualValue(null);
        this.dataAssetProfilingResults.getSampleValues().add(new ProfilingSampleValue(true, 5L, null));
        this.dataAssetProfilingResults.getSampleValues().add(new ProfilingSampleValue(false, 96L, null));
    ...
    @Test
    void proposeCheckConfiguration_whenTruePercentPresentFromSamplesInStatisticsButNoProfilingCheckAndNotNullsCountAboveThresholdAndPercentTrueAbove50_thenNotProposesCheckBecauseWeProposeFalse() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);

        this.profilingCheckResult.setActualValue(null);
        this.dataAssetProfilingResults.getSampleValues().add(new ProfilingSampleValue(true, 9500L, null));
        this.dataAssetProfilingResults.getSampleValues().add(new ProfilingSampleValue(false, 500L, null));
    ...
    @Test
    void proposeCheckConfiguration_whenPercentTruePercentPresentFromSamplesInStatisticsButMiningParametersDisabledCheck_thenNotProposesRules() {
        CheckModel myCheckModel = CheckModelObjectMother.createCheckModel(this.sut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
    ...
    @Test
    void proposeCheckConfiguration_whenPercentTruePercentPresentFromProfilingCheckThatHasNoRulesAndPercentBelow50_thenProposesRules() {
    ...
    @Test
    void proposeCheckConfiguration_whenPercentTruePercentPresentFromProfilingCheckThatHasNoRulesAndPercentAbove50_thenNotProposesRules() {
        CheckModel profilingCheckModel = CheckModelObjectMother.createCheckModel(this.profilingSut, this.columnSpec.getProfilingChecks(),
                this.connectionSpec, this.tableSpec);
        this.profilingCheckResult.importCheckModel(profilingCheckModel);
    ...
    @Test
    void proposeCheckConfiguration_whenTruePercentPercentPresentAndProfilingCheckHasRulesAndTargetIsMonitoringCheck_thenCopiesRules() {
        this.profilingSut = new ColumnTruePercentCheckSpec();
        this.columnSpec.getProfilingChecks().getBool().setProfileTruePercent(this.profilingSut);
        ...
        this.columnSpec.getMonitoringChecks().getDaily().getBool().setDailyTruePercent(this.sut);
