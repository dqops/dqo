...
@SpringBootTest
public class TableDataIngestionDelayCheckSpecTests extends BaseTest {
    private TableDataIngestionDelayCheckSpec sut;
    private TableSpec tableSpec;
    private ConnectionSpec connectionSpec;
    private TableDataIngestionDelayCheckSpec profilingSut;
    ...
    @BeforeEach
    void setUp() {
        this.sut = new TableDataIngestionDelayCheckSpec();
        ...
        this.tableSpec.getProfilingChecks().getTimeliness().setProfileDataIngestionDelay(this.profilingSut);
    ...
    void proposeCheckConfiguration_whenRowCountPresentAndProfilingCheckHasRulesAndTargetIsMonitoringCheck_thenCopiesRules() {
        this.profilingSut = new TableDataIngestionDelayCheckSpec();
        this.tableSpec.getProfilingChecks().getTimeliness().setProfileDataIngestionDelay(this.profilingSut);
        ...
        this.tableSpec.getMonitoringChecks().getDaily().getTimeliness().setDailyDataIngestionDelay(this.sut);
