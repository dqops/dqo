...
from ...models.error_samples_list_model import ErrorSamplesListModel
...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/monitoring/{timeScale}/errorsamples/download".format(
...
) -> Optional[List["ErrorSamplesListModel"]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ErrorSamplesListModel.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[List["ErrorSamplesListModel"]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """getMonitoringProfilingErrorSamplesDownload

     Returns error samples in CSV format related to a column level monitoring checks at a requested time
    scale
