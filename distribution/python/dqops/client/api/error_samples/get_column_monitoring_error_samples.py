...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/monitoring/{timeScale}/errorsamples".format(
...
def sync_detailed(
    ...
    *,
    ...
    """getColumnMonitoringErrorSamples
