...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/monitoring/{timeScale}/errorsamples/download".format(
...
def sync_detailed(
    ...
    *,
    ...
    """getTableMonitoringErrorSamplesDownload

     Returns the error samples in CSV format related to a table level monitoring check a requested time
    scale
