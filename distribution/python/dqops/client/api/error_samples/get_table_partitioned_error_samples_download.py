...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/partitioned/{timeScale}/errorsamples/download".format(
...
def sync_detailed(
    ...
    *,
    ...
    """getTablePartitionedErrorSamplesDownload

     Returns error samples in CSV format related to a table level partitioned check for a requested time
    scale
