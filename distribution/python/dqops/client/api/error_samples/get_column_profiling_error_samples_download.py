...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/profiling/errorsamples/download".format(
...
def sync_detailed(
    ...
    *,
    ...
    """getColumnProfilingErrorSamplesDownload

     Returns the error samples in CSV format related to a check for one of table level data quality
