...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/profiling/errorsamples".format(
...
def sync_detailed(
    ...
    *,
    ...
    """getTableProfilingErrorSamples

     Returns the error samples related to a check for all table level data quality profiling checks on a
    table
