...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/partitioned/{timeScale}/errorsamples/download".format(
...
def sync_detailed(
    ...
    *,
    ...
    """getPartitionedProfilingErrorSamplesDownload

     Returns the error samples in CSV format related to column level partitioned checks for a requested
    time scale
