...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List['TableRemoteBasicModel']]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List['TableRemoteBasicModel']]:
    return Response(
