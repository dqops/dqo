...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[CheckSpecModel]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[CheckSpecModel]:
    return Response(
