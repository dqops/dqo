...
from ...models.get_schema_profiling_checks_ui_check_target import (
...
def _get_kwargs(
    ...
    *,
    ...
    check_target: Union[Unset, None, GetSchemaProfilingChecksUICheckTarget] = UNSET,
    check_category: Union[Unset, None, str] = UNSET,
    check_name: Union[Unset, None, str] = UNSET,
    check_enabled: Union[Unset, None, bool] = UNSET,
) -> Dict[str, Any]:
    url = (
        "{}/api/connections/{connectionName}/schemas/{schemaName}/profiling/ui".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        check_target (Union[Unset, None, GetSchemaProfilingChecksUICheckTarget]):
