...
def _get_kwargs(
    connection_name: str,
    schema_name: str,
    time_scale: GetSchemaRecurringChecksModelTimeScale,
    *,
    client: Client,
    ...
    check_target: Union[Unset, None, GetSchemaRecurringChecksModelCheckTarget] = UNSET,
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        check_target (Union[Unset, None, GetSchemaRecurringChecksModelCheckTarget]):
