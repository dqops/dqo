...
from ...models.get_schema_monitoring_checks_templates_check_target import (
    GetSchemaMonitoringChecksTemplatesCheckTarget,
)
from ...models.get_schema_monitoring_checks_templates_time_scale import (
...
def _get_kwargs(
    connection_name: str,
    schema_name: str,
    time_scale: GetSchemaMonitoringChecksTemplatesTimeScale,
    *,
    client: AuthenticatedClient,
    check_target: Union[
        Unset, None, GetSchemaMonitoringChecksTemplatesCheckTarget
    ] = UNSET,
    check_category: Union[Unset, None, str] = UNSET,
    check_name: Union[Unset, None, str] = UNSET,
) -> Dict[str, Any]:
    url = "{}api/connections/{connectionName}/schemas/{schemaName}/bulkenable/monitoring/{timeScale}".format(
        client.base_url,
...
def sync_detailed(
    ...
    *,
    ...
    """getSchemaMonitoringChecksTemplates
    ...
    Args:
        ...
        schema_name (str):
        time_scale (GetSchemaMonitoringChecksTemplatesTimeScale):
        check_target (Union[Unset, None, GetSchemaMonitoringChecksTemplatesCheckTarget]):
