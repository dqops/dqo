...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[ConnectionModel]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[ConnectionModel]:
    return Response(
