...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/groupings/{groupingConfigurationName}".format(
        client.base_url,connectionName=connection_name,schemaName=schema_name,tableName=table_name,groupingConfigurationName=grouping_configuration_name)
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[DataGroupingConfigurationModel]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[DataGroupingConfigurationModel]:
    return Response(
