...
from ...models.get_table_comparison_recurring_results_time_scale import (
...
def _get_kwargs(
    ...
    schema_name: str,
    table_name: str,
    time_scale: GetTableComparisonRecurringResultsTimeScale,
    table_comparison_configuration_name: str,
    *,
    client: Client,
) -> Dict[str, Any]:
    url = "{}api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/recurring/{timeScale}/comparisons/{tableComparisonConfigurationName}/results".format(
        client.base_url,
...
def sync_detailed(
    ...
    *,
    ...
    """getTableComparisonRecurringResults
