...
def _get_kwargs(
    pattern_name: str,
    *,
    json_body: DefaultTableChecksPatternModel,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    """updateDefaultTableChecksPattern

     Updates an default table-level checks pattern by saving a full specification object

    Args:
        pattern_name (str):
        json_body (DefaultTableChecksPatternModel): Default table-level checks pattern model
