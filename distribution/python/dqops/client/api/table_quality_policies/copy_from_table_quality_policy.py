...
def _get_kwargs(
    ...
    return {
        "method": "post",
        "url": "api/policies/checks/table/{targetPatternName}/copyfrom/{sourcePatternName}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """copyFromTableQualityPolicy

     Creates (adds) a copy of an existing default table-level checks pattern configuration (data quality
