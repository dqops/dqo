...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "put",
        "url": "api/policies/checks/table/{patternName}/monitoring/monthly".format(
...
def sync_detailed(
    ...
    *,
    ...
    """updateMonitoringMonthlyTableQualityPolicy
     ...
     New configuration of the default monthly monitoring checks on a table level. These checks will be
    applied to tables.
