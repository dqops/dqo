...
def sync_detailed(
    ...
    *,
    ...
    """createTableQualityPolicyPattern

     Creates (adds) a new default table-level checks pattern (data quality policy) configuration by
    saving a full specification object.
