...
def _get_kwargs(
    *,
    ...
    url = "{}api/defaults/defaultchecks/dataobservability/recurring/daily/table".format(
        client.base_url
    )
...
def sync_detailed(
    *,
    ...
    """updateDefaultDataObservabilityDailyRecurringTableChecks

     New configuration of the default daily recurring (data observability) checks on a table level. These
    checks will be applied on new tables.
