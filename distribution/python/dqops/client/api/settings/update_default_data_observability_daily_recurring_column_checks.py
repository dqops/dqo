...
def _get_kwargs(
    *,
    ...
    url = (
        "{}api/defaults/defaultchecks/dataobservability/recurring/daily/column".format(
            client.base_url
        )
    )
...
def sync_detailed(
    *,
    ...
    """updateDefaultDataObservabilityDailyRecurringColumnChecks

     New configuration of the default daily recurring (data observability) checks on a column level.
    These checks will be applied on new columns.
