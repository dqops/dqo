...
def sync_detailed(
    *,
    ...
    """updateDefaultDataObservabilityMonthlyRecurringColumnChecks

     New configuration of the default monthly recurring checkpoints on a column level. These checks will
