...
def _get_kwargs(
    *,
    ...
    url = (
        "{}api/defaults/defaultchecks/dataobservability/recurring/monthly/table".format(
            client.base_url
        )
    )
...
def sync_detailed(
    *,
    ...
    """updateDefaultDataObservabilityMonthlyRecurringTableChecks

     New configuration of the default monthly recurring checkpoints on a table level. These checks will
    be applied on new tables.
