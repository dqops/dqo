...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "post",
        "url": "api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/partitioned/{timeScale}/propose".format(
...
def sync_detailed(
    ...
    *,
    ...
    """proposeTablePartitionedChecks

     Proposes the configuration of partitioned checks on a table by generating suggested configuration of
