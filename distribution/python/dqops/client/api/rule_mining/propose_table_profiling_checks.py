...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "post",
        "url": "api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/profiling/propose".format(
...
def sync_detailed(
    ...
    *,
    ...
    """proposeTableProfilingChecks

     Proposes the configuration of profiling checks on a table by generating suggested configuration of
