...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[TableColumnsStatisticsModel]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[TableColumnsStatisticsModel]:
    return Response(
