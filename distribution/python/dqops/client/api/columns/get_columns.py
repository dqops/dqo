...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List['ColumnBasicModel']]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List['ColumnBasicModel']]:
    return Response(
