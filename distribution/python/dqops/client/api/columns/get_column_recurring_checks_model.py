...
from ...models.get_column_recurring_checks_model_time_scale import GetColumnRecurringChecksModelTimeScale
...
def _get_kwargs(
    ...
    table_name: str,
    column_name: str,
    time_scale: GetColumnRecurringChecksModelTimeScale,
    *,
    client: Client,
...
def sync_detailed(
    ...
    *,
    ...
    """ getColumnRecurringChecksModel

     Return a UI friendly model of column level data quality recurring on a column
