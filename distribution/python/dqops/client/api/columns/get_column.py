...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[ColumnModel]:
    if response.status_code == HTTPStatus.OK:
        response_200 = ColumnModel.from_dict(response.json())
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[ColumnModel]:
    return Response(
