...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[ColumnProfilingCheckCategoriesSpec]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[ColumnProfilingCheckCategoriesSpec]:
    return Response(
