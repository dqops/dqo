...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/tablecomparisons/recurring/monthly/{tableComparisonConfigurationName}".format(
        client.base_url,
...
def sync_detailed(
    ...
    *,
    ...
    """updateTableComparisonRecurringMonthly

     Updates a table comparison checks recurring monthly
