...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/tablecomparisons/recurring/daily".format(
        client.base_url,
...
def sync_detailed(
    ...
    *,
    ...
    """createTableComparisonRecurringDaily

     Creates a table comparison configuration using daily recurring checks
