...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "post",
        "url": "api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/tablecomparisons/partitioned/monthly".format(
...
def sync_detailed(
    ...
    *,
    ...
    """createTableComparisonPartitionedMonthly
