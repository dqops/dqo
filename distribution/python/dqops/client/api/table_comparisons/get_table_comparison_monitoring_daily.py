...
def _get_kwargs(
    ...
    return {
        "method": "get",
        "url": "api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/tablecomparisons/{tableComparisonConfigurationName}/monitoring/daily".format(
...
def sync_detailed(
    ...
    *,
    ...
    """getTableComparisonMonitoringDaily
