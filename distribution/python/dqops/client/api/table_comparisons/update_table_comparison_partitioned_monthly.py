...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/groupings/{tableComparisonConfigurationName}/partitioned/monthly".format(
...
def sync_detailed(
    ...
    *,
    ...
    """ updateTableComparisonPartitionedMonthly
