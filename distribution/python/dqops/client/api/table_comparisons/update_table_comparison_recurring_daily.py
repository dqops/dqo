...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/tablecomparisons/recurring/daily/{tableComparisonConfigurationName}".format(
        client.base_url,
...
def sync_detailed(
    ...
    *,
    ...
    """updateTableComparisonRecurringDaily

     Updates a table comparison checks recurring daily
