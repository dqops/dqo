...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/tablecomparisons/{tableComparisonConfigurationName}/recurring/daily".format(
        client.base_url,
...
def sync_detailed(
    ...
    *,
    ...
    """getTableComparisonRecurringDaily

     Returns a model of the table comparison using daily recurring checks (comparison once a day)
