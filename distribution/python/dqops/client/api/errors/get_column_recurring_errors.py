...
from ...models.get_column_recurring_errors_time_scale import GetColumnRecurringErrorsTimeScale
...
def _get_kwargs(
    ...
    table_name: str,
    column_name: str,
    time_scale: GetColumnRecurringErrorsTimeScale,
    *,
    client: Client,
    ...
    url = "{}/api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/recurring/{timeScale}/errors".format(
...
def sync_detailed(
    ...
    *,
    ...
    """ getColumnRecurringErrors

     Returns errors related to the recent column level recurring executions for the recurring at a
