...
from ...models.get_column_monitoring_errors_time_scale import (
...
def _get_kwargs(
    ...
    table_name: str,
    column_name: str,
    time_scale: GetColumnMonitoringErrorsTimeScale,
    *,
    ...
    url = "{}api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/monitoring/{timeScale}/errors".format(
        client.base_url,
...
def sync_detailed(
    ...
    *,
    ...
    """getColumnMonitoringErrors

     Returns errors related to the recent column level monitoring executions for the monitoring at a
