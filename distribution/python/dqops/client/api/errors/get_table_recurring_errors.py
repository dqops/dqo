...
from ...models.get_table_recurring_errors_time_scale import GetTableRecurringErrorsTimeScale
...
def _get_kwargs(
    ...
    schema_name: str,
    table_name: str,
    time_scale: GetTableRecurringErrorsTimeScale,
    *,
    client: Client,
    ...
    url = "{}/api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/recurring/{timeScale}/errors".format(
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List['ErrorsDetailedDataModel']]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in (_response_200):
            response_200_item = ErrorsDetailedDataModel.from_dict(response_200_item_data)
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List['ErrorsDetailedDataModel']]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """ getTableRecurringErrors

     Returns the errors related to the most recent table level recurring executions for the recurring at
    a requested time scale
