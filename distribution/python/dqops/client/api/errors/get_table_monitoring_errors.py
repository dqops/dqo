...
from ...models.get_table_monitoring_errors_time_scale import (
...
def _get_kwargs(
    ...
    schema_name: str,
    table_name: str,
    time_scale: GetTableMonitoringErrorsTimeScale,
    *,
    ...
    url = "{}api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/monitoring/{timeScale}/errors".format(
        client.base_url,
...
def sync_detailed(
    ...
    *,
    ...
    """getTableMonitoringErrors

     Returns the errors related to the most recent table level monitoring executions for the monitoring
