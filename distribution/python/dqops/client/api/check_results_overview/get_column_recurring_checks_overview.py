...
from ...models.get_column_recurring_checks_overview_time_scale import GetColumnRecurringChecksOverviewTimeScale
...
def _get_kwargs(
    ...
    table_name: str,
    column_name: str,
    time_scale: GetColumnRecurringChecksOverviewTimeScale,
    *,
    client: Client,

) -> Dict[str, Any]:
    url = "{}/api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/recurring/{timeScale}/overview".format(
...
def sync_detailed(
    ...
    *,
    ...
    """ getColumnRecurringChecksOverview

     Returns an overview of the most recent column level recurring executions for the recurring at a
