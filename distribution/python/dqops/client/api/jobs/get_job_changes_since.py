...
from ...models.dqo_job_queue_incremental_snapshot_model import DqoJobQueueIncrementalSnapshotModel
...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[DqoJobQueueIncrementalSnapshotModel]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[DqoJobQueueIncrementalSnapshotModel]:
    return Response(
