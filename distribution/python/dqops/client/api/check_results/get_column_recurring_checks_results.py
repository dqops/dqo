...
from ...models.get_column_recurring_checks_results_time_scale import GetColumnRecurringChecksResultsTimeScale
...
def _get_kwargs(
    ...
    table_name: str,
    column_name: str,
    time_scale: GetColumnRecurringChecksResultsTimeScale,
    *,
    client: Client,
    ...
    url = "{}/api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/recurring/{timeScale}/results".format(
...
def sync_detailed(
    ...
    *,
    ...
    """ getColumnRecurringChecksResults

     Returns a complete view of the recent column level recurring executions for the recurring at a
