...
from ...models.get_column_monitoring_checks_results_time_scale import (
...
def _get_kwargs(
    ...
    table_name: str,
    column_name: str,
    time_scale: GetColumnMonitoringChecksResultsTimeScale,
    *,
    ...
    url = "{}api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/monitoring/{timeScale}/results".format(
        client.base_url,
...
def sync_detailed(
    ...
    *,
    ...
    """getColumnMonitoringChecksResults
     ...
     Returns a complete view of the recent column level monitoring executions for the monitoring at a
