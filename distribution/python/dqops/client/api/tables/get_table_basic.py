...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[TableBasicModel]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[TableBasicModel]:
    return Response(
