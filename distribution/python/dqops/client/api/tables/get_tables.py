...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List['TableBasicModel']]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List['TableBasicModel']]:
    return Response(
