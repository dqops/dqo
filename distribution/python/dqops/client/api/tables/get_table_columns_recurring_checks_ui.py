...
from ...models.get_table_columns_recurring_checks_ui_time_scale import (
...
def _get_kwargs(
    ...
    schema_name: str,
    table_name: str,
    time_scale: GetTableColumnsRecurringChecksUITimeScale,
    *,
    client: Client,
    ...
    url = "{}/api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/columnchecks/recurring/{timeScale}/ui".format(
        client.base_url,
...
def sync_detailed(
    ...
    *,
    ...
    """getTableColumnsRecurringChecksUI
