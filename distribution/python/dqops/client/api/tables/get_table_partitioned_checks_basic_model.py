...
from ...models.get_table_partitioned_checks_basic_model_time_scale import GetTablePartitionedChecksBasicModelTimeScale
...
def _get_kwargs(
    ...
    schema_name: str,
    table_name: str,
    time_scale: GetTablePartitionedChecksBasicModelTimeScale,
    *,
    client: Client,
