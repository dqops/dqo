...
from ...models.update_table_recurring_checks_model_time_scale import UpdateTableRecurringChecksModelTimeScale
...
def _get_kwargs(
    ...
    schema_name: str,
    table_name: str,
    time_scale: UpdateTableRecurringChecksModelTimeScale,
    *,
    client: Client,
...
def sync_detailed(
    ...
    *,
    ...
    """ updateTableRecurringChecksModel

     Updates the data quality recurring from a model that contains a patch with changes.
