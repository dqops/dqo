...
def _get_kwargs(
    ...
    *,
    ...
    url = "{}/api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/columnchecks/profiling/ui".format(
        client.base_url,
...
) -> Optional[UITableColumnChecksModel]:
    if response.status_code == HTTPStatus.OK:
        response_200 = UITableColumnChecksModel.from_dict(response.json())
...
def _build_response(
    *, client: Client, response: httpx.Response
) -> Response[UITableColumnChecksModel]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """getTableColumnsProfilingChecksUI
