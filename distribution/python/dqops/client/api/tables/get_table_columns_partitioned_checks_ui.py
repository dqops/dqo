...
from ...models.get_table_columns_partitioned_checks_ui_time_scale import (
...
def _get_kwargs(
    ...
    schema_name: str,
    table_name: str,
    time_scale: GetTableColumnsPartitionedChecksUITimeScale,
    *,
    client: Client,
    ...
    url = "{}/api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/columnchecks/partitioned/{timeScale}/ui".format(
        client.base_url,
...
def sync_detailed(
    ...
    *,
    ...
    """getTableColumnsPartitionedChecksUI
