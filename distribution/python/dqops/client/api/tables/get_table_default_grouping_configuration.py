...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[DataGroupingConfigurationSpec]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[DataGroupingConfigurationSpec]:
    return Response(
