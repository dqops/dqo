...
from ...models.get_table_recurring_checks_templates_time_scale import GetTableRecurringChecksTemplatesTimeScale
...
def _get_kwargs(
    ...
    schema_name: str,
    table_name: str,
    time_scale: GetTableRecurringChecksTemplatesTimeScale,
    *,
    client: Client,
...
def sync_detailed(
    ...
    *,
    ...
    """ getTableRecurringChecksTemplates
