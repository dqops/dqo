...
from ...models.get_table_columns_recurring_checks_model_time_scale import GetTableColumnsRecurringChecksModelTimeScale
...
def _get_kwargs(
    ...
    schema_name: str,
    table_name: str,
    time_scale: GetTableColumnsRecurringChecksModelTimeScale,
    *,
    client: Client,
...
def sync_detailed(
    ...
    *,
    ...
    """ getTableColumnsRecurringChecksModel

     Return a UI friendly model of configurations for column-level data quality recurring checks on a
    table
