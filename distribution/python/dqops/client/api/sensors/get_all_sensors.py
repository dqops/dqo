...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List['SensorBasicModel']]:
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List['SensorBasicModel']]:
    return Response(
