...
def _parse_response(*, client: Client, response: httpx.Response) -> Optional[List['IncidentsPerConnectionModel']]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in (_response_200):
            response_200_item = IncidentsPerConnectionModel.from_dict(response_200_item_data)
...
def _build_response(*, client: Client, response: httpx.Response) -> Response[List['IncidentsPerConnectionModel']]:
    return Response(
