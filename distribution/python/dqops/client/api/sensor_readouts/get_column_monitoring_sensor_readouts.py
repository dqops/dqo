...
from ...models.get_column_monitoring_sensor_readouts_time_scale import (
...
def _get_kwargs(
    ...
    table_name: str,
    column_name: str,
    time_scale: GetColumnMonitoringSensorReadoutsTimeScale,
    *,
    ...
    url = "{}api/connections/{connectionName}/schemas/{schemaName}/tables/{tableName}/columns/{columnName}/monitoring/{timeScale}/readouts".format(
        client.base_url,
...
def sync_detailed(
    ...
    *,
    ...
    """getColumnMonitoringSensorReadouts

     Returns a complete view of the sensor readouts for recent column level monitoring executions for the
    monitoring at a requested time scale
