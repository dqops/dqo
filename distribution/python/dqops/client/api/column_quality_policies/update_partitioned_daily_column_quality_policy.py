...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "put",
        "url": "api/policies/checks/column/{patternName}/partitioned/daily".format(
...
def sync_detailed(
    ...
    *,
    ...
    """updatePartitionedDailyColumnQualityPolicy

     New configuration of the default daily partitioned checks on a column level. These checks will be
    applied to columns.
