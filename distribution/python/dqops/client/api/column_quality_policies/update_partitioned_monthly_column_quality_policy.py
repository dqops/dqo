...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "put",
        "url": "api/policies/checks/column/{patternName}/partitioned/monthly".format(
...
def sync_detailed(
    ...
    *,
    ...
    """updatePartitionedMonthlyColumnQualityPolicy

     New configuration of the default monthly partitioned checks on a column level. These checks will be
    applied to columns.
