...
T = TypeVar("T", bound="ColumnDistinctPercentChange1DayCheckSpec")


@_attrs_define
class ColumnDistinctPercentChange1DayCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_distinct_percent_change_1_day_check_spec = cls(
        ...
        column_distinct_percent_change_1_day_check_spec.additional_properties = d
        return column_distinct_percent_change_1_day_check_spec
