...
if TYPE_CHECKING:
    from ..models.column_accepted_values_text_found_in_set_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextFoundInSetPercentCheckSpec")


@_attrs_define
class ColumnTextFoundInSetPercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnAcceptedValuesTextFoundInSetPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnAcceptedValuesTextFoundInSetPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnAcceptedValuesTextFoundInSetPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_text_found_in_set_percent_check_spec = cls(
        ...
        column_text_found_in_set_percent_check_spec.additional_properties = d
        return column_text_found_in_set_percent_check_spec
