...
if TYPE_CHECKING:
    from ..models.column_whitespace_blank_null_placeholder_text_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnWhitespaceNullPlaceholderTextFoundCheckSpec")


@_attrs_define
class ColumnWhitespaceNullPlaceholderTextFoundCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnWhitespaceBlankNullPlaceholderTextCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnWhitespaceBlankNullPlaceholderTextCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnWhitespaceBlankNullPlaceholderTextCountSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_whitespace_null_placeholder_text_found_check_spec = cls(
        ...
        column_whitespace_null_placeholder_text_found_check_spec.additional_properties = (
            d
        )
        return column_whitespace_null_placeholder_text_found_check_spec
