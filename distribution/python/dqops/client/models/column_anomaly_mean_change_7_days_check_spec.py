...
if TYPE_CHECKING:
    from ..models.change_percentile_moving_within_7_days_rule_parameters_spec import (
...
T = TypeVar("T", bound="ColumnAnomalyMeanChange7DaysCheckSpec")


@attr.s(auto_attribs=True)
class ColumnAnomalyMeanChange7DaysCheckSpec:
    """
    Attributes:
        ...
        warning (Union[Unset, ChangePercentileMovingWithin7DaysRuleParametersSpec]):
        error (Union[Unset, ChangePercentileMovingWithin7DaysRuleParametersSpec]):
        fatal (Union[Unset, ChangePercentileMovingWithin7DaysRuleParametersSpec]):
    """
    ...
    warning: Union[Unset, "ChangePercentileMovingWithin7DaysRuleParametersSpec"] = UNSET
    error: Union[Unset, "ChangePercentileMovingWithin7DaysRuleParametersSpec"] = UNSET
    fatal: Union[Unset, "ChangePercentileMovingWithin7DaysRuleParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_warning, Unset):
            ...
            warning = ChangePercentileMovingWithin7DaysRuleParametersSpec.from_dict(
                _warning
            )
        ...
        if isinstance(_error, Unset):
            ...
            error = ChangePercentileMovingWithin7DaysRuleParametersSpec.from_dict(
                _error
            )
        ...
        if isinstance(_fatal, Unset):
            ...
            fatal = ChangePercentileMovingWithin7DaysRuleParametersSpec.from_dict(
                _fatal
            )

        column_anomaly_mean_change_7_days_check_spec = cls(
        ...
        column_anomaly_mean_change_7_days_check_spec.additional_properties = d
        return column_anomaly_mean_change_7_days_check_spec
