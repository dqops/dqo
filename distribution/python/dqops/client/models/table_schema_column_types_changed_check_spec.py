...
if TYPE_CHECKING:
  from ..models.table_column_types_hash_sensor_parameters_spec import TableColumnTypesHashSensorParametersSpec
...
T = TypeVar("T", bound="TableSchemaColumnTypesChangedCheckSpec")


@attr.s(auto_attribs=True)
class TableSchemaColumnTypesChangedCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = TableColumnTypesHashSensorParametersSpec.from_dict(_parameters)
        ...
        table_schema_column_types_changed_check_spec = cls(
        ...
        table_schema_column_types_changed_check_spec.additional_properties = d
        return table_schema_column_types_changed_check_spec
