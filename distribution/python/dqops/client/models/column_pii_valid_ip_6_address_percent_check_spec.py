...
if TYPE_CHECKING:
  from ..models.column_pii_valid_ip_6_address_percent_sensor_parameters_spec import ColumnPiiValidIp6AddressPercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnPiiValidIp6AddressPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnPiiValidIp6AddressPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnPiiValidIp6AddressPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnPiiValidIp6AddressPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnPiiValidIp6AddressPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_pii_valid_ip_6_address_percent_check_spec = cls(
        ...
        column_pii_valid_ip_6_address_percent_check_spec.additional_properties = d
        return column_pii_valid_ip_6_address_percent_check_spec
