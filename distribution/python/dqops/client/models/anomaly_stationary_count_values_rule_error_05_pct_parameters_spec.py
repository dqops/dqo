...
T = TypeVar("T", bound="AnomalyStationaryCountValuesRuleError05PctParametersSpec")


@_attrs_define
class AnomalyStationaryCountValuesRuleError05PctParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        anomaly_stationary_count_values_rule_error_05_pct_parameters_spec = cls(
            anomaly_percent=anomaly_percent,
        )

        anomaly_stationary_count_values_rule_error_05_pct_parameters_spec.additional_properties = (
            d
        )
        return anomaly_stationary_count_values_rule_error_05_pct_parameters_spec
