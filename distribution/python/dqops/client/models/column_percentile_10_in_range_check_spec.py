...
if TYPE_CHECKING:
  from ..models.column_numeric_percentile_10_sensor_parameters_spec import ColumnNumericPercentile10SensorParametersSpec
...
T = TypeVar("T", bound="ColumnPercentile10InRangeCheckSpec")


@attr.s(auto_attribs=True)
class ColumnPercentile10InRangeCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnNumericPercentile10SensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnNumericPercentile10SensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericPercentile10SensorParametersSpec.from_dict(_parameters)
        ...
        column_percentile_10_in_range_check_spec = cls(
        ...
        column_percentile_10_in_range_check_spec.additional_properties = d
        return column_percentile_10_in_range_check_spec
