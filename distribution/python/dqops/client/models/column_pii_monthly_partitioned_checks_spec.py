...
class ColumnPiiMonthlyPartitionedChecksSpec:
    ...
    monthly_partition_valid_usa_phone_percent: Union[Unset, 'ColumnPiiValidUsaPhonePercentCheckSpec'] = UNSET
    monthly_partition_contains_usa_phone_percent: Union[Unset, 'ColumnPiiContainsUsaPhonePercentCheckSpec'] = UNSET
    monthly_partition_valid_usa_zipcode_percent: Union[Unset, 'ColumnPiiValidUsaZipcodePercentCheckSpec'] = UNSET
    monthly_partition_contains_usa_zipcode_percent: Union[Unset, 'ColumnPiiContainsUsaZipcodePercentCheckSpec'] = UNSET
    monthly_partition_valid_email_percent: Union[Unset, 'ColumnPiiValidEmailPercentCheckSpec'] = UNSET
    monthly_partition_contains_email_percent: Union[Unset, 'ColumnPiiContainsEmailPercentCheckSpec'] = UNSET
    monthly_partition_valid_ip4_address_percent: Union[Unset, 'ColumnPiiValidIp4AddressPercentCheckSpec'] = UNSET
    monthly_partition_contains_ip4_percent: Union[Unset, 'ColumnPiiContainsIp4PercentCheckSpec'] = UNSET
    monthly_partition_valid_ip6_address_percent: Union[Unset, 'ColumnPiiValidIp6AddressPercentCheckSpec'] = UNSET
    monthly_partition_contains_ip6_percent: Union[Unset, 'ColumnPiiContainsIp6PercentCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.monthly_partition_valid_usa_phone_percent, Unset):
            monthly_partition_valid_usa_phone_percent = self.monthly_partition_valid_usa_phone_percent.to_dict()

        monthly_partition_contains_usa_phone_percent: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.monthly_partition_contains_usa_phone_percent, Unset):
            monthly_partition_contains_usa_phone_percent = self.monthly_partition_contains_usa_phone_percent.to_dict()

        monthly_partition_valid_usa_zipcode_percent: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.monthly_partition_valid_usa_zipcode_percent, Unset):
            monthly_partition_valid_usa_zipcode_percent = self.monthly_partition_valid_usa_zipcode_percent.to_dict()

        monthly_partition_contains_usa_zipcode_percent: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.monthly_partition_contains_usa_zipcode_percent, Unset):
            monthly_partition_contains_usa_zipcode_percent = self.monthly_partition_contains_usa_zipcode_percent.to_dict()
        ...
        if not isinstance(self.monthly_partition_valid_email_percent, Unset):
            monthly_partition_valid_email_percent = self.monthly_partition_valid_email_percent.to_dict()
        ...
        if not isinstance(self.monthly_partition_contains_email_percent, Unset):
            monthly_partition_contains_email_percent = self.monthly_partition_contains_email_percent.to_dict()

        monthly_partition_valid_ip4_address_percent: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.monthly_partition_valid_ip4_address_percent, Unset):
            monthly_partition_valid_ip4_address_percent = self.monthly_partition_valid_ip4_address_percent.to_dict()
        ...
        if not isinstance(self.monthly_partition_contains_ip4_percent, Unset):
            monthly_partition_contains_ip4_percent = self.monthly_partition_contains_ip4_percent.to_dict()

        monthly_partition_valid_ip6_address_percent: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.monthly_partition_valid_ip6_address_percent, Unset):
            monthly_partition_valid_ip6_address_percent = self.monthly_partition_valid_ip6_address_percent.to_dict()
        ...
        if not isinstance(self.monthly_partition_contains_ip6_percent, Unset):
            monthly_partition_contains_ip6_percent = self.monthly_partition_contains_ip6_percent.to_dict()
        ...
        if monthly_partition_valid_usa_phone_percent is not UNSET:
            field_dict["monthly_partition_valid_usa_phone_percent"] = monthly_partition_valid_usa_phone_percent
        if monthly_partition_contains_usa_phone_percent is not UNSET:
            field_dict["monthly_partition_contains_usa_phone_percent"] = monthly_partition_contains_usa_phone_percent
        if monthly_partition_valid_usa_zipcode_percent is not UNSET:
            field_dict["monthly_partition_valid_usa_zipcode_percent"] = monthly_partition_valid_usa_zipcode_percent
        if monthly_partition_contains_usa_zipcode_percent is not UNSET:
            field_dict["monthly_partition_contains_usa_zipcode_percent"] = monthly_partition_contains_usa_zipcode_percent
        if monthly_partition_valid_email_percent is not UNSET:
            field_dict["monthly_partition_valid_email_percent"] = monthly_partition_valid_email_percent
        if monthly_partition_contains_email_percent is not UNSET:
            field_dict["monthly_partition_contains_email_percent"] = monthly_partition_contains_email_percent
        if monthly_partition_valid_ip4_address_percent is not UNSET:
            field_dict["monthly_partition_valid_ip4_address_percent"] = monthly_partition_valid_ip4_address_percent
        if monthly_partition_contains_ip4_percent is not UNSET:
            field_dict["monthly_partition_contains_ip4_percent"] = monthly_partition_contains_ip4_percent
        if monthly_partition_valid_ip6_address_percent is not UNSET:
            field_dict["monthly_partition_valid_ip6_address_percent"] = monthly_partition_valid_ip6_address_percent
        if monthly_partition_contains_ip6_percent is not UNSET:
            field_dict["monthly_partition_contains_ip6_percent"] = monthly_partition_contains_ip6_percent
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.column_pii_contains_usa_zipcode_percent_check_spec import ColumnPiiContainsUsaZipcodePercentCheckSpec
        d = src_dict.copy()
        _monthly_partition_valid_usa_phone_percent = d.pop("monthly_partition_valid_usa_phone_percent", UNSET)
        monthly_partition_valid_usa_phone_percent: Union[Unset, ColumnPiiValidUsaPhonePercentCheckSpec]
        if isinstance(_monthly_partition_valid_usa_phone_percent,  Unset):
            monthly_partition_valid_usa_phone_percent = UNSET
        else:
            monthly_partition_valid_usa_phone_percent = ColumnPiiValidUsaPhonePercentCheckSpec.from_dict(_monthly_partition_valid_usa_phone_percent)




        _monthly_partition_contains_usa_phone_percent = d.pop("monthly_partition_contains_usa_phone_percent", UNSET)
        monthly_partition_contains_usa_phone_percent: Union[Unset, ColumnPiiContainsUsaPhonePercentCheckSpec]
        if isinstance(_monthly_partition_contains_usa_phone_percent,  Unset):
            monthly_partition_contains_usa_phone_percent = UNSET
        else:
            monthly_partition_contains_usa_phone_percent = ColumnPiiContainsUsaPhonePercentCheckSpec.from_dict(_monthly_partition_contains_usa_phone_percent)




        _monthly_partition_valid_usa_zipcode_percent = d.pop("monthly_partition_valid_usa_zipcode_percent", UNSET)
        monthly_partition_valid_usa_zipcode_percent: Union[Unset, ColumnPiiValidUsaZipcodePercentCheckSpec]
        if isinstance(_monthly_partition_valid_usa_zipcode_percent,  Unset):
            monthly_partition_valid_usa_zipcode_percent = UNSET
        else:
            monthly_partition_valid_usa_zipcode_percent = ColumnPiiValidUsaZipcodePercentCheckSpec.from_dict(_monthly_partition_valid_usa_zipcode_percent)




        _monthly_partition_contains_usa_zipcode_percent = d.pop("monthly_partition_contains_usa_zipcode_percent", UNSET)
        monthly_partition_contains_usa_zipcode_percent: Union[Unset, ColumnPiiContainsUsaZipcodePercentCheckSpec]
        if isinstance(_monthly_partition_contains_usa_zipcode_percent,  Unset):
            monthly_partition_contains_usa_zipcode_percent = UNSET
        else:
            monthly_partition_contains_usa_zipcode_percent = ColumnPiiContainsUsaZipcodePercentCheckSpec.from_dict(_monthly_partition_contains_usa_zipcode_percent)




        _monthly_partition_valid_email_percent = d.pop("monthly_partition_valid_email_percent", UNSET)
        monthly_partition_valid_email_percent: Union[Unset, ColumnPiiValidEmailPercentCheckSpec]
        if isinstance(_monthly_partition_valid_email_percent,  Unset):
            monthly_partition_valid_email_percent = UNSET
        else:
            monthly_partition_valid_email_percent = ColumnPiiValidEmailPercentCheckSpec.from_dict(_monthly_partition_valid_email_percent)




        _monthly_partition_contains_email_percent = d.pop("monthly_partition_contains_email_percent", UNSET)
        monthly_partition_contains_email_percent: Union[Unset, ColumnPiiContainsEmailPercentCheckSpec]
        if isinstance(_monthly_partition_contains_email_percent,  Unset):
            monthly_partition_contains_email_percent = UNSET
        else:
            monthly_partition_contains_email_percent = ColumnPiiContainsEmailPercentCheckSpec.from_dict(_monthly_partition_contains_email_percent)




        _monthly_partition_valid_ip4_address_percent = d.pop("monthly_partition_valid_ip4_address_percent", UNSET)
        monthly_partition_valid_ip4_address_percent: Union[Unset, ColumnPiiValidIp4AddressPercentCheckSpec]
        if isinstance(_monthly_partition_valid_ip4_address_percent,  Unset):
            monthly_partition_valid_ip4_address_percent = UNSET
        else:
            monthly_partition_valid_ip4_address_percent = ColumnPiiValidIp4AddressPercentCheckSpec.from_dict(_monthly_partition_valid_ip4_address_percent)




        _monthly_partition_contains_ip4_percent = d.pop("monthly_partition_contains_ip4_percent", UNSET)
        monthly_partition_contains_ip4_percent: Union[Unset, ColumnPiiContainsIp4PercentCheckSpec]
        if isinstance(_monthly_partition_contains_ip4_percent,  Unset):
            monthly_partition_contains_ip4_percent = UNSET
        else:
            monthly_partition_contains_ip4_percent = ColumnPiiContainsIp4PercentCheckSpec.from_dict(_monthly_partition_contains_ip4_percent)




        _monthly_partition_valid_ip6_address_percent = d.pop("monthly_partition_valid_ip6_address_percent", UNSET)
        monthly_partition_valid_ip6_address_percent: Union[Unset, ColumnPiiValidIp6AddressPercentCheckSpec]
        if isinstance(_monthly_partition_valid_ip6_address_percent,  Unset):
            monthly_partition_valid_ip6_address_percent = UNSET
        else:
            monthly_partition_valid_ip6_address_percent = ColumnPiiValidIp6AddressPercentCheckSpec.from_dict(_monthly_partition_valid_ip6_address_percent)




        _monthly_partition_contains_ip6_percent = d.pop("monthly_partition_contains_ip6_percent", UNSET)
        monthly_partition_contains_ip6_percent: Union[Unset, ColumnPiiContainsIp6PercentCheckSpec]
        if isinstance(_monthly_partition_contains_ip6_percent,  Unset):
            monthly_partition_contains_ip6_percent = UNSET
        else:
            monthly_partition_contains_ip6_percent = ColumnPiiContainsIp6PercentCheckSpec.from_dict(_monthly_partition_contains_ip6_percent)
