...
if TYPE_CHECKING:
    from ..models.column_accuracy_total_average_match_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnAccuracyTotalTotalAverageMatchPercentCheckSpec")
...
class ColumnAccuracyTotalAverageMatchPercentCheckSpec:
    ...
    Attributes:
        ...
        parameters (Union[Unset, ColumnAccuracyTotalTotalAverageMatchPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnAccuracyTotalTotalAverageMatchPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnAccuracyTotalAverageMatchPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
