...
if TYPE_CHECKING:
    from ..models.column_text_text_surrounded_by_whitespace_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextSurroundedByWhitespaceCheckSpec")


@_attrs_define
class ColumnTextSurroundedByWhitespaceCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnTextTextSurroundedByWhitespaceCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnTextTextSurroundedByWhitespaceCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnTextTextSurroundedByWhitespaceCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_text_surrounded_by_whitespace_check_spec = cls(
        ...
        column_text_surrounded_by_whitespace_check_spec.additional_properties = d
        return column_text_surrounded_by_whitespace_check_spec
