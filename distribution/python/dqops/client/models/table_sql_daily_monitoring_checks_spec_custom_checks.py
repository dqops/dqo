...
T = TypeVar("T", bound="TableSqlDailyMonitoringChecksSpecCustomChecks")


@_attrs_define
class TableSqlDailyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_sql_daily_monitoring_checks_spec_custom_checks = cls()
        ...
        table_sql_daily_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_sql_daily_monitoring_checks_spec_custom_checks
