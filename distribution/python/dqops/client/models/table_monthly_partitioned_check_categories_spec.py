...
if TYPE_CHECKING:
  from ..models.table_monthly_partitioned_check_categories_spec_comparisons import TableMonthlyPartitionedCheckCategoriesSpecComparisons
  from ..models.table_sql_monthly_partitioned_checks_spec import TableSqlMonthlyPartitionedChecksSpec
  from ..models.table_volume_monthly_partitioned_checks_spec import TableVolumeMonthlyPartitionedChecksSpec
  from ..models.table_monthly_partitioned_check_categories_spec_custom import TableMonthlyPartitionedCheckCategoriesSpecCustom
  from ..models.table_timeliness_monthly_partitioned_checks_spec import TableTimelinessMonthlyPartitionedChecksSpec
...
class TableMonthlyPartitionedCheckCategoriesSpec:
    ...
    comparisons: Union[Unset, 'TableMonthlyPartitionedCheckCategoriesSpecComparisons'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_timeliness,  Unset):
            ...
            timeliness = TableTimelinessMonthlyPartitionedChecksSpec.from_dict(_timeliness)
        ...
        if isinstance(_comparisons,  Unset):
            ...
            comparisons = TableMonthlyPartitionedCheckCategoriesSpecComparisons.from_dict(_comparisons)
