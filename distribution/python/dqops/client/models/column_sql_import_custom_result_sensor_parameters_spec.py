...
T = TypeVar("T", bound="ColumnSqlImportCustomResultSensorParametersSpec")


@_attrs_define
class ColumnSqlImportCustomResultSensorParametersSpec:
    """
    Attributes:
        ...
        sql_query (Union[Unset, str]): A custom SELECT statement that queries a logging table with custom results of
            ...
            for which the results are imported, and a {column_name} placeholder replaced with the column name.
    """
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_sql_import_custom_result_sensor_parameters_spec = cls(
            filter_=filter_,
            sql_query=sql_query,
        )

        column_sql_import_custom_result_sensor_parameters_spec.additional_properties = d
        return column_sql_import_custom_result_sensor_parameters_spec
