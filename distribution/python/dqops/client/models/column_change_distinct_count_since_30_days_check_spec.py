...
T = TypeVar("T", bound="ColumnChangeDistinctCountSince30DaysCheckSpec")


@_attrs_define
class ColumnChangeDistinctCountSince30DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_change_distinct_count_since_30_days_check_spec = cls(
        ...
        column_change_distinct_count_since_30_days_check_spec.additional_properties = d
        return column_change_distinct_count_since_30_days_check_spec
