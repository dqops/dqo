...
class ConnectionSpec:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.default_data_stream_mapping, Unset):
            default_data_stream_mapping = self.default_data_stream_mapping.to_dict()
        ...
        if default_data_stream_mapping is not UNSET:
            field_dict["default_data_stream_mapping"] = default_data_stream_mapping
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        default_data_stream_mapping: Union[Unset, DataStreamMappingSpec]
        if isinstance(_default_data_stream_mapping, Unset):
            default_data_stream_mapping = UNSET
        else:
            default_data_stream_mapping = DataStreamMappingSpec.from_dict(
                _default_data_stream_mapping
            )
