...
if TYPE_CHECKING:
  ...
  from ..models.synchronize_multiple_folders_dqo_queue_job_parameters import SynchronizeMultipleFoldersDqoQueueJobParameters
  from ..models.run_checks_queue_job_parameters import RunChecksQueueJobParameters
  from ..models.run_checks_on_table_queue_job_parameters import RunChecksOnTableQueueJobParameters
  from ..models.import_schema_queue_job_parameters import ImportSchemaQueueJobParameters
  from ..models.collect_statistics_on_table_queue_job_parameters import CollectStatisticsOnTableQueueJobParameters
  from ..models.synchronize_root_folder_dqo_queue_job_parameters import SynchronizeRootFolderDqoQueueJobParameters
  from ..models.repair_stored_data_queue_job_parameters import RepairStoredDataQueueJobParameters
  from ..models.collect_statistics_queue_job_parameters import CollectStatisticsQueueJobParameters
...
class DqoJobEntryParametersModel:
    ...
    synchronize_root_folder_parameters: Union[Unset, 'SynchronizeRootFolderDqoQueueJobParameters'] = UNSET
    synchronize_multiple_folders_parameters: Union[Unset, 'SynchronizeMultipleFoldersDqoQueueJobParameters'] = UNSET
    ...
    run_checks_on_table_parameters: Union[Unset, 'RunChecksOnTableQueueJobParameters'] = UNSET
    collect_statistics_parameters: Union[Unset, 'CollectStatisticsQueueJobParameters'] = UNSET
    collect_statistics_on_table_parameters: Union[Unset, 'CollectStatisticsOnTableQueueJobParameters'] = UNSET
    ...
    delete_stored_data_parameters: Union[Unset, 'DeleteStoredDataQueueJobParameters'] = UNSET
    repair_stored_data_parameters: Union[Unset, 'RepairStoredDataQueueJobParameters'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.synchronize_root_folder_parameters, Unset):
            synchronize_root_folder_parameters = self.synchronize_root_folder_parameters.to_dict()
        ...
        if not isinstance(self.synchronize_multiple_folders_parameters, Unset):
            synchronize_multiple_folders_parameters = self.synchronize_multiple_folders_parameters.to_dict()
        ...
        if not isinstance(self.run_scheduled_checks_parameters, Unset):
            run_scheduled_checks_parameters = self.run_scheduled_checks_parameters.to_dict()
        ...
        if not isinstance(self.run_checks_on_table_parameters, Unset):
            run_checks_on_table_parameters = self.run_checks_on_table_parameters.to_dict()
        ...
        if not isinstance(self.collect_statistics_on_table_parameters, Unset):
            collect_statistics_on_table_parameters = self.collect_statistics_on_table_parameters.to_dict()
        ...
        if synchronize_root_folder_parameters is not UNSET:
            field_dict["synchronizeRootFolderParameters"] = synchronize_root_folder_parameters
        if synchronize_multiple_folders_parameters is not UNSET:
            field_dict["synchronizeMultipleFoldersParameters"] = synchronize_multiple_folders_parameters
        ...
        if collect_statistics_on_table_parameters is not UNSET:
            field_dict["collectStatisticsOnTableParameters"] = collect_statistics_on_table_parameters
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.import_tables_queue_job_parameters import ImportTablesQueueJobParameters
        d = src_dict.copy()
        _synchronize_root_folder_parameters = d.pop("synchronizeRootFolderParameters", UNSET)
        synchronize_root_folder_parameters: Union[Unset, SynchronizeRootFolderDqoQueueJobParameters]
        if isinstance(_synchronize_root_folder_parameters,  Unset):
            synchronize_root_folder_parameters = UNSET
        else:
            synchronize_root_folder_parameters = SynchronizeRootFolderDqoQueueJobParameters.from_dict(_synchronize_root_folder_parameters)




        _synchronize_multiple_folders_parameters = d.pop("synchronizeMultipleFoldersParameters", UNSET)
        synchronize_multiple_folders_parameters: Union[Unset, SynchronizeMultipleFoldersDqoQueueJobParameters]
        if isinstance(_synchronize_multiple_folders_parameters,  Unset):
            synchronize_multiple_folders_parameters = UNSET
        else:
            synchronize_multiple_folders_parameters = SynchronizeMultipleFoldersDqoQueueJobParameters.from_dict(_synchronize_multiple_folders_parameters)
        ...
        if isinstance(_run_scheduled_checks_parameters,  Unset):
            ...
            run_scheduled_checks_parameters = RecurringScheduleSpec.from_dict(_run_scheduled_checks_parameters)
        ...
        if isinstance(_run_checks_parameters,  Unset):
            ...
            run_checks_parameters = RunChecksQueueJobParameters.from_dict(_run_checks_parameters)
        ...
        if isinstance(_run_checks_on_table_parameters,  Unset):
            ...
            run_checks_on_table_parameters = RunChecksOnTableQueueJobParameters.from_dict(_run_checks_on_table_parameters)
        ...
        if isinstance(_collect_statistics_parameters,  Unset):
            ...
            collect_statistics_parameters = CollectStatisticsQueueJobParameters.from_dict(_collect_statistics_parameters)




        _collect_statistics_on_table_parameters = d.pop("collectStatisticsOnTableParameters", UNSET)
        collect_statistics_on_table_parameters: Union[Unset, CollectStatisticsOnTableQueueJobParameters]
        if isinstance(_collect_statistics_on_table_parameters,  Unset):
            collect_statistics_on_table_parameters = UNSET
        else:
            collect_statistics_on_table_parameters = CollectStatisticsOnTableQueueJobParameters.from_dict(_collect_statistics_on_table_parameters)
        ...
        if isinstance(_import_schema_parameters,  Unset):
            ...
            import_schema_parameters = ImportSchemaQueueJobParameters.from_dict(_import_schema_parameters)
        ...
        if isinstance(_import_table_parameters,  Unset):
            ...
            import_table_parameters = ImportTablesQueueJobParameters.from_dict(_import_table_parameters)
        ...
        if isinstance(_delete_stored_data_parameters,  Unset):
            ...
            delete_stored_data_parameters = DeleteStoredDataQueueJobParameters.from_dict(_delete_stored_data_parameters)
        ...
        if isinstance(_repair_stored_data_parameters,  Unset):
            ...
            repair_stored_data_parameters = RepairStoredDataQueueJobParameters.from_dict(_repair_stored_data_parameters)
