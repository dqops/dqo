...
if TYPE_CHECKING:
  ...
  from ..models.column_pii_contains_ip_4_percent_sensor_parameters_spec import ColumnPiiContainsIp4PercentSensorParametersSpec
...
class ColumnPiiContainsIp4PercentCheckSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnPiiContainsIp4PercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_pii_contains_ip_4_percent_check_spec = cls(
        ...
        column_pii_contains_ip_4_percent_check_spec.additional_properties = d
        return column_pii_contains_ip_4_percent_check_spec
