...
if TYPE_CHECKING:
    from ..models.column_sql_invalid_value_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnSqlInvalidValueCountCheckSpec")


@_attrs_define
class ColumnSqlInvalidValueCountCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnSqlInvalidValueCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, "ColumnSqlInvalidValueCountSensorParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnSqlInvalidValueCountSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_sql_invalid_value_count_check_spec = cls(
        ...
        column_sql_invalid_value_count_check_spec.additional_properties = d
        return column_sql_invalid_value_count_check_spec
