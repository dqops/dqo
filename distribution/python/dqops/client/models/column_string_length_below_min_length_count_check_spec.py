...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_length_below_min_length_count_sensor_parameters_spec import ColumnStringsStringLengthBelowMinLengthCountSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringLengthBelowMinLengthCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringLengthBelowMinLengthCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringLengthBelowMinLengthCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringLengthBelowMinLengthCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringLengthBelowMinLengthCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_length_below_min_length_count_check_spec = cls(
        ...
        column_string_length_below_min_length_count_check_spec.additional_properties = d
        return column_string_length_below_min_length_count_check_spec
