...
if TYPE_CHECKING:
    from ..models.column_strings_string_length_below_min_length_count_sensor_parameters_spec import (
...
class ColumnStringLengthBelowMinLengthCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringLengthBelowMinLengthCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnStringsStringLengthBelowMinLengthCountSensorParametersSpec.from_dict(
                _parameters
            )
