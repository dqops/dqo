...
T = TypeVar("T", bound="TableChangeRowCountCheckSpec")


@_attrs_define
class TableChangeRowCountCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_change_row_count_check_spec = cls(
        ...
        table_change_row_count_check_spec.additional_properties = d
        return table_change_row_count_check_spec
