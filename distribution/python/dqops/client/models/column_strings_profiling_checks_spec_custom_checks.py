...
T = TypeVar("T", bound="ColumnStringsProfilingChecksSpecCustomChecks")


@_attrs_define
class ColumnStringsProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_strings_profiling_checks_spec_custom_checks = cls()
        ...
        column_strings_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_strings_profiling_checks_spec_custom_checks
