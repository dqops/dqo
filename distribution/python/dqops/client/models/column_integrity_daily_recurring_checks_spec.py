...
class ColumnIntegrityDailyRecurringChecksSpec:
    ...
    daily_foreign_key_not_match_count: Union[Unset, 'ColumnIntegrityForeignKeyNotMatchCountCheckSpec'] = UNSET
    daily_foreign_key_match_percent: Union[Unset, 'ColumnIntegrityForeignKeyMatchPercentCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.daily_foreign_key_not_match_count, Unset):
            daily_foreign_key_not_match_count = self.daily_foreign_key_not_match_count.to_dict()
        ...
        if not isinstance(self.daily_foreign_key_match_percent, Unset):
            daily_foreign_key_match_percent = self.daily_foreign_key_match_percent.to_dict()
        ...
        if daily_foreign_key_not_match_count is not UNSET:
            field_dict["daily_foreign_key_not_match_count"] = daily_foreign_key_not_match_count
        if daily_foreign_key_match_percent is not UNSET:
            field_dict["daily_foreign_key_match_percent"] = daily_foreign_key_match_percent
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.column_integrity_foreign_key_match_percent_check_spec import ColumnIntegrityForeignKeyMatchPercentCheckSpec
        d = src_dict.copy()
        _daily_foreign_key_not_match_count = d.pop("daily_foreign_key_not_match_count", UNSET)
        daily_foreign_key_not_match_count: Union[Unset, ColumnIntegrityForeignKeyNotMatchCountCheckSpec]
        if isinstance(_daily_foreign_key_not_match_count,  Unset):
            daily_foreign_key_not_match_count = UNSET
        else:
            daily_foreign_key_not_match_count = ColumnIntegrityForeignKeyNotMatchCountCheckSpec.from_dict(_daily_foreign_key_not_match_count)




        _daily_foreign_key_match_percent = d.pop("daily_foreign_key_match_percent", UNSET)
        daily_foreign_key_match_percent: Union[Unset, ColumnIntegrityForeignKeyMatchPercentCheckSpec]
        if isinstance(_daily_foreign_key_match_percent,  Unset):
            daily_foreign_key_match_percent = UNSET
        else:
            daily_foreign_key_match_percent = ColumnIntegrityForeignKeyMatchPercentCheckSpec.from_dict(_daily_foreign_key_match_percent)
