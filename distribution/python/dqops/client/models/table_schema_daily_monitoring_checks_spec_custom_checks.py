...
T = TypeVar("T", bound="TableSchemaDailyMonitoringChecksSpecCustomChecks")


@_attrs_define
class TableSchemaDailyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_schema_daily_monitoring_checks_spec_custom_checks = cls()
        ...
        table_schema_daily_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_schema_daily_monitoring_checks_spec_custom_checks
