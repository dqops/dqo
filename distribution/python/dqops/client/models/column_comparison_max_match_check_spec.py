...
T = TypeVar("T", bound="ColumnComparisonMaxMatchCheckSpec")


@_attrs_define
class ColumnComparisonMaxMatchCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_comparison_max_match_check_spec = cls(
        ...
        column_comparison_max_match_check_spec.additional_properties = d
        return column_comparison_max_match_check_spec
