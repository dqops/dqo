...
class ColumnPiiMonthlyRecurringChecksSpec:
    ...
    monthly_valid_usa_zipcode_percent: Union[
    ...
    monthly_valid_email_percent: Union[
    ...
    monthly_valid_ip4_address_percent: Union[
    ...
    monthly_valid_ip6_address_percent: Union[
        Unset, "ColumnPiiValidIp6AddressPercentCheckSpec"
    ] = UNSET
    monthly_contains_ip6_percent: Union[
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.monthly_valid_usa_phone_percent, Unset):
            monthly_valid_usa_phone_percent = (
                self.monthly_valid_usa_phone_percent.to_dict()
            )
        ...
        if not isinstance(self.monthly_valid_usa_zipcode_percent, Unset):
            monthly_valid_usa_zipcode_percent = (
                self.monthly_valid_usa_zipcode_percent.to_dict()
            )
        ...
        if not isinstance(self.monthly_valid_ip4_address_percent, Unset):
            monthly_valid_ip4_address_percent = (
                self.monthly_valid_ip4_address_percent.to_dict()
            )
        ...
        if not isinstance(self.monthly_valid_ip6_address_percent, Unset):
            monthly_valid_ip6_address_percent = (
                self.monthly_valid_ip6_address_percent.to_dict()
            )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_monthly_valid_usa_phone_percent, Unset):
            ...
            monthly_valid_usa_phone_percent = (
                ColumnPiiValidUsaPhonePercentCheckSpec.from_dict(
                    _monthly_valid_usa_phone_percent
                )
            )

        _monthly_contains_usa_phone_percent = d.pop(
        ...
        if isinstance(_monthly_contains_usa_phone_percent, Unset):
            ...
            monthly_contains_usa_phone_percent = (
                ColumnPiiContainsUsaPhonePercentCheckSpec.from_dict(
                    _monthly_contains_usa_phone_percent
                )
            )

        _monthly_valid_usa_zipcode_percent = d.pop(
        ...
        if isinstance(_monthly_valid_usa_zipcode_percent, Unset):
            ...
            monthly_valid_usa_zipcode_percent = (
                ColumnPiiValidUsaZipcodePercentCheckSpec.from_dict(
                    _monthly_valid_usa_zipcode_percent
                )
            )
        ...
        if isinstance(_monthly_valid_email_percent, Unset):
            ...
            monthly_valid_email_percent = ColumnPiiValidEmailPercentCheckSpec.from_dict(
                _monthly_valid_email_percent
            )
        ...
        _monthly_valid_ip4_address_percent = d.pop(
        ...
        if isinstance(_monthly_valid_ip4_address_percent, Unset):
            ...
            monthly_valid_ip4_address_percent = (
                ColumnPiiValidIp4AddressPercentCheckSpec.from_dict(
                    _monthly_valid_ip4_address_percent
                )
            )
        ...
        if isinstance(_monthly_contains_ip4_percent, Unset):
            ...
            monthly_contains_ip4_percent = (
                ColumnPiiContainsIp4PercentCheckSpec.from_dict(
                    _monthly_contains_ip4_percent
                )
            )

        _monthly_valid_ip6_address_percent = d.pop(
        ...
        if isinstance(_monthly_valid_ip6_address_percent, Unset):
            ...
            monthly_valid_ip6_address_percent = (
                ColumnPiiValidIp6AddressPercentCheckSpec.from_dict(
                    _monthly_valid_ip6_address_percent
                )
            )
