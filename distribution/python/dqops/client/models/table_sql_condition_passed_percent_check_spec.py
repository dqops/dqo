...
if TYPE_CHECKING:
  ...
  from ..models.table_sql_condition_passed_percent_sensor_parameters_spec import TableSqlConditionPassedPercentSensorParametersSpec





T = TypeVar("T", bound="TableSqlConditionPassedPercentCheckSpec")
...
class TableSqlConditionPassedPercentCheckSpec:
    ...
    parameters: Union[Unset, 'TableSqlConditionPassedPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = TableSqlConditionPassedPercentSensorParametersSpec.from_dict(_parameters)
        ...
        table_sql_condition_passed_percent_check_spec = cls(
        ...
        table_sql_condition_passed_percent_check_spec.additional_properties = d
        return table_sql_condition_passed_percent_check_spec
