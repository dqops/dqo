...
if TYPE_CHECKING:
    from ..models.column_nulls_not_nulls_count_sensor_parameters_spec import (
        ColumnNullsNotNullsCountSensorParametersSpec,
    )
    from ..models.comment_spec import CommentSpec
    from ..models.cron_schedule_spec import CronScheduleSpec
    from ..models.min_count_rule_constant_1_parameters_spec import (
        MinCountRuleConstant1ParametersSpec,
    )


T = TypeVar("T", bound="ColumnEmptyColumnFoundCheckSpec")


@_attrs_define
class ColumnEmptyColumnFoundCheckSpec:
    """
    Attributes:
        ...
        warning (Union[Unset, MinCountRuleConstant1ParametersSpec]):
        error (Union[Unset, MinCountRuleConstant1ParametersSpec]):
        fatal (Union[Unset, MinCountRuleConstant1ParametersSpec]):
    """
    ...
    warning: Union[Unset, "MinCountRuleConstant1ParametersSpec"] = UNSET
    error: Union[Unset, "MinCountRuleConstant1ParametersSpec"] = UNSET
    fatal: Union[Unset, "MinCountRuleConstant1ParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnNullsNotNullsCountSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        if isinstance(_warning, Unset):
            ...
            warning = MinCountRuleConstant1ParametersSpec.from_dict(_warning)
        ...
        if isinstance(_error, Unset):
            ...
            error = MinCountRuleConstant1ParametersSpec.from_dict(_error)
        ...
        if isinstance(_fatal, Unset):
            ...
            fatal = MinCountRuleConstant1ParametersSpec.from_dict(_fatal)

        column_empty_column_found_check_spec = cls(
        ...
        column_empty_column_found_check_spec.additional_properties = d
        return column_empty_column_found_check_spec
