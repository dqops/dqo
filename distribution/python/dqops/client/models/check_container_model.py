...
from ..models.check_container_model_effective_schedule_enabled_status import CheckContainerModelEffectiveScheduleEnabledStatus
...
class CheckContainerModel:
    ...
    effective_schedule_enabled_status: Union[Unset, CheckContainerModelEffectiveScheduleEnabledStatus] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.effective_schedule_enabled_status, Unset):
            effective_schedule_enabled_status = self.effective_schedule_enabled_status.value
        ...
        if effective_schedule_enabled_status is not UNSET:
            field_dict["effective_schedule_enabled_status"] = effective_schedule_enabled_status
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _effective_schedule_enabled_status = d.pop("effective_schedule_enabled_status", UNSET)
        effective_schedule_enabled_status: Union[Unset, CheckContainerModelEffectiveScheduleEnabledStatus]
        if isinstance(_effective_schedule_enabled_status,  Unset):
            effective_schedule_enabled_status = UNSET
        else:
            effective_schedule_enabled_status = CheckContainerModelEffectiveScheduleEnabledStatus(_effective_schedule_enabled_status)
