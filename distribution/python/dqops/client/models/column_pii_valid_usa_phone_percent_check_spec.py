...
if TYPE_CHECKING:
    from ..models.column_pii_valid_usa_phone_percent_sensor_parameters_spec import (
...
class ColumnPiiValidUsaPhonePercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnPiiValidUsaPhonePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnPiiValidUsaPhonePercentSensorParametersSpec.from_dict(
                _parameters
            )
