...
if TYPE_CHECKING:
  ...
  from ..models.column_pii_valid_usa_phone_percent_sensor_parameters_spec import ColumnPiiValidUsaPhonePercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnPiiValidUsaPhonePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnPiiValidUsaPhonePercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnPiiValidUsaPhonePercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnPiiValidUsaPhonePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnPiiValidUsaPhonePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_pii_valid_usa_phone_percent_check_spec = cls(
        ...
        column_pii_valid_usa_phone_percent_check_spec.additional_properties = d
        return column_pii_valid_usa_phone_percent_check_spec
