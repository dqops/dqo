...
if TYPE_CHECKING:
    ...
    from ..models.column_nulls_nulls_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnAnomalyStationaryNullPercent30DaysCheckSpec")


@_attrs_define
class ColumnAnomalyStationaryNullPercent30DaysCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnNullsNullsPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, "ColumnNullsNullsPercentSensorParametersSpec"] = UNSET
    warning: Union[
        Unset, "AnomalyStationaryPercentileMovingAverage30DaysRule1ParametersSpec"
    ] = UNSET
    error: Union[
        Unset, "AnomalyStationaryPercentileMovingAverage30DaysRule05ParametersSpec"
    ] = UNSET
    fatal: Union[
        Unset, "AnomalyStationaryPercentileMovingAverage30DaysRule01ParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnNullsNullsPercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        if isinstance(_warning, Unset):
            ...
            warning = AnomalyStationaryPercentileMovingAverage30DaysRule1ParametersSpec.from_dict(
                _warning
            )
        ...
        if isinstance(_error, Unset):
            ...
            error = AnomalyStationaryPercentileMovingAverage30DaysRule05ParametersSpec.from_dict(
                _error
            )
        ...
        if isinstance(_fatal, Unset):
            ...
            fatal = AnomalyStationaryPercentileMovingAverage30DaysRule01ParametersSpec.from_dict(
                _fatal
            )

        column_anomaly_stationary_null_percent_30_days_check_spec = cls(
        ...
        column_anomaly_stationary_null_percent_30_days_check_spec.additional_properties = (
            d
        )
        return column_anomaly_stationary_null_percent_30_days_check_spec
