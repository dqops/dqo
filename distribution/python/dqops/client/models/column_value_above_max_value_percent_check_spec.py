...
if TYPE_CHECKING:
    from ..models.column_numeric_value_above_max_value_percent_sensor_parameters_spec import (
...
class ColumnValueAboveMaxValuePercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnNumericValueAboveMaxValuePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnNumericValueAboveMaxValuePercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
