...
if TYPE_CHECKING:
  from ..models.column_numeric_value_above_max_value_percent_sensor_parameters_spec import ColumnNumericValueAboveMaxValuePercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnValueAboveMaxValuePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnValueAboveMaxValuePercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnNumericValueAboveMaxValuePercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnNumericValueAboveMaxValuePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericValueAboveMaxValuePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_value_above_max_value_percent_check_spec = cls(
        ...
        column_value_above_max_value_percent_check_spec.additional_properties = d
        return column_value_above_max_value_percent_check_spec
