...
T = TypeVar("T", bound="ColumnChangeMeanSinceYesterdayCheckSpec")


@_attrs_define
class ColumnChangeMeanSinceYesterdayCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_change_mean_since_yesterday_check_spec = cls(
        ...
        column_change_mean_since_yesterday_check_spec.additional_properties = d
        return column_change_mean_since_yesterday_check_spec
