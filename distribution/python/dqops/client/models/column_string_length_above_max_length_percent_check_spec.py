...
if TYPE_CHECKING:
  from ..models.max_percent_rule_100_parameters_spec import MaxPercentRule100ParametersSpec
  from ..models.recurring_schedule_spec import RecurringScheduleSpec
  from ..models.max_percent_rule_95_parameters_spec import MaxPercentRule95ParametersSpec
  from ..models.max_percent_rule_99_parameters_spec import MaxPercentRule99ParametersSpec
  from ..models.comment_spec import CommentSpec
  from ..models.column_strings_string_length_above_max_length_percent_sensor_parameters_spec import ColumnStringsStringLengthAboveMaxLengthPercentSensorParametersSpec





T = TypeVar("T", bound="ColumnStringLengthAboveMaxLengthPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringLengthAboveMaxLengthPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringLengthAboveMaxLengthPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringLengthAboveMaxLengthPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringLengthAboveMaxLengthPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_length_above_max_length_percent_check_spec = cls(
        ...
        column_string_length_above_max_length_percent_check_spec.additional_properties = d
        return column_string_length_above_max_length_percent_check_spec
