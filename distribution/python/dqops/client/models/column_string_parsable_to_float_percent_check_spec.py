...
if TYPE_CHECKING:
    from ..models.column_strings_string_parsable_to_float_percent_sensor_parameters_spec import (
...
class ColumnStringParsableToFloatPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringParsableToFloatPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringParsableToFloatPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
