...
T = TypeVar("T", bound="OptionalRecurringScheduleSpec")


@attr.s(auto_attribs=True)
class OptionalRecurringScheduleSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        optional_recurring_schedule_spec = cls(
            empty=empty,
            present=present,
        )

        optional_recurring_schedule_spec.additional_properties = d
        return optional_recurring_schedule_spec
