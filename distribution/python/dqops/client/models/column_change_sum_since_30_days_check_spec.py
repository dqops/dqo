...
@_attrs_define
class ColumnChangeSumSince30DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_change_sum_since_30_days_check_spec.additional_properties = d
        return column_change_sum_since_30_days_check_spec
