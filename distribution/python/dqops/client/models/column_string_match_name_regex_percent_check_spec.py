...
if TYPE_CHECKING:
    from ..models.column_strings_string_match_name_regex_percent_sensor_parameters_spec import (
...
class ColumnStringMatchNameRegexPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringMatchNameRegexPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringMatchNameRegexPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
