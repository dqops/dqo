...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_match_name_regex_percent_sensor_parameters_spec import ColumnStringsStringMatchNameRegexPercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringMatchNameRegexPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringMatchNameRegexPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringMatchNameRegexPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringMatchNameRegexPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringMatchNameRegexPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_match_name_regex_percent_check_spec = cls(
        ...
        column_string_match_name_regex_percent_check_spec.additional_properties = d
        return column_string_match_name_regex_percent_check_spec
