...
if TYPE_CHECKING:
  ...
  from ..models.column_consistency_date_match_format_percent_sensor_parameters_spec import ColumnConsistencyDateMatchFormatPercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnConsistencyDateMatchFormatPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnConsistencyDateMatchFormatPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnConsistencyDateMatchFormatPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnConsistencyDateMatchFormatPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnConsistencyDateMatchFormatPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_consistency_date_match_format_percent_check_spec = cls(
        ...
        column_consistency_date_match_format_percent_check_spec.additional_properties = d
        return column_consistency_date_match_format_percent_check_spec
