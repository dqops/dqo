...
if TYPE_CHECKING:
    from ..models.column_consistency_date_match_format_percent_sensor_parameters_spec import (
...
class ColumnConsistencyDateMatchFormatPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnConsistencyDateMatchFormatPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnConsistencyDateMatchFormatPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_consistency_date_match_format_percent_check_spec.additional_properties = (
            d
        )
