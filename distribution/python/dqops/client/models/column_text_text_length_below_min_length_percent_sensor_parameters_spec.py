...
T = TypeVar("T", bound="ColumnTextTextLengthBelowMinLengthPercentSensorParametersSpec")


@_attrs_define
class ColumnTextTextLengthBelowMinLengthPercentSensorParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_text_text_length_below_min_length_percent_sensor_parameters_spec = cls(
            filter_=filter_,
            min_length=min_length,
        )

        column_text_text_length_below_min_length_percent_sensor_parameters_spec.additional_properties = (
            d
        )
        return column_text_text_length_below_min_length_percent_sensor_parameters_spec
