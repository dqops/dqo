...
if TYPE_CHECKING:
  ...
  from ..models.table_volume_row_count_sensor_parameters_spec import TableVolumeRowCountSensorParametersSpec
...
T = TypeVar("T", bound="TableComparisonRowCountMatchCheckSpec")


@attr.s(auto_attribs=True)
class TableComparisonRowCountMatchCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_comparison_row_count_match_check_spec = cls(
        ...
        table_comparison_row_count_match_check_spec.additional_properties = d
        return table_comparison_row_count_match_check_spec
