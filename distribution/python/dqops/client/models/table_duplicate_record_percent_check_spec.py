...
if TYPE_CHECKING:
    ...
    from ..models.table_duplicate_record_percent_sensor_parameters_spec import (
        TableDuplicateRecordPercentSensorParametersSpec,
    )


T = TypeVar("T", bound="TableDuplicateRecordPercentCheckSpec")


@_attrs_define
class TableDuplicateRecordPercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, TableDuplicateRecordPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, "TableDuplicateRecordPercentSensorParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = TableDuplicateRecordPercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        table_duplicate_record_percent_check_spec = cls(
        ...
        table_duplicate_record_percent_check_spec.additional_properties = d
        return table_duplicate_record_percent_check_spec
