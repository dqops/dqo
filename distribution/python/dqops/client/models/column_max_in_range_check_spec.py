...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_max_sensor_parameters_spec import ColumnNumericMaxSensorParametersSpec
...
T = TypeVar("T", bound="ColumnMaxInRangeCheckSpec")


@attr.s(auto_attribs=True)
class ColumnMaxInRangeCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericMaxSensorParametersSpec.from_dict(_parameters)
        ...
        column_max_in_range_check_spec = cls(
        ...
        column_max_in_range_check_spec.additional_properties = d
        return column_max_in_range_check_spec
