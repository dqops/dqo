...
if TYPE_CHECKING:
  ...
  from ..models.column_integrity_foreign_key_not_match_count_sensor_parameters_spec import ColumnIntegrityForeignKeyNotMatchCountSensorParametersSpec





T = TypeVar("T", bound="ColumnIntegrityForeignKeyNotMatchCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnIntegrityForeignKeyNotMatchCountCheckSpec:
    """ 
        Attributes:
    ...
    parameters: Union[Unset, 'ColumnIntegrityForeignKeyNotMatchCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnIntegrityForeignKeyNotMatchCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_integrity_foreign_key_not_match_count_check_spec = cls(
        ...
        column_integrity_foreign_key_not_match_count_check_spec.additional_properties = d
        return column_integrity_foreign_key_not_match_count_check_spec
