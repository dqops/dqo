...
if TYPE_CHECKING:
  from ..models.column_strings_string_empty_count_sensor_parameters_spec import ColumnStringsStringEmptyCountSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringEmptyCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringEmptyCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringEmptyCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringEmptyCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringEmptyCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_empty_count_check_spec = cls(
        ...
        column_string_empty_count_check_spec.additional_properties = d
        return column_string_empty_count_check_spec
