...
if TYPE_CHECKING:
    from ..models.column_strings_string_empty_count_sensor_parameters_spec import (
...
class ColumnStringEmptyCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringEmptyCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnStringsStringEmptyCountSensorParametersSpec.from_dict(
                _parameters
            )
