...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_surrounded_by_whitespace_count_sensor_parameters_spec import ColumnStringsStringSurroundedByWhitespaceCountSensorParametersSpec





T = TypeVar("T", bound="ColumnStringSurroundedByWhitespaceCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringSurroundedByWhitespaceCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringSurroundedByWhitespaceCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringSurroundedByWhitespaceCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringSurroundedByWhitespaceCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_surrounded_by_whitespace_count_check_spec = cls(
        ...
        column_string_surrounded_by_whitespace_count_check_spec.additional_properties = d
        return column_string_surrounded_by_whitespace_count_check_spec
