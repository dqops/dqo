...
if TYPE_CHECKING:
    from ..models.column_strings_string_surrounded_by_whitespace_count_sensor_parameters_spec import (
...
class ColumnStringSurroundedByWhitespaceCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringSurroundedByWhitespaceCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnStringsStringSurroundedByWhitespaceCountSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_string_surrounded_by_whitespace_count_check_spec.additional_properties = (
            d
        )
