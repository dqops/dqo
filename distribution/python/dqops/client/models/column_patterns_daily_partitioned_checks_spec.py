...
class ColumnPatternsDailyPartitionedChecksSpec:
    ...
    Attributes:
        ...
        daily_partition_valid_usa_phone_format_percent (Union[Unset, ColumnValidUsaPhonePercentCheckSpec]):
        daily_partition_valid_usa_zipcode_format_percent (Union[Unset, ColumnValidUsaZipcodePercentCheckSpec]):
    """
    ...
    daily_partition_valid_usa_phone_format_percent: Union[
        Unset, "ColumnValidUsaPhonePercentCheckSpec"
    ] = UNSET
    daily_partition_valid_usa_zipcode_format_percent: Union[
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        daily_partition_valid_usa_phone_format_percent: Union[Unset, Dict[str, Any]] = (
            UNSET
        )
        if not isinstance(self.daily_partition_valid_usa_phone_format_percent, Unset):
            daily_partition_valid_usa_phone_format_percent = (
                self.daily_partition_valid_usa_phone_format_percent.to_dict()
            )

        daily_partition_valid_usa_zipcode_format_percent: Union[
            Unset, Dict[str, Any]
        ] = UNSET
        if not isinstance(self.daily_partition_valid_usa_zipcode_format_percent, Unset):
            daily_partition_valid_usa_zipcode_format_percent = (
                self.daily_partition_valid_usa_zipcode_format_percent.to_dict()
            )
        ...
        if daily_partition_valid_usa_phone_format_percent is not UNSET:
            field_dict["daily_partition_valid_usa_phone_format_percent"] = (
                daily_partition_valid_usa_phone_format_percent
            )
        if daily_partition_valid_usa_zipcode_format_percent is not UNSET:
            field_dict["daily_partition_valid_usa_zipcode_format_percent"] = (
                daily_partition_valid_usa_zipcode_format_percent
            )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _daily_partition_valid_usa_phone_format_percent = d.pop(
            "daily_partition_valid_usa_phone_format_percent", UNSET
        )
        daily_partition_valid_usa_phone_format_percent: Union[
            Unset, ColumnValidUsaPhonePercentCheckSpec
        ]
        if isinstance(_daily_partition_valid_usa_phone_format_percent, Unset):
            daily_partition_valid_usa_phone_format_percent = UNSET
        else:
            daily_partition_valid_usa_phone_format_percent = (
                ColumnValidUsaPhonePercentCheckSpec.from_dict(
                    _daily_partition_valid_usa_phone_format_percent
                )
            )

        _daily_partition_valid_usa_zipcode_format_percent = d.pop(
            "daily_partition_valid_usa_zipcode_format_percent", UNSET
        )
        daily_partition_valid_usa_zipcode_format_percent: Union[
            Unset, ColumnValidUsaZipcodePercentCheckSpec
        ]
        if isinstance(_daily_partition_valid_usa_zipcode_format_percent, Unset):
            daily_partition_valid_usa_zipcode_format_percent = UNSET
        else:
            daily_partition_valid_usa_zipcode_format_percent = (
                ColumnValidUsaZipcodePercentCheckSpec.from_dict(
                    _daily_partition_valid_usa_zipcode_format_percent
                )
            )
        ...
        column_patterns_daily_partitioned_checks_spec = cls(
            ...
            daily_partition_valid_usa_phone_format_percent=daily_partition_valid_usa_phone_format_percent,
            daily_partition_valid_usa_zipcode_format_percent=daily_partition_valid_usa_zipcode_format_percent,
        )
