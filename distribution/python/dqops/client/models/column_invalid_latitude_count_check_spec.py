...
if TYPE_CHECKING:
  from ..models.column_numeric_invalid_latitude_count_sensor_parameters_spec import ColumnNumericInvalidLatitudeCountSensorParametersSpec
...
T = TypeVar("T", bound="ColumnInvalidLatitudeCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnInvalidLatitudeCountCheckSpec:
    """ 
        Attributes:
    ...
    parameters: Union[Unset, 'ColumnNumericInvalidLatitudeCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericInvalidLatitudeCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_invalid_latitude_count_check_spec = cls(
        ...
        column_invalid_latitude_count_check_spec.additional_properties = d
        return column_invalid_latitude_count_check_spec
