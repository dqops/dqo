...
if TYPE_CHECKING:
    from ..models.column_patterns_text_not_matching_regex_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextNotMatchingRegexFoundCheckSpec")


@_attrs_define
class ColumnTextNotMatchingRegexFoundCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnPatternsTextNotMatchingRegexCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsTextNotMatchingRegexCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnPatternsTextNotMatchingRegexCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_text_not_matching_regex_found_check_spec = cls(
        ...
        column_text_not_matching_regex_found_check_spec.additional_properties = d
        return column_text_not_matching_regex_found_check_spec
