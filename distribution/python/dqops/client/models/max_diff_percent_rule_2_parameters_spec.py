...
T = TypeVar("T", bound="MaxDiffPercentRule2ParametersSpec")


@attr.s(auto_attribs=True)
class MaxDiffPercentRule2ParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        max_diff_percent_rule_2_parameters_spec = cls(
            max_diff_percent=max_diff_percent,
        )

        max_diff_percent_rule_2_parameters_spec.additional_properties = d
        return max_diff_percent_rule_2_parameters_spec
