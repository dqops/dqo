...
T = TypeVar("T", bound="ColumnPiiMonthlyMonitoringChecksSpec")
...
class ColumnPiiMonthlyMonitoringChecksSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_pii_monthly_monitoring_checks_spec.additional_properties = d
        return column_pii_monthly_monitoring_checks_spec
