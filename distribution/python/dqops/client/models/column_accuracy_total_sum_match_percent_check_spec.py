...
if TYPE_CHECKING:
  ...
  from ..models.column_accuracy_total_sum_match_percent_sensor_parameters_spec import ColumnAccuracyTotalSumMatchPercentSensorParametersSpec
...
class ColumnAccuracyTotalSumMatchPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnAccuracyTotalSumMatchPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnAccuracyTotalSumMatchPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnAccuracyTotalSumMatchPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_accuracy_total_sum_match_percent_check_spec = cls(
        ...
        column_accuracy_total_sum_match_percent_check_spec.additional_properties = d
        return column_accuracy_total_sum_match_percent_check_spec
