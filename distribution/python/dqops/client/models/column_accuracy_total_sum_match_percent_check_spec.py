...
if TYPE_CHECKING:
    from ..models.column_accuracy_total_sum_match_percent_sensor_parameters_spec import (
...
class ColumnAccuracyTotalSumMatchPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnAccuracyTotalSumMatchPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnAccuracyTotalSumMatchPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
