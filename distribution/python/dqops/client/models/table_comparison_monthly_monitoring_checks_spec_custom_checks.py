...
T = TypeVar("T", bound="TableComparisonMonthlyMonitoringChecksSpecCustomChecks")


@_attrs_define
class TableComparisonMonthlyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_comparison_monthly_monitoring_checks_spec_custom_checks = cls()
        ...
        table_comparison_monthly_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_comparison_monthly_monitoring_checks_spec_custom_checks
