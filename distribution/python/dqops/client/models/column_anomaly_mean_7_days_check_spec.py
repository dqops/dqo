...
if TYPE_CHECKING:
    ...
    from ..models.percentile_moving_within_7_days_rule_parameters_spec import (
        PercentileMovingWithin7DaysRuleParametersSpec,
    )
    from ..models.recurring_schedule_spec import RecurringScheduleSpec


T = TypeVar("T", bound="ColumnAnomalyMean7DaysCheckSpec")


@attr.s(auto_attribs=True)
class ColumnAnomalyMean7DaysCheckSpec:
    """
    Attributes:
        ...
        warning (Union[Unset, PercentileMovingWithin7DaysRuleParametersSpec]):
        error (Union[Unset, PercentileMovingWithin7DaysRuleParametersSpec]):
        fatal (Union[Unset, PercentileMovingWithin7DaysRuleParametersSpec]):
    """
    ...
    warning: Union[Unset, "PercentileMovingWithin7DaysRuleParametersSpec"] = UNSET
    error: Union[Unset, "PercentileMovingWithin7DaysRuleParametersSpec"] = UNSET
    fatal: Union[Unset, "PercentileMovingWithin7DaysRuleParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_warning, Unset):
            ...
            warning = PercentileMovingWithin7DaysRuleParametersSpec.from_dict(_warning)
        ...
        if isinstance(_error, Unset):
            ...
            error = PercentileMovingWithin7DaysRuleParametersSpec.from_dict(_error)
        ...
        if isinstance(_fatal, Unset):
            ...
            fatal = PercentileMovingWithin7DaysRuleParametersSpec.from_dict(_fatal)

        column_anomaly_mean_7_days_check_spec = cls(
        ...
        column_anomaly_mean_7_days_check_spec.additional_properties = d
        return column_anomaly_mean_7_days_check_spec
