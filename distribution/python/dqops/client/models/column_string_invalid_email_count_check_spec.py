...
if TYPE_CHECKING:
    from ..models.column_strings_string_invalid_email_count_sensor_parameters_spec import (
...
class ColumnStringInvalidEmailCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringInvalidEmailCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringInvalidEmailCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
