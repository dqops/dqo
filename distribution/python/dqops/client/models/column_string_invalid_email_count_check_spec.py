...
if TYPE_CHECKING:
  from ..models.column_strings_string_invalid_email_count_sensor_parameters_spec import ColumnStringsStringInvalidEmailCountSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringInvalidEmailCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringInvalidEmailCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringInvalidEmailCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringInvalidEmailCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringInvalidEmailCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_invalid_email_count_check_spec = cls(
        ...
        column_string_invalid_email_count_check_spec.additional_properties = d
        return column_string_invalid_email_count_check_spec
