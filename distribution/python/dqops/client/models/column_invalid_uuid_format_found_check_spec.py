...
if TYPE_CHECKING:
    from ..models.column_patterns_invalid_uuid_format_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnInvalidUuidFormatFoundCheckSpec")


@_attrs_define
class ColumnInvalidUuidFormatFoundCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnPatternsInvalidUuidFormatCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsInvalidUuidFormatCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnPatternsInvalidUuidFormatCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_invalid_uuid_format_found_check_spec = cls(
        ...
        column_invalid_uuid_format_found_check_spec.additional_properties = d
        return column_invalid_uuid_format_found_check_spec
