...
if TYPE_CHECKING:
    from ..models.column_strings_expected_texts_in_top_values_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnExpectedTextsInTopValuesCountCheckSpec")


@_attrs_define
class ColumnExpectedTextsInTopValuesCountCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnStringsExpectedTextsInTopValuesCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnStringsExpectedTextsInTopValuesCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnStringsExpectedTextsInTopValuesCountSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_expected_texts_in_top_values_count_check_spec = cls(
        ...
        column_expected_texts_in_top_values_count_check_spec.additional_properties = d
        return column_expected_texts_in_top_values_count_check_spec
