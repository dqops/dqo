...
T = TypeVar("T", bound="AnomalyStationaryPercentileMovingAverage30DaysRule1ParametersSpec")


@attr.s(auto_attribs=True)
class AnomalyStationaryPercentileMovingAverage30DaysRule1ParametersSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        anomaly_stationary_percentile_moving_average_30_days_rule_1_parameters_spec = cls(
            anomaly_percent=anomaly_percent,
        )

        anomaly_stationary_percentile_moving_average_30_days_rule_1_parameters_spec.additional_properties = d
        return anomaly_stationary_percentile_moving_average_30_days_rule_1_parameters_spec
