...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_non_negative_count_sensor_parameters_spec import ColumnNumericNonNegativeCountSensorParametersSpec





T = TypeVar("T", bound="ColumnNonNegativeCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnNonNegativeCountCheckSpec:
    """ 
        Attributes:
    ...
    parameters: Union[Unset, 'ColumnNumericNonNegativeCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericNonNegativeCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_non_negative_count_check_spec.additional_properties = d
        return column_non_negative_count_check_spec
