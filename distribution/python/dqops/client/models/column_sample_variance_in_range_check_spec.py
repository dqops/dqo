...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_sample_variance_sensor_parameters_spec import ColumnNumericSampleVarianceSensorParametersSpec
...
T = TypeVar("T", bound="ColumnSampleVarianceInRangeCheckSpec")


@attr.s(auto_attribs=True)
class ColumnSampleVarianceInRangeCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericSampleVarianceSensorParametersSpec.from_dict(_parameters)
        ...
        column_sample_variance_in_range_check_spec = cls(
        ...
        column_sample_variance_in_range_check_spec.additional_properties = d
        return column_sample_variance_in_range_check_spec
