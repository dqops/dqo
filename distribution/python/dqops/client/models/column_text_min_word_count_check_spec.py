...
T = TypeVar("T", bound="ColumnTextMinWordCountCheckSpec")


@_attrs_define
class ColumnTextMinWordCountCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_text_min_word_count_check_spec = cls(
        ...
        column_text_min_word_count_check_spec.additional_properties = d
        return column_text_min_word_count_check_spec
