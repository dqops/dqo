...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_expected_numbers_in_use_count_sensor_parameters_spec import ColumnNumericExpectedNumbersInUseCountSensorParametersSpec
...
T = TypeVar("T", bound="ColumnExpectedNumbersInUseCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnExpectedNumbersInUseCountCheckSpec:
    """ 
        Attributes:
    ...
    parameters: Union[Unset, 'ColumnNumericExpectedNumbersInUseCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericExpectedNumbersInUseCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_expected_numbers_in_use_count_check_spec = cls(
        ...
        column_expected_numbers_in_use_count_check_spec.additional_properties = d
        return column_expected_numbers_in_use_count_check_spec
