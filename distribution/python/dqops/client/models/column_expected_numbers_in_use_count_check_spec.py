...
if TYPE_CHECKING:
    from ..models.column_numeric_expected_numbers_in_use_count_sensor_parameters_spec import (
...
class ColumnExpectedNumbersInUseCountCheckSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnNumericExpectedNumbersInUseCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
