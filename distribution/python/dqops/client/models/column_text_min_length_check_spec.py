...
T = TypeVar("T", bound="ColumnTextMinLengthCheckSpec")


@_attrs_define
class ColumnTextMinLengthCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnTextTextMinLengthSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_text_min_length_check_spec.additional_properties = d
        return column_text_min_length_check_spec
