...
if TYPE_CHECKING:
  ...
  from ..models.column_accuracy_total_max_match_percent_sensor_parameters_spec import ColumnAccuracyTotalMaxMatchPercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnAccuracyTotalMaxMatchPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnAccuracyTotalMaxMatchPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnAccuracyTotalMaxMatchPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnAccuracyTotalMaxMatchPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnAccuracyTotalMaxMatchPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_accuracy_total_max_match_percent_check_spec = cls(
        ...
        column_accuracy_total_max_match_percent_check_spec.additional_properties = d
        return column_accuracy_total_max_match_percent_check_spec
