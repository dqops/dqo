...
if TYPE_CHECKING:
    from ..models.column_accuracy_total_max_match_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnAccuracyTotalTotalMaxMatchPercentCheckSpec")
...
class ColumnAccuracyTotalMaxMatchPercentCheckSpec:
    ...
    Attributes:
        ...
        parameters (Union[Unset, ColumnAccuracyTotalTotalMaxMatchPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnAccuracyTotalTotalMaxMatchPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnAccuracyTotalMaxMatchPercentSensorParametersSpec.from_dict(
                _parameters
            )
