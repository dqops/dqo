...
T = TypeVar("T", bound="ColumnMeanInRangeCheckSpec")


@_attrs_define
class ColumnMeanInRangeCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_mean_in_range_check_spec = cls(
        ...
        column_mean_in_range_check_spec.additional_properties = d
        return column_mean_in_range_check_spec
