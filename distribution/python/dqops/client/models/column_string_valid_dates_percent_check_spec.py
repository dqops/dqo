...
if TYPE_CHECKING:
    from ..models.column_strings_string_valid_date_percent_sensor_parameters_spec import (
...
class ColumnStringValidDatesPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringValidDatePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringValidDatePercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
