...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_valid_date_percent_sensor_parameters_spec import ColumnStringsStringValidDatePercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringValidDatesPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringValidDatesPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringValidDatePercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringValidDatePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringValidDatePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_valid_dates_percent_check_spec = cls(
        ...
        column_string_valid_dates_percent_check_spec.additional_properties = d
        return column_string_valid_dates_percent_check_spec
