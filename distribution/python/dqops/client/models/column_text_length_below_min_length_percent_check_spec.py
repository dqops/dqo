...
if TYPE_CHECKING:
    from ..models.column_text_text_length_below_min_length_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextLengthBelowMinLengthPercentCheckSpec")


@_attrs_define
class ColumnTextLengthBelowMinLengthPercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnTextTextLengthBelowMinLengthPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnTextTextLengthBelowMinLengthPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnTextTextLengthBelowMinLengthPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_text_length_below_min_length_percent_check_spec = cls(
        ...
        column_text_length_below_min_length_percent_check_spec.additional_properties = d
        return column_text_length_below_min_length_percent_check_spec
