...
T = TypeVar("T", bound="TableMonthlyMonitoringCheckCategoriesSpecCustom")


@_attrs_define
class TableMonthlyMonitoringCheckCategoriesSpecCustom:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_monthly_monitoring_check_categories_spec_custom = cls()
        ...
        table_monthly_monitoring_check_categories_spec_custom.additional_properties = (
            additional_properties
        )
        return table_monthly_monitoring_check_categories_spec_custom
