...
if TYPE_CHECKING:
  from ..models.table_schema_column_count_check_spec import TableSchemaColumnCountCheckSpec
  from ..models.table_schema_column_types_changed_check_spec import TableSchemaColumnTypesChangedCheckSpec
  from ..models.table_schema_column_count_changed_check_spec import TableSchemaColumnCountChangedCheckSpec
  from ..models.table_schema_column_list_or_order_changed_check_spec import TableSchemaColumnListOrOrderChangedCheckSpec
  from ..models.table_schema_column_list_changed_check_spec import TableSchemaColumnListChangedCheckSpec
...
class TableSchemaProfilingChecksSpec:
    ...
    column_list_or_order_changed: Union[Unset, 'TableSchemaColumnListOrOrderChangedCheckSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_column_count_changed,  Unset):
            ...
            column_count_changed = TableSchemaColumnCountChangedCheckSpec.from_dict(_column_count_changed)
        ...
        if isinstance(_column_list_changed,  Unset):
            ...
            column_list_changed = TableSchemaColumnListChangedCheckSpec.from_dict(_column_list_changed)
        ...
        if isinstance(_column_list_or_order_changed,  Unset):
            ...
            column_list_or_order_changed = TableSchemaColumnListOrOrderChangedCheckSpec.from_dict(_column_list_or_order_changed)
        ...
        if isinstance(_column_types_changed,  Unset):
            ...
            column_types_changed = TableSchemaColumnTypesChangedCheckSpec.from_dict(_column_types_changed)
