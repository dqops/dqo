...
class ColumnUniquenessMonthlyRecurringChecksSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_monthly_distinct_count,  Unset):
            ...
            monthly_distinct_count = ColumnDistinctCountCheckSpec.from_dict(_monthly_distinct_count)
        ...
        if isinstance(_monthly_distinct_percent,  Unset):
            ...
            monthly_distinct_percent = ColumnDistinctPercentCheckSpec.from_dict(_monthly_distinct_percent)
        ...
        if isinstance(_monthly_duplicate_count,  Unset):
            ...
            monthly_duplicate_count = ColumnDuplicateCountCheckSpec.from_dict(_monthly_duplicate_count)
        ...
        if isinstance(_monthly_duplicate_percent,  Unset):
            ...
            monthly_duplicate_percent = ColumnDuplicatePercentCheckSpec.from_dict(_monthly_duplicate_percent)
