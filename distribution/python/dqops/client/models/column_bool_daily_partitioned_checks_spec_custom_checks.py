...
T = TypeVar("T", bound="ColumnBoolDailyPartitionedChecksSpecCustomChecks")


@_attrs_define
class ColumnBoolDailyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_bool_daily_partitioned_checks_spec_custom_checks = cls()
        ...
        column_bool_daily_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_bool_daily_partitioned_checks_spec_custom_checks
