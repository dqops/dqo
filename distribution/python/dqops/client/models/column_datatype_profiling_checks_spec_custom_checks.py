...
T = TypeVar("T", bound="ColumnDatatypeProfilingChecksSpecCustomChecks")


@_attrs_define
class ColumnDatatypeProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_datatype_profiling_checks_spec_custom_checks = cls()
        ...
        column_datatype_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_datatype_profiling_checks_spec_custom_checks
