...
T = TypeVar("T", bound="TableDataFreshnessAnomalyCheckSpec")
...
class TableDataFreshnessAnomalyCheckSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_data_freshness_anomaly_check_spec.additional_properties = d
        return table_data_freshness_anomaly_check_spec
