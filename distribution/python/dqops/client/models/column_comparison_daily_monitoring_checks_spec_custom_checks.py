...
T = TypeVar("T", bound="ColumnComparisonDailyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnComparisonDailyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_comparison_daily_monitoring_checks_spec_custom_checks = cls()
        ...
        column_comparison_daily_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_comparison_daily_monitoring_checks_spec_custom_checks
