...
T = TypeVar("T", bound="ColumnIntegrityDailyPartitionedChecksSpecCustomChecks")


@_attrs_define
class ColumnIntegrityDailyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_integrity_daily_partitioned_checks_spec_custom_checks = cls()
        ...
        column_integrity_daily_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_integrity_daily_partitioned_checks_spec_custom_checks
