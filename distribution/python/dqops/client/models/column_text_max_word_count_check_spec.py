...
if TYPE_CHECKING:
    ...
    from ..models.column_text_max_word_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextMaxWordCountCheckSpec")


@_attrs_define
class ColumnTextMaxWordCountCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnTextMaxWordCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, "ColumnTextMaxWordCountSensorParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnTextMaxWordCountSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_text_max_word_count_check_spec = cls(
        ...
        column_text_max_word_count_check_spec.additional_properties = d
        return column_text_max_word_count_check_spec
