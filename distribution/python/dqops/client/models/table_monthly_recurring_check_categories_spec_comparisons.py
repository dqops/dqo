...
if TYPE_CHECKING:
  from ..models.table_comparison_monthly_recurring_checks_spec import TableComparisonMonthlyRecurringChecksSpec
...
class TableMonthlyRecurringCheckCategoriesSpecComparisons:
    ...
    additional_properties: Dict[str, 'TableComparisonMonthlyRecurringChecksSpec'] = attr.ib(init=False, factory=dict)
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            additional_property = TableComparisonMonthlyRecurringChecksSpec.from_dict(prop_dict)



            additional_properties[prop_name] = additional_property

        table_monthly_recurring_check_categories_spec_comparisons.additional_properties = additional_properties
    ...
    def __setitem__(self, key: str, value: 'TableComparisonMonthlyRecurringChecksSpec') -> None:
