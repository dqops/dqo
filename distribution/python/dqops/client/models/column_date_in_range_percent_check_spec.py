...
if TYPE_CHECKING:
    from ..models.column_date_in_range_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnDateInRangePercentCheckSpec")


@_attrs_define
class ColumnDateInRangePercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnDateInRangePercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, "ColumnDateInRangePercentSensorParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnDateInRangePercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_date_in_range_percent_check_spec = cls(
        ...
        column_date_in_range_percent_check_spec.additional_properties = d
        return column_date_in_range_percent_check_spec
