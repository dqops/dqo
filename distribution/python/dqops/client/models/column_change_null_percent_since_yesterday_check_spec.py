...
if TYPE_CHECKING:
    from ..models.change_percent_1_day_rule_10_parameters_spec import (
        ChangePercent1DayRule10ParametersSpec,
    )
    from ..models.change_percent_1_day_rule_20_parameters_spec import (
        ChangePercent1DayRule20ParametersSpec,
    )
    from ..models.change_percent_1_day_rule_50_parameters_spec import (
...
T = TypeVar("T", bound="ColumnChangeNullPercentSinceYesterdayCheckSpec")


@_attrs_define
class ColumnChangeNullPercentSinceYesterdayCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_change_null_percent_since_yesterday_check_spec = cls(
        ...
        column_change_null_percent_since_yesterday_check_spec.additional_properties = d
        return column_change_null_percent_since_yesterday_check_spec
