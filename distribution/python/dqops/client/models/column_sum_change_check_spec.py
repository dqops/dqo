...
T = TypeVar("T", bound="ColumnSumChangeCheckSpec")


@_attrs_define
class ColumnSumChangeCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_sum_change_check_spec = cls(
        ...
        column_sum_change_check_spec.additional_properties = d
        return column_sum_change_check_spec
