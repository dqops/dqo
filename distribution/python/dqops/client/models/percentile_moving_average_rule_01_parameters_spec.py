...
class PercentileMovingAverageRule01ParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        percentile_moving_average_rule_01_parameters_spec = cls(
            anomaly_percent=anomaly_percent,
        )

        percentile_moving_average_rule_01_parameters_spec.additional_properties = d
        return percentile_moving_average_rule_01_parameters_spec
