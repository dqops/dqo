...
T = TypeVar("T", bound="MinPercentRule2ParametersSpec")


@_attrs_define
class MinPercentRule2ParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        min_percent_rule_2_parameters_spec = cls(
            min_percent=min_percent,
        )

        min_percent_rule_2_parameters_spec.additional_properties = d
        return min_percent_rule_2_parameters_spec
