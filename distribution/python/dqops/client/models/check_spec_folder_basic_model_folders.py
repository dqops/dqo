...
class CheckSpecFolderBasicModelFolders:
    ...
    additional_properties: Dict[str, 'CheckSpecFolderBasicModel'] = attr.ib(init=False, factory=dict)
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        check_spec_folder_basic_model_folders.additional_properties = additional_properties
