...
T = TypeVar(
    "T", bound="AnomalyStationaryPercentileMovingAverageRuleFatal01PctParametersSpec"
)


@_attrs_define
class AnomalyStationaryPercentileMovingAverageRuleFatal01PctParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        anomaly_stationary_percentile_moving_average_rule_fatal_01_pct_parameters_spec = cls(
            anomaly_percent=anomaly_percent,
        )

        anomaly_stationary_percentile_moving_average_rule_fatal_01_pct_parameters_spec.additional_properties = (
            d
        )
        return anomaly_stationary_percentile_moving_average_rule_fatal_01_pct_parameters_spec
