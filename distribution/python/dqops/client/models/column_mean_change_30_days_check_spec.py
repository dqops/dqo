...
T = TypeVar("T", bound="ColumnMeanChange30DaysCheckSpec")


@_attrs_define
class ColumnMeanChange30DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_mean_change_30_days_check_spec = cls(
        ...
        column_mean_change_30_days_check_spec.additional_properties = d
        return column_mean_change_30_days_check_spec
