...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_length_below_min_length_percent_sensor_parameters_spec import ColumnStringsStringLengthBelowMinLengthPercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringLengthBelowMinLengthPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringLengthBelowMinLengthPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringLengthBelowMinLengthPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringLengthBelowMinLengthPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringLengthBelowMinLengthPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_length_below_min_length_percent_check_spec = cls(
        ...
        column_string_length_below_min_length_percent_check_spec.additional_properties = d
        return column_string_length_below_min_length_percent_check_spec
