...
if TYPE_CHECKING:
  ...
  from ..models.table_sql_condition_failed_count_sensor_parameters_spec import TableSqlConditionFailedCountSensorParametersSpec
...
T = TypeVar("T", bound="TableSqlConditionFailedCountCheckSpec")


@attr.s(auto_attribs=True)
class TableSqlConditionFailedCountCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = TableSqlConditionFailedCountSensorParametersSpec.from_dict(_parameters)
        ...
        table_sql_condition_failed_count_check_spec.additional_properties = d
        return table_sql_condition_failed_count_check_spec
