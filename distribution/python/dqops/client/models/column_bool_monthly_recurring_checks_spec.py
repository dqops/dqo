...
class ColumnBoolMonthlyRecurringChecksSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_monthly_true_percent,  Unset):
            ...
            monthly_true_percent = ColumnTruePercentCheckSpec.from_dict(_monthly_true_percent)
        ...
        if isinstance(_monthly_false_percent,  Unset):
            ...
            monthly_false_percent = ColumnFalsePercentCheckSpec.from_dict(_monthly_false_percent)
