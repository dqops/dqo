...
T = TypeVar("T", bound="ColumnNumericValueAboveMaxValuePercentSensorParametersSpec")


@attr.s(auto_attribs=True)
class ColumnNumericValueAboveMaxValuePercentSensorParametersSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_numeric_value_above_max_value_percent_sensor_parameters_spec = cls(
            filter_=filter_,
            max_value=max_value,
        )

        column_numeric_value_above_max_value_percent_sensor_parameters_spec.additional_properties = d
        return column_numeric_value_above_max_value_percent_sensor_parameters_spec
