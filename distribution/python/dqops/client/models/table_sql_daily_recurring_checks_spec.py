...
class TableSqlDailyRecurringChecksSpec:
    ...
    daily_sql_condition_passed_percent_on_table: Union[Unset, 'TableSqlConditionPassedPercentCheckSpec'] = UNSET
    daily_sql_condition_failed_count_on_table: Union[Unset, 'TableSqlConditionFailedCountCheckSpec'] = UNSET
    daily_sql_aggregate_expr_table: Union[Unset, 'TableSqlAggregateExprCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        from ..models.table_sql_condition_passed_percent_check_spec import TableSqlConditionPassedPercentCheckSpec
        from ..models.table_sql_aggregate_expr_check_spec import TableSqlAggregateExprCheckSpec
        daily_sql_condition_passed_percent_on_table: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.daily_sql_condition_passed_percent_on_table, Unset):
            daily_sql_condition_passed_percent_on_table = self.daily_sql_condition_passed_percent_on_table.to_dict()
        ...
        if not isinstance(self.daily_sql_condition_failed_count_on_table, Unset):
            daily_sql_condition_failed_count_on_table = self.daily_sql_condition_failed_count_on_table.to_dict()

        daily_sql_aggregate_expr_table: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.daily_sql_aggregate_expr_table, Unset):
            daily_sql_aggregate_expr_table = self.daily_sql_aggregate_expr_table.to_dict()
        ...
        if daily_sql_condition_passed_percent_on_table is not UNSET:
            field_dict["daily_sql_condition_passed_percent_on_table"] = daily_sql_condition_passed_percent_on_table
        if daily_sql_condition_failed_count_on_table is not UNSET:
            field_dict["daily_sql_condition_failed_count_on_table"] = daily_sql_condition_failed_count_on_table
        if daily_sql_aggregate_expr_table is not UNSET:
            field_dict["daily_sql_aggregate_expr_table"] = daily_sql_aggregate_expr_table
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.table_sql_aggregate_expr_check_spec import TableSqlAggregateExprCheckSpec
        d = src_dict.copy()
        _daily_sql_condition_passed_percent_on_table = d.pop("daily_sql_condition_passed_percent_on_table", UNSET)
        daily_sql_condition_passed_percent_on_table: Union[Unset, TableSqlConditionPassedPercentCheckSpec]
        if isinstance(_daily_sql_condition_passed_percent_on_table,  Unset):
            daily_sql_condition_passed_percent_on_table = UNSET
        else:
            daily_sql_condition_passed_percent_on_table = TableSqlConditionPassedPercentCheckSpec.from_dict(_daily_sql_condition_passed_percent_on_table)




        _daily_sql_condition_failed_count_on_table = d.pop("daily_sql_condition_failed_count_on_table", UNSET)
        daily_sql_condition_failed_count_on_table: Union[Unset, TableSqlConditionFailedCountCheckSpec]
        if isinstance(_daily_sql_condition_failed_count_on_table,  Unset):
            daily_sql_condition_failed_count_on_table = UNSET
        else:
            daily_sql_condition_failed_count_on_table = TableSqlConditionFailedCountCheckSpec.from_dict(_daily_sql_condition_failed_count_on_table)
        ...
        if isinstance(_daily_sql_aggregate_expr_table,  Unset):
            ...
            daily_sql_aggregate_expr_table = TableSqlAggregateExprCheckSpec.from_dict(_daily_sql_aggregate_expr_table)
