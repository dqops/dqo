...
if TYPE_CHECKING:
    from ..models.column_strings_string_length_in_range_percent_sensor_parameters_spec import (
...
class ColumnStringLengthInRangePercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringLengthInRangePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringLengthInRangePercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
