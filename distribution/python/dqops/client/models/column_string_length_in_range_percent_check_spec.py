...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_length_in_range_percent_sensor_parameters_spec import ColumnStringsStringLengthInRangePercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringLengthInRangePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringLengthInRangePercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringLengthInRangePercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringLengthInRangePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringLengthInRangePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_length_in_range_percent_check_spec = cls(
        ...
        column_string_length_in_range_percent_check_spec.additional_properties = d
        return column_string_length_in_range_percent_check_spec
