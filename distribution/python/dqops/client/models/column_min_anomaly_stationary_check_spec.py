...
T = TypeVar("T", bound="ColumnMinAnomalyStationaryCheckSpec")


@_attrs_define
class ColumnMinAnomalyStationaryCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_min_anomaly_stationary_check_spec = cls(
        ...
        column_min_anomaly_stationary_check_spec.additional_properties = d
        return column_min_anomaly_stationary_check_spec
