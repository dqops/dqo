...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_match_regex_percent_sensor_parameters_spec import ColumnStringsStringMatchRegexPercentSensorParametersSpec





T = TypeVar("T", bound="ColumnStringMatchRegexPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringMatchRegexPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringMatchRegexPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringMatchRegexPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringMatchRegexPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_match_regex_percent_check_spec = cls(
        ...
        column_string_match_regex_percent_check_spec.additional_properties = d
        return column_string_match_regex_percent_check_spec
