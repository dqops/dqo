...
if TYPE_CHECKING:
    from ..models.column_strings_string_match_regex_percent_sensor_parameters_spec import (
...
class ColumnStringMatchRegexPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringMatchRegexPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringMatchRegexPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
