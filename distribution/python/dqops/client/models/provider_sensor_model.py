...
class ProviderSensorModel:
    ...
    provider_sensor_definition_spec: Union[Unset, 'ProviderSensorDefinitionSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.provider_sensor_definition_spec, Unset):
            provider_sensor_definition_spec = self.provider_sensor_definition_spec.to_dict()
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_provider_sensor_definition_spec,  Unset):
            ...
            provider_sensor_definition_spec = ProviderSensorDefinitionSpec.from_dict(_provider_sensor_definition_spec)
