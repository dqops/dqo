...
T = TypeVar("T", bound="ColumnPiiMonthlyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnPiiMonthlyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_pii_monthly_monitoring_checks_spec_custom_checks = cls()
        ...
        column_pii_monthly_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_pii_monthly_monitoring_checks_spec_custom_checks
