...
class ColumnComparisonMonthlyPartitionedChecksSpec:
    ...
    monthly_partition_sum_match: Union[Unset, 'ColumnComparisonSumMatchCheckSpec'] = UNSET
    monthly_partition_min_match: Union[Unset, 'ColumnComparisonMinMatchCheckSpec'] = UNSET
    monthly_partition_max_match: Union[Unset, 'ColumnComparisonMaxMatchCheckSpec'] = UNSET
    monthly_partition_mean_match: Union[Unset, 'ColumnComparisonMeanMatchCheckSpec'] = UNSET
    monthly_partition_not_null_count_match: Union[Unset, 'ColumnComparisonNotNullCountMatchCheckSpec'] = UNSET
    monthly_partition_null_count_match: Union[Unset, 'ColumnComparisonNullCountMatchCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.monthly_partition_not_null_count_match, Unset):
            monthly_partition_not_null_count_match = self.monthly_partition_not_null_count_match.to_dict()
        ...
        if not isinstance(self.monthly_partition_null_count_match, Unset):
            monthly_partition_null_count_match = self.monthly_partition_null_count_match.to_dict()
        ...
        if monthly_partition_not_null_count_match is not UNSET:
            field_dict["monthly_partition_not_null_count_match"] = monthly_partition_not_null_count_match
        if monthly_partition_null_count_match is not UNSET:
            field_dict["monthly_partition_null_count_match"] = monthly_partition_null_count_match
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_monthly_partition_sum_match,  Unset):
            ...
            monthly_partition_sum_match = ColumnComparisonSumMatchCheckSpec.from_dict(_monthly_partition_sum_match)
        ...
        if isinstance(_monthly_partition_min_match,  Unset):
            ...
            monthly_partition_min_match = ColumnComparisonMinMatchCheckSpec.from_dict(_monthly_partition_min_match)
        ...
        if isinstance(_monthly_partition_max_match,  Unset):
            ...
            monthly_partition_max_match = ColumnComparisonMaxMatchCheckSpec.from_dict(_monthly_partition_max_match)
        ...
        if isinstance(_monthly_partition_mean_match,  Unset):
            ...
            monthly_partition_mean_match = ColumnComparisonMeanMatchCheckSpec.from_dict(_monthly_partition_mean_match)




        _monthly_partition_not_null_count_match = d.pop("monthly_partition_not_null_count_match", UNSET)
        monthly_partition_not_null_count_match: Union[Unset, ColumnComparisonNotNullCountMatchCheckSpec]
        if isinstance(_monthly_partition_not_null_count_match,  Unset):
            monthly_partition_not_null_count_match = UNSET
        else:
            monthly_partition_not_null_count_match = ColumnComparisonNotNullCountMatchCheckSpec.from_dict(_monthly_partition_not_null_count_match)




        _monthly_partition_null_count_match = d.pop("monthly_partition_null_count_match", UNSET)
        monthly_partition_null_count_match: Union[Unset, ColumnComparisonNullCountMatchCheckSpec]
        if isinstance(_monthly_partition_null_count_match,  Unset):
            monthly_partition_null_count_match = UNSET
        else:
            monthly_partition_null_count_match = ColumnComparisonNullCountMatchCheckSpec.from_dict(_monthly_partition_null_count_match)
