...
if TYPE_CHECKING:
    from ..models.column_strings_string_invalid_ip_6_address_count_sensor_parameters_spec import (
...
class ColumnStringInvalidIp6AddressCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringInvalidIp6AddressCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringInvalidIp6AddressCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
