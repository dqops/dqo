...
if TYPE_CHECKING:
  from ..models.all_checks_patch_parameters_selected_tables_to_columns import AllChecksPatchParametersSelectedTablesToColumns
...
class AllChecksPatchParameters:
    ...
    selected_tables_to_columns: Union[Unset, 'AllChecksPatchParametersSelectedTablesToColumns'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        selected_tables_to_columns: Union[Unset, AllChecksPatchParametersSelectedTablesToColumns]
        if isinstance(_selected_tables_to_columns,  Unset):
            selected_tables_to_columns = UNSET
        else:
            selected_tables_to_columns = AllChecksPatchParametersSelectedTablesToColumns.from_dict(_selected_tables_to_columns)
