...
T = TypeVar("T", bound="ColumnConversionsProfilingChecksSpecCustomChecks")


@_attrs_define
class ColumnConversionsProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_conversions_profiling_checks_spec_custom_checks = cls()
        ...
        column_conversions_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_conversions_profiling_checks_spec_custom_checks
