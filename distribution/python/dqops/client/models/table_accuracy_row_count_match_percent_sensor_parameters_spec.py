...
T = TypeVar("T", bound="TableAccuracyRowCountMatchPercentSensorParametersSpec")


@attr.s(auto_attribs=True)
class TableAccuracyRowCountMatchPercentSensorParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_accuracy_row_count_match_percent_sensor_parameters_spec = cls(
            filter_=filter_,
            referenced_table=referenced_table,
        )

        table_accuracy_row_count_match_percent_sensor_parameters_spec.additional_properties = (
            d
        )
        return table_accuracy_row_count_match_percent_sensor_parameters_spec
