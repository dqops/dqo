...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_value_above_max_value_count_sensor_parameters_spec import ColumnNumericValueAboveMaxValueCountSensorParametersSpec





T = TypeVar("T", bound="ColumnValueAboveMaxValueCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnValueAboveMaxValueCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnNumericValueAboveMaxValueCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnNumericValueAboveMaxValueCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericValueAboveMaxValueCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_value_above_max_value_count_check_spec = cls(
        ...
        column_value_above_max_value_count_check_spec.additional_properties = d
        return column_value_above_max_value_count_check_spec
