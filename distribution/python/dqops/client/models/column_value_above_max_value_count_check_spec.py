...
if TYPE_CHECKING:
    from ..models.column_numeric_value_above_max_value_count_sensor_parameters_spec import (
...
class ColumnValueAboveMaxValueCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnNumericValueAboveMaxValueCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnNumericValueAboveMaxValueCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
