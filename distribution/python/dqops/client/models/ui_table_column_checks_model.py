...
if TYPE_CHECKING:
    ...
    from ..models.ui_column_checks_model import UIColumnChecksModel


T = TypeVar("T", bound="UITableColumnChecksModel")


@attr.s(auto_attribs=True)
class UITableColumnChecksModel:
    """UI model containing information related to column checks on a table level.
    ...
    Attributes:
        ...
        ui_column_checks_models (Union[Unset, List['UIColumnChecksModel']]): List containing information related to
    ...
    ui_column_checks_models: Union[Unset, List["UIColumnChecksModel"]] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        ui_column_checks_models: Union[Unset, List[Dict[str, Any]]] = UNSET
        if not isinstance(self.ui_column_checks_models, Unset):
            ui_column_checks_models = []
            for ui_column_checks_models_item_data in self.ui_column_checks_models:
                ui_column_checks_models_item = (
                    ui_column_checks_models_item_data.to_dict()
                )

                ui_column_checks_models.append(ui_column_checks_models_item)
        ...
        if ui_column_checks_models is not UNSET:
            field_dict["ui_column_checks_models"] = ui_column_checks_models
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ui_column_checks_models = []
        _ui_column_checks_models = d.pop("ui_column_checks_models", UNSET)
        for ui_column_checks_models_item_data in _ui_column_checks_models or []:
            ui_column_checks_models_item = UIColumnChecksModel.from_dict(
                ui_column_checks_models_item_data
            )

            ui_column_checks_models.append(ui_column_checks_models_item)

        ui_table_column_checks_model = cls(
            ...
            ui_column_checks_models=ui_column_checks_models,
        )

        ui_table_column_checks_model.additional_properties = d
        return ui_table_column_checks_model
