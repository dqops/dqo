...
T = TypeVar("T", bound="ColumnCustomSqlMonthlyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnCustomSqlMonthlyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_custom_sql_monthly_monitoring_checks_spec_custom_checks = cls()
        ...
        column_custom_sql_monthly_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_custom_sql_monthly_monitoring_checks_spec_custom_checks
