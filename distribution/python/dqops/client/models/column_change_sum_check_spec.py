...
T = TypeVar("T", bound="ColumnChangeSumCheckSpec")


@attr.s(auto_attribs=True)
class ColumnChangeSumCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_change_sum_check_spec = cls(
        ...
        column_change_sum_check_spec.additional_properties = d
        return column_change_sum_check_spec
