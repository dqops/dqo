...
T = TypeVar("T", bound="ColumnComparisonDailyRecurringChecksSpec")


@attr.s(auto_attribs=True)
class ColumnComparisonDailyRecurringChecksSpec:
    """ 
        Attributes:
    ...
    daily_not_null_count_match: Union[Unset, 'ColumnComparisonNotNullCountMatchCheckSpec'] = UNSET
    daily_null_count_match: Union[Unset, 'ColumnComparisonNullCountMatchCheckSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_daily_sum_match,  Unset):
            ...
            daily_sum_match = ColumnComparisonSumMatchCheckSpec.from_dict(_daily_sum_match)
        ...
        if isinstance(_daily_min_match,  Unset):
            ...
            daily_min_match = ColumnComparisonMinMatchCheckSpec.from_dict(_daily_min_match)
        ...
        if isinstance(_daily_max_match,  Unset):
            ...
            daily_max_match = ColumnComparisonMaxMatchCheckSpec.from_dict(_daily_max_match)
        ...
        if isinstance(_daily_mean_match,  Unset):
            ...
            daily_mean_match = ColumnComparisonMeanMatchCheckSpec.from_dict(_daily_mean_match)
        ...
        if isinstance(_daily_not_null_count_match,  Unset):
            ...
            daily_not_null_count_match = ColumnComparisonNotNullCountMatchCheckSpec.from_dict(_daily_not_null_count_match)
        ...
        if isinstance(_daily_null_count_match,  Unset):
            ...
            daily_null_count_match = ColumnComparisonNullCountMatchCheckSpec.from_dict(_daily_null_count_match)




        column_comparison_daily_recurring_checks_spec = cls(
        ...
        column_comparison_daily_recurring_checks_spec.additional_properties = d
        return column_comparison_daily_recurring_checks_spec
