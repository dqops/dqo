...
T = TypeVar("T", bound="ColumnDatetimeProfilingChecksSpecCustomChecks")


@_attrs_define
class ColumnDatetimeProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_datetime_profiling_checks_spec_custom_checks = cls()
        ...
        column_datetime_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_datetime_profiling_checks_spec_custom_checks
