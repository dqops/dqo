...
T = TypeVar("T", bound="ColumnDailyPartitionedCheckCategoriesSpecCustom")


@attr.s(auto_attribs=True)
class ColumnDailyPartitionedCheckCategoriesSpecCustom:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.custom_check_spec import CustomCheckSpec
        d = src_dict.copy()
        column_daily_partitioned_check_categories_spec_custom = cls(
        )
        ...
        column_daily_partitioned_check_categories_spec_custom.additional_properties = additional_properties
        return column_daily_partitioned_check_categories_spec_custom
