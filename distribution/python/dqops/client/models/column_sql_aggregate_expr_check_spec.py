...
if TYPE_CHECKING:
    ...
    from ..models.column_sql_aggregated_expression_sensor_parameters_spec import (
...
class ColumnSqlAggregateExprCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnSqlAggregatedExpressionSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnSqlAggregatedExpressionSensorParametersSpec.from_dict(
                _parameters
            )
