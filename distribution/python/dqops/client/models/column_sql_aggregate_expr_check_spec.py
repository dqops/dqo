...
if TYPE_CHECKING:
  ...
  from ..models.column_sql_aggregated_expression_sensor_parameters_spec import ColumnSqlAggregatedExpressionSensorParametersSpec
...
T = TypeVar("T", bound="ColumnSqlAggregateExprCheckSpec")


@attr.s(auto_attribs=True)
class ColumnSqlAggregateExprCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnSqlAggregatedExpressionSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnSqlAggregatedExpressionSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnSqlAggregatedExpressionSensorParametersSpec.from_dict(_parameters)
        ...
        column_sql_aggregate_expr_check_spec = cls(
        ...
        column_sql_aggregate_expr_check_spec.additional_properties = d
        return column_sql_aggregate_expr_check_spec
