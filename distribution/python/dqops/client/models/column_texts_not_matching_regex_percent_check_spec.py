...
if TYPE_CHECKING:
    from ..models.column_patterns_texts_not_matching_regex_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextsNotMatchingRegexPercentCheckSpec")


@_attrs_define
class ColumnTextsNotMatchingRegexPercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnPatternsTextsNotMatchingRegexPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsTextsNotMatchingRegexPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnPatternsTextsNotMatchingRegexPercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_texts_not_matching_regex_percent_check_spec = cls(
        ...
        column_texts_not_matching_regex_percent_check_spec.additional_properties = d
        return column_texts_not_matching_regex_percent_check_spec
