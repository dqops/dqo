...
T = TypeVar("T", bound="ColumnDistinctCountAnomalyDifferencingCheckSpec")


@_attrs_define
class ColumnDistinctCountAnomalyDifferencingCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_distinct_count_anomaly_differencing_check_spec = cls(
        ...
        column_distinct_count_anomaly_differencing_check_spec.additional_properties = d
        return column_distinct_count_anomaly_differencing_check_spec
