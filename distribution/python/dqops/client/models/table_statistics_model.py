...
class TableStatisticsModel:
    ...
    collect_table_statistics_job_template: Union[Unset, 'StatisticsCollectorSearchFilters'] = UNSET
    collect_table_and_column_statistics_job_template: Union[Unset, 'StatisticsCollectorSearchFilters'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.collect_table_statistics_job_template, Unset):
            collect_table_statistics_job_template = self.collect_table_statistics_job_template.to_dict()

        collect_table_and_column_statistics_job_template: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.collect_table_and_column_statistics_job_template, Unset):
            collect_table_and_column_statistics_job_template = self.collect_table_and_column_statistics_job_template.to_dict()
        ...
        if collect_table_statistics_job_template is not UNSET:
            field_dict["collect_table_statistics_job_template"] = collect_table_statistics_job_template
        if collect_table_and_column_statistics_job_template is not UNSET:
            field_dict["collect_table_and_column_statistics_job_template"] = collect_table_and_column_statistics_job_template
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _collect_table_statistics_job_template = d.pop("collect_table_statistics_job_template", UNSET)
        collect_table_statistics_job_template: Union[Unset, StatisticsCollectorSearchFilters]
        if isinstance(_collect_table_statistics_job_template,  Unset):
            collect_table_statistics_job_template = UNSET
        else:
            collect_table_statistics_job_template = StatisticsCollectorSearchFilters.from_dict(_collect_table_statistics_job_template)




        _collect_table_and_column_statistics_job_template = d.pop("collect_table_and_column_statistics_job_template", UNSET)
        collect_table_and_column_statistics_job_template: Union[Unset, StatisticsCollectorSearchFilters]
        if isinstance(_collect_table_and_column_statistics_job_template,  Unset):
            ...
            collect_table_and_column_statistics_job_template = StatisticsCollectorSearchFilters.from_dict(_collect_table_and_column_statistics_job_template)
