...
T = TypeVar("T", bound="AnomalyStationaryPercentileMovingAverageRule05ParametersSpec")


@attr.s(auto_attribs=True)
class AnomalyStationaryPercentileMovingAverageRule05ParametersSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        anomaly_stationary_percentile_moving_average_rule_05_parameters_spec = cls(
            anomaly_percent=anomaly_percent,
        )

        anomaly_stationary_percentile_moving_average_rule_05_parameters_spec.additional_properties = d
        return anomaly_stationary_percentile_moving_average_rule_05_parameters_spec
