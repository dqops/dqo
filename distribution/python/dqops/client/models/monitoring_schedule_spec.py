...
T = TypeVar("T", bound="MonitoringScheduleSpec")


@_attrs_define
class MonitoringScheduleSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        monitoring_schedule_spec = cls(
            cron_expression=cron_expression,
            disabled=disabled,
        )

        monitoring_schedule_spec.additional_properties = d
        return monitoring_schedule_spec
