...
if TYPE_CHECKING:
    from ..models.column_numeric_number_found_in_set_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnNumberFoundInSetPercentCheckSpec")


@_attrs_define
class ColumnNumberFoundInSetPercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnNumericNumberFoundInSetPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnNumericNumberFoundInSetPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnNumericNumberFoundInSetPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_number_found_in_set_percent_check_spec = cls(
        ...
        column_number_found_in_set_percent_check_spec.additional_properties = d
        return column_number_found_in_set_percent_check_spec
