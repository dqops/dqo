...
T = TypeVar("T", bound="ColumnChangeDistinctPercentCheckSpec")


@_attrs_define
class ColumnChangeDistinctPercentCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_change_distinct_percent_check_spec = cls(
        ...
        column_change_distinct_percent_check_spec.additional_properties = d
        return column_change_distinct_percent_check_spec
