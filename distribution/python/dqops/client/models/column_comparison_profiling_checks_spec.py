...
class ColumnComparisonProfilingChecksSpec:
    ...
    not_null_count_match: Union[Unset, 'ColumnComparisonNotNullCountMatchCheckSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_not_null_count_match,  Unset):
            ...
            not_null_count_match = ColumnComparisonNotNullCountMatchCheckSpec.from_dict(_not_null_count_match)
        ...
        if isinstance(_null_count_match,  Unset):
            ...
            null_count_match = ColumnComparisonNullCountMatchCheckSpec.from_dict(_null_count_match)
