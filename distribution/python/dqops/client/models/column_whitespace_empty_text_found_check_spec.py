...
if TYPE_CHECKING:
    from ..models.column_whitespace_empty_text_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnWhitespaceEmptyTextFoundCheckSpec")


@_attrs_define
class ColumnWhitespaceEmptyTextFoundCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnWhitespaceEmptyTextCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnWhitespaceEmptyTextCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnWhitespaceEmptyTextCountSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_whitespace_empty_text_found_check_spec = cls(
        ...
        column_whitespace_empty_text_found_check_spec.additional_properties = d
        return column_whitespace_empty_text_found_check_spec
