...
T = TypeVar("T", bound="ColumnSumInRangeCheckSpec")


@attr.s(auto_attribs=True)
class ColumnSumInRangeCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_sum_in_range_check_spec = cls(
        ...
        column_sum_in_range_check_spec.additional_properties = d
        return column_sum_in_range_check_spec
