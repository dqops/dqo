...
T = TypeVar("T", bound="ColumnNullPercentChangeCheckSpec")


@_attrs_define
class ColumnNullPercentChangeCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_null_percent_change_check_spec = cls(
        ...
        column_null_percent_change_check_spec.additional_properties = d
        return column_null_percent_change_check_spec
