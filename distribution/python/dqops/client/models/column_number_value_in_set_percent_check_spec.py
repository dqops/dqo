...
if TYPE_CHECKING:
    from ..models.column_numeric_number_value_in_set_percent_sensor_parameters_spec import (
...
class ColumnNumberValueInSetPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnNumericNumberValueInSetPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnNumericNumberValueInSetPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
