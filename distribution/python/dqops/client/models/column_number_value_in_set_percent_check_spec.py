...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_number_value_in_set_percent_sensor_parameters_spec import ColumnNumericNumberValueInSetPercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnNumberValueInSetPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnNumberValueInSetPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnNumericNumberValueInSetPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnNumericNumberValueInSetPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericNumberValueInSetPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_number_value_in_set_percent_check_spec = cls(
        ...
        column_number_value_in_set_percent_check_spec.additional_properties = d
        return column_number_value_in_set_percent_check_spec
