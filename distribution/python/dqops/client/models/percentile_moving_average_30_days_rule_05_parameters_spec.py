...
T = TypeVar("T", bound="PercentileMovingAverage30DaysRule1ParametersSpec")


@attr.s(auto_attribs=True)
class PercentileMovingAverage30DaysRule05ParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        percentile_moving_average_30_days_rule_05_parameters_spec = cls(
            anomaly_percent=anomaly_percent,
        )

        percentile_moving_average_30_days_rule_05_parameters_spec.additional_properties = d
        return percentile_moving_average_30_days_rule_05_parameters_spec
