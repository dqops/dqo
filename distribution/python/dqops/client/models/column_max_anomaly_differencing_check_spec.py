...
T = TypeVar("T", bound="ColumnMaxAnomalyDifferencingCheckSpec")


@_attrs_define
class ColumnMaxAnomalyDifferencingCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_max_anomaly_differencing_check_spec = cls(
        ...
        column_max_anomaly_differencing_check_spec.additional_properties = d
        return column_max_anomaly_differencing_check_spec
