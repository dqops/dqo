...
if TYPE_CHECKING:
    from ..models.column_numeric_value_below_min_value_count_sensor_parameters_spec import (
...
class ColumnValueBelowMinValueCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnNumericValueBelowMinValueCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnNumericValueBelowMinValueCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
