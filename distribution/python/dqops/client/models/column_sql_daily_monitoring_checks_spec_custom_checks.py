...
T = TypeVar("T", bound="ColumnSqlDailyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnSqlDailyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_sql_daily_monitoring_checks_spec_custom_checks = cls()
        ...
        column_sql_daily_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_sql_daily_monitoring_checks_spec_custom_checks
