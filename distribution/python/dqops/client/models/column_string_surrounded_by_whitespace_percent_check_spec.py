...
if TYPE_CHECKING:
    from ..models.column_strings_string_surrounded_by_whitespace_percent_sensor_parameters_spec import (
...
class ColumnStringSurroundedByWhitespacePercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringSurroundedByWhitespacePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnStringsStringSurroundedByWhitespacePercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_string_surrounded_by_whitespace_percent_check_spec.additional_properties = (
            d
        )
