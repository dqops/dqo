...
if TYPE_CHECKING:
  ...
  from ..models.column_pii_valid_usa_zipcode_percent_sensor_parameters_spec import ColumnPiiValidUsaZipcodePercentSensorParametersSpec





T = TypeVar("T", bound="ColumnPiiValidUsaZipcodePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnPiiValidUsaZipcodePercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnPiiValidUsaZipcodePercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnPiiValidUsaZipcodePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnPiiValidUsaZipcodePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_pii_valid_usa_zipcode_percent_check_spec = cls(
        ...
        column_pii_valid_usa_zipcode_percent_check_spec.additional_properties = d
        return column_pii_valid_usa_zipcode_percent_check_spec
