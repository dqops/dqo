...
if TYPE_CHECKING:
    from ..models.column_pii_valid_usa_zipcode_percent_sensor_parameters_spec import (
...
class ColumnPiiValidUsaZipcodePercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnPiiValidUsaZipcodePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnPiiValidUsaZipcodePercentSensorParametersSpec.from_dict(
                _parameters
            )
