...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_match_date_regex_percent_sensor_parameters_spec import ColumnStringsStringMatchDateRegexPercentSensorParametersSpec





T = TypeVar("T", bound="ColumnStringMatchDateRegexPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringMatchDateRegexPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringMatchDateRegexPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringMatchDateRegexPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringMatchDateRegexPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_match_date_regex_percent_check_spec = cls(
        ...
        column_string_match_date_regex_percent_check_spec.additional_properties = d
        return column_string_match_date_regex_percent_check_spec
