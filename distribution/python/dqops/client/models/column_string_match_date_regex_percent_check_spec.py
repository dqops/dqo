...
if TYPE_CHECKING:
    from ..models.column_strings_string_match_date_regex_percent_sensor_parameters_spec import (
...
class ColumnStringMatchDateRegexPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringMatchDateRegexPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringMatchDateRegexPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
