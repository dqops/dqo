...
T = TypeVar("T", bound="ColumnAnomalyStationaryDistinctPercent30DaysCheckSpec")


@_attrs_define
class ColumnAnomalyStationaryDistinctPercent30DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_anomaly_stationary_distinct_percent_30_days_check_spec = cls(
        ...
        column_anomaly_stationary_distinct_percent_30_days_check_spec.additional_properties = (
            d
        )
        return column_anomaly_stationary_distinct_percent_30_days_check_spec
