...
if TYPE_CHECKING:
    from ..models.column_whitespace_empty_text_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnWhitespaceEmptyTextPercentCheckSpec")


@_attrs_define
class ColumnWhitespaceEmptyTextPercentCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnWhitespaceEmptyTextPercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_whitespace_empty_text_percent_check_spec = cls(
        ...
        column_whitespace_empty_text_percent_check_spec.additional_properties = d
        return column_whitespace_empty_text_percent_check_spec
