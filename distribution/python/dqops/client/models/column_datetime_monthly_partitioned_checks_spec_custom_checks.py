...
T = TypeVar("T", bound="ColumnDatetimeMonthlyPartitionedChecksSpecCustomChecks")


@_attrs_define
class ColumnDatetimeMonthlyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_datetime_monthly_partitioned_checks_spec_custom_checks = cls()
        ...
        column_datetime_monthly_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_datetime_monthly_partitioned_checks_spec_custom_checks
