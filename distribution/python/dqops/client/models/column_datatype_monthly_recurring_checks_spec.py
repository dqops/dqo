...
T = TypeVar("T", bound="ColumnDatatypeMonthlyRecurringChecksSpec")


@attr.s(auto_attribs=True)
class ColumnDatatypeMonthlyRecurringChecksSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_datatype_monthly_recurring_checks_spec = cls(
        ...
        column_datatype_monthly_recurring_checks_spec.additional_properties = d
        return column_datatype_monthly_recurring_checks_spec
