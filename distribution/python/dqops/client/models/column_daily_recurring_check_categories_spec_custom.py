...
T = TypeVar("T", bound="ColumnDailyRecurringCheckCategoriesSpecCustom")


@attr.s(auto_attribs=True)
class ColumnDailyRecurringCheckCategoriesSpecCustom:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.custom_check_spec import CustomCheckSpec
        d = src_dict.copy()
        column_daily_recurring_check_categories_spec_custom = cls(
        )
        ...
        column_daily_recurring_check_categories_spec_custom.additional_properties = additional_properties
        return column_daily_recurring_check_categories_spec_custom
