...
if TYPE_CHECKING:
    from ..models.column_text_text_length_above_max_length_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextLengthAboveMaxLengthCheckSpec")


@_attrs_define
class ColumnTextLengthAboveMaxLengthCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnTextTextLengthAboveMaxLengthCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnTextTextLengthAboveMaxLengthCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnTextTextLengthAboveMaxLengthCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_text_length_above_max_length_check_spec = cls(
        ...
        column_text_length_above_max_length_check_spec.additional_properties = d
        return column_text_length_above_max_length_check_spec
