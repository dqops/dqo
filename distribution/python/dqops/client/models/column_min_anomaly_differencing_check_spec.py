...
if TYPE_CHECKING:
    ...
    from ..models.column_numeric_min_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnMinAnomalyDifferencingCheckSpec")


@_attrs_define
class ColumnMinAnomalyDifferencingCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnNumericMinSensorParametersSpec]):
    ...
    parameters: Union[Unset, "ColumnNumericMinSensorParametersSpec"] = UNSET
    warning: Union[
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnNumericMinSensorParametersSpec.from_dict(_parameters)
        ...
        column_min_anomaly_differencing_check_spec = cls(
        ...
        column_min_anomaly_differencing_check_spec.additional_properties = d
        return column_min_anomaly_differencing_check_spec
