...
class ColumnNullsMonthlyPartitionedChecksSpec:
    ...
    monthly_partition_not_nulls_count: Union[Unset, 'ColumnNotNullsCountCheckSpec'] = UNSET
    monthly_partition_not_nulls_percent: Union[Unset, 'ColumnNotNullsPercentCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.monthly_partition_nulls_percent, Unset):
            monthly_partition_nulls_percent = self.monthly_partition_nulls_percent.to_dict()
        ...
        if not isinstance(self.monthly_partition_not_nulls_count, Unset):
            monthly_partition_not_nulls_count = self.monthly_partition_not_nulls_count.to_dict()
        ...
        if not isinstance(self.monthly_partition_not_nulls_percent, Unset):
            monthly_partition_not_nulls_percent = self.monthly_partition_not_nulls_percent.to_dict()
        ...
        if monthly_partition_nulls_percent is not UNSET:
            field_dict["monthly_partition_nulls_percent"] = monthly_partition_nulls_percent
        if monthly_partition_not_nulls_count is not UNSET:
            field_dict["monthly_partition_not_nulls_count"] = monthly_partition_not_nulls_count
        if monthly_partition_not_nulls_percent is not UNSET:
            field_dict["monthly_partition_not_nulls_percent"] = monthly_partition_not_nulls_percent
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_monthly_partition_nulls_count,  Unset):
            ...
            monthly_partition_nulls_count = ColumnNullsCountCheckSpec.from_dict(_monthly_partition_nulls_count)




        _monthly_partition_nulls_percent = d.pop("monthly_partition_nulls_percent", UNSET)
        monthly_partition_nulls_percent: Union[Unset, ColumnNullsPercentCheckSpec]
        if isinstance(_monthly_partition_nulls_percent,  Unset):
            monthly_partition_nulls_percent = UNSET
        else:
            monthly_partition_nulls_percent = ColumnNullsPercentCheckSpec.from_dict(_monthly_partition_nulls_percent)




        _monthly_partition_not_nulls_count = d.pop("monthly_partition_not_nulls_count", UNSET)
        monthly_partition_not_nulls_count: Union[Unset, ColumnNotNullsCountCheckSpec]
        if isinstance(_monthly_partition_not_nulls_count,  Unset):
            monthly_partition_not_nulls_count = UNSET
        else:
            monthly_partition_not_nulls_count = ColumnNotNullsCountCheckSpec.from_dict(_monthly_partition_not_nulls_count)




        _monthly_partition_not_nulls_percent = d.pop("monthly_partition_not_nulls_percent", UNSET)
        monthly_partition_not_nulls_percent: Union[Unset, ColumnNotNullsPercentCheckSpec]
        if isinstance(_monthly_partition_not_nulls_percent,  Unset):
            monthly_partition_not_nulls_percent = UNSET
        else:
            monthly_partition_not_nulls_percent = ColumnNotNullsPercentCheckSpec.from_dict(_monthly_partition_not_nulls_percent)
