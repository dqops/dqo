...
T = TypeVar("T", bound="ColumnIntegrityForeignKeyNotMatchCountSensorParametersSpec")


@attr.s(auto_attribs=True)
class ColumnIntegrityForeignKeyNotMatchCountSensorParametersSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_integrity_foreign_key_not_match_count_sensor_parameters_spec = cls(
            filter_=filter_,
            foreign_table=foreign_table,
            foreign_column=foreign_column,
        )

        column_integrity_foreign_key_not_match_count_sensor_parameters_spec.additional_properties = d
        return column_integrity_foreign_key_not_match_count_sensor_parameters_spec
