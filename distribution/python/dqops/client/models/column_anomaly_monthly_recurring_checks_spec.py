...
class ColumnAnomalyMonthlyRecurringChecksSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_monthly_mean_change,  Unset):
            ...
            monthly_mean_change = ColumnChangeMeanCheckSpec.from_dict(_monthly_mean_change)
        ...
        if isinstance(_monthly_median_change,  Unset):
            ...
            monthly_median_change = ColumnChangeMedianCheckSpec.from_dict(_monthly_median_change)
