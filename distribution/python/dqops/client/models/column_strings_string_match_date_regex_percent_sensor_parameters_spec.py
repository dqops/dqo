...
from ..types import UNSET, Unset
from ..models.column_strings_string_match_date_regex_percent_sensor_parameters_spec_date_formats import ColumnStringsStringMatchDateRegexPercentSensorParametersSpecDateFormats
...
class ColumnStringsStringMatchDateRegexPercentSensorParametersSpec:
    ...
    date_formats: Union[Unset, ColumnStringsStringMatchDateRegexPercentSensorParametersSpecDateFormats] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        date_formats: Union[Unset, ColumnStringsStringMatchDateRegexPercentSensorParametersSpecDateFormats]
        if isinstance(_date_formats,  Unset):
            date_formats = UNSET
        else:
            date_formats = ColumnStringsStringMatchDateRegexPercentSensorParametersSpecDateFormats(_date_formats)
        ...
        column_strings_string_match_date_regex_percent_sensor_parameters_spec.additional_properties = d
