...
T = TypeVar("T", bound="ColumnMeanChange1DayCheckSpec")


@_attrs_define
class ColumnMeanChange1DayCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_mean_change_1_day_check_spec = cls(
        ...
        column_mean_change_1_day_check_spec.additional_properties = d
        return column_mean_change_1_day_check_spec
