...
if TYPE_CHECKING:
    ...
    from ..models.table_daily_recurring_categories_spec_custom import (
...
T = TypeVar("T", bound="TableDailyRecurringCategoriesSpec")


@attr.s(auto_attribs=True)
class TableDailyRecurringCategoriesSpec:
    """
    Attributes:
        custom (Union[Unset, TableDailyRecurringCategoriesSpecCustom]): Dictionary of custom checks. The keys are check
            names.
    ...
    custom: Union[Unset, "TableDailyRecurringCategoriesSpecCustom"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        custom: Union[Unset, TableDailyRecurringCategoriesSpecCustom]
        if isinstance(_custom, Unset):
            custom = UNSET
        else:
            custom = TableDailyRecurringCategoriesSpecCustom.from_dict(_custom)
        ...
        table_daily_recurring_categories_spec = cls(
            custom=custom,
            volume=volume,
        ...
        table_daily_recurring_categories_spec.additional_properties = d
        return table_daily_recurring_categories_spec
