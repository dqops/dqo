...
if TYPE_CHECKING:
    from ..models.column_strings_string_null_placeholder_percent_sensor_parameters_spec import (
...
class ColumnStringNullPlaceholderPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringNullPlaceholderPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringNullPlaceholderPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
