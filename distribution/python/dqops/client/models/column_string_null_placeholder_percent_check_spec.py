...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_null_placeholder_percent_sensor_parameters_spec import ColumnStringsStringNullPlaceholderPercentSensorParametersSpec





T = TypeVar("T", bound="ColumnStringNullPlaceholderPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringNullPlaceholderPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringNullPlaceholderPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringNullPlaceholderPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringNullPlaceholderPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_null_placeholder_percent_check_spec = cls(
        ...
        column_string_null_placeholder_percent_check_spec.additional_properties = d
        return column_string_null_placeholder_percent_check_spec
