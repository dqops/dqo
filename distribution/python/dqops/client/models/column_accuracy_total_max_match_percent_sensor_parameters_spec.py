...
T = TypeVar("T", bound="ColumnAccuracyTotalMaxMatchPercentSensorParametersSpec")
...
class ColumnAccuracyTotalMaxMatchPercentSensorParametersSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_accuracy_total_max_match_percent_sensor_parameters_spec.additional_properties = d
