...
T = TypeVar("T", bound="TableRowCountChange7DaysCheckSpec")


@_attrs_define
class TableRowCountChange7DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_row_count_change_7_days_check_spec = cls(
        ...
        table_row_count_change_7_days_check_spec.additional_properties = d
        return table_row_count_change_7_days_check_spec
