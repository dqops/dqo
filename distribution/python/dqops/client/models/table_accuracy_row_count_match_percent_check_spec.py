...
if TYPE_CHECKING:
    ...
    from ..models.table_accuracy_row_count_match_percent_sensor_parameters_spec import (
        TableAccuracyRowCountMatchPercentSensorParametersSpec,
    )


T = TypeVar("T", bound="TableAccuracyRowCountMatchPercentCheckSpec")


@attr.s(auto_attribs=True)
class TableAccuracyRowCountMatchPercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, TableAccuracyRowCountMatchPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "TableAccuracyRowCountMatchPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                TableAccuracyRowCountMatchPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        table_accuracy_row_count_match_percent_check_spec = cls(
        ...
        table_accuracy_row_count_match_percent_check_spec.additional_properties = d
        return table_accuracy_row_count_match_percent_check_spec
