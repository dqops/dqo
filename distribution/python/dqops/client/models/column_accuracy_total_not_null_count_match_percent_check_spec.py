...
if TYPE_CHECKING:
    from ..models.column_accuracy_total_not_null_count_match_percent_sensor_parameters_spec import (
        ColumnAccuracyTotalNotNullCountMatchPercentSensorParametersSpec,
    )
    from ..models.comment_spec import CommentSpec
    from ..models.max_diff_percent_rule_1_parameters_spec import (
        MaxDiffPercentRule1ParametersSpec,
    )
    from ..models.max_diff_percent_rule_2_parameters_spec import (
...
T = TypeVar("T", bound="ColumnAccuracyTotalTotalNotNullCountMatchPercentCheckSpec")
...
class ColumnAccuracyTotalNotNullCountMatchPercentCheckSpec:
    ...
    Attributes:
        ...
        parameters (Union[Unset, ColumnAccuracyTotalTotalNotNullCountMatchPercentSensorParametersSpec]):
        warning (Union[Unset, MaxDiffPercentRule1ParametersSpec]):
        error (Union[Unset, MaxDiffPercentRule2ParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnAccuracyTotalTotalNotNullCountMatchPercentSensorParametersSpec"
    ] = UNSET
    warning: Union[Unset, "MaxDiffPercentRule1ParametersSpec"] = UNSET
    error: Union[Unset, "MaxDiffPercentRule2ParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        parameters: Union[
            Unset, ColumnAccuracyTotalNotNullCountMatchPercentSensorParametersSpec
        ]
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = (
                ColumnAccuracyTotalNotNullCountMatchPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        if isinstance(_warning, Unset):
            ...
            warning = MaxDiffPercentRule1ParametersSpec.from_dict(_warning)
        ...
        if isinstance(_error, Unset):
            ...
            error = MaxDiffPercentRule2ParametersSpec.from_dict(_error)
        ...
        column_accuracy_total_not_null_count_match_percent_check_spec.additional_properties = (
            d
        )
