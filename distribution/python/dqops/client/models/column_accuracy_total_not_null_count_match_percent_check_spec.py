...
if TYPE_CHECKING:
  from ..models.max_diff_percent_rule_0_parameters_spec import MaxDiffPercentRule0ParametersSpec
  from ..models.recurring_schedule_spec import RecurringScheduleSpec
  from ..models.max_diff_percent_rule_1_parameters_spec import MaxDiffPercentRule1ParametersSpec
  from ..models.column_accuracy_total_not_null_count_match_percent_sensor_parameters_spec import ColumnAccuracyTotalNotNullCountMatchPercentSensorParametersSpec
  from ..models.comment_spec import CommentSpec
  from ..models.max_diff_percent_rule_5_parameters_spec import MaxDiffPercentRule5ParametersSpec





T = TypeVar("T", bound="ColumnAccuracyTotalNotNullCountMatchPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnAccuracyTotalNotNullCountMatchPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnAccuracyTotalNotNullCountMatchPercentSensorParametersSpec]):
            warning (Union[Unset, MaxDiffPercentRule0ParametersSpec]):
            error (Union[Unset, MaxDiffPercentRule1ParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnAccuracyTotalNotNullCountMatchPercentSensorParametersSpec'] = UNSET
    warning: Union[Unset, 'MaxDiffPercentRule0ParametersSpec'] = UNSET
    error: Union[Unset, 'MaxDiffPercentRule1ParametersSpec'] = UNSET
    fatal: Union[Unset, 'MaxDiffPercentRule5ParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnAccuracyTotalNotNullCountMatchPercentSensorParametersSpec.from_dict(_parameters)
        ...
        if isinstance(_warning,  Unset):
            ...
            warning = MaxDiffPercentRule0ParametersSpec.from_dict(_warning)
        ...
        if isinstance(_error,  Unset):
            ...
            error = MaxDiffPercentRule1ParametersSpec.from_dict(_error)
        ...
        if isinstance(_fatal,  Unset):
            ...
            fatal = MaxDiffPercentRule5ParametersSpec.from_dict(_fatal)




        column_accuracy_total_not_null_count_match_percent_check_spec = cls(
        ...
        column_accuracy_total_not_null_count_match_percent_check_spec.additional_properties = d
        return column_accuracy_total_not_null_count_match_percent_check_spec
