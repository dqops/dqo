...
if TYPE_CHECKING:
    from ..models.data_stream_level_spec import DataStreamLevelSpec


T = TypeVar("T", bound="DataStreamMappingSpec")


@attr.s(auto_attribs=True)
class DataStreamMappingSpec:
    """
    Attributes:
        level_1 (Union[Unset, DataStreamLevelSpec]):
        level_2 (Union[Unset, DataStreamLevelSpec]):
        level_3 (Union[Unset, DataStreamLevelSpec]):
        level_4 (Union[Unset, DataStreamLevelSpec]):
        level_5 (Union[Unset, DataStreamLevelSpec]):
        level_6 (Union[Unset, DataStreamLevelSpec]):
        level_7 (Union[Unset, DataStreamLevelSpec]):
        level_8 (Union[Unset, DataStreamLevelSpec]):
        level_9 (Union[Unset, DataStreamLevelSpec]):
    """

    level_1: Union[Unset, "DataStreamLevelSpec"] = UNSET
    level_2: Union[Unset, "DataStreamLevelSpec"] = UNSET
    level_3: Union[Unset, "DataStreamLevelSpec"] = UNSET
    level_4: Union[Unset, "DataStreamLevelSpec"] = UNSET
    level_5: Union[Unset, "DataStreamLevelSpec"] = UNSET
    level_6: Union[Unset, "DataStreamLevelSpec"] = UNSET
    level_7: Union[Unset, "DataStreamLevelSpec"] = UNSET
    level_8: Union[Unset, "DataStreamLevelSpec"] = UNSET
    level_9: Union[Unset, "DataStreamLevelSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_level_1, Unset):
            ...
            level_1 = DataStreamLevelSpec.from_dict(_level_1)
        ...
        if isinstance(_level_2, Unset):
            ...
            level_2 = DataStreamLevelSpec.from_dict(_level_2)
        ...
        if isinstance(_level_3, Unset):
            ...
            level_3 = DataStreamLevelSpec.from_dict(_level_3)
        ...
        if isinstance(_level_4, Unset):
            ...
            level_4 = DataStreamLevelSpec.from_dict(_level_4)
        ...
        if isinstance(_level_5, Unset):
            ...
            level_5 = DataStreamLevelSpec.from_dict(_level_5)
        ...
        if isinstance(_level_6, Unset):
            ...
            level_6 = DataStreamLevelSpec.from_dict(_level_6)
        ...
        if isinstance(_level_7, Unset):
            ...
            level_7 = DataStreamLevelSpec.from_dict(_level_7)
        ...
        if isinstance(_level_8, Unset):
            ...
            level_8 = DataStreamLevelSpec.from_dict(_level_8)
        ...
        if isinstance(_level_9, Unset):
            ...
            level_9 = DataStreamLevelSpec.from_dict(_level_9)

        data_stream_mapping_spec = cls(
            level_1=level_1,
            level_2=level_2,
            level_3=level_3,
            level_4=level_4,
        ...
        data_stream_mapping_spec.additional_properties = d
        return data_stream_mapping_spec
