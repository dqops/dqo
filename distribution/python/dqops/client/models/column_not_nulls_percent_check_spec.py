...
T = TypeVar("T", bound="ColumnNotNullsPercentCheckSpec")


@_attrs_define
class ColumnNotNullsPercentCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_not_nulls_percent_check_spec.additional_properties = d
        return column_not_nulls_percent_check_spec
