...
if TYPE_CHECKING:
  from ..models.column_numeric_negative_percent_sensor_parameters_spec import ColumnNumericNegativePercentSensorParametersSpec
  from ..models.recurring_schedule_spec import RecurringScheduleSpec
  from ..models.max_percent_rule_0_parameters_spec import MaxPercentRule0ParametersSpec
...
T = TypeVar("T", bound="ColumnNegativePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnNegativePercentCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericNegativePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_negative_percent_check_spec = cls(
        ...
        column_negative_percent_check_spec.additional_properties = d
        return column_negative_percent_check_spec
