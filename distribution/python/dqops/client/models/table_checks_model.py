...
if TYPE_CHECKING:
    ...
    from ..models.table_checks_model_check_containers import (
        TableChecksModelCheckContainers,
    )


T = TypeVar("T", bound="TableChecksModel")


@attr.s(auto_attribs=True)
class TableChecksModel:
    ...
    Attributes:
        ...
        check_containers (Union[Unset, TableChecksModelCheckContainers]): Mapping of check type and timescale to check
    ...
    check_containers: Union[Unset, "TableChecksModelCheckContainers"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        check_containers: Union[Unset, TableChecksModelCheckContainers]
        if isinstance(_check_containers, Unset):
            check_containers = UNSET
        else:
            check_containers = TableChecksModelCheckContainers.from_dict(
                _check_containers
            )

        table_checks_model = cls(
        ...
        table_checks_model.additional_properties = d
        return table_checks_model
