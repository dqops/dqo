...
T = TypeVar("T", bound="TableChecksModelCheckContainers")


@attr.s(auto_attribs=True)
class TableChecksModelCheckContainers:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_checks_model_check_containers = cls()
        ...
        table_checks_model_check_containers.additional_properties = (
            additional_properties
        )
        return table_checks_model_check_containers
