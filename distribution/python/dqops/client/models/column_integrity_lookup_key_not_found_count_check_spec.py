...
if TYPE_CHECKING:
    from ..models.column_integrity_foreign_key_not_match_count_sensor_parameters_spec import (
...
class ColumnIntegrityLookupKeyNotFoundCountCheckSpec:
    ...
    error: Union[Unset, "MaxCountRule0WarningParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnIntegrityForeignKeyNotMatchCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        if isinstance(_error, Unset):
            ...
            error = MaxCountRule0WarningParametersSpec.from_dict(_error)
        ...
        column_integrity_lookup_key_not_found_count_check_spec = cls(
        ...
        column_integrity_lookup_key_not_found_count_check_spec.additional_properties = d
        return column_integrity_lookup_key_not_found_count_check_spec
