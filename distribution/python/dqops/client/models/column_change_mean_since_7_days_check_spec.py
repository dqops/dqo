...
T = TypeVar("T", bound="ColumnChangeMeanSince7DaysCheckSpec")


@_attrs_define
class ColumnChangeMeanSince7DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_change_mean_since_7_days_check_spec = cls(
        ...
        column_change_mean_since_7_days_check_spec.additional_properties = d
        return column_change_mean_since_7_days_check_spec
