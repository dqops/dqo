...
T = TypeVar("T", bound="TableVolumeDailyPartitionedChecksSpecCustomChecks")


@_attrs_define
class TableVolumeDailyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_volume_daily_partitioned_checks_spec_custom_checks = cls()
        ...
        table_volume_daily_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_volume_daily_partitioned_checks_spec_custom_checks
