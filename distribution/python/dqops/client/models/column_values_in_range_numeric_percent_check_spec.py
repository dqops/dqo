...
if TYPE_CHECKING:
    from ..models.column_numeric_values_in_range_numeric_percent_sensor_parameters_spec import (
        ColumnNumericValuesInRangeNumericPercentSensorParametersSpec,
    )
    from ..models.comment_spec import CommentSpec
    from ..models.min_percent_rule_0_parameters_spec import (
        MinPercentRule0ParametersSpec,
    )
    from ..models.min_percent_rule_2_parameters_spec import (
        MinPercentRule2ParametersSpec,
    )
    from ..models.min_percent_rule_5_parameters_spec import (
...
class ColumnValuesInRangeNumericPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnNumericValuesInRangeNumericPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnNumericValuesInRangeNumericPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
