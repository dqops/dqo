...
if TYPE_CHECKING:
  ...
  from ..models.min_percent_rule_2_parameters_spec import MinPercentRule2ParametersSpec
  from ..models.min_percent_rule_0_parameters_spec import MinPercentRule0ParametersSpec
  from ..models.column_numeric_values_in_range_numeric_percent_sensor_parameters_spec import ColumnNumericValuesInRangeNumericPercentSensorParametersSpec
  from ..models.comment_spec import CommentSpec
  from ..models.min_percent_rule_5_parameters_spec import MinPercentRule5ParametersSpec





T = TypeVar("T", bound="ColumnValuesInRangeNumericPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnValuesInRangeNumericPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnNumericValuesInRangeNumericPercentSensorParametersSpec]):
            warning (Union[Unset, MinPercentRule0ParametersSpec]):
            error (Union[Unset, MinPercentRule2ParametersSpec]):
            fatal (Union[Unset, MinPercentRule5ParametersSpec]):
     """
    ...
    parameters: Union[Unset, 'ColumnNumericValuesInRangeNumericPercentSensorParametersSpec'] = UNSET
    warning: Union[Unset, 'MinPercentRule0ParametersSpec'] = UNSET
    error: Union[Unset, 'MinPercentRule2ParametersSpec'] = UNSET
    fatal: Union[Unset, 'MinPercentRule5ParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericValuesInRangeNumericPercentSensorParametersSpec.from_dict(_parameters)
        ...
        if isinstance(_warning,  Unset):
            ...
            warning = MinPercentRule0ParametersSpec.from_dict(_warning)
        ...
        if isinstance(_error,  Unset):
            ...
            error = MinPercentRule2ParametersSpec.from_dict(_error)
        ...
        if isinstance(_fatal,  Unset):
            ...
            fatal = MinPercentRule5ParametersSpec.from_dict(_fatal)




        column_values_in_range_numeric_percent_check_spec = cls(
        ...
        column_values_in_range_numeric_percent_check_spec.additional_properties = d
        return column_values_in_range_numeric_percent_check_spec
