...
class ColumnUniquenessMonthlyMonitoringChecksSpec:
    ...
    Attributes:
        ...
        monthly_distinct_count_change (Union[Unset, ColumnDistinctCountChangeCheckSpec]):
        monthly_distinct_percent_change (Union[Unset, ColumnDistinctPercentChangeCheckSpec]):
    """
    ...
    monthly_distinct_count_change: Union[
        Unset, "ColumnDistinctCountChangeCheckSpec"
    ] = UNSET
    monthly_distinct_percent_change: Union[
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        monthly_distinct_count_change: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.monthly_distinct_count_change, Unset):
            monthly_distinct_count_change = self.monthly_distinct_count_change.to_dict()

        monthly_distinct_percent_change: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.monthly_distinct_percent_change, Unset):
            monthly_distinct_percent_change = (
                self.monthly_distinct_percent_change.to_dict()
            )
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        _monthly_distinct_count_change = d.pop("monthly_distinct_count_change", UNSET)
        monthly_distinct_count_change: Union[Unset, ColumnDistinctCountChangeCheckSpec]
        if isinstance(_monthly_distinct_count_change, Unset):
            monthly_distinct_count_change = UNSET
        else:
            monthly_distinct_count_change = (
                ColumnDistinctCountChangeCheckSpec.from_dict(
                    _monthly_distinct_count_change
                )
            )

        _monthly_distinct_percent_change = d.pop(
            "monthly_distinct_percent_change", UNSET
        )
        monthly_distinct_percent_change: Union[
            Unset, ColumnDistinctPercentChangeCheckSpec
        ]
        if isinstance(_monthly_distinct_percent_change, Unset):
            monthly_distinct_percent_change = UNSET
        else:
            monthly_distinct_percent_change = (
                ColumnDistinctPercentChangeCheckSpec.from_dict(
                    _monthly_distinct_percent_change
                )
            )
        ...
        column_uniqueness_monthly_monitoring_checks_spec = cls(
            ...
            monthly_distinct_count_change=monthly_distinct_count_change,
            monthly_distinct_percent_change=monthly_distinct_percent_change,
        )
