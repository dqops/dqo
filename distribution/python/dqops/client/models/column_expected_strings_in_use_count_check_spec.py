...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_expected_strings_in_use_count_sensor_parameters_spec import ColumnStringsExpectedStringsInUseCountSensorParametersSpec
...
T = TypeVar("T", bound="ColumnExpectedStringsInUseCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnExpectedStringsInUseCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsExpectedStringsInUseCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsExpectedStringsInUseCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsExpectedStringsInUseCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_expected_strings_in_use_count_check_spec = cls(
        ...
        column_expected_strings_in_use_count_check_spec.additional_properties = d
        return column_expected_strings_in_use_count_check_spec
