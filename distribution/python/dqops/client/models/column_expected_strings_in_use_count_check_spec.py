...
if TYPE_CHECKING:
    from ..models.column_strings_expected_strings_in_use_count_sensor_parameters_spec import (
...
class ColumnExpectedStringsInUseCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsExpectedStringsInUseCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsExpectedStringsInUseCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
