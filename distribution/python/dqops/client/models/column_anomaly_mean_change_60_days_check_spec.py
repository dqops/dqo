...
T = TypeVar("T", bound="ColumnAnomalyMeanChange60DaysCheckSpec")


@attr.s(auto_attribs=True)
class ColumnAnomalyMeanChange60DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_anomaly_mean_change_60_days_check_spec = cls(
        ...
        column_anomaly_mean_change_60_days_check_spec.additional_properties = d
        return column_anomaly_mean_change_60_days_check_spec
