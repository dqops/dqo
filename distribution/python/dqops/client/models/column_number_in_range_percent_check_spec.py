...
if TYPE_CHECKING:
    from ..models.column_numeric_number_in_range_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnNumberInRangePercentCheckSpec")


@_attrs_define
class ColumnNumberInRangePercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnNumericNumberInRangePercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnNumericNumberInRangePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnNumericNumberInRangePercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_number_in_range_percent_check_spec = cls(
        ...
        column_number_in_range_percent_check_spec.additional_properties = d
        return column_number_in_range_percent_check_spec
