...
class ColumnStringsProfilingChecksSpec:
    ...
    string_length_below_min_length_count: Union[Unset, 'ColumnStringLengthBelowMinLengthCountCheckSpec'] = UNSET
    string_length_below_min_length_percent: Union[Unset, 'ColumnStringLengthBelowMinLengthPercentCheckSpec'] = UNSET
    string_length_above_max_length_count: Union[Unset, 'ColumnStringLengthAboveMaxLengthCountCheckSpec'] = UNSET
    string_length_above_max_length_percent: Union[Unset, 'ColumnStringLengthAboveMaxLengthPercentCheckSpec'] = UNSET
    string_length_in_range_percent: Union[Unset, 'ColumnStringLengthInRangePercentCheckSpec'] = UNSET
    ...
    string_whitespace_count: Union[Unset, 'ColumnStringWhitespaceCountCheckSpec'] = UNSET
    string_whitespace_percent: Union[Unset, 'ColumnStringWhitespacePercentCheckSpec'] = UNSET
    string_surrounded_by_whitespace_count: Union[Unset, 'ColumnStringSurroundedByWhitespaceCountCheckSpec'] = UNSET
    string_surrounded_by_whitespace_percent: Union[Unset, 'ColumnStringSurroundedByWhitespacePercentCheckSpec'] = UNSET
    string_null_placeholder_count: Union[Unset, 'ColumnStringNullPlaceholderCountCheckSpec'] = UNSET
    string_null_placeholder_percent: Union[Unset, 'ColumnStringNullPlaceholderPercentCheckSpec'] = UNSET
    string_boolean_placeholder_percent: Union[Unset, 'ColumnStringBooleanPlaceholderPercentCheckSpec'] = UNSET
    string_parsable_to_integer_percent: Union[Unset, 'ColumnStringParsableToIntegerPercentCheckSpec'] = UNSET
    string_parsable_to_float_percent: Union[Unset, 'ColumnStringParsableToFloatPercentCheckSpec'] = UNSET
    expected_strings_in_use_count: Union[Unset, 'ColumnExpectedStringsInUseCountCheckSpec'] = UNSET
    string_value_in_set_percent: Union[Unset, 'ColumnStringValueInSetPercentCheckSpec'] = UNSET
    string_valid_dates_percent: Union[Unset, 'ColumnStringValidDatesPercentCheckSpec'] = UNSET
    string_valid_country_code_percent: Union[Unset, 'ColumnStringValidCountryCodePercentCheckSpec'] = UNSET
    string_valid_currency_code_percent: Union[Unset, 'ColumnStringValidCurrencyCodePercentCheckSpec'] = UNSET
    string_invalid_email_count: Union[Unset, 'ColumnStringInvalidEmailCountCheckSpec'] = UNSET
    string_invalid_uuid_count: Union[Unset, 'ColumnStringInvalidUuidCountCheckSpec'] = UNSET
    string_valid_uuid_percent: Union[Unset, 'ColumnStringValidUuidPercentCheckSpec'] = UNSET
    string_invalid_ip4_address_count: Union[Unset, 'ColumnStringInvalidIp4AddressCountCheckSpec'] = UNSET
    string_invalid_ip6_address_count: Union[Unset, 'ColumnStringInvalidIp6AddressCountCheckSpec'] = UNSET
    string_not_match_regex_count: Union[Unset, 'ColumnStringNotMatchRegexCountCheckSpec'] = UNSET
    string_match_regex_percent: Union[Unset, 'ColumnStringMatchRegexPercentCheckSpec'] = UNSET
    string_not_match_date_regex_count: Union[Unset, 'ColumnStringNotMatchDateRegexCountCheckSpec'] = UNSET
    string_match_date_regex_percent: Union[Unset, 'ColumnStringMatchDateRegexPercentCheckSpec'] = UNSET
    string_match_name_regex_percent: Union[Unset, 'ColumnStringMatchNameRegexPercentCheckSpec'] = UNSET
    expected_strings_in_top_values_count: Union[Unset, 'ColumnExpectedStringsInTopValuesCountCheckSpec'] = UNSET
    string_datatype_detected: Union[Unset, 'ColumnStringDatatypeDetectedCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.string_length_below_min_length_count, Unset):
            string_length_below_min_length_count = self.string_length_below_min_length_count.to_dict()
        ...
        if not isinstance(self.string_length_below_min_length_percent, Unset):
            string_length_below_min_length_percent = self.string_length_below_min_length_percent.to_dict()
        ...
        if not isinstance(self.string_length_above_max_length_count, Unset):
            string_length_above_max_length_count = self.string_length_above_max_length_count.to_dict()
        ...
        if not isinstance(self.string_length_above_max_length_percent, Unset):
            string_length_above_max_length_percent = self.string_length_above_max_length_percent.to_dict()

        string_length_in_range_percent: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.string_length_in_range_percent, Unset):
            string_length_in_range_percent = self.string_length_in_range_percent.to_dict()
        ...
        if not isinstance(self.string_surrounded_by_whitespace_count, Unset):
            string_surrounded_by_whitespace_count = self.string_surrounded_by_whitespace_count.to_dict()
        ...
        if not isinstance(self.string_surrounded_by_whitespace_percent, Unset):
            string_surrounded_by_whitespace_percent = self.string_surrounded_by_whitespace_percent.to_dict()
        ...
        if not isinstance(self.string_null_placeholder_percent, Unset):
            string_null_placeholder_percent = self.string_null_placeholder_percent.to_dict()
        ...
        if not isinstance(self.string_boolean_placeholder_percent, Unset):
            string_boolean_placeholder_percent = self.string_boolean_placeholder_percent.to_dict()
        ...
        if not isinstance(self.string_parsable_to_integer_percent, Unset):
            string_parsable_to_integer_percent = self.string_parsable_to_integer_percent.to_dict()
        ...
        if not isinstance(self.string_parsable_to_float_percent, Unset):
            string_parsable_to_float_percent = self.string_parsable_to_float_percent.to_dict()
        ...
        if not isinstance(self.string_valid_country_code_percent, Unset):
            string_valid_country_code_percent = self.string_valid_country_code_percent.to_dict()
        ...
        if not isinstance(self.string_valid_currency_code_percent, Unset):
            string_valid_currency_code_percent = self.string_valid_currency_code_percent.to_dict()
        ...
        if not isinstance(self.string_invalid_ip4_address_count, Unset):
            string_invalid_ip4_address_count = self.string_invalid_ip4_address_count.to_dict()
        ...
        if not isinstance(self.string_invalid_ip6_address_count, Unset):
            string_invalid_ip6_address_count = self.string_invalid_ip6_address_count.to_dict()
        ...
        if not isinstance(self.string_not_match_date_regex_count, Unset):
            string_not_match_date_regex_count = self.string_not_match_date_regex_count.to_dict()
        ...
        if not isinstance(self.string_match_date_regex_percent, Unset):
            string_match_date_regex_percent = self.string_match_date_regex_percent.to_dict()
        ...
        if not isinstance(self.string_match_name_regex_percent, Unset):
            string_match_name_regex_percent = self.string_match_name_regex_percent.to_dict()
        ...
        if not isinstance(self.expected_strings_in_top_values_count, Unset):
            expected_strings_in_top_values_count = self.expected_strings_in_top_values_count.to_dict()
        ...
        if string_length_below_min_length_count is not UNSET:
            field_dict["string_length_below_min_length_count"] = string_length_below_min_length_count
        if string_length_below_min_length_percent is not UNSET:
            field_dict["string_length_below_min_length_percent"] = string_length_below_min_length_percent
        if string_length_above_max_length_count is not UNSET:
            field_dict["string_length_above_max_length_count"] = string_length_above_max_length_count
        if string_length_above_max_length_percent is not UNSET:
            field_dict["string_length_above_max_length_percent"] = string_length_above_max_length_percent
        if string_length_in_range_percent is not UNSET:
            field_dict["string_length_in_range_percent"] = string_length_in_range_percent
        ...
        if string_surrounded_by_whitespace_count is not UNSET:
            field_dict["string_surrounded_by_whitespace_count"] = string_surrounded_by_whitespace_count
        if string_surrounded_by_whitespace_percent is not UNSET:
            field_dict["string_surrounded_by_whitespace_percent"] = string_surrounded_by_whitespace_percent
        ...
        if string_null_placeholder_percent is not UNSET:
            field_dict["string_null_placeholder_percent"] = string_null_placeholder_percent
        if string_boolean_placeholder_percent is not UNSET:
            field_dict["string_boolean_placeholder_percent"] = string_boolean_placeholder_percent
        if string_parsable_to_integer_percent is not UNSET:
            field_dict["string_parsable_to_integer_percent"] = string_parsable_to_integer_percent
        if string_parsable_to_float_percent is not UNSET:
            field_dict["string_parsable_to_float_percent"] = string_parsable_to_float_percent
        ...
        if string_valid_country_code_percent is not UNSET:
            field_dict["string_valid_country_code_percent"] = string_valid_country_code_percent
        if string_valid_currency_code_percent is not UNSET:
            field_dict["string_valid_currency_code_percent"] = string_valid_currency_code_percent
        ...
        if string_invalid_ip4_address_count is not UNSET:
            field_dict["string_invalid_ip4_address_count"] = string_invalid_ip4_address_count
        if string_invalid_ip6_address_count is not UNSET:
            field_dict["string_invalid_ip6_address_count"] = string_invalid_ip6_address_count
        ...
        if string_not_match_date_regex_count is not UNSET:
            field_dict["string_not_match_date_regex_count"] = string_not_match_date_regex_count
        if string_match_date_regex_percent is not UNSET:
            field_dict["string_match_date_regex_percent"] = string_match_date_regex_percent
        if string_match_name_regex_percent is not UNSET:
            field_dict["string_match_name_regex_percent"] = string_match_name_regex_percent
        if expected_strings_in_top_values_count is not UNSET:
            field_dict["expected_strings_in_top_values_count"] = expected_strings_in_top_values_count
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_string_max_length,  Unset):
            ...
            string_max_length = ColumnStringMaxLengthCheckSpec.from_dict(_string_max_length)
        ...
        if isinstance(_string_min_length,  Unset):
            ...
            string_min_length = ColumnStringMinLengthCheckSpec.from_dict(_string_min_length)
        ...
        if isinstance(_string_mean_length,  Unset):
            ...
            string_mean_length = ColumnStringMeanLengthCheckSpec.from_dict(_string_mean_length)




        _string_length_below_min_length_count = d.pop("string_length_below_min_length_count", UNSET)
        string_length_below_min_length_count: Union[Unset, ColumnStringLengthBelowMinLengthCountCheckSpec]
        if isinstance(_string_length_below_min_length_count,  Unset):
            string_length_below_min_length_count = UNSET
        else:
            string_length_below_min_length_count = ColumnStringLengthBelowMinLengthCountCheckSpec.from_dict(_string_length_below_min_length_count)




        _string_length_below_min_length_percent = d.pop("string_length_below_min_length_percent", UNSET)
        string_length_below_min_length_percent: Union[Unset, ColumnStringLengthBelowMinLengthPercentCheckSpec]
        if isinstance(_string_length_below_min_length_percent,  Unset):
            string_length_below_min_length_percent = UNSET
        else:
            string_length_below_min_length_percent = ColumnStringLengthBelowMinLengthPercentCheckSpec.from_dict(_string_length_below_min_length_percent)




        _string_length_above_max_length_count = d.pop("string_length_above_max_length_count", UNSET)
        string_length_above_max_length_count: Union[Unset, ColumnStringLengthAboveMaxLengthCountCheckSpec]
        if isinstance(_string_length_above_max_length_count,  Unset):
            string_length_above_max_length_count = UNSET
        else:
            string_length_above_max_length_count = ColumnStringLengthAboveMaxLengthCountCheckSpec.from_dict(_string_length_above_max_length_count)




        _string_length_above_max_length_percent = d.pop("string_length_above_max_length_percent", UNSET)
        string_length_above_max_length_percent: Union[Unset, ColumnStringLengthAboveMaxLengthPercentCheckSpec]
        if isinstance(_string_length_above_max_length_percent,  Unset):
            string_length_above_max_length_percent = UNSET
        else:
            string_length_above_max_length_percent = ColumnStringLengthAboveMaxLengthPercentCheckSpec.from_dict(_string_length_above_max_length_percent)
        ...
        if isinstance(_string_length_in_range_percent,  Unset):
            ...
            string_length_in_range_percent = ColumnStringLengthInRangePercentCheckSpec.from_dict(_string_length_in_range_percent)
        ...
        if isinstance(_string_empty_count,  Unset):
            ...
            string_empty_count = ColumnStringEmptyCountCheckSpec.from_dict(_string_empty_count)
        ...
        if isinstance(_string_empty_percent,  Unset):
            ...
            string_empty_percent = ColumnStringEmptyPercentCheckSpec.from_dict(_string_empty_percent)
        ...
        if isinstance(_string_whitespace_count,  Unset):
            ...
            string_whitespace_count = ColumnStringWhitespaceCountCheckSpec.from_dict(_string_whitespace_count)
        ...
        if isinstance(_string_whitespace_percent,  Unset):
            ...
            string_whitespace_percent = ColumnStringWhitespacePercentCheckSpec.from_dict(_string_whitespace_percent)




        _string_surrounded_by_whitespace_count = d.pop("string_surrounded_by_whitespace_count", UNSET)
        string_surrounded_by_whitespace_count: Union[Unset, ColumnStringSurroundedByWhitespaceCountCheckSpec]
        if isinstance(_string_surrounded_by_whitespace_count,  Unset):
            string_surrounded_by_whitespace_count = UNSET
        else:
            string_surrounded_by_whitespace_count = ColumnStringSurroundedByWhitespaceCountCheckSpec.from_dict(_string_surrounded_by_whitespace_count)




        _string_surrounded_by_whitespace_percent = d.pop("string_surrounded_by_whitespace_percent", UNSET)
        string_surrounded_by_whitespace_percent: Union[Unset, ColumnStringSurroundedByWhitespacePercentCheckSpec]
        if isinstance(_string_surrounded_by_whitespace_percent,  Unset):
            string_surrounded_by_whitespace_percent = UNSET
        else:
            string_surrounded_by_whitespace_percent = ColumnStringSurroundedByWhitespacePercentCheckSpec.from_dict(_string_surrounded_by_whitespace_percent)
        ...
        if isinstance(_string_null_placeholder_count,  Unset):
            ...
            string_null_placeholder_count = ColumnStringNullPlaceholderCountCheckSpec.from_dict(_string_null_placeholder_count)




        _string_null_placeholder_percent = d.pop("string_null_placeholder_percent", UNSET)
        string_null_placeholder_percent: Union[Unset, ColumnStringNullPlaceholderPercentCheckSpec]
        if isinstance(_string_null_placeholder_percent,  Unset):
            string_null_placeholder_percent = UNSET
        else:
            string_null_placeholder_percent = ColumnStringNullPlaceholderPercentCheckSpec.from_dict(_string_null_placeholder_percent)




        _string_boolean_placeholder_percent = d.pop("string_boolean_placeholder_percent", UNSET)
        string_boolean_placeholder_percent: Union[Unset, ColumnStringBooleanPlaceholderPercentCheckSpec]
        if isinstance(_string_boolean_placeholder_percent,  Unset):
            string_boolean_placeholder_percent = UNSET
        else:
            string_boolean_placeholder_percent = ColumnStringBooleanPlaceholderPercentCheckSpec.from_dict(_string_boolean_placeholder_percent)




        _string_parsable_to_integer_percent = d.pop("string_parsable_to_integer_percent", UNSET)
        string_parsable_to_integer_percent: Union[Unset, ColumnStringParsableToIntegerPercentCheckSpec]
        if isinstance(_string_parsable_to_integer_percent,  Unset):
            string_parsable_to_integer_percent = UNSET
        else:
            string_parsable_to_integer_percent = ColumnStringParsableToIntegerPercentCheckSpec.from_dict(_string_parsable_to_integer_percent)




        _string_parsable_to_float_percent = d.pop("string_parsable_to_float_percent", UNSET)
        string_parsable_to_float_percent: Union[Unset, ColumnStringParsableToFloatPercentCheckSpec]
        if isinstance(_string_parsable_to_float_percent,  Unset):
            string_parsable_to_float_percent = UNSET
        else:
            string_parsable_to_float_percent = ColumnStringParsableToFloatPercentCheckSpec.from_dict(_string_parsable_to_float_percent)
        ...
        if isinstance(_expected_strings_in_use_count,  Unset):
            ...
            expected_strings_in_use_count = ColumnExpectedStringsInUseCountCheckSpec.from_dict(_expected_strings_in_use_count)
        ...
        if isinstance(_string_value_in_set_percent,  Unset):
            ...
            string_value_in_set_percent = ColumnStringValueInSetPercentCheckSpec.from_dict(_string_value_in_set_percent)
        ...
        if isinstance(_string_valid_dates_percent,  Unset):
            ...
            string_valid_dates_percent = ColumnStringValidDatesPercentCheckSpec.from_dict(_string_valid_dates_percent)




        _string_valid_country_code_percent = d.pop("string_valid_country_code_percent", UNSET)
        string_valid_country_code_percent: Union[Unset, ColumnStringValidCountryCodePercentCheckSpec]
        if isinstance(_string_valid_country_code_percent,  Unset):
            string_valid_country_code_percent = UNSET
        else:
            string_valid_country_code_percent = ColumnStringValidCountryCodePercentCheckSpec.from_dict(_string_valid_country_code_percent)




        _string_valid_currency_code_percent = d.pop("string_valid_currency_code_percent", UNSET)
        string_valid_currency_code_percent: Union[Unset, ColumnStringValidCurrencyCodePercentCheckSpec]
        if isinstance(_string_valid_currency_code_percent,  Unset):
            string_valid_currency_code_percent = UNSET
        else:
            string_valid_currency_code_percent = ColumnStringValidCurrencyCodePercentCheckSpec.from_dict(_string_valid_currency_code_percent)
        ...
        if isinstance(_string_invalid_email_count,  Unset):
            ...
            string_invalid_email_count = ColumnStringInvalidEmailCountCheckSpec.from_dict(_string_invalid_email_count)
        ...
        if isinstance(_string_invalid_uuid_count,  Unset):
            ...
            string_invalid_uuid_count = ColumnStringInvalidUuidCountCheckSpec.from_dict(_string_invalid_uuid_count)
        ...
        if isinstance(_string_valid_uuid_percent,  Unset):
            ...
            string_valid_uuid_percent = ColumnStringValidUuidPercentCheckSpec.from_dict(_string_valid_uuid_percent)




        _string_invalid_ip4_address_count = d.pop("string_invalid_ip4_address_count", UNSET)
        string_invalid_ip4_address_count: Union[Unset, ColumnStringInvalidIp4AddressCountCheckSpec]
        if isinstance(_string_invalid_ip4_address_count,  Unset):
            string_invalid_ip4_address_count = UNSET
        else:
            string_invalid_ip4_address_count = ColumnStringInvalidIp4AddressCountCheckSpec.from_dict(_string_invalid_ip4_address_count)




        _string_invalid_ip6_address_count = d.pop("string_invalid_ip6_address_count", UNSET)
        string_invalid_ip6_address_count: Union[Unset, ColumnStringInvalidIp6AddressCountCheckSpec]
        if isinstance(_string_invalid_ip6_address_count,  Unset):
            string_invalid_ip6_address_count = UNSET
        else:
            string_invalid_ip6_address_count = ColumnStringInvalidIp6AddressCountCheckSpec.from_dict(_string_invalid_ip6_address_count)
        ...
        if isinstance(_string_not_match_regex_count,  Unset):
            ...
            string_not_match_regex_count = ColumnStringNotMatchRegexCountCheckSpec.from_dict(_string_not_match_regex_count)
        ...
        if isinstance(_string_match_regex_percent,  Unset):
            ...
            string_match_regex_percent = ColumnStringMatchRegexPercentCheckSpec.from_dict(_string_match_regex_percent)




        _string_not_match_date_regex_count = d.pop("string_not_match_date_regex_count", UNSET)
        string_not_match_date_regex_count: Union[Unset, ColumnStringNotMatchDateRegexCountCheckSpec]
        if isinstance(_string_not_match_date_regex_count,  Unset):
            string_not_match_date_regex_count = UNSET
        else:
            string_not_match_date_regex_count = ColumnStringNotMatchDateRegexCountCheckSpec.from_dict(_string_not_match_date_regex_count)




        _string_match_date_regex_percent = d.pop("string_match_date_regex_percent", UNSET)
        string_match_date_regex_percent: Union[Unset, ColumnStringMatchDateRegexPercentCheckSpec]
        if isinstance(_string_match_date_regex_percent,  Unset):
            string_match_date_regex_percent = UNSET
        else:
            string_match_date_regex_percent = ColumnStringMatchDateRegexPercentCheckSpec.from_dict(_string_match_date_regex_percent)




        _string_match_name_regex_percent = d.pop("string_match_name_regex_percent", UNSET)
        string_match_name_regex_percent: Union[Unset, ColumnStringMatchNameRegexPercentCheckSpec]
        if isinstance(_string_match_name_regex_percent,  Unset):
            string_match_name_regex_percent = UNSET
        else:
            string_match_name_regex_percent = ColumnStringMatchNameRegexPercentCheckSpec.from_dict(_string_match_name_regex_percent)




        _expected_strings_in_top_values_count = d.pop("expected_strings_in_top_values_count", UNSET)
        expected_strings_in_top_values_count: Union[Unset, ColumnExpectedStringsInTopValuesCountCheckSpec]
        if isinstance(_expected_strings_in_top_values_count,  Unset):
            expected_strings_in_top_values_count = UNSET
        else:
            expected_strings_in_top_values_count = ColumnExpectedStringsInTopValuesCountCheckSpec.from_dict(_expected_strings_in_top_values_count)
        ...
        if isinstance(_string_datatype_detected,  Unset):
            ...
            string_datatype_detected = ColumnStringDatatypeDetectedCheckSpec.from_dict(_string_datatype_detected)
