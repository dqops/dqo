...
T = TypeVar("T", bound="ColumnAcceptedValuesDailyPartitionedChecksSpecCustomChecks")


@_attrs_define
class ColumnAcceptedValuesDailyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_accepted_values_daily_partitioned_checks_spec_custom_checks = cls()
        ...
        column_accepted_values_daily_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_accepted_values_daily_partitioned_checks_spec_custom_checks
