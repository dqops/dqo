...
class CheckModel:
    ...
    Attributes:
        ...
        supports_data_streams (Union[Unset, bool]): The data quality check supports a custom data stream mapping
            configuration.
        data_streams_override (Union[Unset, DataStreamMappingSpec]):
        ...
        data_stream (Union[Unset, str]): The name of a data stream mapping defined at a table that should be used for
            this check.
    ...
    supports_data_streams: Union[Unset, bool] = UNSET
    data_streams_override: Union[Unset, "DataStreamMappingSpec"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        supports_data_streams = self.supports_data_streams
        data_streams_override: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.data_streams_override, Unset):
            data_streams_override = self.data_streams_override.to_dict()
        ...
        if supports_data_streams is not UNSET:
            field_dict["supports_data_streams"] = supports_data_streams
        if data_streams_override is not UNSET:
            field_dict["data_streams_override"] = data_streams_override
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        supports_data_streams = d.pop("supports_data_streams", UNSET)

        _data_streams_override = d.pop("data_streams_override", UNSET)
        data_streams_override: Union[Unset, DataStreamMappingSpec]
        if isinstance(_data_streams_override, Unset):
            data_streams_override = UNSET
        else:
            data_streams_override = DataStreamMappingSpec.from_dict(
                _data_streams_override
            )
        ...
        check_model = cls(
            ...
            rule=rule,
            supports_data_streams=supports_data_streams,
            data_streams_override=data_streams_override,
