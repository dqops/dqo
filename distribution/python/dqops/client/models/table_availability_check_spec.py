...
if TYPE_CHECKING:
  from ..models.table_availability_sensor_parameters_spec import TableAvailabilitySensorParametersSpec
  from ..models.recurring_schedule_spec import RecurringScheduleSpec
  from ..models.max_failures_rule_5_parameters_spec import MaxFailuresRule5ParametersSpec
  from ..models.max_failures_rule_0_parameters_spec import MaxFailuresRule0ParametersSpec
  from ..models.comment_spec import CommentSpec
  from ..models.max_failures_rule_10_parameters_spec import MaxFailuresRule10ParametersSpec





T = TypeVar("T", bound="TableAvailabilityCheckSpec")


@attr.s(auto_attribs=True)
class TableAvailabilityCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = TableAvailabilitySensorParametersSpec.from_dict(_parameters)
        ...
        table_availability_check_spec.additional_properties = d
        return table_availability_check_spec
