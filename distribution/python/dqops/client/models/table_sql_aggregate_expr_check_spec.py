...
if TYPE_CHECKING:
  from ..models.table_sql_aggregated_expression_sensor_parameters_spec import TableSqlAggregatedExpressionSensorParametersSpec
...
T = TypeVar("T", bound="TableSqlAggregateExprCheckSpec")


@attr.s(auto_attribs=True)
class TableSqlAggregateExprCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = TableSqlAggregatedExpressionSensorParametersSpec.from_dict(_parameters)
        ...
        table_sql_aggregate_expr_check_spec = cls(
        ...
        table_sql_aggregate_expr_check_spec.additional_properties = d
        return table_sql_aggregate_expr_check_spec
