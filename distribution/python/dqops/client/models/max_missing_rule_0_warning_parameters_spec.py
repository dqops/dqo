...
T = TypeVar("T", bound="MaxMissingRule0WarningParametersSpec")


@_attrs_define
class MaxMissingRule0WarningParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        max_missing_rule_0_warning_parameters_spec = cls(
            max_missing=max_missing,
        )

        max_missing_rule_0_warning_parameters_spec.additional_properties = d
        return max_missing_rule_0_warning_parameters_spec
