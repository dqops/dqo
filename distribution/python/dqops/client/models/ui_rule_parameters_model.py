...
if TYPE_CHECKING:
    from ..models.ui_field_model import UIFieldModel


T = TypeVar("T", bound="UIRuleParametersModel")


@attr.s(auto_attribs=True)
class UIRuleParametersModel:
    """UI model that returns the form definition and the form data to edit parameters (thresholds) for a rule at a single
    severity level (low, medium, high).
        ...
        Attributes:
            ...
            rule_parameters (Union[Unset, List['UIFieldModel']]): List of fields for editing the rule parameters like
                thresholds.
    ...
    rule_parameters: Union[Unset, List["UIFieldModel"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for rule_parameters_item_data in _rule_parameters or []:
            rule_parameters_item = UIFieldModel.from_dict(rule_parameters_item_data)
        ...
        ui_rule_parameters_model.additional_properties = d
        return ui_rule_parameters_model
