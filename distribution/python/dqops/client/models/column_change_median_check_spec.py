...
T = TypeVar("T", bound="ColumnChangeMedianCheckSpec")


@attr.s(auto_attribs=True)
class ColumnChangeMedianCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.change_percent_rule_10_parameters_spec import ChangePercentRule10ParametersSpec
        from ..models.change_percent_rule_20_parameters_spec import ChangePercentRule20ParametersSpec
        from ..models.change_percent_rule_20_parameters_spec import ChangePercentRule50ParametersSpec
        ...
        column_change_median_check_spec = cls(
        ...
        column_change_median_check_spec.additional_properties = d
        return column_change_median_check_spec
