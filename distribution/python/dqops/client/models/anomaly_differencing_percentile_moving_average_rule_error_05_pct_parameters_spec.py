...
T = TypeVar(
    "T", bound="AnomalyDifferencingPercentileMovingAverageRuleError05PctParametersSpec"
)


@_attrs_define
class AnomalyDifferencingPercentileMovingAverageRuleError05PctParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return anomaly_differencing_percentile_moving_average_rule_error_05_pct_parameters_spec
