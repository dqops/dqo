...
T = TypeVar("T", bound="ColumnChangeSumSinceYesterdayCheckSpec")


@_attrs_define
class ColumnChangeSumSinceYesterdayCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_change_sum_since_yesterday_check_spec = cls(
        ...
        column_change_sum_since_yesterday_check_spec.additional_properties = d
        return column_change_sum_since_yesterday_check_spec
