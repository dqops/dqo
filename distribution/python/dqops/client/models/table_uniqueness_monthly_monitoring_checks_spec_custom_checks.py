...
T = TypeVar("T", bound="TableUniquenessMonthlyMonitoringChecksSpecCustomChecks")


@_attrs_define
class TableUniquenessMonthlyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_uniqueness_monthly_monitoring_checks_spec_custom_checks = cls()
        ...
        table_uniqueness_monthly_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_uniqueness_monthly_monitoring_checks_spec_custom_checks
