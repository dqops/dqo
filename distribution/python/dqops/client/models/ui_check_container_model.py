...
from ..models.ui_check_container_model_effective_schedule_enabled_status import (
...
if TYPE_CHECKING:
    ...
    from ..models.ui_effective_schedule_model import UIEffectiveScheduleModel
    from ..models.ui_quality_category_model import UIQualityCategoryModel


T = TypeVar("T", bound="UICheckContainerModel")


@attr.s(auto_attribs=True)
class UICheckContainerModel:
    """UI model that returns the form definition and the form data to edit all data quality checks divided by categories.

    Attributes:
        categories (Union[Unset, List['UIQualityCategoryModel']]): List of all data quality categories that contain data
            quality checks inside.
        effective_schedule (Union[Unset, UIEffectiveScheduleModel]): Model of a configured schedule (enabled on
            connection or table) or schedule override (on check). Describes the CRON expression and the time of the upcoming
            execution, as well as the duration until this time.
        effective_schedule_enabled_status (Union[Unset, UICheckContainerModelEffectiveScheduleEnabledStatus]): State of
    ...
    categories: Union[Unset, List["UIQualityCategoryModel"]] = UNSET
    effective_schedule: Union[Unset, "UIEffectiveScheduleModel"] = UNSET
    effective_schedule_enabled_status: Union[
        Unset, UICheckContainerModelEffectiveScheduleEnabledStatus
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for categories_item_data in _categories or []:
            categories_item = UIQualityCategoryModel.from_dict(categories_item_data)

            categories.append(categories_item)

        _effective_schedule = d.pop("effective_schedule", UNSET)
        effective_schedule: Union[Unset, UIEffectiveScheduleModel]
        if isinstance(_effective_schedule, Unset):
            effective_schedule = UNSET
        else:
            effective_schedule = UIEffectiveScheduleModel.from_dict(_effective_schedule)
        ...
        ui_check_container_model.additional_properties = d
        return ui_check_container_model
