...
T = TypeVar("T", bound="UIQualityCategoryModel")


@attr.s(auto_attribs=True)
class UIQualityCategoryModel:
    ...
    Attributes:
        ...
        checks (Union[Unset, List['UICheckModel']]): List of data quality checks within the category.
    ...
    checks: Union[Unset, List["UICheckModel"]] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for checks_item_data in _checks or []:
            checks_item = UICheckModel.from_dict(checks_item_data)
        ...
        ui_quality_category_model.additional_properties = d
        return ui_quality_category_model
