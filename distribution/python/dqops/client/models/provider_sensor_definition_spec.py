...
class ProviderSensorDefinitionSpec:
    ...
    Attributes:
        ...
        supports_grouping_by_data_stream (Union[Unset, bool]): The sensor supports grouping by the data stream, using
            the GROUP BY clause in SQL. Sensors that support a GROUP BY condition can capture separate data quality scores
            for each data stream. The default value is true, because most of the data quality sensor support grouping.
    ...
    supports_grouping_by_data_stream: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        supports_grouping_by_data_stream = self.supports_grouping_by_data_stream
        ...
        if supports_grouping_by_data_stream is not UNSET:
            field_dict[
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        supports_grouping_by_data_stream = d.pop(
            "supports_grouping_by_data_stream", UNSET
        )
        ...
        provider_sensor_definition_spec = cls(
            ...
            supports_grouping_by_data_stream=supports_grouping_by_data_stream,
