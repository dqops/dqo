...
T = TypeVar("T", bound="ColumnSchemaMonthlyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnSchemaMonthlyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_schema_monthly_monitoring_checks_spec_custom_checks = cls()
        ...
        column_schema_monthly_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_schema_monthly_monitoring_checks_spec_custom_checks
