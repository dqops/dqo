...
if TYPE_CHECKING:
    from ..models.column_strings_string_valid_currency_code_percent_sensor_parameters_spec import (
...
class ColumnStringValidCurrencyCodePercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringValidCurrencyCodePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnStringsStringValidCurrencyCodePercentSensorParametersSpec.from_dict(
                _parameters
            )
