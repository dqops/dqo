...
if TYPE_CHECKING:
  from ..models.min_percent_rule_100_parameters_spec import MinPercentRule100ParametersSpec
  from ..models.min_percent_rule_95_parameters_spec import MinPercentRule95ParametersSpec
  from ..models.recurring_schedule_spec import RecurringScheduleSpec
  from ..models.min_percent_rule_99_parameters_spec import MinPercentRule99ParametersSpec
  from ..models.comment_spec import CommentSpec
  from ..models.column_strings_string_valid_currency_code_percent_sensor_parameters_spec import ColumnStringsStringValidCurrencyCodePercentSensorParametersSpec





T = TypeVar("T", bound="ColumnStringValidCurrencyCodePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringValidCurrencyCodePercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringValidCurrencyCodePercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringValidCurrencyCodePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringValidCurrencyCodePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_valid_currency_code_percent_check_spec = cls(
        ...
        column_string_valid_currency_code_percent_check_spec.additional_properties = d
        return column_string_valid_currency_code_percent_check_spec
