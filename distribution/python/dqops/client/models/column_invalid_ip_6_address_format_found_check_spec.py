...
if TYPE_CHECKING:
    from ..models.column_patterns_invalid_ip_6_address_format_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnInvalidIp6AddressFormatFoundCheckSpec")


@_attrs_define
class ColumnInvalidIp6AddressFormatFoundCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnPatternsInvalidIp6AddressFormatCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsInvalidIp6AddressFormatCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnPatternsInvalidIp6AddressFormatCountSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_invalid_ip_6_address_format_found_check_spec = cls(
        ...
        column_invalid_ip_6_address_format_found_check_spec.additional_properties = d
        return column_invalid_ip_6_address_format_found_check_spec
