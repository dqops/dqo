...
if TYPE_CHECKING:
    from ..models.column_patterns_valid_usa_zipcode_format_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnValidUsaZipcodePercentCheckSpec")


@_attrs_define
class ColumnValidUsaZipcodePercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnPatternsValidUsaZipcodeFormatPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsValidUsaZipcodeFormatPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnPatternsValidUsaZipcodeFormatPercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_valid_usa_zipcode_percent_check_spec = cls(
        ...
        column_valid_usa_zipcode_percent_check_spec.additional_properties = d
        return column_valid_usa_zipcode_percent_check_spec
