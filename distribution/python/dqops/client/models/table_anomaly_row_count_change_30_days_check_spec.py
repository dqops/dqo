...
T = TypeVar("T", bound="TableAnomalyRowCountChange30DaysCheckSpec")


@attr.s(auto_attribs=True)
class TableAnomalyRowCountChange30DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_anomaly_row_count_change_30_days_check_spec = cls(
        ...
        table_anomaly_row_count_change_30_days_check_spec.additional_properties = d
        return table_anomaly_row_count_change_30_days_check_spec
