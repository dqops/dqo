...
if TYPE_CHECKING:
  from ..models.table_column_list_unordered_hash_sensor_parameters_spec import TableColumnListUnorderedHashSensorParametersSpec
...
class TableSchemaColumnListChangedCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = TableColumnListUnorderedHashSensorParametersSpec.from_dict(_parameters)
        ...
        table_schema_column_list_changed_check_spec.additional_properties = d
        return table_schema_column_list_changed_check_spec
