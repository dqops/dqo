...
if TYPE_CHECKING:
    ...
    from ..models.table_sql_invalid_record_count_sensor_parameters_spec import (
        TableSqlInvalidRecordCountSensorParametersSpec,
    )


T = TypeVar("T", bound="TableSqlInvalidRecordCountCheckSpec")


@_attrs_define
class TableSqlInvalidRecordCountCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, TableSqlInvalidRecordCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, "TableSqlInvalidRecordCountSensorParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = TableSqlInvalidRecordCountSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        table_sql_invalid_record_count_check_spec = cls(
        ...
        table_sql_invalid_record_count_check_spec.additional_properties = d
        return table_sql_invalid_record_count_check_spec
