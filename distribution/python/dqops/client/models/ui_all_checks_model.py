...
if TYPE_CHECKING:
    ...
    from ..models.ui_all_column_checks_model import UIAllColumnChecksModel
    from ..models.ui_all_table_checks_model import UIAllTableChecksModel


T = TypeVar("T", bound="UIAllChecksModel")


@attr.s(auto_attribs=True)
class UIAllChecksModel:
    ...
    Attributes:
        ...
        table_checks_model (Union[Unset, UIAllTableChecksModel]): UI model that returns the model of selected
            information related to table checks on a connection level.
        column_checks_model (Union[Unset, UIAllColumnChecksModel]): UI model that returns the model of selected
            information related to column checks on a connection level.
    """
    ...
    table_checks_model: Union[Unset, "UIAllTableChecksModel"] = UNSET
    column_checks_model: Union[Unset, "UIAllColumnChecksModel"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_checks_model: Union[Unset, UIAllTableChecksModel]
        if isinstance(_table_checks_model, Unset):
            table_checks_model = UNSET
        else:
            table_checks_model = UIAllTableChecksModel.from_dict(_table_checks_model)

        _column_checks_model = d.pop("column_checks_model", UNSET)
        column_checks_model: Union[Unset, UIAllColumnChecksModel]
        if isinstance(_column_checks_model, Unset):
            column_checks_model = UNSET
        else:
            column_checks_model = UIAllColumnChecksModel.from_dict(_column_checks_model)

        ui_all_checks_model = cls(
        ...
        ui_all_checks_model.additional_properties = d
        return ui_all_checks_model
