...
class TableSchemaDailyRecurringChecksSpec:
    ...
    daily_column_count_changed: Union[Unset, 'TableSchemaColumnCountChangedCheckSpec'] = UNSET
    daily_column_list_changed: Union[Unset, 'TableSchemaColumnListChangedCheckSpec'] = UNSET
    daily_column_list_or_order_changed: Union[Unset, 'TableSchemaColumnListOrOrderChangedCheckSpec'] = UNSET
    daily_column_types_changed: Union[Unset, 'TableSchemaColumnTypesChangedCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.daily_column_list_or_order_changed, Unset):
            daily_column_list_or_order_changed = self.daily_column_list_or_order_changed.to_dict()
        ...
        if daily_column_list_or_order_changed is not UNSET:
            field_dict["daily_column_list_or_order_changed"] = daily_column_list_or_order_changed
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_daily_column_count,  Unset):
            ...
            daily_column_count = TableSchemaColumnCountCheckSpec.from_dict(_daily_column_count)
        ...
        if isinstance(_daily_column_count_changed,  Unset):
            ...
            daily_column_count_changed = TableSchemaColumnCountChangedCheckSpec.from_dict(_daily_column_count_changed)
        ...
        if isinstance(_daily_column_list_changed,  Unset):
            ...
            daily_column_list_changed = TableSchemaColumnListChangedCheckSpec.from_dict(_daily_column_list_changed)




        _daily_column_list_or_order_changed = d.pop("daily_column_list_or_order_changed", UNSET)
        daily_column_list_or_order_changed: Union[Unset, TableSchemaColumnListOrOrderChangedCheckSpec]
        if isinstance(_daily_column_list_or_order_changed,  Unset):
            daily_column_list_or_order_changed = UNSET
        else:
            daily_column_list_or_order_changed = TableSchemaColumnListOrOrderChangedCheckSpec.from_dict(_daily_column_list_or_order_changed)
        ...
        if isinstance(_daily_column_types_changed,  Unset):
            ...
            daily_column_types_changed = TableSchemaColumnTypesChangedCheckSpec.from_dict(_daily_column_types_changed)
