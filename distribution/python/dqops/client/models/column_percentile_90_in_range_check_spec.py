...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_percentile_90_sensor_parameters_spec import ColumnNumericPercentile90SensorParametersSpec
...
T = TypeVar("T", bound="ColumnPercentile90InRangeCheckSpec")


@attr.s(auto_attribs=True)
class ColumnPercentile90InRangeCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnNumericPercentile90SensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnNumericPercentile90SensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericPercentile90SensorParametersSpec.from_dict(_parameters)
        ...
        column_percentile_90_in_range_check_spec = cls(
        ...
        column_percentile_90_in_range_check_spec.additional_properties = d
        return column_percentile_90_in_range_check_spec
