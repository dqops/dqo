...
T = TypeVar("T", bound="ColumnNumericNumberFoundInSetPercentSensorParametersSpec")


@_attrs_define
class ColumnNumericNumberFoundInSetPercentSensorParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_numeric_number_found_in_set_percent_sensor_parameters_spec = cls(
            filter_=filter_,
            expected_values=expected_values,
        )

        column_numeric_number_found_in_set_percent_sensor_parameters_spec.additional_properties = (
            d
        )
        return column_numeric_number_found_in_set_percent_sensor_parameters_spec
