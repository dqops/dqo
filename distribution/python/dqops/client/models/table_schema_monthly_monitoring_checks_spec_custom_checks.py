...
T = TypeVar("T", bound="TableSchemaMonthlyMonitoringChecksSpecCustomChecks")


@_attrs_define
class TableSchemaMonthlyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_schema_monthly_monitoring_checks_spec_custom_checks = cls()
        ...
        table_schema_monthly_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_schema_monthly_monitoring_checks_spec_custom_checks
