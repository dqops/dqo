...
class TableTimelinessMonthlyRecurringChecksSpec:
    ...
    monthly_data_ingestion_delay: Union[Unset, 'TableDataIngestionDelayCheckSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_monthly_data_freshness,  Unset):
            ...
            monthly_data_freshness = TableDataFreshnessCheckSpec.from_dict(_monthly_data_freshness)
        ...
        if isinstance(_monthly_data_staleness,  Unset):
            ...
            monthly_data_staleness = TableDataStalenessCheckSpec.from_dict(_monthly_data_staleness)
        ...
        if isinstance(_monthly_data_ingestion_delay,  Unset):
            ...
            monthly_data_ingestion_delay = TableDataIngestionDelayCheckSpec.from_dict(_monthly_data_ingestion_delay)
