...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_value_in_set_percent_sensor_parameters_spec import ColumnStringsStringValueInSetPercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringValueInSetPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringValueInSetPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringValueInSetPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringValueInSetPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringValueInSetPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_value_in_set_percent_check_spec = cls(
        ...
        column_string_value_in_set_percent_check_spec.additional_properties = d
        return column_string_value_in_set_percent_check_spec
