...
if TYPE_CHECKING:
    from ..models.column_strings_string_value_in_set_percent_sensor_parameters_spec import (
...
class ColumnStringValueInSetPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringValueInSetPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringValueInSetPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
