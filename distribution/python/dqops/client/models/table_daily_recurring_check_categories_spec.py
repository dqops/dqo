...
if TYPE_CHECKING:
  from ..models.table_accuracy_daily_recurring_checks_spec import TableAccuracyDailyRecurringChecksSpec
  from ..models.table_sql_daily_recurring_checks_spec import TableSqlDailyRecurringChecksSpec
  from ..models.table_volume_daily_recurring_checks_spec import TableVolumeDailyRecurringChecksSpec
  from ..models.table_daily_recurring_check_categories_spec_comparisons import TableDailyRecurringCheckCategoriesSpecComparisons
  from ..models.table_schema_daily_recurring_checks_spec import TableSchemaDailyRecurringChecksSpec
  from ..models.table_timeliness_daily_recurring_checks_spec import TableTimelinessDailyRecurringChecksSpec
  from ..models.table_daily_recurring_check_categories_spec_custom import TableDailyRecurringCheckCategoriesSpecCustom
  from ..models.table_availability_daily_recurring_checks_spec import TableAvailabilityDailyRecurringChecksSpec
...
class TableDailyRecurringCheckCategoriesSpec:
    ...
    comparisons: Union[Unset, 'TableDailyRecurringCheckCategoriesSpecComparisons'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_availability,  Unset):
            ...
            availability = TableAvailabilityDailyRecurringChecksSpec.from_dict(_availability)
        ...
        if isinstance(_comparisons,  Unset):
            ...
            comparisons = TableDailyRecurringCheckCategoriesSpecComparisons.from_dict(_comparisons)
