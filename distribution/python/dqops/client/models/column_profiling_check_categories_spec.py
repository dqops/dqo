...
if TYPE_CHECKING:
  from ..models.column_uniqueness_profiling_checks_spec import ColumnUniquenessProfilingChecksSpec
  from ..models.column_accuracy_profiling_checks_spec import ColumnAccuracyProfilingChecksSpec
  ...
  from ..models.column_profiling_check_categories_spec_comparisons import ColumnProfilingCheckCategoriesSpecComparisons
  from ..models.column_datetime_profiling_checks_spec import ColumnDatetimeProfilingChecksSpec
  from ..models.column_anomaly_profiling_checks_spec import ColumnAnomalyProfilingChecksSpec
  from ..models.column_schema_profiling_checks_spec import ColumnSchemaProfilingChecksSpec
  from ..models.column_strings_profiling_checks_spec import ColumnStringsProfilingChecksSpec
  from ..models.column_consistency_profiling_checks_spec import ColumnConsistencyProfilingChecksSpec
  from ..models.column_nulls_profiling_checks_spec import ColumnNullsProfilingChecksSpec
  from ..models.column_integrity_profiling_checks_spec import ColumnIntegrityProfilingChecksSpec
  from ..models.column_profiling_check_categories_spec_custom import ColumnProfilingCheckCategoriesSpecCustom
  from ..models.column_numeric_profiling_checks_spec import ColumnNumericProfilingChecksSpec
...
class ColumnProfilingCheckCategoriesSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_comparisons,  Unset):
            ...
            comparisons = ColumnProfilingCheckCategoriesSpecComparisons.from_dict(_comparisons)
