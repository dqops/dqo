...
if TYPE_CHECKING:
    from ..models.column_patterns_texts_matching_regex_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextsMatchingRegexPercentCheckSpec")


@_attrs_define
class ColumnTextsMatchingRegexPercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnPatternsTextsMatchingRegexPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsTextsMatchingRegexPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnPatternsTextsMatchingRegexPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_texts_matching_regex_percent_check_spec = cls(
        ...
        column_texts_matching_regex_percent_check_spec.additional_properties = d
        return column_texts_matching_regex_percent_check_spec
