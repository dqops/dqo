...
T = TypeVar("T", bound="OptionalCheckContainerModel")


@_attrs_define
class OptionalCheckContainerModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        optional_check_container_model = cls(
            empty=empty,
            present=present,
        )

        optional_check_container_model.additional_properties = d
        return optional_check_container_model
