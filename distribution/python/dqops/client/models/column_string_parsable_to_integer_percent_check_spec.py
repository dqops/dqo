...
if TYPE_CHECKING:
    from ..models.column_strings_string_parsable_to_integer_percent_sensor_parameters_spec import (
...
class ColumnStringParsableToIntegerPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringParsableToIntegerPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnStringsStringParsableToIntegerPercentSensorParametersSpec.from_dict(
                _parameters
            )
