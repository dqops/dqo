...
if TYPE_CHECKING:
  from ..models.column_strings_string_parsable_to_integer_percent_sensor_parameters_spec import ColumnStringsStringParsableToIntegerPercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringParsableToIntegerPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringParsableToIntegerPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringParsableToIntegerPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringParsableToIntegerPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringParsableToIntegerPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_parsable_to_integer_percent_check_spec = cls(
        ...
        column_string_parsable_to_integer_percent_check_spec.additional_properties = d
        return column_string_parsable_to_integer_percent_check_spec
