...
T = TypeVar("T", bound="ColumnSchemaProfilingChecksSpecCustomChecks")


@_attrs_define
class ColumnSchemaProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_schema_profiling_checks_spec_custom_checks = cls()
        ...
        column_schema_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_schema_profiling_checks_spec_custom_checks
