...
if TYPE_CHECKING:
    from ..models.column_strings_expected_text_values_in_use_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnExpectedTextValuesInUseCountCheckSpec")


@_attrs_define
class ColumnExpectedTextValuesInUseCountCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnStringsExpectedTextValuesInUseCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnStringsExpectedTextValuesInUseCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsExpectedTextValuesInUseCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_expected_text_values_in_use_count_check_spec = cls(
        ...
        column_expected_text_values_in_use_count_check_spec.additional_properties = d
        return column_expected_text_values_in_use_count_check_spec
