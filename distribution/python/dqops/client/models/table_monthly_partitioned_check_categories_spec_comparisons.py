...
if TYPE_CHECKING:
  from ..models.table_comparison_monthly_partitioned_checks_spec import TableComparisonMonthlyPartitionedChecksSpec
...
class TableMonthlyPartitionedCheckCategoriesSpecComparisons:
    ...
    additional_properties: Dict[str, 'TableComparisonMonthlyPartitionedChecksSpec'] = attr.ib(init=False, factory=dict)
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            additional_property = TableComparisonMonthlyPartitionedChecksSpec.from_dict(prop_dict)



            additional_properties[prop_name] = additional_property

        table_monthly_partitioned_check_categories_spec_comparisons.additional_properties = additional_properties
    ...
    def __setitem__(self, key: str, value: 'TableComparisonMonthlyPartitionedChecksSpec') -> None:
