...
class ColumnUniquenessMonthlyPartitionedChecksSpec:
    ...
    monthly_partition_distinct_percent: Union[Unset, 'ColumnDistinctPercentCheckSpec'] = UNSET
    monthly_partition_duplicate_count: Union[Unset, 'ColumnDuplicateCountCheckSpec'] = UNSET
    monthly_partition_duplicate_percent: Union[Unset, 'ColumnDuplicatePercentCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.monthly_partition_distinct_count, Unset):
            monthly_partition_distinct_count = self.monthly_partition_distinct_count.to_dict()
        ...
        if not isinstance(self.monthly_partition_distinct_percent, Unset):
            monthly_partition_distinct_percent = self.monthly_partition_distinct_percent.to_dict()
        ...
        if not isinstance(self.monthly_partition_duplicate_count, Unset):
            monthly_partition_duplicate_count = self.monthly_partition_duplicate_count.to_dict()
        ...
        if not isinstance(self.monthly_partition_duplicate_percent, Unset):
            monthly_partition_duplicate_percent = self.monthly_partition_duplicate_percent.to_dict()
        ...
        if monthly_partition_distinct_count is not UNSET:
            field_dict["monthly_partition_distinct_count"] = monthly_partition_distinct_count
        if monthly_partition_distinct_percent is not UNSET:
            field_dict["monthly_partition_distinct_percent"] = monthly_partition_distinct_percent
        if monthly_partition_duplicate_count is not UNSET:
            field_dict["monthly_partition_duplicate_count"] = monthly_partition_duplicate_count
        if monthly_partition_duplicate_percent is not UNSET:
            field_dict["monthly_partition_duplicate_percent"] = monthly_partition_duplicate_percent
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_monthly_partition_distinct_count,  Unset):
            ...
            monthly_partition_distinct_count = ColumnDistinctCountCheckSpec.from_dict(_monthly_partition_distinct_count)




        _monthly_partition_distinct_percent = d.pop("monthly_partition_distinct_percent", UNSET)
        monthly_partition_distinct_percent: Union[Unset, ColumnDistinctPercentCheckSpec]
        if isinstance(_monthly_partition_distinct_percent,  Unset):
            monthly_partition_distinct_percent = UNSET
        else:
            monthly_partition_distinct_percent = ColumnDistinctPercentCheckSpec.from_dict(_monthly_partition_distinct_percent)




        _monthly_partition_duplicate_count = d.pop("monthly_partition_duplicate_count", UNSET)
        monthly_partition_duplicate_count: Union[Unset, ColumnDuplicateCountCheckSpec]
        if isinstance(_monthly_partition_duplicate_count,  Unset):
            monthly_partition_duplicate_count = UNSET
        else:
            monthly_partition_duplicate_count = ColumnDuplicateCountCheckSpec.from_dict(_monthly_partition_duplicate_count)




        _monthly_partition_duplicate_percent = d.pop("monthly_partition_duplicate_percent", UNSET)
        monthly_partition_duplicate_percent: Union[Unset, ColumnDuplicatePercentCheckSpec]
        if isinstance(_monthly_partition_duplicate_percent,  Unset):
            monthly_partition_duplicate_percent = UNSET
        else:
            monthly_partition_duplicate_percent = ColumnDuplicatePercentCheckSpec.from_dict(_monthly_partition_duplicate_percent)
