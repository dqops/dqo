...
if TYPE_CHECKING:
    ...
    from ..models.table_sql_import_custom_result_sensor_parameters_spec import (
        TableSqlImportCustomResultSensorParametersSpec,
    )


T = TypeVar("T", bound="TableSqlImportCustomResultCheckSpec")


@_attrs_define
class TableSqlImportCustomResultCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, TableSqlImportCustomResultSensorParametersSpec]):
    ...
    parameters: Union[Unset, "TableSqlImportCustomResultSensorParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = TableSqlImportCustomResultSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        table_sql_import_custom_result_check_spec = cls(
        ...
        table_sql_import_custom_result_check_spec.additional_properties = d
        return table_sql_import_custom_result_check_spec
