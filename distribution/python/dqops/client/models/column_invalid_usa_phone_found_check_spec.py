...
if TYPE_CHECKING:
    from ..models.column_patterns_invalid_usa_phone_format_found_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnInvalidUsaPhoneFoundCheckSpec")


@_attrs_define
class ColumnInvalidUsaPhoneFoundCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnPatternsInvalidUsaPhoneFormatFoundSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsInvalidUsaPhoneFormatFoundSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnPatternsInvalidUsaPhoneFormatFoundSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_invalid_usa_phone_found_check_spec = cls(
        ...
        column_invalid_usa_phone_found_check_spec.additional_properties = d
        return column_invalid_usa_phone_found_check_spec
