...
if TYPE_CHECKING:
  ...
  from ..models.table_partition_reload_lag_check_spec import TablePartitionReloadLagCheckSpec
...
class TableTimelinessMonthlyPartitionedChecksSpec:
    ...
    monthly_partition_data_freshness: Union[Unset, 'TableDataFreshnessCheckSpec'] = UNSET
    monthly_partition_data_staleness: Union[Unset, 'TableDataStalenessCheckSpec'] = UNSET
    monthly_partition_data_ingestion_delay: Union[Unset, 'TableDataIngestionDelayCheckSpec'] = UNSET
    monthly_partition_reload_lag: Union[Unset, 'TablePartitionReloadLagCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.monthly_partition_data_freshness, Unset):
            monthly_partition_data_freshness = self.monthly_partition_data_freshness.to_dict()
        ...
        if not isinstance(self.monthly_partition_data_staleness, Unset):
            monthly_partition_data_staleness = self.monthly_partition_data_staleness.to_dict()
        ...
        if not isinstance(self.monthly_partition_data_ingestion_delay, Unset):
            monthly_partition_data_ingestion_delay = self.monthly_partition_data_ingestion_delay.to_dict()
        ...
        if monthly_partition_data_freshness is not UNSET:
            field_dict["monthly_partition_data_freshness"] = monthly_partition_data_freshness
        if monthly_partition_data_staleness is not UNSET:
            field_dict["monthly_partition_data_staleness"] = monthly_partition_data_staleness
        if monthly_partition_data_ingestion_delay is not UNSET:
            field_dict["monthly_partition_data_ingestion_delay"] = monthly_partition_data_ingestion_delay
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        from ..models.table_data_staleness_check_spec import TableDataStalenessCheckSpec
        d = src_dict.copy()
        _monthly_partition_data_freshness = d.pop("monthly_partition_data_freshness", UNSET)
        monthly_partition_data_freshness: Union[Unset, TableDataFreshnessCheckSpec]
        if isinstance(_monthly_partition_data_freshness,  Unset):
            monthly_partition_data_freshness = UNSET
        else:
            monthly_partition_data_freshness = TableDataFreshnessCheckSpec.from_dict(_monthly_partition_data_freshness)




        _monthly_partition_data_staleness = d.pop("monthly_partition_data_staleness", UNSET)
        monthly_partition_data_staleness: Union[Unset, TableDataStalenessCheckSpec]
        if isinstance(_monthly_partition_data_staleness,  Unset):
            monthly_partition_data_staleness = UNSET
        else:
            monthly_partition_data_staleness = TableDataStalenessCheckSpec.from_dict(_monthly_partition_data_staleness)




        _monthly_partition_data_ingestion_delay = d.pop("monthly_partition_data_ingestion_delay", UNSET)
        monthly_partition_data_ingestion_delay: Union[Unset, TableDataIngestionDelayCheckSpec]
        if isinstance(_monthly_partition_data_ingestion_delay,  Unset):
            monthly_partition_data_ingestion_delay = UNSET
        else:
            monthly_partition_data_ingestion_delay = TableDataIngestionDelayCheckSpec.from_dict(_monthly_partition_data_ingestion_delay)
        ...
        if isinstance(_monthly_partition_reload_lag,  Unset):
            ...
            monthly_partition_reload_lag = TablePartitionReloadLagCheckSpec.from_dict(_monthly_partition_reload_lag)
