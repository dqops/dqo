...
if TYPE_CHECKING:
  ...
  from ..models.table_timeliness_partition_reload_lag_sensor_parameters_spec import TableTimelinessPartitionReloadLagSensorParametersSpec
...
T = TypeVar("T", bound="TablePartitionReloadLagCheckSpec")
...
class TablePartitionReloadLagCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, TableTimelinessPartitionReloadLagSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'TableTimelinessPartitionReloadLagSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = TableTimelinessPartitionReloadLagSensorParametersSpec.from_dict(_parameters)
        ...
        table_partition_reload_lag_check_spec = cls(
        ...
        table_partition_reload_lag_check_spec.additional_properties = d
        return table_partition_reload_lag_check_spec
