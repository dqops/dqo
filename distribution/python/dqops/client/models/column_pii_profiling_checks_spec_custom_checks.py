...
T = TypeVar("T", bound="ColumnPiiProfilingChecksSpecCustomChecks")


@_attrs_define
class ColumnPiiProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_pii_profiling_checks_spec_custom_checks = cls()
        ...
        column_pii_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_pii_profiling_checks_spec_custom_checks
