...
if TYPE_CHECKING:
    from ..models.column_patterns_invalid_usa_zipcode_format_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnInvalidUsaZipcodePercentCheckSpec")


@_attrs_define
class ColumnInvalidUsaZipcodePercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnPatternsInvalidUsaZipcodeFormatPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsInvalidUsaZipcodeFormatPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnPatternsInvalidUsaZipcodeFormatPercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_invalid_usa_zipcode_percent_check_spec = cls(
        ...
        column_invalid_usa_zipcode_percent_check_spec.additional_properties = d
        return column_invalid_usa_zipcode_percent_check_spec
