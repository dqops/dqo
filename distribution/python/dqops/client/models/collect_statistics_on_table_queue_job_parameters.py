...
from ..models.collect_statistics_on_table_queue_job_parameters_data_scope import CollectStatisticsOnTableQueueJobParametersDataScope
...
class CollectStatisticsOnTableQueueJobParameters:
    ...
    data_scope: Union[Unset, CollectStatisticsOnTableQueueJobParametersDataScope] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_data_scope,  Unset):
            ...
            data_scope = CollectStatisticsOnTableQueueJobParametersDataScope(_data_scope)
