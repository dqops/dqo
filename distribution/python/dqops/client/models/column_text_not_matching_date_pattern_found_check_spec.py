...
if TYPE_CHECKING:
    from ..models.column_patterns_text_not_matching_date_pattern_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextNotMatchingDatePatternFoundCheckSpec")


@_attrs_define
class ColumnTextNotMatchingDatePatternFoundCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnPatternsTextNotMatchingDatePatternCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsTextNotMatchingDatePatternCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnPatternsTextNotMatchingDatePatternCountSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_text_not_matching_date_pattern_found_check_spec = cls(
        ...
        column_text_not_matching_date_pattern_found_check_spec.additional_properties = d
        return column_text_not_matching_date_pattern_found_check_spec
