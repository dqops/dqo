...
T = TypeVar("T", bound="ColumnStringsExpectedStringsInUseCountSensorParametersSpec")


@attr.s(auto_attribs=True)
class ColumnStringsExpectedStringsInUseCountSensorParametersSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_strings_expected_strings_in_use_count_sensor_parameters_spec = cls(
            filter_=filter_,
            expected_values=expected_values,
        )

        column_strings_expected_strings_in_use_count_sensor_parameters_spec.additional_properties = d
        return column_strings_expected_strings_in_use_count_sensor_parameters_spec
