...
T = TypeVar("T", bound="ColumnNumericNumberBelowMinValuePercentSensorParametersSpec")


@_attrs_define
class ColumnNumericNumberBelowMinValuePercentSensorParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_numeric_number_below_min_value_percent_sensor_parameters_spec = cls(
            filter_=filter_,
            min_value=min_value,
        )

        column_numeric_number_below_min_value_percent_sensor_parameters_spec.additional_properties = (
            d
        )
        return column_numeric_number_below_min_value_percent_sensor_parameters_spec
