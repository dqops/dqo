...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_valid_latitude_percent_sensor_parameters_spec import ColumnNumericValidLatitudePercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnValidLatitudePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnValidLatitudePercentCheckSpec:
    """ 
        Attributes:
    ...
    parameters: Union[Unset, 'ColumnNumericValidLatitudePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericValidLatitudePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_valid_latitude_percent_check_spec = cls(
        ...
        column_valid_latitude_percent_check_spec.additional_properties = d
        return column_valid_latitude_percent_check_spec
