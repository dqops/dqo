...
T = TypeVar("T", bound="ColumnTextDailyPartitionedChecksSpecCustomChecks")


@_attrs_define
class ColumnTextDailyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_text_daily_partitioned_checks_spec_custom_checks = cls()
        ...
        column_text_daily_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_text_daily_partitioned_checks_spec_custom_checks
