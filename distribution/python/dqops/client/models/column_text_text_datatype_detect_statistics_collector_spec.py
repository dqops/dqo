...
T = TypeVar("T", bound="ColumnTextTextDatatypeDetectStatisticsCollectorSpec")


@_attrs_define
class ColumnTextTextDatatypeDetectStatisticsCollectorSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_text_text_datatype_detect_statistics_collector_spec = cls(
            disabled=disabled,
            parameters=parameters,
        )

        column_text_text_datatype_detect_statistics_collector_spec.additional_properties = (
            d
        )
        return column_text_text_datatype_detect_statistics_collector_spec
