...
T = TypeVar("T", bound="ColumnSumChange30DaysCheckSpec")


@_attrs_define
class ColumnSumChange30DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_sum_change_30_days_check_spec = cls(
        ...
        column_sum_change_30_days_check_spec.additional_properties = d
        return column_sum_change_30_days_check_spec
