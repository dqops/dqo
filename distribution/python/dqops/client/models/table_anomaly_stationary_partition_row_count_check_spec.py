...
if TYPE_CHECKING:
  from ..models.anomaly_stationary_percentile_moving_average_rule_1_parameters_spec import AnomalyStationaryPercentileMovingAverageRule1ParametersSpec
  from ..models.anomaly_stationary_percentile_moving_average_rule_01_parameters_spec import AnomalyStationaryPercentileMovingAverageRule01ParametersSpec
  ...
  from ..models.anomaly_stationary_percentile_moving_average_rule_05_parameters_spec import AnomalyStationaryPercentileMovingAverageRule05ParametersSpec





T = TypeVar("T", bound="TableAnomalyStationaryPartitionRowCountCheckSpec")


@attr.s(auto_attribs=True)
class TableAnomalyStationaryPartitionRowCountCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_anomaly_stationary_partition_row_count_check_spec = cls(
        ...
        table_anomaly_stationary_partition_row_count_check_spec.additional_properties = d
        return table_anomaly_stationary_partition_row_count_check_spec
