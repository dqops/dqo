...
T = TypeVar("T", bound="TableVolumeProfilingChecksSpecCustomChecks")


@_attrs_define
class TableVolumeProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_volume_profiling_checks_spec_custom_checks = cls()
        ...
        table_volume_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_volume_profiling_checks_spec_custom_checks
