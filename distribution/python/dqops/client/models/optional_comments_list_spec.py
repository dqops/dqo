...
T = TypeVar("T", bound="OptionalCommentsListSpec")


@_attrs_define
class OptionalCommentsListSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        optional_comments_list_spec = cls(
            empty=empty,
            present=present,
        )

        optional_comments_list_spec.additional_properties = d
        return optional_comments_list_spec
