...
T = TypeVar("T", bound="ColumnAnomalySum30DaysCheckSpec")


@attr.s(auto_attribs=True)
class ColumnAnomalySum30DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_anomaly_sum_30_days_check_spec = cls(
        ...
        column_anomaly_sum_30_days_check_spec.additional_properties = d
        return column_anomaly_sum_30_days_check_spec
