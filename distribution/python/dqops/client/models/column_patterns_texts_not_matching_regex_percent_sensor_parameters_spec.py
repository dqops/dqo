...
class ColumnPatternsTextsNotMatchingRegexPercentSensorParametersSpec:
    ...
    Attributes:
        ...
        regex (Union[Unset, str]): This field can be used to define custom regex. In order to define custom regex, user
            should write correct regex as a string. If regex is not defined by user then default regex is null
    """
