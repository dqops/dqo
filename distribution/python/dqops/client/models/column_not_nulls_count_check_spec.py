...
if TYPE_CHECKING:
  from ..models.min_count_rule_warning_parameters_spec import MinCountRuleWarningParametersSpec
  ...
  from ..models.min_count_rule_fatal_parameters_spec import MinCountRuleFatalParametersSpec
...
class ColumnNotNullsCountCheckSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_not_nulls_count_check_spec.additional_properties = d
        return column_not_nulls_count_check_spec
