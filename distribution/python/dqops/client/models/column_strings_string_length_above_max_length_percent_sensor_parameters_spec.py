...
T = TypeVar(
    "T", bound="ColumnStringsStringLengthAboveMaxLengthPercentSensorParametersSpec"
)
...
class ColumnStringsStringLengthAboveMaxLengthPercentSensorParametersSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_strings_string_length_above_max_length_percent_sensor_parameters_spec = (
            cls(
                filter_=filter_,
        ...
        column_strings_string_length_above_max_length_percent_sensor_parameters_spec.additional_properties = (
            d
        )
        return (
            column_strings_string_length_above_max_length_percent_sensor_parameters_spec
