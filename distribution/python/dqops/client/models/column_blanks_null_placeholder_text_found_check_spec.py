...
if TYPE_CHECKING:
    from ..models.column_blanks_blank_null_placeholder_text_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnBlanksNullPlaceholderTextFoundCheckSpec")


@_attrs_define
class ColumnBlanksNullPlaceholderTextFoundCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnBlanksBlankNullPlaceholderTextCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnBlanksBlankNullPlaceholderTextCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnBlanksBlankNullPlaceholderTextCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_blanks_null_placeholder_text_found_check_spec = cls(
        ...
        column_blanks_null_placeholder_text_found_check_spec.additional_properties = d
        return column_blanks_null_placeholder_text_found_check_spec
