...
T = TypeVar("T", bound="ColumnTextTextLengthBelowMinLengthCountSensorParametersSpec")


@_attrs_define
class ColumnTextTextLengthBelowMinLengthCountSensorParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_text_text_length_below_min_length_count_sensor_parameters_spec = cls(
            filter_=filter_,
            min_length=min_length,
        )

        column_text_text_length_below_min_length_count_sensor_parameters_spec.additional_properties = (
            d
        )
        return column_text_text_length_below_min_length_count_sensor_parameters_spec
