...
if TYPE_CHECKING:
    from ..models.column_patterns_invalid_ip_4_address_format_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnInvalidIp4AddressFormatFoundCheckSpec")


@_attrs_define
class ColumnInvalidIp4AddressFormatFoundCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnPatternsInvalidIp4AddressFormatCountSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_invalid_ip_4_address_format_found_check_spec = cls(
        ...
        column_invalid_ip_4_address_format_found_check_spec.additional_properties = d
        return column_invalid_ip_4_address_format_found_check_spec
