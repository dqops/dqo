...
T = TypeVar("T", bound="TableRowCountCheckSpec")


@attr.s(auto_attribs=True)
class TableRowCountCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_row_count_check_spec.additional_properties = d
        return table_row_count_check_spec
