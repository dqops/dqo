...
if TYPE_CHECKING:
    from ..models.column_text_text_parsable_to_boolean_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextParsableToBooleanPercentCheckSpec")


@_attrs_define
class ColumnTextParsableToBooleanPercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnTextTextParsableToBooleanPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnTextTextParsableToBooleanPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnTextTextParsableToBooleanPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_text_parsable_to_boolean_percent_check_spec = cls(
        ...
        column_text_parsable_to_boolean_percent_check_spec.additional_properties = d
        return column_text_parsable_to_boolean_percent_check_spec
