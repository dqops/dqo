...
T = TypeVar("T", bound="ColumnAnomalyStationaryPartitionSumCheckSpec")


@attr.s(auto_attribs=True)
class ColumnAnomalyStationaryPartitionSumCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_anomaly_stationary_partition_sum_check_spec = cls(
        ...
        column_anomaly_stationary_partition_sum_check_spec.additional_properties = d
        return column_anomaly_stationary_partition_sum_check_spec
