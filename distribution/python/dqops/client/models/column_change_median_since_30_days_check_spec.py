...
T = TypeVar("T", bound="ColumnChangeMedianSince30DaysCheckSpec")


@_attrs_define
class ColumnChangeMedianSince30DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_change_median_since_30_days_check_spec = cls(
        ...
        column_change_median_since_30_days_check_spec.additional_properties = d
        return column_change_median_since_30_days_check_spec
