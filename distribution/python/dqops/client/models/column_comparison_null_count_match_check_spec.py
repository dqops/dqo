...
if TYPE_CHECKING:
  ...
  from ..models.column_nulls_nulls_count_sensor_parameters_spec import ColumnNullsNullsCountSensorParametersSpec





T = TypeVar("T", bound="ColumnComparisonNullCountMatchCheckSpec")


@attr.s(auto_attribs=True)
class ColumnComparisonNullCountMatchCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnNullsNullsCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnNullsNullsCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNullsNullsCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_comparison_null_count_match_check_spec = cls(
        ...
        column_comparison_null_count_match_check_spec.additional_properties = d
        return column_comparison_null_count_match_check_spec
