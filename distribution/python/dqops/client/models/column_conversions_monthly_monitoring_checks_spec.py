...
if TYPE_CHECKING:
    from ..models.column_conversions_monthly_monitoring_checks_spec_custom_checks import (
...
T = TypeVar("T", bound="ColumnConversionsMonthlyMonitoringChecksSpec")


@_attrs_define
class ColumnConversionsMonthlyMonitoringChecksSpec:
    """
    Attributes:
        custom_checks (Union[Unset, ColumnConversionsMonthlyMonitoringChecksSpecCustomChecks]): Dictionary of additional
    ...
    custom_checks: Union[
        Unset, "ColumnConversionsMonthlyMonitoringChecksSpecCustomChecks"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_custom_checks, Unset):
            ...
            custom_checks = (
                ColumnConversionsMonthlyMonitoringChecksSpecCustomChecks.from_dict(
                    _custom_checks
                )
            )
        ...
        column_conversions_monthly_monitoring_checks_spec = cls(
        ...
        column_conversions_monthly_monitoring_checks_spec.additional_properties = d
        return column_conversions_monthly_monitoring_checks_spec
