...
if TYPE_CHECKING:
  ...
  from ..models.anomaly_differencing_percentile_moving_average_rule_1_parameters_spec import AnomalyDifferencingPercentileMovingAverageRule1ParametersSpec
  from ..models.anomaly_differencing_percentile_moving_average_rule_01_parameters_spec import AnomalyDifferencingPercentileMovingAverageRule01ParametersSpec
  from ..models.anomaly_differencing_percentile_moving_average_rule_05_parameters_spec import AnomalyDifferencingPercentileMovingAverageRule05ParametersSpec
  from ..models.comment_spec import CommentSpec
  from ..models.column_numeric_sum_sensor_parameters_spec import ColumnNumericSumSensorParametersSpec





T = TypeVar("T", bound="ColumnAnomalyDifferencingSumCheckSpec")


@attr.s(auto_attribs=True)
class ColumnAnomalyDifferencingSumCheckSpec:
    """ 
        Attributes:
    ...
    warning: Union[Unset, 'AnomalyDifferencingPercentileMovingAverageRule1ParametersSpec'] = UNSET
    error: Union[Unset, 'AnomalyDifferencingPercentileMovingAverageRule05ParametersSpec'] = UNSET
    fatal: Union[Unset, 'AnomalyDifferencingPercentileMovingAverageRule01ParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_warning,  Unset):
            ...
            warning = AnomalyDifferencingPercentileMovingAverageRule1ParametersSpec.from_dict(_warning)
        ...
        if isinstance(_error,  Unset):
            ...
            error = AnomalyDifferencingPercentileMovingAverageRule05ParametersSpec.from_dict(_error)
        ...
        if isinstance(_fatal,  Unset):
            ...
            fatal = AnomalyDifferencingPercentileMovingAverageRule01ParametersSpec.from_dict(_fatal)




        column_anomaly_differencing_sum_check_spec = cls(
        ...
        column_anomaly_differencing_sum_check_spec.additional_properties = d
        return column_anomaly_differencing_sum_check_spec
