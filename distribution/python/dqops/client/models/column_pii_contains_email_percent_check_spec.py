...
if TYPE_CHECKING:
  from ..models.column_pii_contains_email_percent_sensor_parameters_spec import ColumnPiiContainsEmailPercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnPiiContainsEmailPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnPiiContainsEmailPercentCheckSpec:
    """ 
        Attributes:
    ...
    parameters: Union[Unset, 'ColumnPiiContainsEmailPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnPiiContainsEmailPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_pii_contains_email_percent_check_spec.additional_properties = d
        return column_pii_contains_email_percent_check_spec
