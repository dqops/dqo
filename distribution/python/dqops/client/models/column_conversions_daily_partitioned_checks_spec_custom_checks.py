...
T = TypeVar("T", bound="ColumnConversionsDailyPartitionedChecksSpecCustomChecks")


@_attrs_define
class ColumnConversionsDailyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_conversions_daily_partitioned_checks_spec_custom_checks = cls()
        ...
        column_conversions_daily_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_conversions_daily_partitioned_checks_spec_custom_checks
