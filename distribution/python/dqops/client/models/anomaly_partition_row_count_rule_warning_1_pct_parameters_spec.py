...
T = TypeVar("T", bound="AnomalyPartitionRowCountRuleWarning1PctParametersSpec")


@_attrs_define
class AnomalyPartitionRowCountRuleWarning1PctParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return anomaly_partition_row_count_rule_warning_1_pct_parameters_spec
