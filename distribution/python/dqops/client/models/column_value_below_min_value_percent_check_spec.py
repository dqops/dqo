...
if TYPE_CHECKING:
    from ..models.column_numeric_value_below_min_value_percent_sensor_parameters_spec import (
...
class ColumnValueBelowMinValuePercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnNumericValueBelowMinValuePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnNumericValueBelowMinValuePercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
