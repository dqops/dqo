...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_value_below_min_value_percent_sensor_parameters_spec import ColumnNumericValueBelowMinValuePercentSensorParametersSpec





T = TypeVar("T", bound="ColumnValueBelowMinValuePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnValueBelowMinValuePercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnNumericValueBelowMinValuePercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnNumericValueBelowMinValuePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericValueBelowMinValuePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_value_below_min_value_percent_check_spec = cls(
        ...
        column_value_below_min_value_percent_check_spec.additional_properties = d
        return column_value_below_min_value_percent_check_spec
