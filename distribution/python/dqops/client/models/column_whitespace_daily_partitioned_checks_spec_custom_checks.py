...
T = TypeVar("T", bound="ColumnWhitespaceDailyPartitionedChecksSpecCustomChecks")


@_attrs_define
class ColumnWhitespaceDailyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_whitespace_daily_partitioned_checks_spec_custom_checks = cls()
        ...
        column_whitespace_daily_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_whitespace_daily_partitioned_checks_spec_custom_checks
