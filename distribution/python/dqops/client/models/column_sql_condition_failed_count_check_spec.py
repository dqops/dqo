...
if TYPE_CHECKING:
  ...
  from ..models.column_sql_condition_failed_count_sensor_parameters_spec import ColumnSqlConditionFailedCountSensorParametersSpec
...
class ColumnSqlConditionFailedCountCheckSpec:
    ...
    parameters: Union[Unset, 'ColumnSqlConditionFailedCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnSqlConditionFailedCountSensorParametersSpec.from_dict(_parameters)
