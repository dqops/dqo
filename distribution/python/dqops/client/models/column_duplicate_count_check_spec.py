...
T = TypeVar("T", bound="ColumnDuplicateCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnDuplicateCountCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_duplicate_count_check_spec = cls(
        ...
        column_duplicate_count_check_spec.additional_properties = d
        return column_duplicate_count_check_spec
