...
T = TypeVar("T", bound="ColumnDuplicatePercentCheckSpec")


@_attrs_define
class ColumnDuplicatePercentCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_duplicate_percent_check_spec = cls(
        ...
        column_duplicate_percent_check_spec.additional_properties = d
        return column_duplicate_percent_check_spec
