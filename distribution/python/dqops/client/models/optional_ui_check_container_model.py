...
T = TypeVar("T", bound="OptionalUICheckContainerModel")


@attr.s(auto_attribs=True)
class OptionalUICheckContainerModel:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        optional_ui_check_container_model = cls(
            empty=empty,
            present=present,
        )

        optional_ui_check_container_model.additional_properties = d
        return optional_ui_check_container_model
