...
T = TypeVar("T", bound="MinCountRule0ParametersSpec")


@_attrs_define
class MinCountRule0ParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        min_count_rule_0_parameters_spec = cls(
            min_count=min_count,
        )

        min_count_rule_0_parameters_spec.additional_properties = d
        return min_count_rule_0_parameters_spec
