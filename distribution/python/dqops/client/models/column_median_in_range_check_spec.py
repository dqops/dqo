...
T = TypeVar("T", bound="ColumnMedianInRangeCheckSpec")


@attr.s(auto_attribs=True)
class ColumnMedianInRangeCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_median_in_range_check_spec = cls(
        ...
        column_median_in_range_check_spec.additional_properties = d
        return column_median_in_range_check_spec
