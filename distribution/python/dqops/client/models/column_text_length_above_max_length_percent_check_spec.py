...
if TYPE_CHECKING:
    from ..models.column_text_text_length_above_max_length_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextLengthAboveMaxLengthPercentCheckSpec")


@_attrs_define
class ColumnTextLengthAboveMaxLengthPercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnTextTextLengthAboveMaxLengthPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnTextTextLengthAboveMaxLengthPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnTextTextLengthAboveMaxLengthPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_text_length_above_max_length_percent_check_spec = cls(
        ...
        column_text_length_above_max_length_percent_check_spec.additional_properties = d
        return column_text_length_above_max_length_percent_check_spec
