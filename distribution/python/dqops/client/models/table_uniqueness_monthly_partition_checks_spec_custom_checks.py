...
T = TypeVar("T", bound="TableUniquenessMonthlyPartitionChecksSpecCustomChecks")


@_attrs_define
class TableUniquenessMonthlyPartitionChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_uniqueness_monthly_partition_checks_spec_custom_checks = cls()
        ...
        table_uniqueness_monthly_partition_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_uniqueness_monthly_partition_checks_spec_custom_checks
