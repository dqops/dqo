...
if TYPE_CHECKING:
  from ..models.column_strings_string_min_length_sensor_parameters_spec import ColumnStringsStringMinLengthSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringMinLengthCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringMinLengthCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringMinLengthSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_min_length_check_spec = cls(
        ...
        column_string_min_length_check_spec.additional_properties = d
        return column_string_min_length_check_spec
