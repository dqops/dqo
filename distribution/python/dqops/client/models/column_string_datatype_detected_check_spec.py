...
if TYPE_CHECKING:
  from ..models.datatype_equals_rule_parameters_spec import DatatypeEqualsRuleParametersSpec
...
T = TypeVar("T", bound="ColumnStringDatatypeDetectedCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringDatatypeDetectedCheckSpec:
    """ 
        Attributes:
            ...
            warning (Union[Unset, DatatypeEqualsRuleParametersSpec]):
            error (Union[Unset, DatatypeEqualsRuleParametersSpec]):
            fatal (Union[Unset, DatatypeEqualsRuleParametersSpec]):
     """
    ...
    warning: Union[Unset, 'DatatypeEqualsRuleParametersSpec'] = UNSET
    error: Union[Unset, 'DatatypeEqualsRuleParametersSpec'] = UNSET
    fatal: Union[Unset, 'DatatypeEqualsRuleParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_warning,  Unset):
            ...
            warning = DatatypeEqualsRuleParametersSpec.from_dict(_warning)
        ...
        if isinstance(_error,  Unset):
            ...
            error = DatatypeEqualsRuleParametersSpec.from_dict(_error)
        ...
        if isinstance(_fatal,  Unset):
            ...
            fatal = DatatypeEqualsRuleParametersSpec.from_dict(_fatal)




        column_string_datatype_detected_check_spec = cls(
        ...
        column_string_datatype_detected_check_spec.additional_properties = d
        return column_string_datatype_detected_check_spec
