...
T = TypeVar(
    "T", bound="AnomalyDifferencingPercentileMovingAverageRuleFatal01PctParametersSpec"
)


@_attrs_define
class AnomalyDifferencingPercentileMovingAverageRuleFatal01PctParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return anomaly_differencing_percentile_moving_average_rule_fatal_01_pct_parameters_spec
