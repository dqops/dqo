...
T = TypeVar("T", bound="TableAnomalyDifferencingRowCountCheckSpec")


@_attrs_define
class TableAnomalyDifferencingRowCountCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_anomaly_differencing_row_count_check_spec = cls(
        ...
        table_anomaly_differencing_row_count_check_spec.additional_properties = d
        return table_anomaly_differencing_row_count_check_spec
