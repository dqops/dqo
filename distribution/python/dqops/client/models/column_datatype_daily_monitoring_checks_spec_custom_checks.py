...
T = TypeVar("T", bound="ColumnDatatypeDailyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnDatatypeDailyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_datatype_daily_monitoring_checks_spec_custom_checks = cls()
        ...
        column_datatype_daily_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_datatype_daily_monitoring_checks_spec_custom_checks
