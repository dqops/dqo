...
if TYPE_CHECKING:
    from ..models.column_blanks_blank_null_placeholder_text_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnBlanksNullPlaceholderTextPercentCheckSpec")


@_attrs_define
class ColumnBlanksNullPlaceholderTextPercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnBlanksBlankNullPlaceholderTextPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnBlanksBlankNullPlaceholderTextPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnBlanksBlankNullPlaceholderTextPercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_blanks_null_placeholder_text_percent_check_spec = cls(
        ...
        column_blanks_null_placeholder_text_percent_check_spec.additional_properties = d
        return column_blanks_null_placeholder_text_percent_check_spec
