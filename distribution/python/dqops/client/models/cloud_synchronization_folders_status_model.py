...
from ..models.cloud_synchronization_folders_status_model_data_check_results import CloudSynchronizationFoldersStatusModelDataCheckResults
from ..models.cloud_synchronization_folders_status_model_sensors import CloudSynchronizationFoldersStatusModelSensors
from ..models.cloud_synchronization_folders_status_model_rules import CloudSynchronizationFoldersStatusModelRules
from ..models.cloud_synchronization_folders_status_model_data_statistics import CloudSynchronizationFoldersStatusModelDataStatistics
from ..models.cloud_synchronization_folders_status_model_sources import CloudSynchronizationFoldersStatusModelSources
from ..models.cloud_synchronization_folders_status_model_checks import CloudSynchronizationFoldersStatusModelChecks
from typing import Union
from ..models.cloud_synchronization_folders_status_model_data_incidents import CloudSynchronizationFoldersStatusModelDataIncidents
from ..types import UNSET, Unset
from ..models.cloud_synchronization_folders_status_model_data_errors import CloudSynchronizationFoldersStatusModelDataErrors
from ..models.cloud_synchronization_folders_status_model_data_sensor_readouts import CloudSynchronizationFoldersStatusModelDataSensorReadouts
...
class CloudSynchronizationFoldersStatusModel:
    ...
    data_sensor_readouts: Union[Unset, CloudSynchronizationFoldersStatusModelDataSensorReadouts] = UNSET
    data_check_results: Union[Unset, CloudSynchronizationFoldersStatusModelDataCheckResults] = UNSET
    data_statistics: Union[Unset, CloudSynchronizationFoldersStatusModelDataStatistics] = UNSET
    data_errors: Union[Unset, CloudSynchronizationFoldersStatusModelDataErrors] = UNSET
    data_incidents: Union[Unset, CloudSynchronizationFoldersStatusModelDataIncidents] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        data_sensor_readouts: Union[Unset, CloudSynchronizationFoldersStatusModelDataSensorReadouts]
        if isinstance(_data_sensor_readouts,  Unset):
            data_sensor_readouts = UNSET
        else:
            data_sensor_readouts = CloudSynchronizationFoldersStatusModelDataSensorReadouts(_data_sensor_readouts)




        _data_check_results = d.pop("data_check_results", UNSET)
        data_check_results: Union[Unset, CloudSynchronizationFoldersStatusModelDataCheckResults]
        if isinstance(_data_check_results,  Unset):
            data_check_results = UNSET
        else:
            data_check_results = CloudSynchronizationFoldersStatusModelDataCheckResults(_data_check_results)




        _data_statistics = d.pop("data_statistics", UNSET)
        data_statistics: Union[Unset, CloudSynchronizationFoldersStatusModelDataStatistics]
        if isinstance(_data_statistics,  Unset):
            data_statistics = UNSET
        else:
            data_statistics = CloudSynchronizationFoldersStatusModelDataStatistics(_data_statistics)
        ...
        data_incidents: Union[Unset, CloudSynchronizationFoldersStatusModelDataIncidents]
        if isinstance(_data_incidents,  Unset):
            data_incidents = UNSET
        else:
            data_incidents = CloudSynchronizationFoldersStatusModelDataIncidents(_data_incidents)
