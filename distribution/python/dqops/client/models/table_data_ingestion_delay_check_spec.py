...
if TYPE_CHECKING:
    ...
    from ..models.table_timeliness_data_ingestion_delay_sensor_parameters_spec import (
...
class TableDataIngestionDelayCheckSpec:
    ...
    parameters: Union[
        Unset, "TableTimelinessDataIngestionDelaySensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                TableTimelinessDataIngestionDelaySensorParametersSpec.from_dict(
                    _parameters
                )
            )
