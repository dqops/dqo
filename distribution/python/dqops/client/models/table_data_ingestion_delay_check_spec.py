...
if TYPE_CHECKING:
  ...
  from ..models.table_timeliness_data_ingestion_delay_sensor_parameters_spec import TableTimelinessDataIngestionDelaySensorParametersSpec
...
T = TypeVar("T", bound="TableDataIngestionDelayCheckSpec")


@attr.s(auto_attribs=True)
class TableDataIngestionDelayCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, TableTimelinessDataIngestionDelaySensorParametersSpec]):
    ...
    parameters: Union[Unset, 'TableTimelinessDataIngestionDelaySensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = TableTimelinessDataIngestionDelaySensorParametersSpec.from_dict(_parameters)
        ...
        table_data_ingestion_delay_check_spec = cls(
        ...
        table_data_ingestion_delay_check_spec.additional_properties = d
        return table_data_ingestion_delay_check_spec
