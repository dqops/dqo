...
if TYPE_CHECKING:
    from ..models.column_accuracy_max_match_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnAccuracyMaxMatchPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnAccuracyMaxMatchPercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnAccuracyMaxMatchPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnAccuracyMaxMatchPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnAccuracyMaxMatchPercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_accuracy_max_match_percent_check_spec = cls(
        ...
        column_accuracy_max_match_percent_check_spec.additional_properties = d
        return column_accuracy_max_match_percent_check_spec
