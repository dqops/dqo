...
if TYPE_CHECKING:
  ...
  from ..models.anomaly_differencing_percentile_moving_average_30_days_rule_1_parameters_spec import AnomalyDifferencingPercentileMovingAverage30DaysRule1ParametersSpec
  from ..models.anomaly_differencing_percentile_moving_average_30_days_rule_05_parameters_spec import AnomalyDifferencingPercentileMovingAverage30DaysRule05ParametersSpec
  from ..models.table_volume_row_count_sensor_parameters_spec import TableVolumeRowCountSensorParametersSpec
  from ..models.comment_spec import CommentSpec
  from ..models.anomaly_differencing_percentile_moving_average_30_days_rule_01_parameters_spec import AnomalyDifferencingPercentileMovingAverage30DaysRule01ParametersSpec





T = TypeVar("T", bound="TableAnomalyDifferencingRowCount30DaysCheckSpec")


@attr.s(auto_attribs=True)
class TableAnomalyDifferencingRowCount30DaysCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_anomaly_differencing_row_count_30_days_check_spec = cls(
        ...
        table_anomaly_differencing_row_count_30_days_check_spec.additional_properties = d
        return table_anomaly_differencing_row_count_30_days_check_spec
