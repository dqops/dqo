...
T = TypeVar("T", bound="AnomalyPartitionRowCountRuleError05PctParametersSpec")


@_attrs_define
class AnomalyPartitionRowCountRuleError05PctParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return anomaly_partition_row_count_rule_error_05_pct_parameters_spec
