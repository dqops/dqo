...
T = TypeVar("T", bound="ColumnAnomalyDifferencingDistinctCount30DaysCheckSpec")


@_attrs_define
class ColumnAnomalyDifferencingDistinctCount30DaysCheckSpec:
    """
    Attributes:
    ...
    warning: Union[
        Unset, "AnomalyDifferencingPercentileMovingAverage30DaysRule1ParametersSpec"
    ] = UNSET
    error: Union[
        Unset, "AnomalyDifferencingPercentileMovingAverage30DaysRule05ParametersSpec"
    ] = UNSET
    fatal: Union[
        Unset, "AnomalyDifferencingPercentileMovingAverage30DaysRule01ParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_warning, Unset):
            ...
            warning = AnomalyDifferencingPercentileMovingAverage30DaysRule1ParametersSpec.from_dict(
                _warning
            )
        ...
        if isinstance(_error, Unset):
            ...
            error = AnomalyDifferencingPercentileMovingAverage30DaysRule05ParametersSpec.from_dict(
                _error
            )
        ...
        if isinstance(_fatal, Unset):
            ...
            fatal = AnomalyDifferencingPercentileMovingAverage30DaysRule01ParametersSpec.from_dict(
                _fatal
            )

        column_anomaly_differencing_distinct_count_30_days_check_spec = cls(
        ...
        column_anomaly_differencing_distinct_count_30_days_check_spec.additional_properties = (
            d
        )
        return column_anomaly_differencing_distinct_count_30_days_check_spec
