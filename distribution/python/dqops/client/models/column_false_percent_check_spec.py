...
if TYPE_CHECKING:
  ...
  from ..models.column_bool_false_percent_sensor_parameters_spec import ColumnBoolFalsePercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnFalsePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnFalsePercentCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnBoolFalsePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_false_percent_check_spec.additional_properties = d
        return column_false_percent_check_spec
