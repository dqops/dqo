...
T = TypeVar("T", bound="ColumnAcceptedValuesTextFoundInSetPercentSensorParametersSpec")


@_attrs_define
class ColumnAcceptedValuesTextFoundInSetPercentSensorParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_accepted_values_text_found_in_set_percent_sensor_parameters_spec = cls(
            filter_=filter_,
            expected_values=expected_values,
        )

        column_accepted_values_text_found_in_set_percent_sensor_parameters_spec.additional_properties = (
            d
        )
        return column_accepted_values_text_found_in_set_percent_sensor_parameters_spec
