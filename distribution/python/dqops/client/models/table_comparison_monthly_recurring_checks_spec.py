...
T = TypeVar("T", bound="TableComparisonMonthlyRecurringChecksSpec")


@attr.s(auto_attribs=True)
class TableComparisonMonthlyRecurringChecksSpec:
    """ 
        Attributes:
            monthly_row_count_match (Union[Unset, TableComparisonRowCountMatchCheckSpec]):
     """

    monthly_row_count_match: Union[Unset, 'TableComparisonRowCountMatchCheckSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_monthly_row_count_match,  Unset):
            ...
            monthly_row_count_match = TableComparisonRowCountMatchCheckSpec.from_dict(_monthly_row_count_match)




        table_comparison_monthly_recurring_checks_spec = cls(
            monthly_row_count_match=monthly_row_count_match,
        )

        table_comparison_monthly_recurring_checks_spec.additional_properties = d
        return table_comparison_monthly_recurring_checks_spec
