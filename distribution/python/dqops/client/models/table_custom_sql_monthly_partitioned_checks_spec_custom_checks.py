...
T = TypeVar("T", bound="TableCustomSqlMonthlyPartitionedChecksSpecCustomChecks")


@_attrs_define
class TableCustomSqlMonthlyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_custom_sql_monthly_partitioned_checks_spec_custom_checks = cls()
        ...
        table_custom_sql_monthly_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_custom_sql_monthly_partitioned_checks_spec_custom_checks
