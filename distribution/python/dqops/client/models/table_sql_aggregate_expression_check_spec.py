...
if TYPE_CHECKING:
    from ..models.between_floats_rule_parameters_spec import (
        BetweenFloatsRuleParametersSpec,
    )
    from ..models.comment_spec import CommentSpec
    from ..models.monitoring_schedule_spec import MonitoringScheduleSpec
    from ..models.table_sql_aggregated_expression_sensor_parameters_spec import (
        TableSqlAggregatedExpressionSensorParametersSpec,
    )


T = TypeVar("T", bound="TableSqlAggregateExpressionCheckSpec")


@_attrs_define
class TableSqlAggregateExpressionCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, TableSqlAggregatedExpressionSensorParametersSpec]):
    ...
    parameters: Union[Unset, "TableSqlAggregatedExpressionSensorParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = TableSqlAggregatedExpressionSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        table_sql_aggregate_expression_check_spec = cls(
        ...
        table_sql_aggregate_expression_check_spec.additional_properties = d
        return table_sql_aggregate_expression_check_spec
