...
T = TypeVar("T", bound="ColumnRangeMedianValueStatisticsCollectorSpec")


@_attrs_define
class ColumnRangeMedianValueStatisticsCollectorSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_range_median_value_statistics_collector_spec = cls(
            disabled=disabled,
            parameters=parameters,
        )

        column_range_median_value_statistics_collector_spec.additional_properties = d
        return column_range_median_value_statistics_collector_spec
