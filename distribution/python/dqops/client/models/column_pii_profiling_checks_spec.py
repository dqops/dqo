...
class ColumnPiiProfilingChecksSpec:
    ...
    contains_email_percent: Union[
        Unset, "ColumnPiiContainsEmailPercentCheckSpec"
    ] = UNSET
    valid_ip4_address_percent: Union[
    ...
    valid_ip6_address_percent: Union[
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_valid_usa_phone_percent, Unset):
            ...
            valid_usa_phone_percent = ColumnPiiValidUsaPhonePercentCheckSpec.from_dict(
                _valid_usa_phone_percent
            )
        ...
        if isinstance(_valid_email_percent, Unset):
            ...
            valid_email_percent = ColumnPiiValidEmailPercentCheckSpec.from_dict(
                _valid_email_percent
            )
        ...
        if isinstance(_contains_email_percent, Unset):
            ...
            contains_email_percent = ColumnPiiContainsEmailPercentCheckSpec.from_dict(
                _contains_email_percent
            )
        ...
        if isinstance(_contains_ip4_percent, Unset):
            ...
            contains_ip4_percent = ColumnPiiContainsIp4PercentCheckSpec.from_dict(
                _contains_ip4_percent
            )
        ...
        if isinstance(_contains_ip6_percent, Unset):
            ...
            contains_ip6_percent = ColumnPiiContainsIp6PercentCheckSpec.from_dict(
                _contains_ip6_percent
            )
