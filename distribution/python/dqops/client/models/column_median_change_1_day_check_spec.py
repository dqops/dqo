...
T = TypeVar("T", bound="ColumnMedianChange1DayCheckSpec")


@_attrs_define
class ColumnMedianChange1DayCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_median_change_1_day_check_spec = cls(
        ...
        column_median_change_1_day_check_spec.additional_properties = d
        return column_median_change_1_day_check_spec
