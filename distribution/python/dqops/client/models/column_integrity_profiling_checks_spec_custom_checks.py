...
T = TypeVar("T", bound="ColumnIntegrityProfilingChecksSpecCustomChecks")


@_attrs_define
class ColumnIntegrityProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_integrity_profiling_checks_spec_custom_checks = cls()
        ...
        column_integrity_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_integrity_profiling_checks_spec_custom_checks
