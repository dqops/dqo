...
if TYPE_CHECKING:
  from ..models.column_strings_string_not_match_regex_count_sensor_parameters_spec import ColumnStringsStringNotMatchRegexCountSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringNotMatchRegexCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringNotMatchRegexCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringNotMatchRegexCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringNotMatchRegexCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringNotMatchRegexCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_not_match_regex_count_check_spec = cls(
        ...
        column_string_not_match_regex_count_check_spec.additional_properties = d
        return column_string_not_match_regex_count_check_spec
