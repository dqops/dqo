...
if TYPE_CHECKING:
    from ..models.column_strings_string_not_match_regex_count_sensor_parameters_spec import (
...
class ColumnStringNotMatchRegexCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringNotMatchRegexCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringNotMatchRegexCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
