...
T = TypeVar("T", bound="MinPercentRule99ParametersSpec")


@_attrs_define
class MinPercentRule99ParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        min_percent_rule_99_parameters_spec = cls(
            min_percent=min_percent,
        )

        min_percent_rule_99_parameters_spec.additional_properties = d
        return min_percent_rule_99_parameters_spec
