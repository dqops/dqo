...
T = TypeVar("T", bound="TableRowCountChangeCheckSpec")


@_attrs_define
class TableRowCountChangeCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_row_count_change_check_spec = cls(
        ...
        table_row_count_change_check_spec.additional_properties = d
        return table_row_count_change_check_spec
