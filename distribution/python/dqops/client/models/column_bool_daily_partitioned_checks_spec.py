...
class ColumnBoolDailyPartitionedChecksSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_daily_partition_true_percent,  Unset):
            ...
            daily_partition_true_percent = ColumnTruePercentCheckSpec.from_dict(_daily_partition_true_percent)
        ...
        if isinstance(_daily_partition_false_percent,  Unset):
            ...
            daily_partition_false_percent = ColumnFalsePercentCheckSpec.from_dict(_daily_partition_false_percent)
