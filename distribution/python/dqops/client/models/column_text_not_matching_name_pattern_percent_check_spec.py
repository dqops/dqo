...
if TYPE_CHECKING:
    from ..models.column_patterns_text_not_matching_name_pattern_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextNotMatchingNamePatternPercentCheckSpec")


@_attrs_define
class ColumnTextNotMatchingNamePatternPercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnPatternsTextNotMatchingNamePatternPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsTextNotMatchingNamePatternPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnPatternsTextNotMatchingNamePatternPercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_text_not_matching_name_pattern_percent_check_spec = cls(
        ...
        column_text_not_matching_name_pattern_percent_check_spec.additional_properties = (
            d
        )
        return column_text_not_matching_name_pattern_percent_check_spec
