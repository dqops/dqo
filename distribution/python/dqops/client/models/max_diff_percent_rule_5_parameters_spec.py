...
class MaxDiffPercentRule5ParametersSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        max_diff_percent_rule_5_parameters_spec = cls(
            max_diff_percent=max_diff_percent,
        )

        max_diff_percent_rule_5_parameters_spec.additional_properties = d
        return max_diff_percent_rule_5_parameters_spec
