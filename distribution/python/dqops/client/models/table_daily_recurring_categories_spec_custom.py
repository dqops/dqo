...
T = TypeVar("T", bound="TableDailyRecurringCategoriesSpecCustom")


@attr.s(auto_attribs=True)
class TableDailyRecurringCategoriesSpecCustom:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_daily_recurring_categories_spec_custom = cls()
        ...
        table_daily_recurring_categories_spec_custom.additional_properties = (
            additional_properties
        )
        return table_daily_recurring_categories_spec_custom
