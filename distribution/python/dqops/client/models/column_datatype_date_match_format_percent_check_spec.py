...
if TYPE_CHECKING:
    from ..models.column_datatype_date_match_format_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnDatatypeDateMatchFormatPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnDatatypeDateMatchFormatPercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnDatatypeDateMatchFormatPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnDatatypeDateMatchFormatPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnDatatypeDateMatchFormatPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_datatype_date_match_format_percent_check_spec = cls(
        ...
        column_datatype_date_match_format_percent_check_spec.additional_properties = d
        return column_datatype_date_match_format_percent_check_spec
