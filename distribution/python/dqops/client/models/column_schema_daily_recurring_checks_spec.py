...
class ColumnSchemaDailyRecurringChecksSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_daily_column_exists,  Unset):
            ...
            daily_column_exists = ColumnSchemaColumnExistsCheckSpec.from_dict(_daily_column_exists)
        ...
        if isinstance(_daily_column_type_changed,  Unset):
            ...
            daily_column_type_changed = ColumnSchemaTypeChangedCheckSpec.from_dict(_daily_column_type_changed)
