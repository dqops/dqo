...
T = TypeVar("T", bound="ColumnMeanAnomalyStationaryCheckSpec")


@_attrs_define
class ColumnMeanAnomalyStationaryCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_mean_anomaly_stationary_check_spec = cls(
        ...
        column_mean_anomaly_stationary_check_spec.additional_properties = d
        return column_mean_anomaly_stationary_check_spec
