...
class TableDailyPartitionedCheckCategoriesSpecCustom:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.custom_check_spec import CustomCheckSpec
        d = src_dict.copy()
        table_daily_partitioned_check_categories_spec_custom = cls(
        )
        ...
        table_daily_partitioned_check_categories_spec_custom.additional_properties = additional_properties
        return table_daily_partitioned_check_categories_spec_custom
