...
if TYPE_CHECKING:
  from ..models.column_pii_contains_usa_zipcode_percent_sensor_parameters_spec import ColumnPiiContainsUsaZipcodePercentSensorParametersSpec
...
class ColumnPiiContainsUsaZipcodePercentCheckSpec:
    ...
    parameters: Union[Unset, 'ColumnPiiContainsUsaZipcodePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnPiiContainsUsaZipcodePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_pii_contains_usa_zipcode_percent_check_spec = cls(
        ...
        column_pii_contains_usa_zipcode_percent_check_spec.additional_properties = d
        return column_pii_contains_usa_zipcode_percent_check_spec
