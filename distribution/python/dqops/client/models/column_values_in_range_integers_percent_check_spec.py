...
if TYPE_CHECKING:
    from ..models.column_numeric_values_in_range_integers_percent_sensor_parameters_spec import (
...
class ColumnValuesInRangeIntegersPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnNumericValuesInRangeIntegersPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnNumericValuesInRangeIntegersPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
