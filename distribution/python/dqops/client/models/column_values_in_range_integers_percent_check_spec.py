...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_values_in_range_integers_percent_sensor_parameters_spec import ColumnNumericValuesInRangeIntegersPercentSensorParametersSpec





T = TypeVar("T", bound="ColumnValuesInRangeIntegersPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnValuesInRangeIntegersPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnNumericValuesInRangeIntegersPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnNumericValuesInRangeIntegersPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericValuesInRangeIntegersPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_values_in_range_integers_percent_check_spec = cls(
        ...
        column_values_in_range_integers_percent_check_spec.additional_properties = d
        return column_values_in_range_integers_percent_check_spec
