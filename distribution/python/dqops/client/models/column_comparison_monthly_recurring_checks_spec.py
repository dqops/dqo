...
T = TypeVar("T", bound="ColumnComparisonMonthlyRecurringChecksSpec")


@attr.s(auto_attribs=True)
class ColumnComparisonMonthlyRecurringChecksSpec:
    """ 
        Attributes:
    ...
    monthly_not_null_count_match: Union[Unset, 'ColumnComparisonNotNullCountMatchCheckSpec'] = UNSET
    monthly_null_count_match: Union[Unset, 'ColumnComparisonNullCountMatchCheckSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_monthly_sum_match,  Unset):
            ...
            monthly_sum_match = ColumnComparisonSumMatchCheckSpec.from_dict(_monthly_sum_match)
        ...
        if isinstance(_monthly_min_match,  Unset):
            ...
            monthly_min_match = ColumnComparisonMinMatchCheckSpec.from_dict(_monthly_min_match)
        ...
        if isinstance(_monthly_max_match,  Unset):
            ...
            monthly_max_match = ColumnComparisonMaxMatchCheckSpec.from_dict(_monthly_max_match)
        ...
        if isinstance(_monthly_mean_match,  Unset):
            ...
            monthly_mean_match = ColumnComparisonMeanMatchCheckSpec.from_dict(_monthly_mean_match)
        ...
        if isinstance(_monthly_not_null_count_match,  Unset):
            ...
            monthly_not_null_count_match = ColumnComparisonNotNullCountMatchCheckSpec.from_dict(_monthly_not_null_count_match)
        ...
        if isinstance(_monthly_null_count_match,  Unset):
            ...
            monthly_null_count_match = ColumnComparisonNullCountMatchCheckSpec.from_dict(_monthly_null_count_match)




        column_comparison_monthly_recurring_checks_spec = cls(
        ...
        column_comparison_monthly_recurring_checks_spec.additional_properties = d
        return column_comparison_monthly_recurring_checks_spec
