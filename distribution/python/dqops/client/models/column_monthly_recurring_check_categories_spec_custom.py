...
T = TypeVar("T", bound="ColumnMonthlyRecurringCheckCategoriesSpecCustom")


@attr.s(auto_attribs=True)
class ColumnMonthlyRecurringCheckCategoriesSpecCustom:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.custom_check_spec import CustomCheckSpec
        d = src_dict.copy()
        column_monthly_recurring_check_categories_spec_custom = cls(
        )
        ...
        column_monthly_recurring_check_categories_spec_custom.additional_properties = additional_properties
        return column_monthly_recurring_check_categories_spec_custom
