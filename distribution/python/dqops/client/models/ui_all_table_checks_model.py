...
from ..models.ui_all_table_checks_model_check_target import (
...
if TYPE_CHECKING:
    ...
    from ..models.ui_schema_table_checks_model import UISchemaTableChecksModel


T = TypeVar("T", bound="UIAllTableChecksModel")


@attr.s(auto_attribs=True)
class UIAllTableChecksModel:
    """UI model that returns the model of selected information related to table checks on a connection level.

    Attributes:
        check_target (Union[Unset, UIAllTableChecksModelCheckTarget]): Check target.
        ...
        ui_schema_table_checks_models (Union[Unset, List['UISchemaTableChecksModel']]): List containing information
            related to tables in each schema.
    """

    check_target: Union[Unset, UIAllTableChecksModelCheckTarget] = UNSET
    ...
    ui_schema_table_checks_models: Union[
        Unset, List["UISchemaTableChecksModel"]
    ] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        ui_schema_table_checks_models: Union[Unset, List[Dict[str, Any]]] = UNSET
        if not isinstance(self.ui_schema_table_checks_models, Unset):
            ui_schema_table_checks_models = []
            for (
                ui_schema_table_checks_models_item_data
            ) in self.ui_schema_table_checks_models:
                ui_schema_table_checks_models_item = (
                    ui_schema_table_checks_models_item_data.to_dict()
                )

                ui_schema_table_checks_models.append(ui_schema_table_checks_models_item)
        ...
        if ui_schema_table_checks_models is not UNSET:
            field_dict["ui_schema_table_checks_models"] = ui_schema_table_checks_models
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        check_target: Union[Unset, UIAllTableChecksModelCheckTarget]
        if isinstance(_check_target, Unset):
            check_target = UNSET
        else:
            check_target = UIAllTableChecksModelCheckTarget(_check_target)
        ...
        ui_schema_table_checks_models = []
        _ui_schema_table_checks_models = d.pop("ui_schema_table_checks_models", UNSET)
        for ui_schema_table_checks_models_item_data in (
            _ui_schema_table_checks_models or []
        ):
            ui_schema_table_checks_models_item = UISchemaTableChecksModel.from_dict(
                ui_schema_table_checks_models_item_data
            )

            ui_schema_table_checks_models.append(ui_schema_table_checks_models_item)

        ui_all_table_checks_model = cls(
            check_target=check_target,
            run_checks_job_template=run_checks_job_template,
            data_clean_job_template=data_clean_job_template,
            ui_schema_table_checks_models=ui_schema_table_checks_models,
        )

        ui_all_table_checks_model.additional_properties = d
        return ui_all_table_checks_model
