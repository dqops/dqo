...
class ColumnSqlAggregateExpressionCheckSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_sql_aggregate_expression_check_spec = cls(
        ...
        column_sql_aggregate_expression_check_spec.additional_properties = d
        return column_sql_aggregate_expression_check_spec
