...
if TYPE_CHECKING:
    ...
    from ..models.column_text_text_mean_length_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextMeanLengthCheckSpec")


@_attrs_define
class ColumnTextMeanLengthCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnTextTextMeanLengthSensorParametersSpec]):
    ...
    parameters: Union[Unset, "ColumnTextTextMeanLengthSensorParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnTextTextMeanLengthSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_text_mean_length_check_spec = cls(
        ...
        column_text_mean_length_check_spec.additional_properties = d
        return column_text_mean_length_check_spec
