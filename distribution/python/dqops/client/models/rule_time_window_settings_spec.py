...
from ..models.rule_time_window_settings_spec_historic_data_point_grouping import RuleTimeWindowSettingsSpecHistoricDataPointGrouping
from ..types import UNSET, Unset
...
class RuleTimeWindowSettingsSpec:
    ...
    historic_data_point_grouping: Union[Unset, RuleTimeWindowSettingsSpecHistoricDataPointGrouping] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        historic_data_point_grouping: Union[Unset, RuleTimeWindowSettingsSpecHistoricDataPointGrouping]
        if isinstance(_historic_data_point_grouping,  Unset):
            historic_data_point_grouping = UNSET
        else:
            historic_data_point_grouping = RuleTimeWindowSettingsSpecHistoricDataPointGrouping(_historic_data_point_grouping)
