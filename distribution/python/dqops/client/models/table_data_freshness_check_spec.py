...
if TYPE_CHECKING:
  ...
  from ..models.table_timeliness_data_freshness_sensor_parameters_spec import TableTimelinessDataFreshnessSensorParametersSpec
...
class TableDataFreshnessCheckSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = TableTimelinessDataFreshnessSensorParametersSpec.from_dict(_parameters)
