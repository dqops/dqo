...
T = TypeVar("T", bound="ColumnAnomalyStationaryNullPercentCheckSpec")


@_attrs_define
class ColumnAnomalyStationaryNullPercentCheckSpec:
    """
    Attributes:
    ...
    error: Union[
        Unset, "AnomalyStationaryPercentileMovingAverageRule05ParametersSpec"
    ] = UNSET
    fatal: Union[
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_warning, Unset):
            ...
            warning = (
                AnomalyStationaryPercentileMovingAverageRule1ParametersSpec.from_dict(
                    _warning
                )
            )
        ...
        if isinstance(_error, Unset):
            ...
            error = (
                AnomalyStationaryPercentileMovingAverageRule05ParametersSpec.from_dict(
                    _error
                )
            )
        ...
        if isinstance(_fatal, Unset):
            ...
            fatal = (
                AnomalyStationaryPercentileMovingAverageRule01ParametersSpec.from_dict(
                    _fatal
                )
            )

        column_anomaly_stationary_null_percent_check_spec = cls(
        ...
        column_anomaly_stationary_null_percent_check_spec.additional_properties = d
        return column_anomaly_stationary_null_percent_check_spec
