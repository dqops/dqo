...
class ChangePercent30DaysRule50ParametersSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        change_percent_30_days_rule_50_parameters_spec = cls(
            max_percent=max_percent,
            exact_day=exact_day,
        )

        change_percent_30_days_rule_50_parameters_spec.additional_properties = d
        return change_percent_30_days_rule_50_parameters_spec
