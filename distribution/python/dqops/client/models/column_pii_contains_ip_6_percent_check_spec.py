...
if TYPE_CHECKING:
  ...
  from ..models.column_pii_contains_ip_6_percent_sensor_parameters_spec import ColumnPiiContainsIp6PercentSensorParametersSpec





T = TypeVar("T", bound="ColumnPiiContainsIp6PercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnPiiContainsIp6PercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnPiiContainsIp6PercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnPiiContainsIp6PercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnPiiContainsIp6PercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_pii_contains_ip_6_percent_check_spec = cls(
        ...
        column_pii_contains_ip_6_percent_check_spec.additional_properties = d
        return column_pii_contains_ip_6_percent_check_spec
