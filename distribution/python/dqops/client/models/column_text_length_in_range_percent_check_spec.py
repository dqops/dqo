...
if TYPE_CHECKING:
    from ..models.column_text_text_length_in_range_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextLengthInRangePercentCheckSpec")


@_attrs_define
class ColumnTextLengthInRangePercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnTextTextLengthInRangePercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnTextTextLengthInRangePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnTextTextLengthInRangePercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_text_length_in_range_percent_check_spec = cls(
        ...
        column_text_length_in_range_percent_check_spec.additional_properties = d
        return column_text_length_in_range_percent_check_spec
