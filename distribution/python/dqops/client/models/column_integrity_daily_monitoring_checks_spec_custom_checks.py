...
T = TypeVar("T", bound="ColumnIntegrityDailyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnIntegrityDailyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_integrity_daily_monitoring_checks_spec_custom_checks = cls()
        ...
        column_integrity_daily_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_integrity_daily_monitoring_checks_spec_custom_checks
