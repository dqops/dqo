...
T = TypeVar("T", bound="UIColumnChecksModelCheckContainers")


@attr.s(auto_attribs=True)
class UIColumnChecksModelCheckContainers:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        ui_column_checks_model_check_containers = cls()
        ...
        ui_column_checks_model_check_containers.additional_properties = (
            additional_properties
        )
        return ui_column_checks_model_check_containers
