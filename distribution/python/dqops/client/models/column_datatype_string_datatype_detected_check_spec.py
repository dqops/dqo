...
T = TypeVar("T", bound="ColumnDatatypeStringDatatypeDetectedCheckSpec")


@_attrs_define
class ColumnDatatypeStringDatatypeDetectedCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_datatype_string_datatype_detected_check_spec = cls(
        ...
        column_datatype_string_datatype_detected_check_spec.additional_properties = d
        return column_datatype_string_datatype_detected_check_spec
