...
T = TypeVar("T", bound="PercentileMovingAverageRule1ParametersSpec")


@attr.s(auto_attribs=True)
class PercentileMovingAverageRule1ParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        percentile_moving_average_rule_1_parameters_spec = cls(
            anomaly_percent=anomaly_percent,
        )

        percentile_moving_average_rule_1_parameters_spec.additional_properties = d
        return percentile_moving_average_rule_1_parameters_spec
