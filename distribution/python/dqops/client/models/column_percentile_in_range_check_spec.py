...
if TYPE_CHECKING:
  from ..models.column_numeric_percentile_sensor_parameters_spec import ColumnNumericPercentileSensorParametersSpec
...
class ColumnPercentileInRangeCheckSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericPercentileSensorParametersSpec.from_dict(_parameters)
        ...
        column_percentile_in_range_check_spec = cls(
        ...
        column_percentile_in_range_check_spec.additional_properties = d
        return column_percentile_in_range_check_spec
