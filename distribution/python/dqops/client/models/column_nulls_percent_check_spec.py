...
T = TypeVar("T", bound="ColumnNullsPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnNullsPercentCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_nulls_percent_check_spec = cls(
        ...
        column_nulls_percent_check_spec.additional_properties = d
        return column_nulls_percent_check_spec
