...
from ..models.ui_effective_schedule_model_schedule_group import (
    UIEffectiveScheduleModelScheduleGroup,
)
from ..models.ui_effective_schedule_model_schedule_level import (
...
T = TypeVar("T", bound="UIEffectiveScheduleModel")


@attr.s(auto_attribs=True)
class UIEffectiveScheduleModel:
    ...
    expression and the time of the upcoming execution, as well as the duration until this time.
        ...
        Attributes:
            schedule_group (Union[Unset, UIEffectiveScheduleModelScheduleGroup]): Field value for a schedule group to which
                this schedule belongs.
            schedule_level (Union[Unset, UIEffectiveScheduleModelScheduleLevel]): Field value for the level at which the
    ...
    schedule_group: Union[Unset, UIEffectiveScheduleModelScheduleGroup] = UNSET
    schedule_level: Union[Unset, UIEffectiveScheduleModelScheduleLevel] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        schedule_group: Union[Unset, UIEffectiveScheduleModelScheduleGroup]
        if isinstance(_schedule_group, Unset):
            schedule_group = UNSET
        else:
            schedule_group = UIEffectiveScheduleModelScheduleGroup(_schedule_group)

        _schedule_level = d.pop("schedule_level", UNSET)
        schedule_level: Union[Unset, UIEffectiveScheduleModelScheduleLevel]
        if isinstance(_schedule_level, Unset):
            schedule_level = UNSET
        else:
            schedule_level = UIEffectiveScheduleModelScheduleLevel(_schedule_level)
        ...
        ui_effective_schedule_model = cls(
        ...
        ui_effective_schedule_model.additional_properties = d
        return ui_effective_schedule_model
