...
if TYPE_CHECKING:
  ...
  from ..models.column_sql_condition_passed_percent_sensor_parameters_spec import ColumnSqlConditionPassedPercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnSqlConditionPassedPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnSqlConditionPassedPercentCheckSpec:
    """ 
        Attributes:
    ...
    parameters: Union[Unset, 'ColumnSqlConditionPassedPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnSqlConditionPassedPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_sql_condition_passed_percent_check_spec = cls(
        ...
        column_sql_condition_passed_percent_check_spec.additional_properties = d
        return column_sql_condition_passed_percent_check_spec
