...
if TYPE_CHECKING:
  from ..models.column_sql_monthly_recurring_checks_spec import ColumnSqlMonthlyRecurringChecksSpec
  from ..models.column_datetime_monthly_recurring_checks_spec import ColumnDatetimeMonthlyRecurringChecksSpec
  from ..models.column_uniqueness_monthly_recurring_checks_spec import ColumnUniquenessMonthlyRecurringChecksSpec
  from ..models.column_monthly_recurring_check_categories_spec_custom import ColumnMonthlyRecurringCheckCategoriesSpecCustom
  from ..models.column_numeric_monthly_recurring_checks_spec import ColumnNumericMonthlyRecurringChecksSpec
  from ..models.column_bool_monthly_recurring_checks_spec import ColumnBoolMonthlyRecurringChecksSpec
  from ..models.column_pii_monthly_recurring_checks_spec import ColumnPiiMonthlyRecurringChecksSpec
  from ..models.column_strings_monthly_recurring_checks_spec import ColumnStringsMonthlyRecurringChecksSpec
  from ..models.column_monthly_recurring_check_categories_spec_comparisons import ColumnMonthlyRecurringCheckCategoriesSpecComparisons
  from ..models.column_nulls_monthly_recurring_checks_spec import ColumnNullsMonthlyRecurringChecksSpec
  from ..models.column_consistency_monthly_recurring_checks_spec import ColumnConsistencyMonthlyRecurringChecksSpec
  from ..models.column_integrity_monthly_recurring_checks_spec import ColumnIntegrityMonthlyRecurringChecksSpec
  from ..models.column_accuracy_monthly_recurring_checks_spec import ColumnAccuracyMonthlyRecurringChecksSpec
  from ..models.column_schema_monthly_recurring_checks_spec import ColumnSchemaMonthlyRecurringChecksSpec
  from ..models.column_anomaly_monthly_recurring_checks_spec import ColumnAnomalyMonthlyRecurringChecksSpec
...
class ColumnMonthlyRecurringCheckCategoriesSpec:
    ...
    comparisons: Union[Unset, 'ColumnMonthlyRecurringCheckCategoriesSpecComparisons'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_uniqueness,  Unset):
            ...
            uniqueness = ColumnUniquenessMonthlyRecurringChecksSpec.from_dict(_uniqueness)
        ...
        if isinstance(_consistency,  Unset):
            ...
            consistency = ColumnConsistencyMonthlyRecurringChecksSpec.from_dict(_consistency)
        ...
        if isinstance(_comparisons,  Unset):
            ...
            comparisons = ColumnMonthlyRecurringCheckCategoriesSpecComparisons.from_dict(_comparisons)
