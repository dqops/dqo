...
T = TypeVar("T", bound="TableTimelinessProfilingChecksSpecCustomChecks")


@_attrs_define
class TableTimelinessProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_timeliness_profiling_checks_spec_custom_checks = cls()
        ...
        table_timeliness_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_timeliness_profiling_checks_spec_custom_checks
