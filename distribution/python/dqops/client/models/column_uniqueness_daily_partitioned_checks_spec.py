...
class ColumnUniquenessDailyPartitionedChecksSpec:
    ...
    daily_partition_duplicate_count: Union[Unset, 'ColumnDuplicateCountCheckSpec'] = UNSET
    daily_partition_duplicate_percent: Union[Unset, 'ColumnDuplicatePercentCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.daily_partition_distinct_percent, Unset):
            daily_partition_distinct_percent = self.daily_partition_distinct_percent.to_dict()
        ...
        if not isinstance(self.daily_partition_duplicate_count, Unset):
            daily_partition_duplicate_count = self.daily_partition_duplicate_count.to_dict()
        ...
        if not isinstance(self.daily_partition_duplicate_percent, Unset):
            daily_partition_duplicate_percent = self.daily_partition_duplicate_percent.to_dict()
        ...
        if daily_partition_distinct_percent is not UNSET:
            field_dict["daily_partition_distinct_percent"] = daily_partition_distinct_percent
        if daily_partition_duplicate_count is not UNSET:
            field_dict["daily_partition_duplicate_count"] = daily_partition_duplicate_count
        if daily_partition_duplicate_percent is not UNSET:
            field_dict["daily_partition_duplicate_percent"] = daily_partition_duplicate_percent
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_daily_partition_distinct_count,  Unset):
            ...
            daily_partition_distinct_count = ColumnDistinctCountCheckSpec.from_dict(_daily_partition_distinct_count)
        ...
        if isinstance(_daily_partition_distinct_percent,  Unset):
            ...
            daily_partition_distinct_percent = ColumnDistinctPercentCheckSpec.from_dict(_daily_partition_distinct_percent)




        _daily_partition_duplicate_count = d.pop("daily_partition_duplicate_count", UNSET)
        daily_partition_duplicate_count: Union[Unset, ColumnDuplicateCountCheckSpec]
        if isinstance(_daily_partition_duplicate_count,  Unset):
            daily_partition_duplicate_count = UNSET
        else:
            daily_partition_duplicate_count = ColumnDuplicateCountCheckSpec.from_dict(_daily_partition_duplicate_count)




        _daily_partition_duplicate_percent = d.pop("daily_partition_duplicate_percent", UNSET)
        daily_partition_duplicate_percent: Union[Unset, ColumnDuplicatePercentCheckSpec]
        if isinstance(_daily_partition_duplicate_percent,  Unset):
            daily_partition_duplicate_percent = UNSET
        else:
            daily_partition_duplicate_percent = ColumnDuplicatePercentCheckSpec.from_dict(_daily_partition_duplicate_percent)
