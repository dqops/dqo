...
class ColumnUniquenessDailyPartitionedChecksSpec:
    """
    Attributes:
        daily_partition_unique_count (Union[Unset, ColumnUniqueCountCheckSpec]):
        daily_partition_unique_percent (Union[Unset, ColumnUniquePercentCheckSpec]):
    ...
    daily_partition_unique_count: Union[Unset, "ColumnUniqueCountCheckSpec"] = UNSET
    daily_partition_unique_percent: Union[Unset, "ColumnUniquePercentCheckSpec"] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        daily_partition_unique_count: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.daily_partition_unique_count, Unset):
            daily_partition_unique_count = self.daily_partition_unique_count.to_dict()

        daily_partition_unique_percent: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.daily_partition_unique_percent, Unset):
            daily_partition_unique_percent = (
                self.daily_partition_unique_percent.to_dict()
            )
        ...
        field_dict.update({})
        if daily_partition_unique_count is not UNSET:
            field_dict["daily_partition_unique_count"] = daily_partition_unique_count
        if daily_partition_unique_percent is not UNSET:
            field_dict[
                "daily_partition_unique_percent"
            ] = daily_partition_unique_percent
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        _daily_partition_unique_count = d.pop("daily_partition_unique_count", UNSET)
        daily_partition_unique_count: Union[Unset, ColumnUniqueCountCheckSpec]
        if isinstance(_daily_partition_unique_count, Unset):
            daily_partition_unique_count = UNSET
        else:
            daily_partition_unique_count = ColumnUniqueCountCheckSpec.from_dict(
                _daily_partition_unique_count
            )

        _daily_partition_unique_percent = d.pop("daily_partition_unique_percent", UNSET)
        daily_partition_unique_percent: Union[Unset, ColumnUniquePercentCheckSpec]
        if isinstance(_daily_partition_unique_percent, Unset):
            daily_partition_unique_percent = UNSET
        else:
            daily_partition_unique_percent = ColumnUniquePercentCheckSpec.from_dict(
                _daily_partition_unique_percent
            )
        ...
        column_uniqueness_daily_partitioned_checks_spec = cls(
            daily_partition_unique_count=daily_partition_unique_count,
            daily_partition_unique_percent=daily_partition_unique_percent,
