...
T = TypeVar("T", bound="ColumnTextTextLengthAboveMaxLengthCountSensorParametersSpec")


@_attrs_define
class ColumnTextTextLengthAboveMaxLengthCountSensorParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_text_text_length_above_max_length_count_sensor_parameters_spec = cls(
            filter_=filter_,
            max_length=max_length,
        )

        column_text_text_length_above_max_length_count_sensor_parameters_spec.additional_properties = (
            d
        )
        return column_text_text_length_above_max_length_count_sensor_parameters_spec
