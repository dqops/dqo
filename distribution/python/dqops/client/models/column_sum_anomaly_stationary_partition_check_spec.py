...
T = TypeVar("T", bound="ColumnSumAnomalyStationaryPartitionCheckSpec")


@_attrs_define
class ColumnSumAnomalyStationaryPartitionCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_sum_anomaly_stationary_partition_check_spec = cls(
        ...
        column_sum_anomaly_stationary_partition_check_spec.additional_properties = d
        return column_sum_anomaly_stationary_partition_check_spec
