...
T = TypeVar("T", bound="UICheckBasicModel")


@attr.s(auto_attribs=True)
class UICheckBasicModel:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        ui_check_basic_model.additional_properties = d
        return ui_check_basic_model
