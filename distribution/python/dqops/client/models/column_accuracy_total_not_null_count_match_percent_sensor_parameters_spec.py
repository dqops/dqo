...
T = TypeVar("T", bound="ColumnAccuracyTotalNotNullCountMatchPercentSensorParametersSpec")
...
class ColumnAccuracyTotalNotNullCountMatchPercentSensorParametersSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_accuracy_total_not_null_count_match_percent_sensor_parameters_spec.additional_properties = d
