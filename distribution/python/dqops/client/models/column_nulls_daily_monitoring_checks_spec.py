...
class ColumnNullsDailyMonitoringChecksSpec:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        daily_empty_column_found: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.daily_empty_column_found, Unset):
            daily_empty_column_found = self.daily_empty_column_found.to_dict()
        ...
        if daily_empty_column_found is not UNSET:
            field_dict["daily_empty_column_found"] = daily_empty_column_found
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_nulls_daily_monitoring_checks_spec = cls(
            ...
            daily_empty_column_found=daily_empty_column_found,
