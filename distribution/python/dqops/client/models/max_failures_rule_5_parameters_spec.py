...
T = TypeVar("T", bound="MaxFailuresRule5ParametersSpec")
...
class MaxFailuresRule5ParametersSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        max_failures_rule_5_parameters_spec = cls(
            max_failures=max_failures,
        )

        max_failures_rule_5_parameters_spec.additional_properties = d
        return max_failures_rule_5_parameters_spec
