...
T = TypeVar("T", bound="ColumnDistinctPercentChange7DaysCheckSpec")


@_attrs_define
class ColumnDistinctPercentChange7DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_distinct_percent_change_7_days_check_spec = cls(
        ...
        column_distinct_percent_change_7_days_check_spec.additional_properties = d
        return column_distinct_percent_change_7_days_check_spec
