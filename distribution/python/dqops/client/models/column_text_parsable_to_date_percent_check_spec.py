...
if TYPE_CHECKING:
    from ..models.column_text_text_parsable_to_date_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextParsableToDatePercentCheckSpec")


@_attrs_define
class ColumnTextParsableToDatePercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnTextTextParsableToDatePercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnTextTextParsableToDatePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnTextTextParsableToDatePercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_text_parsable_to_date_percent_check_spec = cls(
        ...
        column_text_parsable_to_date_percent_check_spec.additional_properties = d
        return column_text_parsable_to_date_percent_check_spec
