...
class IncidentIssueHistogramModelDays:
    ...
    additional_properties: Dict[str, 'IncidentDailyIssuesCount'] = attr.ib(init=False, factory=dict)
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        incident_issue_histogram_model_days.additional_properties = additional_properties
