...
T = TypeVar("T", bound="ColumnBoolMonthlyPartitionedChecksSpecCustomChecks")


@_attrs_define
class ColumnBoolMonthlyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_bool_monthly_partitioned_checks_spec_custom_checks = cls()
        ...
        column_bool_monthly_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_bool_monthly_partitioned_checks_spec_custom_checks
