...
if TYPE_CHECKING:
    from ..models.column_accuracy_not_null_count_match_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnAccuracyNotNullCountMatchPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnAccuracyNotNullCountMatchPercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnAccuracyNotNullCountMatchPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnAccuracyNotNullCountMatchPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnAccuracyNotNullCountMatchPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_accuracy_not_null_count_match_percent_check_spec = cls(
        ...
        column_accuracy_not_null_count_match_percent_check_spec.additional_properties = (
            d
        )
        return column_accuracy_not_null_count_match_percent_check_spec
