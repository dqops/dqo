...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_min_sensor_parameters_spec import ColumnNumericMinSensorParametersSpec
...
T = TypeVar("T", bound="ColumnComparisonMinMatchCheckSpec")


@attr.s(auto_attribs=True)
class ColumnComparisonMinMatchCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_comparison_min_match_check_spec = cls(
        ...
        column_comparison_min_match_check_spec.additional_properties = d
        return column_comparison_min_match_check_spec
