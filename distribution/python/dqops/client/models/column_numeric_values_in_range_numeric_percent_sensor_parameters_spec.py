...
T = TypeVar("T", bound="ColumnNumericValuesInRangeNumericPercentSensorParametersSpec")


@attr.s(auto_attribs=True)
class ColumnNumericValuesInRangeNumericPercentSensorParametersSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_numeric_values_in_range_numeric_percent_sensor_parameters_spec = cls(
            filter_=filter_,
            min_value=min_value,
            max_value=max_value,
        )

        column_numeric_values_in_range_numeric_percent_sensor_parameters_spec.additional_properties = d
        return column_numeric_values_in_range_numeric_percent_sensor_parameters_spec
