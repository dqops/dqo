...
T = TypeVar("T", bound="ColumnSumChange1DayCheckSpec")


@_attrs_define
class ColumnSumChange1DayCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_sum_change_1_day_check_spec = cls(
        ...
        column_sum_change_1_day_check_spec.additional_properties = d
        return column_sum_change_1_day_check_spec
