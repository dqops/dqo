...
if TYPE_CHECKING:
  ...
  from ..models.between_floats_rule_parameters_spec import BetweenFloatsRuleParametersSpec
  from ..models.column_numeric_population_stddev_sensor_parameters_spec import ColumnNumericPopulationStddevSensorParametersSpec
...
T = TypeVar("T", bound="ColumnPopulationStddevInRangeCheckSpec")


@attr.s(auto_attribs=True)
class ColumnPopulationStddevInRangeCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnNumericPopulationStddevSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnNumericPopulationStddevSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericPopulationStddevSensorParametersSpec.from_dict(_parameters)
        ...
        if isinstance(_warning,  Unset):
            ...
            warning = BetweenFloatsRuleParametersSpec.from_dict(_warning)
        ...
        if isinstance(_error,  Unset):
            ...
            error = BetweenFloatsRuleParametersSpec.from_dict(_error)
        ...
        if isinstance(_fatal,  Unset):
            ...
            fatal = BetweenFloatsRuleParametersSpec.from_dict(_fatal)




        column_population_stddev_in_range_check_spec = cls(
        ...
        column_population_stddev_in_range_check_spec.additional_properties = d
        return column_population_stddev_in_range_check_spec
