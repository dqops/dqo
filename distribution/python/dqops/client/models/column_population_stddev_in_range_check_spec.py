...
if TYPE_CHECKING:
    ...
    from ..models.column_numeric_population_stddev_sensor_parameters_spec import (
...
class ColumnPopulationStddevInRangeCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnNumericPopulationStddevSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnNumericPopulationStddevSensorParametersSpec.from_dict(
                _parameters
            )
