...
if TYPE_CHECKING:
  from ..models.table_column_list_ordered_hash_sensor_parameters_spec import TableColumnListOrderedHashSensorParametersSpec
...
T = TypeVar("T", bound="TableSchemaColumnListOrOrderChangedCheckSpec")


@attr.s(auto_attribs=True)
class TableSchemaColumnListOrOrderChangedCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, TableColumnListOrderedHashSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'TableColumnListOrderedHashSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = TableColumnListOrderedHashSensorParametersSpec.from_dict(_parameters)
        ...
        table_schema_column_list_or_order_changed_check_spec = cls(
        ...
        table_schema_column_list_or_order_changed_check_spec.additional_properties = d
        return table_schema_column_list_or_order_changed_check_spec
