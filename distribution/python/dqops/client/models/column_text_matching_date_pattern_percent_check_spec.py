...
if TYPE_CHECKING:
    from ..models.column_patterns_text_matching_date_pattern_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextMatchingDatePatternPercentCheckSpec")


@_attrs_define
class ColumnTextMatchingDatePatternPercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnPatternsTextMatchingDatePatternPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsTextMatchingDatePatternPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnPatternsTextMatchingDatePatternPercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_text_matching_date_pattern_percent_check_spec = cls(
        ...
        column_text_matching_date_pattern_percent_check_spec.additional_properties = d
        return column_text_matching_date_pattern_percent_check_spec
