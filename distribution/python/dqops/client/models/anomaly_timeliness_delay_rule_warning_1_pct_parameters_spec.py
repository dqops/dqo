...
T = TypeVar("T", bound="AnomalyTimelinessDelayRuleWarning1PctParametersSpec")


@_attrs_define
class AnomalyTimelinessDelayRuleWarning1PctParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        anomaly_timeliness_delay_rule_warning_1_pct_parameters_spec = cls(
            anomaly_percent=anomaly_percent,
        )

        anomaly_timeliness_delay_rule_warning_1_pct_parameters_spec.additional_properties = (
            d
        )
        return anomaly_timeliness_delay_rule_warning_1_pct_parameters_spec
