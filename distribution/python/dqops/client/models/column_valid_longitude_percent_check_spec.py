...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_valid_longitude_percent_sensor_parameters_spec import ColumnNumericValidLongitudePercentSensorParametersSpec
...
class ColumnValidLongitudePercentCheckSpec:
    ...
    parameters: Union[Unset, 'ColumnNumericValidLongitudePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericValidLongitudePercentSensorParametersSpec.from_dict(_parameters)
