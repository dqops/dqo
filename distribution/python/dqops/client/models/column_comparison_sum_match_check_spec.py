...
T = TypeVar("T", bound="ColumnComparisonSumMatchCheckSpec")


@attr.s(auto_attribs=True)
class ColumnComparisonSumMatchCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_comparison_sum_match_check_spec = cls(
        ...
        column_comparison_sum_match_check_spec.additional_properties = d
        return column_comparison_sum_match_check_spec
