...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_negative_count_sensor_parameters_spec import ColumnNumericNegativeCountSensorParametersSpec
...
T = TypeVar("T", bound="ColumnNegativeCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnNegativeCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnNumericNegativeCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnNumericNegativeCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericNegativeCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_negative_count_check_spec = cls(
        ...
        column_negative_count_check_spec.additional_properties = d
        return column_negative_count_check_spec
