...
class ColumnAnomalyDailyRecurringChecksSpec:
    ...
    daily_mean_change_yesterday: Union[Unset, 'ColumnChangeMeanSinceYesterdayCheckSpec'] = UNSET
    daily_median_change: Union[Unset, 'ColumnChangeMedianCheckSpec'] = UNSET
    daily_median_change_yesterday: Union[Unset, 'ColumnChangeMedianSinceYesterdayCheckSpec'] = UNSET
    daily_sum_change: Union[Unset, 'ColumnChangeSumCheckSpec'] = UNSET
    daily_sum_change_yesterday: Union[Unset, 'ColumnChangeSumSinceYesterdayCheckSpec'] = UNSET
    daily_mean_anomaly_stationary_30_days: Union[Unset, 'ColumnAnomalyStationaryMean30DaysCheckSpec'] = UNSET
    daily_mean_anomaly_stationary: Union[Unset, 'ColumnAnomalyStationaryMeanCheckSpec'] = UNSET
    daily_median_anomaly_stationary_30_days: Union[Unset, 'ColumnAnomalyStationaryMedian30DaysCheckSpec'] = UNSET
    daily_median_anomaly_stationary: Union[Unset, 'ColumnAnomalyStationaryMedianCheckSpec'] = UNSET
    daily_sum_anomaly_differencing_30_days: Union[Unset, 'ColumnAnomalyDifferencingSum30DaysCheckSpec'] = UNSET
    daily_sum_anomaly_differencing: Union[Unset, 'ColumnAnomalyDifferencingSumCheckSpec'] = UNSET
    daily_mean_change_7_days: Union[Unset, 'ColumnChangeMeanSince7DaysCheckSpec'] = UNSET
    daily_mean_change_30_days: Union[Unset, 'ColumnChangeMeanSince30DaysCheckSpec'] = UNSET
    daily_median_change_7_days: Union[Unset, 'ColumnChangeMedianSince7DaysCheckSpec'] = UNSET
    daily_median_change_30_days: Union[Unset, 'ColumnChangeMedianSince30DaysCheckSpec'] = UNSET
    daily_sum_change_7_days: Union[Unset, 'ColumnChangeSumSince7DaysCheckSpec'] = UNSET
    daily_sum_change_30_days: Union[Unset, 'ColumnChangeSumSince30DaysCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.daily_mean_anomaly_stationary_30_days, Unset):
            daily_mean_anomaly_stationary_30_days = self.daily_mean_anomaly_stationary_30_days.to_dict()
        ...
        if not isinstance(self.daily_median_anomaly_stationary_30_days, Unset):
            daily_median_anomaly_stationary_30_days = self.daily_median_anomaly_stationary_30_days.to_dict()
        ...
        if not isinstance(self.daily_median_anomaly_stationary, Unset):
            daily_median_anomaly_stationary = self.daily_median_anomaly_stationary.to_dict()
        ...
        if not isinstance(self.daily_sum_anomaly_differencing_30_days, Unset):
            daily_sum_anomaly_differencing_30_days = self.daily_sum_anomaly_differencing_30_days.to_dict()

        daily_sum_anomaly_differencing: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.daily_sum_anomaly_differencing, Unset):
            daily_sum_anomaly_differencing = self.daily_sum_anomaly_differencing.to_dict()
        ...
        if daily_mean_anomaly_stationary_30_days is not UNSET:
            field_dict["daily_mean_anomaly_stationary_30_days"] = daily_mean_anomaly_stationary_30_days
        ...
        if daily_median_anomaly_stationary_30_days is not UNSET:
            field_dict["daily_median_anomaly_stationary_30_days"] = daily_median_anomaly_stationary_30_days
        if daily_median_anomaly_stationary is not UNSET:
            field_dict["daily_median_anomaly_stationary"] = daily_median_anomaly_stationary
        if daily_sum_anomaly_differencing_30_days is not UNSET:
            field_dict["daily_sum_anomaly_differencing_30_days"] = daily_sum_anomaly_differencing_30_days
        if daily_sum_anomaly_differencing is not UNSET:
            field_dict["daily_sum_anomaly_differencing"] = daily_sum_anomaly_differencing
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_daily_mean_change_yesterday,  Unset):
            ...
            daily_mean_change_yesterday = ColumnChangeMeanSinceYesterdayCheckSpec.from_dict(_daily_mean_change_yesterday)
        ...
        if isinstance(_daily_median_change,  Unset):
            ...
            daily_median_change = ColumnChangeMedianCheckSpec.from_dict(_daily_median_change)
        ...
        if isinstance(_daily_median_change_yesterday,  Unset):
            ...
            daily_median_change_yesterday = ColumnChangeMedianSinceYesterdayCheckSpec.from_dict(_daily_median_change_yesterday)
        ...
        if isinstance(_daily_sum_change_yesterday,  Unset):
            ...
            daily_sum_change_yesterday = ColumnChangeSumSinceYesterdayCheckSpec.from_dict(_daily_sum_change_yesterday)




        _daily_mean_anomaly_stationary_30_days = d.pop("daily_mean_anomaly_stationary_30_days", UNSET)
        daily_mean_anomaly_stationary_30_days: Union[Unset, ColumnAnomalyStationaryMean30DaysCheckSpec]
        if isinstance(_daily_mean_anomaly_stationary_30_days,  Unset):
            daily_mean_anomaly_stationary_30_days = UNSET
        else:
            daily_mean_anomaly_stationary_30_days = ColumnAnomalyStationaryMean30DaysCheckSpec.from_dict(_daily_mean_anomaly_stationary_30_days)
        ...
        if isinstance(_daily_mean_anomaly_stationary,  Unset):
            ...
            daily_mean_anomaly_stationary = ColumnAnomalyStationaryMeanCheckSpec.from_dict(_daily_mean_anomaly_stationary)




        _daily_median_anomaly_stationary_30_days = d.pop("daily_median_anomaly_stationary_30_days", UNSET)
        daily_median_anomaly_stationary_30_days: Union[Unset, ColumnAnomalyStationaryMedian30DaysCheckSpec]
        if isinstance(_daily_median_anomaly_stationary_30_days,  Unset):
            daily_median_anomaly_stationary_30_days = UNSET
        else:
            daily_median_anomaly_stationary_30_days = ColumnAnomalyStationaryMedian30DaysCheckSpec.from_dict(_daily_median_anomaly_stationary_30_days)




        _daily_median_anomaly_stationary = d.pop("daily_median_anomaly_stationary", UNSET)
        daily_median_anomaly_stationary: Union[Unset, ColumnAnomalyStationaryMedianCheckSpec]
        if isinstance(_daily_median_anomaly_stationary,  Unset):
            daily_median_anomaly_stationary = UNSET
        else:
            daily_median_anomaly_stationary = ColumnAnomalyStationaryMedianCheckSpec.from_dict(_daily_median_anomaly_stationary)




        _daily_sum_anomaly_differencing_30_days = d.pop("daily_sum_anomaly_differencing_30_days", UNSET)
        daily_sum_anomaly_differencing_30_days: Union[Unset, ColumnAnomalyDifferencingSum30DaysCheckSpec]
        if isinstance(_daily_sum_anomaly_differencing_30_days,  Unset):
            daily_sum_anomaly_differencing_30_days = UNSET
        else:
            daily_sum_anomaly_differencing_30_days = ColumnAnomalyDifferencingSum30DaysCheckSpec.from_dict(_daily_sum_anomaly_differencing_30_days)
        ...
        if isinstance(_daily_sum_anomaly_differencing,  Unset):
            ...
            daily_sum_anomaly_differencing = ColumnAnomalyDifferencingSumCheckSpec.from_dict(_daily_sum_anomaly_differencing)
        ...
        if isinstance(_daily_mean_change_7_days,  Unset):
            ...
            daily_mean_change_7_days = ColumnChangeMeanSince7DaysCheckSpec.from_dict(_daily_mean_change_7_days)
        ...
        if isinstance(_daily_mean_change_30_days,  Unset):
            ...
            daily_mean_change_30_days = ColumnChangeMeanSince30DaysCheckSpec.from_dict(_daily_mean_change_30_days)
        ...
        if isinstance(_daily_median_change_7_days,  Unset):
            ...
            daily_median_change_7_days = ColumnChangeMedianSince7DaysCheckSpec.from_dict(_daily_median_change_7_days)
        ...
        if isinstance(_daily_median_change_30_days,  Unset):
            ...
            daily_median_change_30_days = ColumnChangeMedianSince30DaysCheckSpec.from_dict(_daily_median_change_30_days)
        ...
        if isinstance(_daily_sum_change_7_days,  Unset):
            ...
            daily_sum_change_7_days = ColumnChangeSumSince7DaysCheckSpec.from_dict(_daily_sum_change_7_days)
        ...
        if isinstance(_daily_sum_change_30_days,  Unset):
            ...
            daily_sum_change_30_days = ColumnChangeSumSince30DaysCheckSpec.from_dict(_daily_sum_change_30_days)
