...
T = TypeVar("T", bound="ColumnMedianAnomalyStationaryCheckSpec")


@_attrs_define
class ColumnMedianAnomalyStationaryCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_median_anomaly_stationary_check_spec = cls(
        ...
        column_median_anomaly_stationary_check_spec.additional_properties = d
        return column_median_anomaly_stationary_check_spec
