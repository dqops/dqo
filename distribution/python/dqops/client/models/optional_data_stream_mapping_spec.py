...
T = TypeVar("T", bound="OptionalDataStreamMappingSpec")


@attr.s(auto_attribs=True)
class OptionalDataStreamMappingSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        optional_data_stream_mapping_spec = cls(
            empty=empty,
            present=present,
        )

        optional_data_stream_mapping_spec.additional_properties = d
        return optional_data_stream_mapping_spec
