...
T = TypeVar("T", bound="ColumnTextMonthlyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnTextMonthlyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_text_monthly_monitoring_checks_spec_custom_checks = cls()
        ...
        column_text_monthly_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_text_monthly_monitoring_checks_spec_custom_checks
