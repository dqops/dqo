...
T = TypeVar("T", bound="ColumnSumChange7DaysCheckSpec")


@_attrs_define
class ColumnSumChange7DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_sum_change_7_days_check_spec = cls(
        ...
        column_sum_change_7_days_check_spec.additional_properties = d
        return column_sum_change_7_days_check_spec
