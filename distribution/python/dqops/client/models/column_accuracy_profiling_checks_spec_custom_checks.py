...
T = TypeVar("T", bound="ColumnAccuracyProfilingChecksSpecCustomChecks")


@_attrs_define
class ColumnAccuracyProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_accuracy_profiling_checks_spec_custom_checks = cls()
        ...
        column_accuracy_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_accuracy_profiling_checks_spec_custom_checks
