...
T = TypeVar("T", bound="ColumnAnomalyMonthlyPartitionedChecksSpecCustomChecks")


@_attrs_define
class ColumnAnomalyMonthlyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_anomaly_monthly_partitioned_checks_spec_custom_checks = cls()
        ...
        column_anomaly_monthly_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_anomaly_monthly_partitioned_checks_spec_custom_checks
