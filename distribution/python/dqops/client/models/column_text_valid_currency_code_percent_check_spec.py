...
if TYPE_CHECKING:
    from ..models.column_text_text_valid_currency_code_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextValidCurrencyCodePercentCheckSpec")


@_attrs_define
class ColumnTextValidCurrencyCodePercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnTextTextValidCurrencyCodePercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnTextTextValidCurrencyCodePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnTextTextValidCurrencyCodePercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_text_valid_currency_code_percent_check_spec = cls(
        ...
        column_text_valid_currency_code_percent_check_spec.additional_properties = d
        return column_text_valid_currency_code_percent_check_spec
