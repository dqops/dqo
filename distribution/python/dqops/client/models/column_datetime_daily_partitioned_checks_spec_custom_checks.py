...
T = TypeVar("T", bound="ColumnDatetimeDailyPartitionedChecksSpecCustomChecks")


@_attrs_define
class ColumnDatetimeDailyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_datetime_daily_partitioned_checks_spec_custom_checks = cls()
        ...
        column_datetime_daily_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_datetime_daily_partitioned_checks_spec_custom_checks
