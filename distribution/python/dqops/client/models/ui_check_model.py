...
from ..models.ui_check_model_check_target import UICheckModelCheckTarget
from ..models.ui_check_model_configuration_requirements_errors_item import (
    UICheckModelConfigurationRequirementsErrorsItem,
)
from ..models.ui_check_model_schedule_enabled_status import (
...
if TYPE_CHECKING:
    ...
    from ..models.ui_rule_thresholds_model import UIRuleThresholdsModel


T = TypeVar("T", bound="UICheckModel")
...
class UICheckModel:
    ...
    Attributes:
        ...
        sensor_parameters (Union[Unset, List['UIFieldModel']]): List of fields for editing the sensor parameters.
        ...
        quality_dimension (Union[Unset, str]): Data quality dimension used for tagging the results of this data quality
            checks.
        rule (Union[Unset, UIRuleThresholdsModel]): UI model that returns the form definition and the form data to edit
        ...
        schedule_enabled_status (Union[Unset, UICheckModelScheduleEnabledStatus]): State of the scheduling override for
            this check.
        ...
        data_stream (Union[Unset, str]): The name of a data stream mapping defined at a table that should be used for
            this check.
        check_target (Union[Unset, UICheckModelCheckTarget]): Type of the check's target (column, table).
        configuration_requirements_errors (Union[Unset, List[UICheckModelConfigurationRequirementsErrorsItem]]): List of
    ...
    sensor_parameters: Union[Unset, List["UIFieldModel"]] = UNSET
    sensor_name: Union[Unset, str] = UNSET
    quality_dimension: Union[Unset, str] = UNSET
    rule: Union[Unset, "UIRuleThresholdsModel"] = UNSET
    ...
    schedule_enabled_status: Union[Unset, UICheckModelScheduleEnabledStatus] = UNSET
    ...
    check_target: Union[Unset, UICheckModelCheckTarget] = UNSET
    configuration_requirements_errors: Union[
        Unset, List[UICheckModelConfigurationRequirementsErrorsItem]
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for sensor_parameters_item_data in _sensor_parameters or []:
            sensor_parameters_item = UIFieldModel.from_dict(sensor_parameters_item_data)
        ...
        rule: Union[Unset, UIRuleThresholdsModel]
        if isinstance(_rule, Unset):
            rule = UNSET
        else:
            rule = UIRuleThresholdsModel.from_dict(_rule)
        ...
        schedule_enabled_status: Union[Unset, UICheckModelScheduleEnabledStatus]
        if isinstance(_schedule_enabled_status, Unset):
            schedule_enabled_status = UNSET
        else:
            schedule_enabled_status = UICheckModelScheduleEnabledStatus(
        ...
        check_target: Union[Unset, UICheckModelCheckTarget]
        if isinstance(_check_target, Unset):
            check_target = UNSET
        else:
            check_target = UICheckModelCheckTarget(_check_target)
        ...
        ui_check_model.additional_properties = d
        return ui_check_model
