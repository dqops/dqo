...
if TYPE_CHECKING:
    from ..models.column_strings_string_length_above_max_length_count_sensor_parameters_spec import (
...
class ColumnStringLengthAboveMaxLengthCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringLengthAboveMaxLengthCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnStringsStringLengthAboveMaxLengthCountSensorParametersSpec.from_dict(
                _parameters
            )
