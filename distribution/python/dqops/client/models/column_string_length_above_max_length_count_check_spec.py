...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_length_above_max_length_count_sensor_parameters_spec import ColumnStringsStringLengthAboveMaxLengthCountSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringLengthAboveMaxLengthCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringLengthAboveMaxLengthCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringLengthAboveMaxLengthCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringLengthAboveMaxLengthCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringLengthAboveMaxLengthCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_length_above_max_length_count_check_spec = cls(
        ...
        column_string_length_above_max_length_count_check_spec.additional_properties = d
        return column_string_length_above_max_length_count_check_spec
