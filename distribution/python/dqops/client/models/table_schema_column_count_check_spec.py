...
if TYPE_CHECKING:
  from ..models.table_column_count_sensor_parameters_spec import TableColumnCountSensorParametersSpec
  from ..models.equals_integer_rule_parameters_spec import EqualsIntegerRuleParametersSpec
...
T = TypeVar("T", bound="TableSchemaColumnCountCheckSpec")


@attr.s(auto_attribs=True)
class TableSchemaColumnCountCheckSpec:
    """ 
        Attributes:
            ...
            warning (Union[Unset, EqualsIntegerRuleParametersSpec]):
            error (Union[Unset, EqualsIntegerRuleParametersSpec]):
            fatal (Union[Unset, EqualsIntegerRuleParametersSpec]):
     """
    ...
    warning: Union[Unset, 'EqualsIntegerRuleParametersSpec'] = UNSET
    error: Union[Unset, 'EqualsIntegerRuleParametersSpec'] = UNSET
    fatal: Union[Unset, 'EqualsIntegerRuleParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_warning,  Unset):
            ...
            warning = EqualsIntegerRuleParametersSpec.from_dict(_warning)
        ...
        if isinstance(_error,  Unset):
            ...
            error = EqualsIntegerRuleParametersSpec.from_dict(_error)
        ...
        if isinstance(_fatal,  Unset):
            ...
            fatal = EqualsIntegerRuleParametersSpec.from_dict(_fatal)




        table_schema_column_count_check_spec = cls(
        ...
        table_schema_column_count_check_spec.additional_properties = d
        return table_schema_column_count_check_spec
