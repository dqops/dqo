...
T = TypeVar("T", bound="ColumnStringDatatypeChangedCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringDatatypeChangedCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_string_datatype_changed_check_spec = cls(
        ...
        column_string_datatype_changed_check_spec.additional_properties = d
        return column_string_datatype_changed_check_spec
