...
if TYPE_CHECKING:
    from ..models.column_strings_string_valid_uuid_percent_sensor_parameters_spec import (
...
class ColumnStringValidUuidPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringValidUuidPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringValidUuidPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
