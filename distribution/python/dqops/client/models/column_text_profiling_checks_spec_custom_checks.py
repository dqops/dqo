...
T = TypeVar("T", bound="ColumnTextProfilingChecksSpecCustomChecks")


@_attrs_define
class ColumnTextProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_text_profiling_checks_spec_custom_checks = cls()
        ...
        column_text_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_text_profiling_checks_spec_custom_checks
