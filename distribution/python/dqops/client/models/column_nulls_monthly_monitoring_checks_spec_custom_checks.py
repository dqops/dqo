...
T = TypeVar("T", bound="ColumnNullsMonthlyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnNullsMonthlyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_nulls_monthly_monitoring_checks_spec_custom_checks = cls()
        ...
        column_nulls_monthly_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_nulls_monthly_monitoring_checks_spec_custom_checks
