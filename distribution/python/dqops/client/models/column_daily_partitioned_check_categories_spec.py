...
if TYPE_CHECKING:
  from ..models.column_bool_daily_partitioned_checks_spec import ColumnBoolDailyPartitionedChecksSpec
  from ..models.column_sql_daily_partitioned_checks_spec import ColumnSqlDailyPartitionedChecksSpec
  from ..models.column_consistency_daily_partitioned_checks_spec import ColumnConsistencyDailyPartitionedChecksSpec
  from ..models.column_anomaly_daily_partitioned_checks_spec import ColumnAnomalyDailyPartitionedChecksSpec
  from ..models.column_daily_partitioned_check_categories_spec_comparisons import ColumnDailyPartitionedCheckCategoriesSpecComparisons
  from ..models.column_daily_partitioned_check_categories_spec_custom import ColumnDailyPartitionedCheckCategoriesSpecCustom
  from ..models.column_strings_daily_partitioned_checks_spec import ColumnStringsDailyPartitionedChecksSpec
  from ..models.column_uniqueness_daily_partitioned_checks_spec import ColumnUniquenessDailyPartitionedChecksSpec
  from ..models.column_pii_daily_partitioned_checks_spec import ColumnPiiDailyPartitionedChecksSpec
  from ..models.column_integrity_daily_partitioned_checks_spec import ColumnIntegrityDailyPartitionedChecksSpec
  from ..models.column_numeric_daily_partitioned_checks_spec import ColumnNumericDailyPartitionedChecksSpec
  from ..models.column_nulls_daily_partitioned_checks_spec import ColumnNullsDailyPartitionedChecksSpec
  from ..models.column_accuracy_daily_partitioned_checks_spec import ColumnAccuracyDailyPartitionedChecksSpec
  from ..models.column_datetime_daily_partitioned_checks_spec import ColumnDatetimeDailyPartitionedChecksSpec
...
class ColumnDailyPartitionedCheckCategoriesSpec:
    ...
    comparisons: Union[Unset, 'ColumnDailyPartitionedCheckCategoriesSpecComparisons'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_uniqueness,  Unset):
            ...
            uniqueness = ColumnUniquenessDailyPartitionedChecksSpec.from_dict(_uniqueness)
        ...
        if isinstance(_consistency,  Unset):
            ...
            consistency = ColumnConsistencyDailyPartitionedChecksSpec.from_dict(_consistency)
        ...
        if isinstance(_comparisons,  Unset):
            ...
            comparisons = ColumnDailyPartitionedCheckCategoriesSpecComparisons.from_dict(_comparisons)
