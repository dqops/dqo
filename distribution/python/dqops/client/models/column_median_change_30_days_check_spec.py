...
T = TypeVar("T", bound="ColumnMedianChange30DaysCheckSpec")


@_attrs_define
class ColumnMedianChange30DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_median_change_30_days_check_spec = cls(
        ...
        column_median_change_30_days_check_spec.additional_properties = d
        return column_median_change_30_days_check_spec
