...
if TYPE_CHECKING:
  ...
  from ..models.table_timeliness_data_staleness_sensor_parameters_spec import TableTimelinessDataStalenessSensorParametersSpec
...
class TableDataStalenessCheckSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = TableTimelinessDataStalenessSensorParametersSpec.from_dict(_parameters)
        ...
        table_data_staleness_check_spec = cls(
        ...
        table_data_staleness_check_spec.additional_properties = d
        return table_data_staleness_check_spec
