...
if TYPE_CHECKING:
  ...
  from ..models.table_accuracy_total_row_count_match_percent_sensor_parameters_spec import TableAccuracyTotalRowCountMatchPercentSensorParametersSpec





T = TypeVar("T", bound="TableAccuracyTotalRowCountMatchPercentCheckSpec")


@attr.s(auto_attribs=True)
class TableAccuracyTotalRowCountMatchPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, TableAccuracyTotalRowCountMatchPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'TableAccuracyTotalRowCountMatchPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = TableAccuracyTotalRowCountMatchPercentSensorParametersSpec.from_dict(_parameters)
        ...
        table_accuracy_total_row_count_match_percent_check_spec = cls(
        ...
        table_accuracy_total_row_count_match_percent_check_spec.additional_properties = d
        return table_accuracy_total_row_count_match_percent_check_spec
