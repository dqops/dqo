...
if TYPE_CHECKING:
    ...
    from ..models.table_accuracy_total_row_count_match_percent_sensor_parameters_spec import (
...
class TableAccuracyTotalRowCountMatchPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "TableAccuracyTotalRowCountMatchPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                TableAccuracyTotalRowCountMatchPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
