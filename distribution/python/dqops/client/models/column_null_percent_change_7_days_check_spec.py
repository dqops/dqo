...
if TYPE_CHECKING:
    from ..models.change_percent_7_days_rule_10_parameters_spec import (
        ChangePercent7DaysRule10ParametersSpec,
    )
    from ..models.change_percent_7_days_rule_20_parameters_spec import (
        ChangePercent7DaysRule20ParametersSpec,
    )
    from ..models.change_percent_7_days_rule_50_parameters_spec import (
...
T = TypeVar("T", bound="ColumnNullPercentChange7DaysCheckSpec")


@_attrs_define
class ColumnNullPercentChange7DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_null_percent_change_7_days_check_spec = cls(
        ...
        column_null_percent_change_7_days_check_spec.additional_properties = d
        return column_null_percent_change_7_days_check_spec
