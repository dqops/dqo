...
T = TypeVar("T", bound="ColumnStringsMonthlyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnStringsMonthlyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_strings_monthly_monitoring_checks_spec_custom_checks = cls()
        ...
        column_strings_monthly_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_strings_monthly_monitoring_checks_spec_custom_checks
