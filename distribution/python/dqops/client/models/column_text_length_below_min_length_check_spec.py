...
if TYPE_CHECKING:
    from ..models.column_text_text_length_below_min_length_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextLengthBelowMinLengthCheckSpec")


@_attrs_define
class ColumnTextLengthBelowMinLengthCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnTextTextLengthBelowMinLengthCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnTextTextLengthBelowMinLengthCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnTextTextLengthBelowMinLengthCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_text_length_below_min_length_check_spec = cls(
        ...
        column_text_length_below_min_length_check_spec.additional_properties = d
        return column_text_length_below_min_length_check_spec
