...
if TYPE_CHECKING:
    from ..models.change_percentile_moving_average_30_days_rule_parameters_spec import (
        ChangePercentileMovingAverage30DaysRuleParametersSpec,
    )
    from ..models.column_numeric_mean_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnAnomalyMeanChange30DaysCheckSpec")


@attr.s(auto_attribs=True)
class ColumnAnomalyMeanChange30DaysCheckSpec:
    """
    Attributes:
        ...
        warning (Union[Unset, ChangePercentileMovingAverage30DaysRuleParametersSpec]):
        error (Union[Unset, ChangePercentileMovingAverage30DaysRuleParametersSpec]):
        fatal (Union[Unset, ChangePercentileMovingAverage30DaysRuleParametersSpec]):
    """
    ...
    warning: Union[
        Unset, "ChangePercentileMovingAverage30DaysRuleParametersSpec"
    ] = UNSET
    error: Union[Unset, "ChangePercentileMovingAverage30DaysRuleParametersSpec"] = UNSET
    fatal: Union[Unset, "ChangePercentileMovingAverage30DaysRuleParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_warning, Unset):
            ...
            warning = ChangePercentileMovingAverage30DaysRuleParametersSpec.from_dict(
                _warning
            )
        ...
        if isinstance(_error, Unset):
            ...
            error = ChangePercentileMovingAverage30DaysRuleParametersSpec.from_dict(
                _error
            )
        ...
        if isinstance(_fatal, Unset):
            ...
            fatal = ChangePercentileMovingAverage30DaysRuleParametersSpec.from_dict(
                _fatal
            )

        column_anomaly_mean_change_30_days_check_spec = cls(
        ...
        column_anomaly_mean_change_30_days_check_spec.additional_properties = d
        return column_anomaly_mean_change_30_days_check_spec
