...
if TYPE_CHECKING:
    from ..models.change_percentile_moving_within_30_days_rule_parameters_spec import (
...
class ColumnAnomalyMeanChange30DaysCheckSpec:
    ...
    Attributes:
        ...
        warning (Union[Unset, ChangePercentileMovingWithin30DaysRuleParametersSpec]):
        error (Union[Unset, ChangePercentileMovingWithin30DaysRuleParametersSpec]):
        fatal (Union[Unset, ChangePercentileMovingWithin30DaysRuleParametersSpec]):
    """
    ...
    warning: Union[
        Unset, "ChangePercentileMovingWithin30DaysRuleParametersSpec"
    ] = UNSET
    error: Union[Unset, "ChangePercentileMovingWithin30DaysRuleParametersSpec"] = UNSET
    fatal: Union[Unset, "ChangePercentileMovingWithin30DaysRuleParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_warning, Unset):
            ...
            warning = ChangePercentileMovingWithin30DaysRuleParametersSpec.from_dict(
                _warning
            )
        ...
        if isinstance(_error, Unset):
            ...
            error = ChangePercentileMovingWithin30DaysRuleParametersSpec.from_dict(
                _error
            )
        ...
        if isinstance(_fatal, Unset):
            ...
            fatal = ChangePercentileMovingWithin30DaysRuleParametersSpec.from_dict(
                _fatal
            )
