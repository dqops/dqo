...
T = TypeVar("T", bound="TableMonthlyPartitionedCheckCategoriesSpecCustom")
...
class TableMonthlyPartitionedCheckCategoriesSpecCustom:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.custom_check_spec import CustomCheckSpec
        d = src_dict.copy()
        table_monthly_partitioned_check_categories_spec_custom = cls(
        )
        ...
        table_monthly_partitioned_check_categories_spec_custom.additional_properties = additional_properties
        return table_monthly_partitioned_check_categories_spec_custom
