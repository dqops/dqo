...
T = TypeVar("T", bound="ColumnSqlProfilingChecksSpecCustomChecks")


@_attrs_define
class ColumnSqlProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_sql_profiling_checks_spec_custom_checks = cls()
        ...
        column_sql_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_sql_profiling_checks_spec_custom_checks
