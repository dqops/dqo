...
T = TypeVar("T", bound="ColumnNullsMonthlyRecurringChecksSpec")


@attr.s(auto_attribs=True)
class ColumnNullsMonthlyRecurringChecksSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_monthly_nulls_count,  Unset):
            ...
            monthly_nulls_count = ColumnNullsCountCheckSpec.from_dict(_monthly_nulls_count)
        ...
        if isinstance(_monthly_nulls_percent,  Unset):
            ...
            monthly_nulls_percent = ColumnNullsPercentCheckSpec.from_dict(_monthly_nulls_percent)
        ...
        if isinstance(_monthly_not_nulls_count,  Unset):
            ...
            monthly_not_nulls_count = ColumnNotNullsCountCheckSpec.from_dict(_monthly_not_nulls_count)
        ...
        if isinstance(_monthly_not_nulls_percent,  Unset):
            ...
            monthly_not_nulls_percent = ColumnNotNullsPercentCheckSpec.from_dict(_monthly_not_nulls_percent)




        column_nulls_monthly_recurring_checks_spec = cls(
        ...
        column_nulls_monthly_recurring_checks_spec.additional_properties = d
        return column_nulls_monthly_recurring_checks_spec
