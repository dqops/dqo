...
if TYPE_CHECKING:
  ...
  from ..models.column_datetime_value_in_range_date_percent_sensor_parameters_spec import ColumnDatetimeValueInRangeDatePercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnDatetimeValueInRangeDatePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnDatetimeValueInRangeDatePercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnDatetimeValueInRangeDatePercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnDatetimeValueInRangeDatePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnDatetimeValueInRangeDatePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_datetime_value_in_range_date_percent_check_spec = cls(
        ...
        column_datetime_value_in_range_date_percent_check_spec.additional_properties = d
        return column_datetime_value_in_range_date_percent_check_spec
