...
if TYPE_CHECKING:
    from ..models.column_datetime_value_in_range_date_percent_sensor_parameters_spec import (
...
class ColumnDatetimeValueInRangeDatePercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnDatetimeValueInRangeDatePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnDatetimeValueInRangeDatePercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
