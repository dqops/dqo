...
if TYPE_CHECKING:
    from ..models.column_patterns_invalid_email_format_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnInvalidEmailFormatFoundCheckSpec")


@_attrs_define
class ColumnInvalidEmailFormatFoundCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnPatternsInvalidEmailFormatCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsInvalidEmailFormatCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnPatternsInvalidEmailFormatCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_invalid_email_format_found_check_spec = cls(
        ...
        column_invalid_email_format_found_check_spec.additional_properties = d
        return column_invalid_email_format_found_check_spec
