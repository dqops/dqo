...
if TYPE_CHECKING:
    from ..models.column_strings_string_invalid_uuid_count_sensor_parameters_spec import (
...
class ColumnStringInvalidUuidCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringInvalidUuidCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringInvalidUuidCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
