...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_invalid_uuid_count_sensor_parameters_spec import ColumnStringsStringInvalidUuidCountSensorParametersSpec





T = TypeVar("T", bound="ColumnStringInvalidUuidCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringInvalidUuidCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringInvalidUuidCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringInvalidUuidCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringInvalidUuidCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_invalid_uuid_count_check_spec = cls(
        ...
        column_string_invalid_uuid_count_check_spec.additional_properties = d
        return column_string_invalid_uuid_count_check_spec
