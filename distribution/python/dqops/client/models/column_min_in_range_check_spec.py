...
T = TypeVar("T", bound="ColumnMinInRangeCheckSpec")


@attr.s(auto_attribs=True)
class ColumnMinInRangeCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_min_in_range_check_spec = cls(
        ...
        column_min_in_range_check_spec.additional_properties = d
        return column_min_in_range_check_spec
