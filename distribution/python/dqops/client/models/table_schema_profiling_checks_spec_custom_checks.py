...
T = TypeVar("T", bound="TableSchemaProfilingChecksSpecCustomChecks")


@_attrs_define
class TableSchemaProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_schema_profiling_checks_spec_custom_checks = cls()
        ...
        table_schema_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_schema_profiling_checks_spec_custom_checks
