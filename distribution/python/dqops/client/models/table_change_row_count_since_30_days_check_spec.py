...
T = TypeVar("T", bound="TableChangeRowCountSince30DaysCheckSpec")


@_attrs_define
class TableChangeRowCountSince30DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_change_row_count_since_30_days_check_spec = cls(
        ...
        table_change_row_count_since_30_days_check_spec.additional_properties = d
        return table_change_row_count_since_30_days_check_spec
