...
if TYPE_CHECKING:
  ...
  from ..models.column_bool_true_percent_sensor_parameters_spec import ColumnBoolTruePercentSensorParametersSpec





T = TypeVar("T", bound="ColumnTruePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnTruePercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnBoolTruePercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnBoolTruePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnBoolTruePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_true_percent_check_spec = cls(
        ...
        column_true_percent_check_spec.additional_properties = d
        return column_true_percent_check_spec
