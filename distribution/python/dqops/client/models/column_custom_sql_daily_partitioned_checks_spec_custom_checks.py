...
T = TypeVar("T", bound="ColumnCustomSqlDailyPartitionedChecksSpecCustomChecks")


@_attrs_define
class ColumnCustomSqlDailyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_custom_sql_daily_partitioned_checks_spec_custom_checks = cls()
        ...
        column_custom_sql_daily_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_custom_sql_daily_partitioned_checks_spec_custom_checks
