...
T = TypeVar("T", bound="ColumnWhitespaceDailyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnWhitespaceDailyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_whitespace_daily_monitoring_checks_spec_custom_checks = cls()
        ...
        column_whitespace_daily_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_whitespace_daily_monitoring_checks_spec_custom_checks
