...
T = TypeVar("T", bound="ColumnChangeDistinctPercentSince7DaysCheckSpec")


@_attrs_define
class ColumnChangeDistinctPercentSince7DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_change_distinct_percent_since_7_days_check_spec = cls(
        ...
        column_change_distinct_percent_since_7_days_check_spec.additional_properties = d
        return column_change_distinct_percent_since_7_days_check_spec
