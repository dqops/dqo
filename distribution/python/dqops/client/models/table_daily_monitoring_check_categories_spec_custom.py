...
T = TypeVar("T", bound="TableDailyMonitoringCheckCategoriesSpecCustom")


@_attrs_define
class TableDailyMonitoringCheckCategoriesSpecCustom:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_daily_monitoring_check_categories_spec_custom = cls()
        ...
        table_daily_monitoring_check_categories_spec_custom.additional_properties = (
            additional_properties
        )
        return table_daily_monitoring_check_categories_spec_custom
