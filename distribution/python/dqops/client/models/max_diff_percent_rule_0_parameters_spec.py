...
T = TypeVar("T", bound="MaxDiffPercentRule0ParametersSpec")


@_attrs_define
class MaxDiffPercentRule0ParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        max_diff_percent_rule_0_parameters_spec = cls(
            max_diff_percent=max_diff_percent,
        )

        max_diff_percent_rule_0_parameters_spec.additional_properties = d
        return max_diff_percent_rule_0_parameters_spec
