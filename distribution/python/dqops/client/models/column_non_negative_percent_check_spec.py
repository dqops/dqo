...
if TYPE_CHECKING:
  from ..models.column_numeric_non_negative_percent_sensor_parameters_spec import ColumnNumericNonNegativePercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnNonNegativePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnNonNegativePercentCheckSpec:
    """ 
        Attributes:
    ...
    parameters: Union[Unset, 'ColumnNumericNonNegativePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericNonNegativePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_non_negative_percent_check_spec.additional_properties = d
        return column_non_negative_percent_check_spec
