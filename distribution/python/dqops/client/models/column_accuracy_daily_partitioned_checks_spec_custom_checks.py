...
T = TypeVar("T", bound="ColumnAccuracyDailyPartitionedChecksSpecCustomChecks")


@_attrs_define
class ColumnAccuracyDailyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_accuracy_daily_partitioned_checks_spec_custom_checks = cls()
        ...
        column_accuracy_daily_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_accuracy_daily_partitioned_checks_spec_custom_checks
