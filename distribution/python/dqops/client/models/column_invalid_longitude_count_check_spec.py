...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_invalid_longitude_count_sensor_parameters_spec import ColumnNumericInvalidLongitudeCountSensorParametersSpec
...
T = TypeVar("T", bound="ColumnInvalidLongitudeCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnInvalidLongitudeCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnNumericInvalidLongitudeCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnNumericInvalidLongitudeCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericInvalidLongitudeCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_invalid_longitude_count_check_spec = cls(
        ...
        column_invalid_longitude_count_check_spec.additional_properties = d
        return column_invalid_longitude_count_check_spec
