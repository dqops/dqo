...
if TYPE_CHECKING:
    from ..models.column_numeric_invalid_longitude_count_sensor_parameters_spec import (
...
class ColumnInvalidLongitudeCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnNumericInvalidLongitudeCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnNumericInvalidLongitudeCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
