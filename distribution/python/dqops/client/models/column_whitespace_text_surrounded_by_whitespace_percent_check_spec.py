...
if TYPE_CHECKING:
    from ..models.column_whitespace_text_surrounded_by_whitespace_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnWhitespaceTextSurroundedByWhitespacePercentCheckSpec")


@_attrs_define
class ColumnWhitespaceTextSurroundedByWhitespacePercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnWhitespaceTextSurroundedByWhitespacePercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnWhitespaceTextSurroundedByWhitespacePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnWhitespaceTextSurroundedByWhitespacePercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_whitespace_text_surrounded_by_whitespace_percent_check_spec = cls(
        ...
        column_whitespace_text_surrounded_by_whitespace_percent_check_spec.additional_properties = (
            d
        )
        return column_whitespace_text_surrounded_by_whitespace_percent_check_spec
