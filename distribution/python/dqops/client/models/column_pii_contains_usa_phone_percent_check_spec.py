...
if TYPE_CHECKING:
    from ..models.column_pii_contains_usa_phone_percent_sensor_parameters_spec import (
...
class ColumnPiiContainsUsaPhonePercentCheckSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnPiiContainsUsaPhonePercentSensorParametersSpec.from_dict(
                _parameters
            )
