...
if TYPE_CHECKING:
  ...
  from ..models.column_pii_contains_usa_phone_percent_sensor_parameters_spec import ColumnPiiContainsUsaPhonePercentSensorParametersSpec





T = TypeVar("T", bound="ColumnPiiContainsUsaPhonePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnPiiContainsUsaPhonePercentCheckSpec:
    """ 
        Attributes:
    ...
    parameters: Union[Unset, 'ColumnPiiContainsUsaPhonePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnPiiContainsUsaPhonePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_pii_contains_usa_phone_percent_check_spec = cls(
        ...
        column_pii_contains_usa_phone_percent_check_spec.additional_properties = d
        return column_pii_contains_usa_phone_percent_check_spec
