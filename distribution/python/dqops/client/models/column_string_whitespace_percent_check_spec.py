...
if TYPE_CHECKING:
    from ..models.column_strings_string_whitespace_percent_sensor_parameters_spec import (
...
class ColumnStringWhitespacePercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringWhitespacePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringWhitespacePercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
