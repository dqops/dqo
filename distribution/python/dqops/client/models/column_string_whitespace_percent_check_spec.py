...
if TYPE_CHECKING:
  from ..models.column_strings_string_whitespace_percent_sensor_parameters_spec import ColumnStringsStringWhitespacePercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringWhitespacePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringWhitespacePercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringWhitespacePercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringWhitespacePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringWhitespacePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_whitespace_percent_check_spec = cls(
        ...
        column_string_whitespace_percent_check_spec.additional_properties = d
        return column_string_whitespace_percent_check_spec
