...
if TYPE_CHECKING:
    from ..models.column_numeric_number_below_min_value_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnNumberBelowMinValueCheckSpec")


@_attrs_define
class ColumnNumberBelowMinValueCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnNumericNumberBelowMinValueCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnNumericNumberBelowMinValueCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnNumericNumberBelowMinValueCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_number_below_min_value_check_spec = cls(
        ...
        column_number_below_min_value_check_spec.additional_properties = d
        return column_number_below_min_value_check_spec
