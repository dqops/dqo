...
if TYPE_CHECKING:
    from ..models.column_sql_import_custom_result_sensor_parameters_spec import (
        ColumnSqlImportCustomResultSensorParametersSpec,
    )
    from ..models.comment_spec import CommentSpec
    from ..models.cron_schedule_spec import CronScheduleSpec
    from ..models.import_severity_rule_parameters_spec import (
        ImportSeverityRuleParametersSpec,
    )


T = TypeVar("T", bound="ColumnSqlImportCustomResultCheckSpec")


@_attrs_define
class ColumnSqlImportCustomResultCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnSqlImportCustomResultSensorParametersSpec]):
        warning (Union[Unset, ImportSeverityRuleParametersSpec]):
        error (Union[Unset, ImportSeverityRuleParametersSpec]):
        fatal (Union[Unset, ImportSeverityRuleParametersSpec]):
    """
    ...
    parameters: Union[Unset, "ColumnSqlImportCustomResultSensorParametersSpec"] = UNSET
    warning: Union[Unset, "ImportSeverityRuleParametersSpec"] = UNSET
    error: Union[Unset, "ImportSeverityRuleParametersSpec"] = UNSET
    fatal: Union[Unset, "ImportSeverityRuleParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnSqlImportCustomResultSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        if isinstance(_warning, Unset):
            ...
            warning = ImportSeverityRuleParametersSpec.from_dict(_warning)
        ...
        if isinstance(_error, Unset):
            ...
            error = ImportSeverityRuleParametersSpec.from_dict(_error)
        ...
        if isinstance(_fatal, Unset):
            ...
            fatal = ImportSeverityRuleParametersSpec.from_dict(_fatal)

        column_sql_import_custom_result_check_spec = cls(
        ...
        column_sql_import_custom_result_check_spec.additional_properties = d
        return column_sql_import_custom_result_check_spec
