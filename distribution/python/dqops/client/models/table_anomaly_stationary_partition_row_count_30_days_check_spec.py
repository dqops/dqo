...
if TYPE_CHECKING:
  ...
  from ..models.anomaly_stationary_percentile_moving_average_30_days_rule_05_parameters_spec import AnomalyStationaryPercentileMovingAverage30DaysRule05ParametersSpec
  from ..models.anomaly_stationary_percentile_moving_average_30_days_rule_1_parameters_spec import AnomalyStationaryPercentileMovingAverage30DaysRule1ParametersSpec
  from ..models.table_volume_row_count_sensor_parameters_spec import TableVolumeRowCountSensorParametersSpec
  from ..models.anomaly_stationary_percentile_moving_average_30_days_rule_01_parameters_spec import AnomalyStationaryPercentileMovingAverage30DaysRule01ParametersSpec
...
T = TypeVar("T", bound="TableAnomalyStationaryPartitionRowCount30DaysCheckSpec")


@attr.s(auto_attribs=True)
class TableAnomalyStationaryPartitionRowCount30DaysCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_anomaly_stationary_partition_row_count_30_days_check_spec = cls(
        ...
        table_anomaly_stationary_partition_row_count_30_days_check_spec.additional_properties = d
        return table_anomaly_stationary_partition_row_count_30_days_check_spec
