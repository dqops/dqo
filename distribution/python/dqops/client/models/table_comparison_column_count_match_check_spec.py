...
T = TypeVar("T", bound="TableComparisonColumnCountMatchCheckSpec")


@_attrs_define
class TableComparisonColumnCountMatchCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_comparison_column_count_match_check_spec = cls(
        ...
        table_comparison_column_count_match_check_spec.additional_properties = d
        return table_comparison_column_count_match_check_spec
