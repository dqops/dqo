...
T = TypeVar("T", bound="ColumnDailyMonitoringCheckCategoriesSpecCustom")


@_attrs_define
class ColumnDailyMonitoringCheckCategoriesSpecCustom:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_daily_monitoring_check_categories_spec_custom = cls()
        ...
        column_daily_monitoring_check_categories_spec_custom.additional_properties = (
            additional_properties
        )
        return column_daily_monitoring_check_categories_spec_custom
