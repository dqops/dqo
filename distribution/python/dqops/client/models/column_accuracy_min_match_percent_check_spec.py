...
if TYPE_CHECKING:
    from ..models.column_accuracy_min_match_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnAccuracyMinMatchPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnAccuracyMinMatchPercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnAccuracyMinMatchPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnAccuracyMinMatchPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnAccuracyMinMatchPercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_accuracy_min_match_percent_check_spec = cls(
        ...
        column_accuracy_min_match_percent_check_spec.additional_properties = d
        return column_accuracy_min_match_percent_check_spec
