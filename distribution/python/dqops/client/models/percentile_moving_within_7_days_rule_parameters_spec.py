...
T = TypeVar("T", bound="PercentileMovingWithin7DaysRuleParametersSpec")


@attr.s(auto_attribs=True)
class PercentileMovingWithin7DaysRuleParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        percentile_moving_within_7_days_rule_parameters_spec = cls(
            anomaly_percent=anomaly_percent,
        )

        percentile_moving_within_7_days_rule_parameters_spec.additional_properties = d
        return percentile_moving_within_7_days_rule_parameters_spec
