...
T = TypeVar("T", bound="ColumnPatternsMonthlyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnPatternsMonthlyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_patterns_monthly_monitoring_checks_spec_custom_checks = cls()
        ...
        column_patterns_monthly_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_patterns_monthly_monitoring_checks_spec_custom_checks
