...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_mean_sensor_parameters_spec import ColumnNumericMeanSensorParametersSpec
...
T = TypeVar("T", bound="ColumnComparisonMeanMatchCheckSpec")


@attr.s(auto_attribs=True)
class ColumnComparisonMeanMatchCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_comparison_mean_match_check_spec = cls(
        ...
        column_comparison_mean_match_check_spec.additional_properties = d
        return column_comparison_mean_match_check_spec
