...
class TableTimelinessDailyPartitionedChecksSpec:
    ...
    daily_partition_data_ingestion_delay: Union[Unset, 'TableDataIngestionDelayCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.daily_partition_data_freshness, Unset):
            daily_partition_data_freshness = self.daily_partition_data_freshness.to_dict()

        daily_partition_data_staleness: Union[Unset, Dict[str, Any]] = UNSET
        if not isinstance(self.daily_partition_data_staleness, Unset):
            daily_partition_data_staleness = self.daily_partition_data_staleness.to_dict()
        ...
        if not isinstance(self.daily_partition_data_ingestion_delay, Unset):
            daily_partition_data_ingestion_delay = self.daily_partition_data_ingestion_delay.to_dict()
        ...
        if daily_partition_data_freshness is not UNSET:
            field_dict["daily_partition_data_freshness"] = daily_partition_data_freshness
        if daily_partition_data_staleness is not UNSET:
            field_dict["daily_partition_data_staleness"] = daily_partition_data_staleness
        if daily_partition_data_ingestion_delay is not UNSET:
            field_dict["daily_partition_data_ingestion_delay"] = daily_partition_data_ingestion_delay
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_daily_partition_data_freshness,  Unset):
            ...
            daily_partition_data_freshness = TableDataFreshnessCheckSpec.from_dict(_daily_partition_data_freshness)
        ...
        if isinstance(_daily_partition_data_staleness,  Unset):
            ...
            daily_partition_data_staleness = TableDataStalenessCheckSpec.from_dict(_daily_partition_data_staleness)




        _daily_partition_data_ingestion_delay = d.pop("daily_partition_data_ingestion_delay", UNSET)
        daily_partition_data_ingestion_delay: Union[Unset, TableDataIngestionDelayCheckSpec]
        if isinstance(_daily_partition_data_ingestion_delay,  Unset):
            daily_partition_data_ingestion_delay = UNSET
        else:
            daily_partition_data_ingestion_delay = TableDataIngestionDelayCheckSpec.from_dict(_daily_partition_data_ingestion_delay)
        ...
        if isinstance(_daily_partition_reload_lag,  Unset):
            ...
            daily_partition_reload_lag = TablePartitionReloadLagCheckSpec.from_dict(_daily_partition_reload_lag)
