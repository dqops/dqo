...
if TYPE_CHECKING:
  from ..models.column_column_exists_sensor_parameters_spec import ColumnColumnExistsSensorParametersSpec
  from ..models.comment_spec import CommentSpec
  from ..models.equals_integer_1_rule_parameters_spec import EqualsInteger1RuleParametersSpec
...
class ColumnSchemaColumnExistsCheckSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_schema_column_exists_check_spec.additional_properties = d
        return column_schema_column_exists_check_spec
