...
T = TypeVar("T", bound="TableRowCountChange1DayCheckSpec")


@_attrs_define
class TableRowCountChange1DayCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_row_count_change_1_day_check_spec = cls(
        ...
        table_row_count_change_1_day_check_spec.additional_properties = d
        return table_row_count_change_1_day_check_spec
