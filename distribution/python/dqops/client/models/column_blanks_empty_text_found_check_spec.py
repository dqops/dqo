...
if TYPE_CHECKING:
    from ..models.column_blanks_empty_text_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnBlanksEmptyTextFoundCheckSpec")


@_attrs_define
class ColumnBlanksEmptyTextFoundCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnBlanksEmptyTextCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, "ColumnBlanksEmptyTextCountSensorParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnBlanksEmptyTextCountSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_blanks_empty_text_found_check_spec = cls(
        ...
        column_blanks_empty_text_found_check_spec.additional_properties = d
        return column_blanks_empty_text_found_check_spec
