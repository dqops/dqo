...
T = TypeVar("T", bound="ColumnUniquenessDailyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnUniquenessDailyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_uniqueness_daily_monitoring_checks_spec_custom_checks = cls()
        ...
        column_uniqueness_daily_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_uniqueness_daily_monitoring_checks_spec_custom_checks
