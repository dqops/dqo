...
T = TypeVar("T", bound="MaxDaysRule2ParametersSpec")


@_attrs_define
class MaxDaysRule2ParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        max_days_rule_2_parameters_spec = cls(
            max_days=max_days,
        )

        max_days_rule_2_parameters_spec.additional_properties = d
        return max_days_rule_2_parameters_spec
