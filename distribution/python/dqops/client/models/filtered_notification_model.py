...
T = TypeVar("T", bound="FilteredNotificationModel")


@_attrs_define
class FilteredNotificationModel:
    """Filtered notification list model.

    Attributes:
        name (Union[Unset, str]): The name of the filtered notification.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        return filtered_notification_model
