...
class ColumnMaxAnomalyStationaryCheckSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_max_anomaly_stationary_check_spec = cls(
        ...
        column_max_anomaly_stationary_check_spec.additional_properties = d
        return column_max_anomaly_stationary_check_spec
