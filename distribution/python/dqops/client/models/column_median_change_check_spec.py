...
T = TypeVar("T", bound="ColumnMedianChangeCheckSpec")


@_attrs_define
class ColumnMedianChangeCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_median_change_check_spec = cls(
        ...
        column_median_change_check_spec.additional_properties = d
        return column_median_change_check_spec
