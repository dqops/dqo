...
if TYPE_CHECKING:
    from ..models.column_whitespace_blank_null_placeholder_text_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnWhitespaceNullPlaceholderTextPercentCheckSpec")


@_attrs_define
class ColumnWhitespaceNullPlaceholderTextPercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnWhitespaceBlankNullPlaceholderTextPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnWhitespaceBlankNullPlaceholderTextPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnWhitespaceBlankNullPlaceholderTextPercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_whitespace_null_placeholder_text_percent_check_spec = cls(
        ...
        column_whitespace_null_placeholder_text_percent_check_spec.additional_properties = (
            d
        )
        return column_whitespace_null_placeholder_text_percent_check_spec
