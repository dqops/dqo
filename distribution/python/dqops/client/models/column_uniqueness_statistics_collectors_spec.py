...
if TYPE_CHECKING:
  from ..models.column_uniqueness_distinct_count_statistics_collector_spec import ColumnUniquenessDistinctCountStatisticsCollectorSpec
  from ..models.column_uniqueness_duplicate_percent_statistics_collector_spec import ColumnUniquenessDuplicatePercentStatisticsCollectorSpec
  from ..models.column_uniqueness_distinct_percent_statistics_collector_spec import ColumnUniquenessDistinctPercentStatisticsCollectorSpec
  from ..models.column_uniqueness_duplicate_count_statistics_collector_spec import ColumnUniquenessDuplicateCountStatisticsCollectorSpec
...
class ColumnUniquenessStatisticsCollectorsSpec:
    ...
    distinct_count: Union[Unset, 'ColumnUniquenessDistinctCountStatisticsCollectorSpec'] = UNSET
    distinct_percent: Union[Unset, 'ColumnUniquenessDistinctPercentStatisticsCollectorSpec'] = UNSET
    duplicate_count: Union[Unset, 'ColumnUniquenessDuplicateCountStatisticsCollectorSpec'] = UNSET
    duplicate_percent: Union[Unset, 'ColumnUniquenessDuplicatePercentStatisticsCollectorSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_distinct_count,  Unset):
            ...
            distinct_count = ColumnUniquenessDistinctCountStatisticsCollectorSpec.from_dict(_distinct_count)
        ...
        if isinstance(_distinct_percent,  Unset):
            ...
            distinct_percent = ColumnUniquenessDistinctPercentStatisticsCollectorSpec.from_dict(_distinct_percent)
        ...
        if isinstance(_duplicate_count,  Unset):
            ...
            duplicate_count = ColumnUniquenessDuplicateCountStatisticsCollectorSpec.from_dict(_duplicate_count)
        ...
        if isinstance(_duplicate_percent,  Unset):
            ...
            duplicate_percent = ColumnUniquenessDuplicatePercentStatisticsCollectorSpec.from_dict(_duplicate_percent)
