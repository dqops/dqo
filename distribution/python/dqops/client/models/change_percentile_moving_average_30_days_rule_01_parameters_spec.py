...
class ChangePercentileMovingAverage30DaysRule01ParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        change_percentile_moving_average_30_days_rule_01_parameters_spec = cls(
            anomaly_percent=anomaly_percent,
        )

        change_percentile_moving_average_30_days_rule_01_parameters_spec.additional_properties = (
            d
        )
        return change_percentile_moving_average_30_days_rule_01_parameters_spec
