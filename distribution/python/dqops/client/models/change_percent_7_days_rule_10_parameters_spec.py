...
T = TypeVar("T", bound="ChangePercent7DaysRule10ParametersSpec")


@_attrs_define
class ChangePercent7DaysRule10ParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        change_percent_7_days_rule_10_parameters_spec = cls(
            max_percent=max_percent,
            exact_day=exact_day,
        )

        change_percent_7_days_rule_10_parameters_spec.additional_properties = d
        return change_percent_7_days_rule_10_parameters_spec
