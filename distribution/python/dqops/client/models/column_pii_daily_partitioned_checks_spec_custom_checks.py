...
T = TypeVar("T", bound="ColumnPiiDailyPartitionedChecksSpecCustomChecks")


@_attrs_define
class ColumnPiiDailyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_pii_daily_partitioned_checks_spec_custom_checks = cls()
        ...
        column_pii_daily_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_pii_daily_partitioned_checks_spec_custom_checks
