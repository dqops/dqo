...
T = TypeVar("T", bound="ColumnComparisonProfilingChecksSpecCustomChecks")


@_attrs_define
class ColumnComparisonProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_comparison_profiling_checks_spec_custom_checks = cls()
        ...
        column_comparison_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_comparison_profiling_checks_spec_custom_checks
