...
T = TypeVar("T", bound="ColumnDistinctCountChangeCheckSpec")


@_attrs_define
class ColumnDistinctCountChangeCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_distinct_count_change_check_spec = cls(
        ...
        column_distinct_count_change_check_spec.additional_properties = d
        return column_distinct_count_change_check_spec
