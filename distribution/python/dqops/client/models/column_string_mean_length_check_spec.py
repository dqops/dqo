...
T = TypeVar("T", bound="ColumnStringMeanLengthCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringMeanLengthCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_string_mean_length_check_spec = cls(
        ...
        column_string_mean_length_check_spec.additional_properties = d
        return column_string_mean_length_check_spec
