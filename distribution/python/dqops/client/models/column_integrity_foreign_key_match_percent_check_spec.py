...
if TYPE_CHECKING:
  ...
  from ..models.column_integrity_foreign_key_match_percent_sensor_parameters_spec import ColumnIntegrityForeignKeyMatchPercentSensorParametersSpec





T = TypeVar("T", bound="ColumnIntegrityForeignKeyMatchPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnIntegrityForeignKeyMatchPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnIntegrityForeignKeyMatchPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnIntegrityForeignKeyMatchPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnIntegrityForeignKeyMatchPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_integrity_foreign_key_match_percent_check_spec = cls(
        ...
        column_integrity_foreign_key_match_percent_check_spec.additional_properties = d
        return column_integrity_foreign_key_match_percent_check_spec
