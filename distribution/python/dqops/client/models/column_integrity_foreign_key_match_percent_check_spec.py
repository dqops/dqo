...
if TYPE_CHECKING:
    from ..models.column_integrity_foreign_key_match_percent_sensor_parameters_spec import (
...
class ColumnIntegrityForeignKeyMatchPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnIntegrityForeignKeyMatchPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnIntegrityForeignKeyMatchPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
