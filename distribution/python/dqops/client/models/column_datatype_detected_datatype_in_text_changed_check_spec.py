...
T = TypeVar("T", bound="ColumnDatatypeDetectedDatatypeInTextChangedCheckSpec")


@_attrs_define
class ColumnDatatypeDetectedDatatypeInTextChangedCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_datatype_detected_datatype_in_text_changed_check_spec = cls(
        ...
        column_datatype_detected_datatype_in_text_changed_check_spec.additional_properties = (
            d
        )
        return column_datatype_detected_datatype_in_text_changed_check_spec
