...
T = TypeVar("T", bound="ChangePercentileMovingAverage30DaysRule1ParametersSpec")


@attr.s(auto_attribs=True)
class ChangePercentileMovingAverage30DaysRule05ParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        change_percentile_moving_average_30_days_rule_05_parameters_spec = cls(
            anomaly_percent=anomaly_percent,
        )

        change_percentile_moving_average_30_days_rule_05_parameters_spec.additional_properties = (
            d
        )
        return change_percentile_moving_average_30_days_rule_05_parameters_spec
