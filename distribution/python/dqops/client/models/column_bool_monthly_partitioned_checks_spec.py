...
class ColumnBoolMonthlyPartitionedChecksSpec:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.monthly_partition_true_percent, Unset):
            monthly_partition_true_percent = self.monthly_partition_true_percent.to_dict()
        ...
        if not isinstance(self.monthly_partition_false_percent, Unset):
            monthly_partition_false_percent = self.monthly_partition_false_percent.to_dict()
        ...
        if monthly_partition_true_percent is not UNSET:
            field_dict["monthly_partition_true_percent"] = monthly_partition_true_percent
        if monthly_partition_false_percent is not UNSET:
            field_dict["monthly_partition_false_percent"] = monthly_partition_false_percent
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_monthly_partition_true_percent,  Unset):
            ...
            monthly_partition_true_percent = ColumnTruePercentCheckSpec.from_dict(_monthly_partition_true_percent)




        _monthly_partition_false_percent = d.pop("monthly_partition_false_percent", UNSET)
        monthly_partition_false_percent: Union[Unset, ColumnFalsePercentCheckSpec]
        if isinstance(_monthly_partition_false_percent,  Unset):
            monthly_partition_false_percent = UNSET
        else:
            monthly_partition_false_percent = ColumnFalsePercentCheckSpec.from_dict(_monthly_partition_false_percent)
