...
T = TypeVar("T", bound="ColumnBlanksProfilingChecksSpecCustomChecks")


@_attrs_define
class ColumnBlanksProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_blanks_profiling_checks_spec_custom_checks = cls()
        ...
        column_blanks_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_blanks_profiling_checks_spec_custom_checks
