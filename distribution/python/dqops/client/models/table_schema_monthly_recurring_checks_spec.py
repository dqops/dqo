...
class TableSchemaMonthlyRecurringChecksSpec:
    ...
    monthly_column_count_changed: Union[Unset, 'TableSchemaColumnCountChangedCheckSpec'] = UNSET
    monthly_column_list_changed: Union[Unset, 'TableSchemaColumnListChangedCheckSpec'] = UNSET
    monthly_column_list_or_order_changed: Union[Unset, 'TableSchemaColumnListOrOrderChangedCheckSpec'] = UNSET
    monthly_column_types_changed: Union[Unset, 'TableSchemaColumnTypesChangedCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.monthly_column_list_or_order_changed, Unset):
            monthly_column_list_or_order_changed = self.monthly_column_list_or_order_changed.to_dict()
        ...
        if monthly_column_list_or_order_changed is not UNSET:
            field_dict["monthly_column_list_or_order_changed"] = monthly_column_list_or_order_changed
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_monthly_column_count,  Unset):
            ...
            monthly_column_count = TableSchemaColumnCountCheckSpec.from_dict(_monthly_column_count)
        ...
        if isinstance(_monthly_column_count_changed,  Unset):
            ...
            monthly_column_count_changed = TableSchemaColumnCountChangedCheckSpec.from_dict(_monthly_column_count_changed)
        ...
        if isinstance(_monthly_column_list_changed,  Unset):
            ...
            monthly_column_list_changed = TableSchemaColumnListChangedCheckSpec.from_dict(_monthly_column_list_changed)




        _monthly_column_list_or_order_changed = d.pop("monthly_column_list_or_order_changed", UNSET)
        monthly_column_list_or_order_changed: Union[Unset, TableSchemaColumnListOrOrderChangedCheckSpec]
        if isinstance(_monthly_column_list_or_order_changed,  Unset):
            monthly_column_list_or_order_changed = UNSET
        else:
            monthly_column_list_or_order_changed = TableSchemaColumnListOrOrderChangedCheckSpec.from_dict(_monthly_column_list_or_order_changed)
        ...
        if isinstance(_monthly_column_types_changed,  Unset):
            ...
            monthly_column_types_changed = TableSchemaColumnTypesChangedCheckSpec.from_dict(_monthly_column_types_changed)
