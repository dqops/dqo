...
T = TypeVar("T", bound="AnomalyTimelinessDelayRuleError05PctParametersSpec")


@_attrs_define
class AnomalyTimelinessDelayRuleError05PctParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        anomaly_timeliness_delay_rule_error_05_pct_parameters_spec = cls(
            anomaly_percent=anomaly_percent,
        )

        anomaly_timeliness_delay_rule_error_05_pct_parameters_spec.additional_properties = (
            d
        )
        return anomaly_timeliness_delay_rule_error_05_pct_parameters_spec
