...
if TYPE_CHECKING:
  ...
  from ..models.column_numeric_population_variance_sensor_parameters_spec import ColumnNumericPopulationVarianceSensorParametersSpec
...
T = TypeVar("T", bound="ColumnPopulationVarianceInRangeCheckSpec")


@attr.s(auto_attribs=True)
class ColumnPopulationVarianceInRangeCheckSpec:
    """ 
        Attributes:
    ...
    parameters: Union[Unset, 'ColumnNumericPopulationVarianceSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNumericPopulationVarianceSensorParametersSpec.from_dict(_parameters)
        ...
        column_population_variance_in_range_check_spec = cls(
        ...
        column_population_variance_in_range_check_spec.additional_properties = d
        return column_population_variance_in_range_check_spec
