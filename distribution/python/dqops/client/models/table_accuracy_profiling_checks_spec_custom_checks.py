...
T = TypeVar("T", bound="TableAccuracyProfilingChecksSpecCustomChecks")


@_attrs_define
class TableAccuracyProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_accuracy_profiling_checks_spec_custom_checks = cls()
        ...
        table_accuracy_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_accuracy_profiling_checks_spec_custom_checks
