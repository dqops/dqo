...
T = TypeVar("T", bound="ColumnMonthlyMonitoringCheckCategoriesSpecCustom")


@_attrs_define
class ColumnMonthlyMonitoringCheckCategoriesSpecCustom:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_monthly_monitoring_check_categories_spec_custom = cls()
        ...
        column_monthly_monitoring_check_categories_spec_custom.additional_properties = (
            additional_properties
        )
        return column_monthly_monitoring_check_categories_spec_custom
