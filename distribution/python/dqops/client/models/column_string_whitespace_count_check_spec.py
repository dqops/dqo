...
if TYPE_CHECKING:
    from ..models.column_strings_string_whitespace_count_sensor_parameters_spec import (
...
class ColumnStringWhitespaceCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringWhitespaceCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringWhitespaceCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
