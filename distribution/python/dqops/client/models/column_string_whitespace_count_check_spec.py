...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_whitespace_count_sensor_parameters_spec import ColumnStringsStringWhitespaceCountSensorParametersSpec





T = TypeVar("T", bound="ColumnStringWhitespaceCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringWhitespaceCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringWhitespaceCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringWhitespaceCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringWhitespaceCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_whitespace_count_check_spec = cls(
        ...
        column_string_whitespace_count_check_spec.additional_properties = d
        return column_string_whitespace_count_check_spec
