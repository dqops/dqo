...
if TYPE_CHECKING:
  ...
  from ..models.column_uniqueness_distinct_percent_sensor_parameters_spec import ColumnUniquenessDistinctPercentSensorParametersSpec
...
class ColumnDistinctPercentCheckSpec:
    ...
    parameters: Union[Unset, 'ColumnUniquenessDistinctPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnUniquenessDistinctPercentSensorParametersSpec.from_dict(_parameters)
