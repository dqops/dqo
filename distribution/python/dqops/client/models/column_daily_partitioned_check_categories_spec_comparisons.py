...
if TYPE_CHECKING:
  from ..models.column_comparison_daily_partitioned_checks_spec import ColumnComparisonDailyPartitionedChecksSpec
...
class ColumnDailyPartitionedCheckCategoriesSpecComparisons:
    ...
    additional_properties: Dict[str, 'ColumnComparisonDailyPartitionedChecksSpec'] = attr.ib(init=False, factory=dict)
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            additional_property = ColumnComparisonDailyPartitionedChecksSpec.from_dict(prop_dict)



            additional_properties[prop_name] = additional_property

        column_daily_partitioned_check_categories_spec_comparisons.additional_properties = additional_properties
    ...
    def __setitem__(self, key: str, value: 'ColumnComparisonDailyPartitionedChecksSpec') -> None:
