...
T = TypeVar("T", bound="ColumnNumericProfilingChecksSpecCustomChecks")


@_attrs_define
class ColumnNumericProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_numeric_profiling_checks_spec_custom_checks = cls()
        ...
        column_numeric_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_numeric_profiling_checks_spec_custom_checks
