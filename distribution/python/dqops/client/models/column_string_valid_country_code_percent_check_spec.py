...
if TYPE_CHECKING:
    from ..models.column_strings_string_valid_country_code_percent_sensor_parameters_spec import (
...
class ColumnStringValidCountryCodePercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringValidCountryCodePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnStringsStringValidCountryCodePercentSensorParametersSpec.from_dict(
                _parameters
            )
