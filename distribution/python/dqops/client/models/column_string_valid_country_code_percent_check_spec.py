...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_valid_country_code_percent_sensor_parameters_spec import ColumnStringsStringValidCountryCodePercentSensorParametersSpec





T = TypeVar("T", bound="ColumnStringValidCountryCodePercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringValidCountryCodePercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringValidCountryCodePercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringValidCountryCodePercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringValidCountryCodePercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_valid_country_code_percent_check_spec = cls(
        ...
        column_string_valid_country_code_percent_check_spec.additional_properties = d
        return column_string_valid_country_code_percent_check_spec
