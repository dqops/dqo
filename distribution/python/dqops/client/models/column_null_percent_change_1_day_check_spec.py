...
T = TypeVar("T", bound="ColumnNullPercentChange1DayCheckSpec")


@_attrs_define
class ColumnNullPercentChange1DayCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_null_percent_change_1_day_check_spec = cls(
        ...
        column_null_percent_change_1_day_check_spec.additional_properties = d
        return column_null_percent_change_1_day_check_spec
