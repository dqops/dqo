...
T = TypeVar("T", bound="ColumnPatternsDailyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnPatternsDailyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_patterns_daily_monitoring_checks_spec_custom_checks = cls()
        ...
        column_patterns_daily_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_patterns_daily_monitoring_checks_spec_custom_checks
