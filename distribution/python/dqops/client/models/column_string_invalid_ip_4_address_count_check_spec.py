...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_invalid_ip_4_address_count_sensor_parameters_spec import ColumnStringsStringInvalidIp4AddressCountSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringInvalidIp4AddressCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringInvalidIp4AddressCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringInvalidIp4AddressCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringInvalidIp4AddressCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringInvalidIp4AddressCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_invalid_ip_4_address_count_check_spec = cls(
        ...
        column_string_invalid_ip_4_address_count_check_spec.additional_properties = d
        return column_string_invalid_ip_4_address_count_check_spec
