...
if TYPE_CHECKING:
    from ..models.column_strings_string_invalid_ip_4_address_count_sensor_parameters_spec import (
...
class ColumnStringInvalidIp4AddressCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringInvalidIp4AddressCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringInvalidIp4AddressCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
