...
T = TypeVar("T", bound="MinPercentRule5ParametersSpec")


@_attrs_define
class MinPercentRule5ParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        min_percent_rule_5_parameters_spec = cls(
            min_percent=min_percent,
        )

        min_percent_rule_5_parameters_spec.additional_properties = d
        return min_percent_rule_5_parameters_spec
