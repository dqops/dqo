...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_boolean_placeholder_percent_sensor_parameters_spec import ColumnStringsStringBooleanPlaceholderPercentSensorParametersSpec





T = TypeVar("T", bound="ColumnStringBooleanPlaceholderPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringBooleanPlaceholderPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringBooleanPlaceholderPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringBooleanPlaceholderPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringBooleanPlaceholderPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_boolean_placeholder_percent_check_spec = cls(
        ...
        column_string_boolean_placeholder_percent_check_spec.additional_properties = d
        return column_string_boolean_placeholder_percent_check_spec
