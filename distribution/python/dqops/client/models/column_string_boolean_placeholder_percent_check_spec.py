...
if TYPE_CHECKING:
    from ..models.column_strings_string_boolean_placeholder_percent_sensor_parameters_spec import (
...
class ColumnStringBooleanPlaceholderPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringBooleanPlaceholderPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnStringsStringBooleanPlaceholderPercentSensorParametersSpec.from_dict(
                _parameters
            )
