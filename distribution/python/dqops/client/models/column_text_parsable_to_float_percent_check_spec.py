...
if TYPE_CHECKING:
    from ..models.column_text_text_parsable_to_float_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextParsableToFloatPercentCheckSpec")


@_attrs_define
class ColumnTextParsableToFloatPercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnTextTextParsableToFloatPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnTextTextParsableToFloatPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnTextTextParsableToFloatPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_text_parsable_to_float_percent_check_spec = cls(
        ...
        column_text_parsable_to_float_percent_check_spec.additional_properties = d
        return column_text_parsable_to_float_percent_check_spec
