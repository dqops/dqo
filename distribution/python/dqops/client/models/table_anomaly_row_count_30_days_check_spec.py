...
T = TypeVar("T", bound="TableAnomalyRowCount30DaysCheckSpec")


@attr.s(auto_attribs=True)
class TableAnomalyRowCount30DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_anomaly_row_count_30_days_check_spec.additional_properties = d
        return table_anomaly_row_count_30_days_check_spec
