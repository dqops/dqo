...
T = TypeVar("T", bound="AnomalyPartitionRowCountRuleFatal01PctParametersSpec")


@_attrs_define
class AnomalyPartitionRowCountRuleFatal01PctParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        anomaly_partition_row_count_rule_fatal_01_pct_parameters_spec = cls(
            anomaly_percent=anomaly_percent,
        )

        anomaly_partition_row_count_rule_fatal_01_pct_parameters_spec.additional_properties = (
            d
        )
        return anomaly_partition_row_count_rule_fatal_01_pct_parameters_spec
