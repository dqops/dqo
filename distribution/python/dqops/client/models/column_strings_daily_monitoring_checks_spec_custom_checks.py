...
T = TypeVar("T", bound="ColumnStringsDailyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnStringsDailyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_strings_daily_monitoring_checks_spec_custom_checks = cls()
        ...
        column_strings_daily_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_strings_daily_monitoring_checks_spec_custom_checks
