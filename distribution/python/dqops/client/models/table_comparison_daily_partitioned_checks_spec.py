...
class TableComparisonDailyPartitionedChecksSpec:
    ...
    daily_partition_row_count_match: Union[Unset, 'TableComparisonRowCountMatchCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.daily_partition_row_count_match, Unset):
            daily_partition_row_count_match = self.daily_partition_row_count_match.to_dict()
        ...
        if daily_partition_row_count_match is not UNSET:
            field_dict["daily_partition_row_count_match"] = daily_partition_row_count_match
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.table_comparison_row_count_match_check_spec import TableComparisonRowCountMatchCheckSpec
        d = src_dict.copy()
        _daily_partition_row_count_match = d.pop("daily_partition_row_count_match", UNSET)
        daily_partition_row_count_match: Union[Unset, TableComparisonRowCountMatchCheckSpec]
        if isinstance(_daily_partition_row_count_match,  Unset):
            daily_partition_row_count_match = UNSET
        else:
            daily_partition_row_count_match = TableComparisonRowCountMatchCheckSpec.from_dict(_daily_partition_row_count_match)
