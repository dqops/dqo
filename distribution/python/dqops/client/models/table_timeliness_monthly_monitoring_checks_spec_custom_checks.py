...
T = TypeVar("T", bound="TableTimelinessMonthlyMonitoringChecksSpecCustomChecks")


@_attrs_define
class TableTimelinessMonthlyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_timeliness_monthly_monitoring_checks_spec_custom_checks = cls()
        ...
        table_timeliness_monthly_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_timeliness_monthly_monitoring_checks_spec_custom_checks
