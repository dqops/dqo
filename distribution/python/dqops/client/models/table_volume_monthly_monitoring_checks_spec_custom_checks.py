...
T = TypeVar("T", bound="TableVolumeMonthlyMonitoringChecksSpecCustomChecks")


@_attrs_define
class TableVolumeMonthlyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_volume_monthly_monitoring_checks_spec_custom_checks = cls()
        ...
        table_volume_monthly_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_volume_monthly_monitoring_checks_spec_custom_checks
