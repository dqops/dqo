...
if TYPE_CHECKING:
    ...
    from ..models.ui_column_checks_model_check_containers import (
        UIColumnChecksModelCheckContainers,
    )


T = TypeVar("T", bound="UIColumnChecksModel")


@attr.s(auto_attribs=True)
class UIColumnChecksModel:
    ...
    Attributes:
        ...
        check_containers (Union[Unset, UIColumnChecksModelCheckContainers]): Mapping of check type and timescale to
            check container on this column.
    """
    ...
    check_containers: Union[Unset, "UIColumnChecksModelCheckContainers"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        check_containers: Union[Unset, UIColumnChecksModelCheckContainers]
        if isinstance(_check_containers, Unset):
            check_containers = UNSET
        else:
            check_containers = UIColumnChecksModelCheckContainers.from_dict(
                _check_containers
            )

        ui_column_checks_model = cls(
        ...
        ui_column_checks_model.additional_properties = d
        return ui_column_checks_model
