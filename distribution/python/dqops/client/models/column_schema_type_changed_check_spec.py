...
if TYPE_CHECKING:
  ...
  from ..models.column_column_type_hash_sensor_parameters_spec import ColumnColumnTypeHashSensorParametersSpec
...
T = TypeVar("T", bound="ColumnSchemaTypeChangedCheckSpec")


@attr.s(auto_attribs=True)
class ColumnSchemaTypeChangedCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnColumnTypeHashSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnColumnTypeHashSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnColumnTypeHashSensorParametersSpec.from_dict(_parameters)
        ...
        column_schema_type_changed_check_spec = cls(
        ...
        column_schema_type_changed_check_spec.additional_properties = d
        return column_schema_type_changed_check_spec
