...
if TYPE_CHECKING:
    ...
    from ..models.table_duplicate_record_count_sensor_parameters_spec import (
        TableDuplicateRecordCountSensorParametersSpec,
    )


T = TypeVar("T", bound="TableDuplicateRecordCountCheckSpec")


@_attrs_define
class TableDuplicateRecordCountCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, TableDuplicateRecordCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, "TableDuplicateRecordCountSensorParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = TableDuplicateRecordCountSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        table_duplicate_record_count_check_spec = cls(
        ...
        table_duplicate_record_count_check_spec.additional_properties = d
