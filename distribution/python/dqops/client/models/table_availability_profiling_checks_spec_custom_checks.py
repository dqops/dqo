...
T = TypeVar("T", bound="TableAvailabilityProfilingChecksSpecCustomChecks")


@_attrs_define
class TableAvailabilityProfilingChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_availability_profiling_checks_spec_custom_checks = cls()
        ...
        table_availability_profiling_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_availability_profiling_checks_spec_custom_checks
