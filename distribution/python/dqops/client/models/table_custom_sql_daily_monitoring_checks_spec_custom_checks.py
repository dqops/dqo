...
T = TypeVar("T", bound="TableCustomSqlDailyMonitoringChecksSpecCustomChecks")


@_attrs_define
class TableCustomSqlDailyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_custom_sql_daily_monitoring_checks_spec_custom_checks = cls()
        ...
        table_custom_sql_daily_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_custom_sql_daily_monitoring_checks_spec_custom_checks
