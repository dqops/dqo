...
if TYPE_CHECKING:
    from ..models.column_blanks_whitespace_text_count_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnBlanksWhitespaceTextFoundCheckSpec")


@_attrs_define
class ColumnBlanksWhitespaceTextFoundCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnBlanksWhitespaceTextCountSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnBlanksWhitespaceTextCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnBlanksWhitespaceTextCountSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_blanks_whitespace_text_found_check_spec = cls(
        ...
        column_blanks_whitespace_text_found_check_spec.additional_properties = d
        return column_blanks_whitespace_text_found_check_spec
