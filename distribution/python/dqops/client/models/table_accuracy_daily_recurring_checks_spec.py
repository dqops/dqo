...
class TableAccuracyDailyRecurringChecksSpec:
    ...
    daily_total_row_count_match_percent: Union[Unset, 'TableAccuracyTotalRowCountMatchPercentCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.daily_total_row_count_match_percent, Unset):
            daily_total_row_count_match_percent = self.daily_total_row_count_match_percent.to_dict()
        ...
        if daily_total_row_count_match_percent is not UNSET:
            field_dict["daily_total_row_count_match_percent"] = daily_total_row_count_match_percent
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        from ..models.table_accuracy_total_row_count_match_percent_check_spec import TableAccuracyTotalRowCountMatchPercentCheckSpec
        d = src_dict.copy()
        _daily_total_row_count_match_percent = d.pop("daily_total_row_count_match_percent", UNSET)
        daily_total_row_count_match_percent: Union[Unset, TableAccuracyTotalRowCountMatchPercentCheckSpec]
        if isinstance(_daily_total_row_count_match_percent,  Unset):
            daily_total_row_count_match_percent = UNSET
        else:
            daily_total_row_count_match_percent = TableAccuracyTotalRowCountMatchPercentCheckSpec.from_dict(_daily_total_row_count_match_percent)
