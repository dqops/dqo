...
from ..models.connection_remote_model_connection_status import ConnectionRemoteModelConnectionStatus
from ..types import UNSET, Unset
...
class ConnectionRemoteModel:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_connection_status,  Unset):
            ...
            connection_status = ConnectionRemoteModelConnectionStatus(_connection_status)
