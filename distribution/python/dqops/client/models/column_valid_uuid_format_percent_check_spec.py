...
if TYPE_CHECKING:
    from ..models.column_patterns_valid_uuid_format_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnValidUuidFormatPercentCheckSpec")


@_attrs_define
class ColumnValidUuidFormatPercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnPatternsValidUuidFormatPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsValidUuidFormatPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnPatternsValidUuidFormatPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_valid_uuid_format_percent_check_spec = cls(
        ...
        column_valid_uuid_format_percent_check_spec.additional_properties = d
        return column_valid_uuid_format_percent_check_spec
