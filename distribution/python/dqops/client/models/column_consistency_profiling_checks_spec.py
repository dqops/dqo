...
class ColumnConsistencyProfilingChecksSpec:
    ...
    date_match_format_percent: Union[Unset, 'ColumnConsistencyDateMatchFormatPercentCheckSpec'] = UNSET
    string_datatype_changed: Union[Unset, 'ColumnStringDatatypeChangedCheckSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_date_match_format_percent,  Unset):
            ...
            date_match_format_percent = ColumnConsistencyDateMatchFormatPercentCheckSpec.from_dict(_date_match_format_percent)
        ...
        if isinstance(_string_datatype_changed,  Unset):
            ...
            string_datatype_changed = ColumnStringDatatypeChangedCheckSpec.from_dict(_string_datatype_changed)
