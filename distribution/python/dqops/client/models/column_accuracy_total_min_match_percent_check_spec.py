...
if TYPE_CHECKING:
    from ..models.column_accuracy_total_min_match_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnAccuracyTotalTotalMinMatchPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnAccuracyTotalMinMatchPercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnAccuracyTotalTotalMinMatchPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnAccuracyTotalTotalMinMatchPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        parameters: Union[Unset, ColumnAccuracyTotalMinMatchPercentSensorParametersSpec]
        if isinstance(_parameters, Unset):
            parameters = UNSET
        else:
            parameters = ColumnAccuracyTotalMinMatchPercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_accuracy_total_min_match_percent_check_spec = cls(
        ...
        column_accuracy_total_min_match_percent_check_spec.additional_properties = d
        return column_accuracy_total_min_match_percent_check_spec
