...
if TYPE_CHECKING:
  ...
  from ..models.column_accuracy_total_min_match_percent_sensor_parameters_spec import ColumnAccuracyTotalMinMatchPercentSensorParametersSpec





T = TypeVar("T", bound="ColumnAccuracyTotalMinMatchPercentCheckSpec")
...
class ColumnAccuracyTotalMinMatchPercentCheckSpec:
    ...
    parameters: Union[Unset, 'ColumnAccuracyTotalMinMatchPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnAccuracyTotalMinMatchPercentSensorParametersSpec.from_dict(_parameters)
