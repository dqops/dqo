...
@_attrs_define
class TableChangeRowCountSince7DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_change_row_count_since_7_days_check_spec.additional_properties = d
        return table_change_row_count_since_7_days_check_spec
