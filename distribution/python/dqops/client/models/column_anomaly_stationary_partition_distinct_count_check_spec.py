...
T = TypeVar("T", bound="ColumnAnomalyStationaryPartitionDistinctCountCheckSpec")


@_attrs_define
class ColumnAnomalyStationaryPartitionDistinctCountCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_anomaly_stationary_partition_distinct_count_check_spec = cls(
        ...
        column_anomaly_stationary_partition_distinct_count_check_spec.additional_properties = (
            d
        )
        return column_anomaly_stationary_partition_distinct_count_check_spec
