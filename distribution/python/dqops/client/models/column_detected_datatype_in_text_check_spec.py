...
if TYPE_CHECKING:
    ...
    from ..models.detected_datatype_equals_rule_parameters_spec import (
        DetectedDatatypeEqualsRuleParametersSpec,
    )
    from ..models.monitoring_schedule_spec import MonitoringScheduleSpec


T = TypeVar("T", bound="ColumnDetectedDatatypeInTextCheckSpec")


@_attrs_define
class ColumnDetectedDatatypeInTextCheckSpec:
    """
    Attributes:
        ...
        warning (Union[Unset, DetectedDatatypeEqualsRuleParametersSpec]):
        error (Union[Unset, DetectedDatatypeEqualsRuleParametersSpec]):
        fatal (Union[Unset, DetectedDatatypeEqualsRuleParametersSpec]):
    """
    ...
    warning: Union[Unset, "DetectedDatatypeEqualsRuleParametersSpec"] = UNSET
    error: Union[Unset, "DetectedDatatypeEqualsRuleParametersSpec"] = UNSET
    fatal: Union[Unset, "DetectedDatatypeEqualsRuleParametersSpec"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_warning, Unset):
            ...
            warning = DetectedDatatypeEqualsRuleParametersSpec.from_dict(_warning)
        ...
        if isinstance(_error, Unset):
            ...
            error = DetectedDatatypeEqualsRuleParametersSpec.from_dict(_error)
        ...
        if isinstance(_fatal, Unset):
            ...
            fatal = DetectedDatatypeEqualsRuleParametersSpec.from_dict(_fatal)

        column_detected_datatype_in_text_check_spec = cls(
        ...
        column_detected_datatype_in_text_check_spec.additional_properties = d
        return column_detected_datatype_in_text_check_spec
