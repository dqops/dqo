...
T = TypeVar("T", bound="TableRowCountAnomalyDifferencingCheckSpec")


@_attrs_define
class TableRowCountAnomalyDifferencingCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        table_row_count_anomaly_differencing_check_spec = cls(
        ...
        table_row_count_anomaly_differencing_check_spec.additional_properties = d
        return table_row_count_anomaly_differencing_check_spec
