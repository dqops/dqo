...
T = TypeVar("T", bound="ColumnNumericMonthlyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnNumericMonthlyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_numeric_monthly_monitoring_checks_spec_custom_checks = cls()
        ...
        column_numeric_monthly_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_numeric_monthly_monitoring_checks_spec_custom_checks
