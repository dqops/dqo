...
if TYPE_CHECKING:
  from ..models.column_comparison_profiling_checks_spec import ColumnComparisonProfilingChecksSpec
...
class ColumnProfilingCheckCategoriesSpecComparisons:
    ...
    additional_properties: Dict[str, 'ColumnComparisonProfilingChecksSpec'] = attr.ib(init=False, factory=dict)
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            additional_property = ColumnComparisonProfilingChecksSpec.from_dict(prop_dict)



            additional_properties[prop_name] = additional_property

        column_profiling_check_categories_spec_comparisons.additional_properties = additional_properties
    ...
    def __setitem__(self, key: str, value: 'ColumnComparisonProfilingChecksSpec') -> None:
