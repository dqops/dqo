...
T = TypeVar("T", bound="EmptyColumnFoundCheckSpec")


@_attrs_define
class EmptyColumnFoundCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        empty_column_found_check_spec = cls(
        ...
        empty_column_found_check_spec.additional_properties = d
        return empty_column_found_check_spec
