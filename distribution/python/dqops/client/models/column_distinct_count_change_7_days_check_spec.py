...
T = TypeVar("T", bound="ColumnDistinctCountChange7DaysCheckSpec")


@_attrs_define
class ColumnDistinctCountChange7DaysCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_distinct_count_change_7_days_check_spec = cls(
        ...
        column_distinct_count_change_7_days_check_spec.additional_properties = d
        return column_distinct_count_change_7_days_check_spec
