...
class ColumnUniquenessDailyRecurringChecksSpec:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_daily_distinct_count,  Unset):
            ...
            daily_distinct_count = ColumnDistinctCountCheckSpec.from_dict(_daily_distinct_count)
        ...
        if isinstance(_daily_distinct_percent,  Unset):
            ...
            daily_distinct_percent = ColumnDistinctPercentCheckSpec.from_dict(_daily_distinct_percent)
        ...
        if isinstance(_daily_duplicate_count,  Unset):
            ...
            daily_duplicate_count = ColumnDuplicateCountCheckSpec.from_dict(_daily_duplicate_count)
        ...
        if isinstance(_daily_duplicate_percent,  Unset):
            ...
            daily_duplicate_percent = ColumnDuplicatePercentCheckSpec.from_dict(_daily_duplicate_percent)
