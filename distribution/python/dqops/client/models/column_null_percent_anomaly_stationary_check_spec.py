...
T = TypeVar("T", bound="ColumnNullPercentAnomalyStationaryCheckSpec")


@_attrs_define
class ColumnNullPercentAnomalyStationaryCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_null_percent_anomaly_stationary_check_spec = cls(
        ...
        column_null_percent_anomaly_stationary_check_spec.additional_properties = d
        return column_null_percent_anomaly_stationary_check_spec
