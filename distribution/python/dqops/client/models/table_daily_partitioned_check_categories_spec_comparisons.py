...
if TYPE_CHECKING:
  from ..models.table_comparison_daily_partitioned_checks_spec import TableComparisonDailyPartitionedChecksSpec
...
class TableDailyPartitionedCheckCategoriesSpecComparisons:
    ...
    additional_properties: Dict[str, 'TableComparisonDailyPartitionedChecksSpec'] = attr.ib(init=False, factory=dict)
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        for prop_name, prop_dict in d.items():
            additional_property = TableComparisonDailyPartitionedChecksSpec.from_dict(prop_dict)



            additional_properties[prop_name] = additional_property

        table_daily_partitioned_check_categories_spec_comparisons.additional_properties = additional_properties
    ...
    def __setitem__(self, key: str, value: 'TableComparisonDailyPartitionedChecksSpec') -> None:
