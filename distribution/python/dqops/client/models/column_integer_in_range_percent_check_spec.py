...
if TYPE_CHECKING:
    from ..models.column_numeric_integer_in_range_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnIntegerInRangePercentCheckSpec")


@_attrs_define
class ColumnIntegerInRangePercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnNumericIntegerInRangePercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnNumericIntegerInRangePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnNumericIntegerInRangePercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_integer_in_range_percent_check_spec = cls(
        ...
        column_integer_in_range_percent_check_spec.additional_properties = d
        return column_integer_in_range_percent_check_spec
