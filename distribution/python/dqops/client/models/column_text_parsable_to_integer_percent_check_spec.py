...
if TYPE_CHECKING:
    from ..models.column_text_text_parsable_to_integer_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextParsableToIntegerPercentCheckSpec")


@_attrs_define
class ColumnTextParsableToIntegerPercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnTextTextParsableToIntegerPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnTextTextParsableToIntegerPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnTextTextParsableToIntegerPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_text_parsable_to_integer_percent_check_spec = cls(
        ...
        column_text_parsable_to_integer_percent_check_spec.additional_properties = d
        return column_text_parsable_to_integer_percent_check_spec
