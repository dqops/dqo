...
if TYPE_CHECKING:
    from ..models.column_whitespace_whitespace_text_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnWhitespaceWhitespaceTextPercentCheckSpec")


@_attrs_define
class ColumnWhitespaceWhitespaceTextPercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnWhitespaceWhitespaceTextPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnWhitespaceWhitespaceTextPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnWhitespaceWhitespaceTextPercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_whitespace_whitespace_text_percent_check_spec = cls(
        ...
        column_whitespace_whitespace_text_percent_check_spec.additional_properties = d
        return column_whitespace_whitespace_text_percent_check_spec
