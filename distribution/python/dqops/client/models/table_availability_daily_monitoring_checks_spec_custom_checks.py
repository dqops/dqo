...
T = TypeVar("T", bound="TableAvailabilityDailyMonitoringChecksSpecCustomChecks")


@_attrs_define
class TableAvailabilityDailyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        table_availability_daily_monitoring_checks_spec_custom_checks = cls()
        ...
        table_availability_daily_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return table_availability_daily_monitoring_checks_spec_custom_checks
