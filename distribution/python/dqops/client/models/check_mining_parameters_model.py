...
class CheckMiningParametersModel:
    ...
    Attributes:
        ...
        propose_column_count_check (Union[Unset, bool]): Proposes the default configuration of the column count check.
        ...
        propose_null_checks (Union[Unset, bool]): Proposes the default configuration the null checks that validate the
            count and percentage of nulls. The default value of this parameter is 'true'.
    ...
    propose_column_count_check: Union[Unset, bool] = UNSET
    propose_timeliness_checks: Union[Unset, bool] = UNSET
    propose_null_checks: Union[Unset, bool] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        propose_column_count_check = self.propose_column_count_check
        propose_timeliness_checks = self.propose_timeliness_checks
        propose_null_checks = self.propose_null_checks
        ...
        if propose_column_count_check is not UNSET:
            field_dict["propose_column_count_check"] = propose_column_count_check
        if propose_timeliness_checks is not UNSET:
            field_dict["propose_timeliness_checks"] = propose_timeliness_checks
        if propose_null_checks is not UNSET:
            field_dict["propose_null_checks"] = propose_null_checks
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        propose_column_count_check = d.pop("propose_column_count_check", UNSET)

        propose_timeliness_checks = d.pop("propose_timeliness_checks", UNSET)

        propose_null_checks = d.pop("propose_null_checks", UNSET)
        ...
        check_mining_parameters_model = cls(
            ...
            propose_column_count_check=propose_column_count_check,
            propose_timeliness_checks=propose_timeliness_checks,
            propose_null_checks=propose_null_checks,
