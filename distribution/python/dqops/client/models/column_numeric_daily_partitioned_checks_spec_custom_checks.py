...
T = TypeVar("T", bound="ColumnNumericDailyPartitionedChecksSpecCustomChecks")


@_attrs_define
class ColumnNumericDailyPartitionedChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_numeric_daily_partitioned_checks_spec_custom_checks = cls()
        ...
        column_numeric_daily_partitioned_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_numeric_daily_partitioned_checks_spec_custom_checks
