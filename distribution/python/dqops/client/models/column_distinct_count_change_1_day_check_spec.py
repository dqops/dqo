...
T = TypeVar("T", bound="ColumnDistinctCountChange1DayCheckSpec")


@_attrs_define
class ColumnDistinctCountChange1DayCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_distinct_count_change_1_day_check_spec = cls(
        ...
        column_distinct_count_change_1_day_check_spec.additional_properties = d
        return column_distinct_count_change_1_day_check_spec
