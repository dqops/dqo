...
if TYPE_CHECKING:
    from ..models.column_patterns_text_not_matching_date_pattern_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnTextNotMatchingDatePatternPercentCheckSpec")


@_attrs_define
class ColumnTextNotMatchingDatePatternPercentCheckSpec:
    """
    Attributes:
        ...
        parameters (Union[Unset, ColumnPatternsTextNotMatchingDatePatternPercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnPatternsTextNotMatchingDatePatternPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnPatternsTextNotMatchingDatePatternPercentSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_text_not_matching_date_pattern_percent_check_spec = cls(
        ...
        column_text_not_matching_date_pattern_percent_check_spec.additional_properties = (
            d
        )
        return column_text_not_matching_date_pattern_percent_check_spec
