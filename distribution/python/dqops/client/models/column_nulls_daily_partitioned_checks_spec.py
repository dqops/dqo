...
class ColumnNullsDailyPartitionedChecksSpec:
    ...
    daily_partition_not_nulls_count: Union[Unset, 'ColumnNotNullsCountCheckSpec'] = UNSET
    daily_partition_not_nulls_percent: Union[Unset, 'ColumnNotNullsPercentCheckSpec'] = UNSET
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.daily_partition_not_nulls_count, Unset):
            daily_partition_not_nulls_count = self.daily_partition_not_nulls_count.to_dict()
        ...
        if not isinstance(self.daily_partition_not_nulls_percent, Unset):
            daily_partition_not_nulls_percent = self.daily_partition_not_nulls_percent.to_dict()
        ...
        if daily_partition_not_nulls_count is not UNSET:
            field_dict["daily_partition_not_nulls_count"] = daily_partition_not_nulls_count
        if daily_partition_not_nulls_percent is not UNSET:
            field_dict["daily_partition_not_nulls_percent"] = daily_partition_not_nulls_percent
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_daily_partition_nulls_count,  Unset):
            ...
            daily_partition_nulls_count = ColumnNullsCountCheckSpec.from_dict(_daily_partition_nulls_count)
        ...
        if isinstance(_daily_partition_nulls_percent,  Unset):
            ...
            daily_partition_nulls_percent = ColumnNullsPercentCheckSpec.from_dict(_daily_partition_nulls_percent)




        _daily_partition_not_nulls_count = d.pop("daily_partition_not_nulls_count", UNSET)
        daily_partition_not_nulls_count: Union[Unset, ColumnNotNullsCountCheckSpec]
        if isinstance(_daily_partition_not_nulls_count,  Unset):
            daily_partition_not_nulls_count = UNSET
        else:
            daily_partition_not_nulls_count = ColumnNotNullsCountCheckSpec.from_dict(_daily_partition_not_nulls_count)




        _daily_partition_not_nulls_percent = d.pop("daily_partition_not_nulls_percent", UNSET)
        daily_partition_not_nulls_percent: Union[Unset, ColumnNotNullsPercentCheckSpec]
        if isinstance(_daily_partition_not_nulls_percent,  Unset):
            daily_partition_not_nulls_percent = UNSET
        else:
            daily_partition_not_nulls_percent = ColumnNotNullsPercentCheckSpec.from_dict(_daily_partition_not_nulls_percent)
