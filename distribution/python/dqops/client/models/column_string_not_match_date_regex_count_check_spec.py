...
if TYPE_CHECKING:
    from ..models.column_strings_string_not_match_date_regex_count_sensor_parameters_spec import (
...
class ColumnStringNotMatchDateRegexCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringNotMatchDateRegexCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringNotMatchDateRegexCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
