...
if TYPE_CHECKING:
  from ..models.column_strings_string_not_match_date_regex_count_sensor_parameters_spec import ColumnStringsStringNotMatchDateRegexCountSensorParametersSpec
...
T = TypeVar("T", bound="ColumnStringNotMatchDateRegexCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringNotMatchDateRegexCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringNotMatchDateRegexCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringNotMatchDateRegexCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringNotMatchDateRegexCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_not_match_date_regex_count_check_spec = cls(
        ...
        column_string_not_match_date_regex_count_check_spec.additional_properties = d
        return column_string_not_match_date_regex_count_check_spec
