...
T = TypeVar("T", bound="ColumnDistinctCountAnomalyStationaryPartitionCheckSpec")


@_attrs_define
class ColumnDistinctCountAnomalyStationaryPartitionCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_distinct_count_anomaly_stationary_partition_check_spec = cls(
        ...
        column_distinct_count_anomaly_stationary_partition_check_spec.additional_properties = (
            d
        )
        return column_distinct_count_anomaly_stationary_partition_check_spec
