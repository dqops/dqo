...
if TYPE_CHECKING:
  ...
  from ..models.column_strings_string_null_placeholder_count_sensor_parameters_spec import ColumnStringsStringNullPlaceholderCountSensorParametersSpec





T = TypeVar("T", bound="ColumnStringNullPlaceholderCountCheckSpec")


@attr.s(auto_attribs=True)
class ColumnStringNullPlaceholderCountCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnStringsStringNullPlaceholderCountSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnStringsStringNullPlaceholderCountSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnStringsStringNullPlaceholderCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_string_null_placeholder_count_check_spec = cls(
        ...
        column_string_null_placeholder_count_check_spec.additional_properties = d
        return column_string_null_placeholder_count_check_spec
