...
if TYPE_CHECKING:
    from ..models.column_strings_string_null_placeholder_count_sensor_parameters_spec import (
...
class ColumnStringNullPlaceholderCountCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnStringsStringNullPlaceholderCountSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnStringsStringNullPlaceholderCountSensorParametersSpec.from_dict(
                    _parameters
                )
            )
