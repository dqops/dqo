...
if TYPE_CHECKING:
    from ..models.column_patterns_invalid_usa_zipcode_format_found_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnInvalidUsaZipcodeFoundCheckSpec")


@_attrs_define
class ColumnInvalidUsaZipcodeFoundCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnPatternsInvalidUsaZipcodeFormatFoundSensorParametersSpec.from_dict(
                _parameters
            )
        ...
        column_invalid_usa_zipcode_found_check_spec.additional_properties = d
        return column_invalid_usa_zipcode_found_check_spec
