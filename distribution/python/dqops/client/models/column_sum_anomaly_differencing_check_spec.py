...
T = TypeVar("T", bound="ColumnSumAnomalyDifferencingCheckSpec")


@_attrs_define
class ColumnSumAnomalyDifferencingCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_sum_anomaly_differencing_check_spec = cls(
        ...
        column_sum_anomaly_differencing_check_spec.additional_properties = d
        return column_sum_anomaly_differencing_check_spec
