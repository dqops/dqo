...
T = TypeVar("T", bound="ColumnSchemaDailyMonitoringChecksSpecCustomChecks")


@_attrs_define
class ColumnSchemaDailyMonitoringChecksSpecCustomChecks:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        d = src_dict.copy()
        column_schema_daily_monitoring_checks_spec_custom_checks = cls()
        ...
        column_schema_daily_monitoring_checks_spec_custom_checks.additional_properties = (
            additional_properties
        )
        return column_schema_daily_monitoring_checks_spec_custom_checks
