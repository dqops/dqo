...
T = TypeVar("T", bound="MaxCountRule1ParametersSpec")


@_attrs_define
class MaxCountRule1ParametersSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        max_count_rule_1_parameters_spec = cls(
            max_count=max_count,
        )

        max_count_rule_1_parameters_spec.additional_properties = d
        return max_count_rule_1_parameters_spec
