...
class ColumnAccuracyMonthlyRecurringChecksSpec:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        if not isinstance(self.monthly_total_min_match_percent, Unset):
            monthly_total_min_match_percent = self.monthly_total_min_match_percent.to_dict()
        ...
        if not isinstance(self.monthly_total_max_match_percent, Unset):
            monthly_total_max_match_percent = self.monthly_total_max_match_percent.to_dict()
        ...
        if not isinstance(self.monthly_total_average_match_percent, Unset):
            monthly_total_average_match_percent = self.monthly_total_average_match_percent.to_dict()
        ...
        if monthly_total_max_match_percent is not UNSET:
            field_dict["monthly_total_max_match_percent"] = monthly_total_max_match_percent
