...
T = TypeVar("T", bound="OptionalCronScheduleSpec")


@_attrs_define
class OptionalCronScheduleSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        optional_cron_schedule_spec = cls(
            empty=empty,
            present=present,
        )

        optional_cron_schedule_spec.additional_properties = d
        return optional_cron_schedule_spec
