...
if TYPE_CHECKING:
  from ..models.column_nulls_not_nulls_count_sensor_parameters_spec import ColumnNullsNotNullsCountSensorParametersSpec
...
T = TypeVar("T", bound="ColumnComparisonNotNullCountMatchCheckSpec")


@attr.s(auto_attribs=True)
class ColumnComparisonNotNullCountMatchCheckSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnNullsNotNullsCountSensorParametersSpec.from_dict(_parameters)
        ...
        column_comparison_not_null_count_match_check_spec = cls(
        ...
        column_comparison_not_null_count_match_check_spec.additional_properties = d
        return column_comparison_not_null_count_match_check_spec
