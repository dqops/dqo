...
if TYPE_CHECKING:
    from ..models.column_numeric_number_below_min_value_percent_sensor_parameters_spec import (
...
T = TypeVar("T", bound="ColumnNumberBelowMinValuePercentCheckSpec")


@_attrs_define
class ColumnNumberBelowMinValuePercentCheckSpec:
    """
    Attributes:
        ...
        data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
            ...
            table.
        parameters (Union[Unset, ColumnNumericNumberBelowMinValuePercentSensorParametersSpec]):
    ...
    parameters: Union[
        Unset, "ColumnNumericNumberBelowMinValuePercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ColumnNumericNumberBelowMinValuePercentSensorParametersSpec.from_dict(
                    _parameters
                )
            )
        ...
        column_number_below_min_value_percent_check_spec = cls(
        ...
        column_number_below_min_value_percent_check_spec.additional_properties = d
        return column_number_below_min_value_percent_check_spec
