...
T = TypeVar("T", bound="ColumnSqlConditionFailedCountSensorParametersSpec")


@attr.s(auto_attribs=True)
class ColumnSqlConditionFailedCountSensorParametersSpec:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_sql_condition_failed_count_sensor_parameters_spec = cls(
            filter_=filter_,
            sql_condition=sql_condition,
        )

        column_sql_condition_failed_count_sensor_parameters_spec.additional_properties = d
        return column_sql_condition_failed_count_sensor_parameters_spec
