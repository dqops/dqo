...
T = TypeVar("T", bound="ColumnMeanChangeCheckSpec")


@_attrs_define
class ColumnMeanChangeCheckSpec:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        column_mean_change_check_spec = cls(
        ...
        column_mean_change_check_spec.additional_properties = d
        return column_mean_change_check_spec
