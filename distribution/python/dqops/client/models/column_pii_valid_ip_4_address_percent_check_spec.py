...
if TYPE_CHECKING:
    from ..models.column_pii_valid_ip_4_address_percent_sensor_parameters_spec import (
...
class ColumnPiiValidIp4AddressPercentCheckSpec:
    ...
    parameters: Union[
        Unset, "ColumnPiiValidIp4AddressPercentSensorParametersSpec"
    ] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = ColumnPiiValidIp4AddressPercentSensorParametersSpec.from_dict(
                _parameters
            )
