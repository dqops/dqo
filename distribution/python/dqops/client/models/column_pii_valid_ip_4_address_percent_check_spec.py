...
if TYPE_CHECKING:
  ...
  from ..models.column_pii_valid_ip_4_address_percent_sensor_parameters_spec import ColumnPiiValidIp4AddressPercentSensorParametersSpec
...
T = TypeVar("T", bound="ColumnPiiValidIp4AddressPercentCheckSpec")


@attr.s(auto_attribs=True)
class ColumnPiiValidIp4AddressPercentCheckSpec:
    """ 
        Attributes:
            ...
            data_grouping (Union[Unset, str]): Data grouping configuration name that should be applied to this data quality
                ...
                table.
            parameters (Union[Unset, ColumnPiiValidIp4AddressPercentSensorParametersSpec]):
    ...
    parameters: Union[Unset, 'ColumnPiiValidIp4AddressPercentSensorParametersSpec'] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        if isinstance(_parameters,  Unset):
            ...
            parameters = ColumnPiiValidIp4AddressPercentSensorParametersSpec.from_dict(_parameters)
        ...
        column_pii_valid_ip_4_address_percent_check_spec = cls(
        ...
        column_pii_valid_ip_4_address_percent_check_spec.additional_properties = d
        return column_pii_valid_ip_4_address_percent_check_spec
