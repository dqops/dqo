...
def get_severity_value(rule_severity: RuleSeverityLevel) -> int:
    ...
    if rule_severity == RuleSeverityLevel.VALID:    return 0
    if rule_severity == RuleSeverityLevel.WARNING:  return 1
    if rule_severity == RuleSeverityLevel.ERROR:    return 2
    if rule_severity == RuleSeverityLevel.FATAL:    return 3
