...
from dqops.airflow.check_results.dqo_assert_table_status_operator import DqoAssertTableStatusOperator
...
class DqoAssertProfilingTableStatusOperator(BaseOperator):
    """
