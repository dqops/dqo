...
def evaluate_rule(rule_parameters: RuleExecutionRunParameters) -> RuleExecutionResult:
    ...
    above_median_multiples_array = [(readout / filtered_median_float - 1.0) for readout in extracted if readout >= filtered_median_float]
    ...
    below_median_multiples_array = [(-1.0 / (readout / filtered_median_float)) for readout in extracted if readout < filtered_median_float if readout != 0]
